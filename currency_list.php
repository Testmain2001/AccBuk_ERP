...
<div class="row">     
	<div class="col-md-2">       
	<h4 class="fw-bold mb-4" style="padding-top:2px;"> Currency Master</h4>
	</div>
	<div class="col-md-2">
	...
	<tbody>
	   <?php
			...
			foreach($data as $info){
						...
						$href= 'currency_list.php?id='.$info['id'].'&PTask=view';
		...
		<td>
            <!--div class="dropdown"-->
				...
				<?php if((CheckEditMenu())==1) {  ?>
               	<a class="dropdown-item" href="currency_list.php?id=<?php echo $info['id'];?>&PTask=update"><i class="bx bx-edit-alt me-1"></i> Edit</a>
				<?php } ?>
				<?php if((CheckDeleteMenu())==1){ ?>
                <a class="dropdown-item" href="currency_list.php?id=<?php echo $info['id'];?>&PTask=delete"><i class="bx bx-trash me-1"></i> Delete</a>
				<?php } ?>
              </div>
            <!--/div-->
        </td>
...
<?php 
include("form/currency_form.php");
?>
...
if($_REQUEST['PTask']=='delete'){?>	
 window.onload=function(){
	var r=confirm("Are you sure to delete?");
		...
		{
			window.location="currency_list.php";
		}
 ...
 function CheckDelete()
{
	...
	else
	{
			...
			window.location="currency_list.php?PTask=delete&id="+val; 
...
function savedata(){
	...
	jQuery.ajax({url:'handler/currency_form.php', type:'POST',
				data: { PTask:PTask,id:id,currency_symbol:currency_symbol,formal_name:formal_name,decimal_places:decimal_places,table:table,LastEdited:LastEdited},
