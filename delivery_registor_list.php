...
<div class="row">     
	<div class="col-md-3">       
	<h4 class="fw-bold mb-4" style="padding-top:2px;">Delivery Registor </h4>
	</div>
  ...
  <div class="card-datatable table-responsive pt-0" style="overflow-x: auto;">
	...
	<tbody>
	   <?php
			...
			$data=$utilObj->getMultipleRow("delivery_challan"," $cnd");
			foreach($data as $info){
					...
					foreach($data1 as $info1)
					{
						...
						<td class="<?php echo $hidetd; ?>" rowspan="<?php echo $rowspan; ?>"><?php echo $sale_order['order_no']; ?></td>
...
function Search(){
	...
	window.location="delivery_registor_list.php?FromDate="+fromdate+"&ToDate="+todate+"&customer="+customer+"&Task=filter";
