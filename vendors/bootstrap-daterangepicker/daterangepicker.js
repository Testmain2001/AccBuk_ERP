  ...
  DateRangePicker.prototype = {
    ...
    updateCalendars: function () {
      if (this.timePicker) {
        ...
        if (this.endDate) {
          hour = parseFloat(this.container.find(".left .hourselect").val(), 10);
          minute = parseFloat(
            this.container.find(".left .minuteselect").val(),
            10
          );
          second = this.timePickerSeconds
            ? parseFloat(this.container.find(".left .secondselect").val(), 10)
            : 0;
          ...
          second = this.timePickerSeconds
            ? parseFloat(this.container.find(".right .secondselect").val(), 10)
            : 0;
          if (!this.timePicker24Hour) {
    ...
    monthOrYearChanged: function (e) {
      ...
      var month = parseFloat(cal.find(".monthselect").val(), 10);
    ...
    timeChanged: function (e) {
      ...
      var hour = parseFloat(cal.find(".hourselect").val(), 10);
      var minute = parseFloat(cal.find(".minuteselect").val(), 10);
      var second = this.timePickerSeconds
        ? parseFloat(cal.find(".secondselect").val(), 10)
        : 0;
