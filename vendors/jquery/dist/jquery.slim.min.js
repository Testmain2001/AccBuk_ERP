...
!(function (a, b) {
  ...
  (o.fn = o.prototype =
    ...
    o.extend({
      ...
      isNumeric: function (a) {
        var b = o.type(a);
        return ("number" === b || "string" === b) && a - parseFloat(a) + 1 >= 0;
      },
      isPlainObject: function (a) {
        return "object" !== o.type(a) || a.nodeType || o.isWindow(a)
          ? !1
    ...
    "function" == typeof Symbol && (o.fn[Symbol.iterator] = c[Symbol.iterator]),
    o.each(
  ...
  (o.find = u),
    ...
    (o.uniqueSort = o.unique = u.uniqueSort),
    (o.text = u.getText),
    (o.isXMLDoc = u.isXML),
  ...
  function A(a, b, c) {
    ...
    if ("string" == typeof b) {
      if (z.test(b)) return o.filter(b, a, c);
      b = o.filter(b, a);
    }
    return o.grep(a, function (a) {
  ...
  (o.filter = function (a, b, c) {
    ...
    o.fn.extend({
      ...
      is: function (a) {
        return !!A(this, "string" == typeof a && x.test(a) ? o(a) : a || [], !1)
          .length;
      },
    });
  var B,
      ...
      if (((c = c || B), "string" == typeof a)) {
        ...
        if (e[1]) {
          if (
            ...
            o.merge(
              this,
              o.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : d, !0)
            ),
            y.test(e[1]) && o.isPlainObject(b))
          )
            for (e in b)
    ...
    function (a, b) {
      o.fn[a] = function (c, d) {
        ...
        return (
          ...
          this.length > 1 &&
            (F[a] || o.uniqueSort(e), E.test(a) && e.reverse()),
          this.pushStack(e)
        );
      };
    }
  ...
  o.Callbacks = function (a) {
    a = "string" == typeof a ? I(a) : o.extend({}, a);
    var b,
      c,
      d,
      e,
              ...
              (function d(b) {
                o.each(b, function (b, c) {
                  o.isFunction(c)
                    ...
                    : c && c.length && "string" !== o.type(c) && d(c);
                });
              })(arguments),
              c && !b && i()),
            this
            ...
            return o
              .Deferred(function (b) {
                o.each(c, function (c, d) {
                  var g = o.isFunction(a[d[4]]) && a[d[4]];
                  f[d[1]](function () {
              ...
              return function () {
                    ...
                    : function () {
                        try {
                          ...
                          o.Deferred.exceptionHook &&
                            o.Deferred.exceptionHook(a, l.stackTrace),
                            b + 1 >= g &&
                              (d !== K && ((i = void 0), (j = [a])),
                ...
                b
                  ...
                  : (o.Deferred.getStackHook &&
                      (l.stackTrace = o.Deferred.getStackHook()),
                    a.setTimeout(l));
              };
            }
            return o
              .Deferred(function (a) {
                c[0][3].add(h(0, a, o.isFunction(f) ? f : J, a.notifyWith)),
                  c[1][3].add(h(0, a, o.isFunction(b) ? b : J)),
                  c[2][3].add(h(0, a, o.isFunction(d) ? d : K));
              })
              .promise();
          },
          promise: function (a) {
    ...
    when: function () {
      var a,
        ...
        i = function (a) {
          return function (c) {
            (b[a] = this),
              (d[a] = arguments.length > 1 ? e.call(arguments) : c),
              --g || h.resolveWith(1 === b.length ? b[0] : b, d);
          };
        };
      if (f > 0)
        for (b = new Array(f); f > c; c++)
          d[c] && o.isFunction((a = d[c].promise))
            ? a.call(d[c]).done(i(c)).fail(h.reject)
            : d[c] && o.isFunction((a = d[c].then))
            ? a.call(d[c], i(c), h.reject)
            : i(c)(d[c]);
      else h.resolveWith();
      return h.promise();
    },
  ...
  o.Deferred.exceptionHook = function (b, c) {
    a.console &&
      a.console.warn &&
      b &&
      L.test(b.name) &&
      a.console.warn("jQuery.Deferred exception: " + b.message, c);
  };
  var M;
    ...
    o.extend({
      ...
      ready: function (a) {
        (a === !0 ? --o.readyWait : o.isReady) ||
          ((o.isReady = !0),
          (a !== !0 && --o.readyWait > 0) || M.resolveWith(d, [o]));
      },
    });
  function N() {
  ...
  (Q.uid = 1),
    (Q.prototype = {
      ...
      set: function (a, b, c) {
        var d,
          e = this.cache(a);
        if ("string" == typeof b) e[o.camelCase(b)] = c;
        else for (d in b) e[o.camelCase(d)] = b[d];
        return e;
      },
      get: function (a, b) {
        return void 0 === b
          ? this.cache(a)
          : a[this.expando] && a[this.expando][o.camelCase(b)];
      },
      ...
      remove: function (a, b) {
        ...
        if (void 0 !== d) {
          if (void 0 !== b) {
            o.isArray(b)
              ? (b = b.map(o.camelCase))
              : ((b = o.camelCase(b)), (b = b in d ? [b] : b.match(H) || [])),
              (c = b.length);
            while (c--) delete d[b[c]];
          }
          (void 0 === b || o.isEmptyObject(d)) &&
            (a.nodeType ? (a[this.expando] = void 0) : delete a[this.expando]);
        }
      },
      hasData: function (a) {
        var b = a[this.expando];
        return void 0 !== b && !o.isEmptyObject(b);
      },
    });
  var R = new Q(),
    S = new Q(),
  ...
  function V(a, b, c) {
    ...
    if (void 0 === c && 1 === a.nodeType)
      if (
        ((d = "data-" + b.replace(U, "-$&").toLowerCase()),
        (c = a.getAttribute(d)),
        "string" == typeof c)
      ) {
        try {
    ...
    o.fn.extend({
      data: function (a, b) {
        ...
        if (void 0 === a) {
          if (
            this.length &&
            ((e = S.get(f)), 1 === f.nodeType && !R.get(f, "hasDataAttrs"))
          ) {
            c = g.length;
            while (c--)
              g[c] &&
                ((d = g[c].name),
                0 === d.indexOf("data-") &&
                  ((d = o.camelCase(d.slice(5))), V(f, d, e[d])));
        ...
        return "object" == typeof a
          ...
          : O(
              ...
              function (b) {
                var c;
                if (f && void 0 === b) {
                  if (((c = S.get(f, a)), void 0 !== c)) return c;
                  if (((c = V(f, a)), void 0 !== c)) return c;
                } else
                  this.each(function () {
                    S.set(this, a, b);
                  });
  ...
  function _(a, b, c, d) {
    var e,
      ...
      k = (o.cssNumber[b] || ("px" !== j && +i)) && X.exec(o.css(a, b));
    if (k && k[3] !== j) {
      (j = j || k[3]), (c = c || []), (k = +i || 1);
      do (f = f || ".5"), (k /= f), o.style(a, b, k + j);
      while (f !== (f = h() / i) && 1 !== f && --g);
    }
    return (
      c &&
    ...
    for (var c, d, e = [], f = 0, g = a.length; g > f; f++)
      (d = a[f]),
        d.style &&
          ...
          b
            ? ("none" === c &&
                ((e[f] = R.get(d, "display") || null),
                e[f] || (d.style.display = "")),
              "" === d.style.display &&
                "none" === o.css(d, "display") &&
                o.contains(d.ownerDocument, d) &&
                (e[f] = ba(d)))
            : "none" !== c && ((e[f] = "none"), R.set(d, "display", c)));
  ...
  function ka(a, b, c, d, e) {
    for (
      ...
      if (((f = a[n]), f || 0 === f))
        if ("object" === o.type(f)) o.merge(m, f.nodeType ? [f] : f);
        else if (ja.test(f)) {
          (g = g || l.appendChild(b.createElement("div"))),
            (h = (ea.exec(f) || ["", ""])[1].toLowerCase()),
            (i = ga[h] || ga._default),
            (g.innerHTML = i[1] + o.htmlPrefilter(f) + i[2]),
            (k = i[0]);
    ...
    (l.textContent = ""), (n = 0);
    while ((f = m[n++]))
      if (d && o.inArray(f, d) > -1) e && e.push(f);
      else if (
        ((j = o.contains(f.ownerDocument, f)),
        (g = ha(l.appendChild(f), "script")),
        j && ia(g),
        c)
      ) {
        k = 0;
        while ((f = g[k++])) fa.test(f.type || "") && c.push(f);
      }
    return l;
  }
  !(function () {
  ...
  (o.event = {
      ...
      if (r) {
        c.handler && ((f = c), (c = f.handler), (e = f.selector)),
          ...
          (g = r.handle) ||
            (g = r.handle =
              function (b) {
                return "undefined" != typeof o && o.event.triggered !== b.type
    ...
    (o.Event.prototype = {
      ...
      preventDefault: function () {
        ...
        (this.isDefaultPrevented = oa), a && a.preventDefault();
      },
      stopPropagation: function () {
        var a = this.originalEvent;
        (this.isPropagationStopped = oa), a && a.stopPropagation();
      },
  ...
  function Aa(a, b) {
    ...
    if (1 === b.nodeType) {
      if (
        R.hasData(a) &&
        ((f = R.access(a)), (g = R.set(b, f)), (j = f.events))
      ) {
  ...
  function Ca(a, b, c, d) {
    ...
    var e,
      ...
      r = b[0],
      s = o.isFunction(r);
    if (s || (p > 1 && "string" == typeof r && !l.checkClone && ua.test(r)))
      return a.each(function (e) {
        var f = a.eq(e);
        s && (b[0] = r.call(this, e, f.html())), Ca(f, b, c, d);
      });
    if (
      p &&
      ((e = ka(b, a[0].ownerDocument, !1, a, d)),
      (g = e.firstChild),
      ...
      for (h = o.map(ha(e, "script"), ya), i = h.length; p > n; n++)
        (j = e),
          n !== q &&
            ((j = o.clone(j, !0, !0)), i && o.merge(h, ha(j, "script"))),
          c.call(a[n], j, n);
      if (i)
        for (k = h[h.length - 1].ownerDocument, o.map(h, za), n = 0; i > n; n++)
          (j = h[n]),
            fa.test(j.type || "") &&
              !R.access(j, "globalEval") &&
              o.contains(k, j) &&
              (j.src
                ? o._evalUrl && o._evalUrl(j.src)
                : m(j.textContent.replace(wa, ""), k));
    }
    return a;
  }
  function Da(a, b, c) {
    for (var d, e = b ? o.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
      c || 1 !== d.nodeType || o.cleanData(ha(d)),
        d.parentNode &&
          (c && o.contains(d.ownerDocument, d) && ia(ha(d, "script")),
  ...
  o.extend({
    ...
    clone: function (a, b, c) {
      ...
      if (
        ...
        for (g = ha(h), f = ha(a), d = 0, e = f.length; e > d; d++)
          Ba(f[d], g[d]);
      if (b)
        if (c)
          for (f = f || ha(a), g = g || ha(h), d = 0, e = f.length; e > d; d++)
            Aa(f[d], g[d]);
        else Aa(a, h);
      return (
        (g = ha(h, "script")), g.length > 0 && ia(g, !i && ha(a, "script")), h
      );
    },
            ...
            if (
              ...
              try {
                for (; d > c; c++)
                  (b = this[c] || {}),
                    1 === b.nodeType &&
                      (o.cleanData(ha(b, !1)), (b.innerHTML = a));
                b = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return Ca(
          ...
          function (b) {
            ...
            o.inArray(this, a) < 0 &&
              (o.cleanData(ha(this)), c && c.replaceChild(b, this));
          },
          a
        );
      },
  ...
  var Ka = /^(none|table(?!-c[ea]).+)/,
    ...
    Na = ["Webkit", "Moz", "ms"],
    Oa = d.createElement("div").style;
  function Pa(a) {
    if (a in Oa) return a;
    var b = a[0].toUpperCase() + a.slice(1),
      c = Na.length;
    while (c--) if (((a = Na[c] + b), a in Oa)) return a;
  }
  function Qa(a, b, c) {
    var d = X.exec(b);
  ...
  function Ra(a, b, c, d, e) {
    for (
      ...
      "margin" === c && (g += o.css(a, c + Y[f], !0, e)),
        d
          ? ("content" === c && (g -= o.css(a, "padding" + Y[f], !0, e)),
            "margin" !== c && (g -= o.css(a, "border" + Y[f] + "Width", !0, e)))
          : ((g += o.css(a, "padding" + Y[f], !0, e)),
            "padding" !== c &&
              (g += o.css(a, "border" + Y[f] + "Width", !0, e)));
    return g;
  }
  function Sa(b, c, e) {
    var f,
      g = !0,
      h = Ga(b),
      i = "border-box" === o.css(b, "boxSizing", !1, h);
    if (
    ...
    style: function (a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        var e,
          ...
          i = a.style;
        return (
          (b = o.cssProps[h] || (o.cssProps[h] = Pa(h) || h)),
      ...
      o.cssHooks[b] = {
        ...
        set: function (a, c, d) {
          var e,
            ...
            g =
              d &&
              Ra(a, b, d, "border-box" === o.css(a, "boxSizing", !1, f), f);
          return (
            g &&
              (e = X.exec(c)) &&
              "px" !== (e[3] || "px") &&
              ((a.style[b] = c), (c = o.css(a, b))),
            Qa(a, c, g)
          );
        },
      };
        ...
        if (3 !== f && 8 !== f && 2 !== f)
          return "undefined" == typeof a.getAttribute
            ...
            : ((1 === f && o.isXMLDoc(a)) ||
                ((b = b.replace(Va, Wa)),
                (e =
                  o.attrHooks[b] || (o.expr.match.bool.test(b) ? Ta : void 0))),
              void 0 !== c
                ? null === c
                ...
                ? d
                : ((d = o.find.attr(a, b)), null == d ? void 0 : d));
      },
      attrHooks: {
        type: {
          set: function (a, b) {
    ...
    o.extend({
      prop: function (a, b, c) {
        ...
        if (3 !== f && 8 !== f && 2 !== f)
          return (
            (1 === f && o.isXMLDoc(a)) ||
              ((b = o.propFix[b] || b), (e = o.propHooks[b])),
            void 0 !== c
              ? e && "set" in e && void 0 !== (d = e.set(a, c, b))
                ? d
                : (a[b] = c)
  ...
  o.fn.extend({
        ...
        if (e)
          return (
            ...
            b && "get" in b && void 0 !== (c = b.get(e, "value"))
              ? c
              : ((c = e.value),
                "string" == typeof c ? c.replace(_a, "") : null == c ? "" : c)
          );
      }
    },
  }),
      ...
      valHooks: {
        ...
        select: {
          ...
          set: function (a, b) {
            ...
            while (g--)
              (d = e[g]),
                (d.selected = o.inArray(o.valHooks.option.get(d), f) > -1) &&
                  (c = !0);
    ...
    o.each(["radio", "checkbox"], function () {
      (o.valHooks[this] = {
        set: function (a, b) {
          return o.isArray(b)
            ? (a.checked = o.inArray(o(a).val(), b) > -1)
            : void 0;
        },
      }),
        l.checkOn ||
  ...
  o.extend(o.event, {
    trigger: function (b, c, e, f) {
      ...
      if (
        ...
        if (!f && !n.noBubble && !o.isWindow(e)) {
          for (
            j = n.delegateType || q, ab.test(j + q) || (h = h.parentNode);
            h;
            h = h.parentNode
          )
            p.push(h), (i = h);
        ...
        while ((h = p[g++]) && !b.isPropagationStopped())
          (b.type = g > 1 ? j : n.bindType || q),
            (m = (R.get(h, "events") || {})[b.type] && R.get(h, "handle")),
            m && m.apply(h, c),
            (m = l && h[l]),
            m &&
              m.apply &&
    ...
    simulate: function (a, b, c) {
      var d = o.extend(new o.Event(), c, { type: a, isSimulated: !0 });
      o.event.trigger(d, null, b), d.isDefaultPrevented() && c.preventDefault();
    },
  }),
    o.fn.extend({
        ...
        o.event.special[b] = {
          setup: function () {
            var d = this.ownerDocument || this,
              e = R.access(d, b);
            e || d.addEventListener(a, c, !0), R.access(d, b, (e || 0) + 1);
          },
          teardown: function () {
            var d = this.ownerDocument || this,
              e = R.access(d, b) - 1;
            e
              ? R.access(d, b, e)
              : (d.removeEventListener(a, c, !0), R.remove(d, b));
          },
        };
      }),
    o.fn.extend({
      wrapAll: function (a) {
        ...
        return (
          this[0] &&
            (o.isFunction(a) && (a = a.call(this[0])),
  ...
  (o.offset = {
    setOffset: function (a, b, c) {
      ...
      "static" === k && (a.style.position = "relative"),
        ...
        o.isFunction(b) && (b = b.call(a, c, o.extend({}, h))),
    ...
    o.fn.extend({
          ...
          return (
            "fixed" === o.css(c, "position")
              ...
              : ((a = this.offsetParent()),
                ...
                (d.top += o.css(a[0], "borderTopWidth", !0) - a.scrollTop()),
                (d.left +=
                  o.css(a[0], "borderLeftWidth", !0) - a.scrollLeft())),
            {
      ...
      offsetParent: function () {
        return this.map(function () {
          ...
          while (a && "static" === o.css(a, "position")) a = a.offsetParent;
          return a || Ha;
        });
      },
    }),
    ...
    o.each(["top", "left"], function (a, b) {
      o.cssHooks[b] = Ja(l.pixelPosition, function (a, c) {
        return c
          ? ((c = Ia(a, b)), Fa.test(c) ? o(a).position()[b] + "px" : c)
          : void 0;
      });
    }),
