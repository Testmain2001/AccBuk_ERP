...
!(function (a) {
  "function" == typeof define && define.amd
    ...
    : "object" == typeof exports // Node/CommonJS
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  function i(b, c, d) {
    ...
    var e = Math.floor(c / b.length),
      ...
      i = [],
      k = 0;
    j(b), // give all elements their natural height
      ...
      a(g).each(function (b, c) {
        var d = b === g.length - 1 ? f : e,
          j = h[b],
          k = i[b],
          l = d - (j - k); // subtract the margin/padding
  ...
  function k(b) {
    var c = 0; // sometimes not accurate of width the text needs to stay on one line. insurance
    return (
  ...
  function o(a, b) {
    ...
    return {
      left: e,
      right: e + a[0].clientWidth, // clientWidth includes padding but NOT scrollbars
      top: f,
  ...
  function p(a, b) {
    var c = a.offset(),
      d =
        c.left +
        t(a, "border-left-width") +
        t(a, "padding-left") -
        (b ? b.left : 0),
      e =
        c.top +
        t(a, "border-top-width") +
        t(a, "padding-top") -
        (b ? b.top : 0);
  ...
  function s() {
    ...
    var b = a("<div><div/></div>")
        ...
        .appendTo("body"),
      c = b.children(),
      d = c.offset().left > b.offset().left; // is the inner div shifted to accommodate a left scrollbar?
    return b.remove(), d;
  }
  ...
  function F(a, b, c) {
    var d, e;
    for (d = 0; d < c.length; d++) if ((e = G(a, b, c[d]))) return e;
    return 0;
  }
  function G(a, b, c) {
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  function M(a, b) {
    ...
    for (
      c = 0;
      c < Ya.length && ((d = Ya[c]), (e = N(d, a, b)), !(e >= 1 && fa(e)));
      c++
    );
    return d;
  }
  ...
  function P(a, b) {
    ...
    return R(a) || R(b)
      ...
      : ((c = a.asMonths()),
        (d = b.asMonths()),
        Math.abs(c) >= 1 && fa(c) && Math.abs(d) >= 1 && fa(d)
          ? c / d
          : a.asDays() / b.asDays());
  }
  ...
  function U(a, b) {
      ...
      for (c = 0; c < b.length; c++) {
        ...
        for (d = b[c], e = [], f = a.length - 1; f >= 0; f--)
          if (((g = a[f][d]), "object" == typeof g)) e.unshift(g);
            ...
            i[d] = g; // if there were no objects, this value will be used
            break;
          }
    ...
    for (c = a.length - 1; c >= 0; c--) {
      h = a[c];
      for (d in h)
        d in i || // if already assigned by previous props or complex props, don't reassign
          (i[d] = h[d]);
    }
    return i;
  }
  ...
  function ia(c, d, e) {
    var f,
      ...
      i,
      j = c[0],
      k = 1 == c.length && "string" == typeof j; // flag for extended functionality
    // clone it
    // "parsing" is required
  ...
  function ja(a, c) {
    ...
    for (d = 0; h > d; d++)
      (e = a[d]),
        b.isMoment(e) || (e = Ta.moment.parseZone(e)),
        (f = f || e._ambigTime),
        (g = g || e._ambigZone),
        i.push(e);
  ...
  function oa(a, b) {
    var c,
      d = "";
    for (c = 0; c < b.length; c++) d += pa(a, b[c]);
    return d;
  }
  function pa(a, b) {
    var c, d; // a token, like "YYYY"
    ...
    return "string" == typeof b
      ...
      ? fb[c]
        ? fb[c](a)
        : ma(a, c)
      : b.maybe && ((d = oa(a, b.maybe)), d.match(/[1-9]/))
      ? d
      : "";
  }
  ...
  function qa(a, b, c, d, e) {
    var f; // works with moment-pre-2.8
    // Expand localized format strings, like "LL" -> "MMMM D YYYY"
    // BTW, this is not important for `formatDate` because it is impossible to put custom tokens
    // or non-zero areas in Moment's localized format strings.
    return (
      (a = Ta.moment.parseZone(a)),
      (b = Ta.moment.parseZone(b)),
  ...
  function ra(a, b, c, d, e) {
    ...
    for (g = 0; g < c.length && ((f = sa(a, b, j, k, c[g])), f !== !1); g++)
      l += f;
    // Similarly, start at the rightmost side of the formatting string and move left
    for (h = c.length - 1; h > g && ((f = sa(a, b, j, k, c[h])), f !== !1); h--)
      m = f + m;
  ...
  function sa(a, b, c, d, e) {
    ...
    return "string" == typeof e
      ? e
      : (f = e.token) && ((g = gb[f.charAt(0)]), g && c.isSame(d, g))
      ? ma(a, f)
      : !1;
  }
  function ta(a) {
  ...
  function ua(a) {
    for (
      ...
      b[1] // a literal string inside [ ... ]
        ? c.push(b[1])
        : b[2] // non-zero formatting inside ( ... )
        ? c.push({ maybe: ua(b[2]) })
        : b[3] // a formatting token
        ? c.push({ token: b[3] })
        : b[5] && // an unenclosed literal string
          c.push(b[5]);
    return c;
  } // export
  ...
  function wa(a, b) {
    ...
    return (
      Y(b, "constructor") && (c = b.constructor),
      "function" != typeof c &&
        (c = b.constructor =
          function () {
            a.apply(this, arguments);
          }),
      (c.prototype = V(a.prototype)),
      W(b, c.prototype),
      X(b, c.prototype),
      W(a, c),
      c
  ...
  function ya(a, b) {
    return a || b
      ? a && b
        ? a.component === b.component && za(a, b) && za(b, a)
        : !1
      : !0;
  }
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  function Ca(a) {
    return _((a.source || {}).rendering, a.rendering);
  }
  function Da(a) {
    var b,
      c,
  ...
  function Ia(a) {
    ...
    for (b = 0; b < a.length; b++) {
      ...
      for (c = a[b], d = 0; d < e.length && La(c, e[d]).length; d++);
  ...
  function Ka(a) {
    ...
    if (void 0 === a.forwardPressure) {
      ...
      for (b = 0; b < d.length; b++)
        (c = d[b]), Ka(c), (e = Math.max(e, 1 + c.forwardPressure));
      a.forwardPressure = e;
    }
  }
  ...
  function La(a, b, c) {
    c = c || [];
    for (var d = 0; d < b.length; d++) Ma(a, b[d]) && c.push(b[d]);
    return c;
  }
  ...
  function Na(c, d) {
    ...
    function f() {
      (U = O.theme ? "ui" : "fc"),
        c.addClass("fc"),
        c.addClass(N.isTouch ? "fc-touch" : "fc-cursor"),
        O.isRTL ? c.addClass("fc-rtl") : c.addClass("fc-ltr"),
        O.theme ? c.addClass("ui-widget") : c.addClass("fc-unthemed"),
        (T = a("<div class='fc-view-container'/>").prependTo(c)),
        (R = N.header = new Qa(N, O)),
        (S = R.render()),
        S && c.prepend(S),
        i(O.defaultView),
        O.handleWindowResize &&
          ((Y = ha(m, O.windowResizeDelay)), a(window).resize(Y));
    }
    function g() {
      W && W.removeElement(),
        R.removeElement(),
    ...
    function i(b) {
      ca++,
        ...
        W &&
          b &&
          W.type !== b &&
          (R.deactivateButton(W.type),
          H(), // prevent a scroll jump when view element is removed
          W.removeElement(),
          (W = N.view = null)),
        ...
        !W &&
          ...
          W.setElement(
            a("<div class='fc-view fc-" + b + "-view' />").appendTo(T)
          ),
          R.activateButton(b)),
        W &&
        ...
        I(), // undo any lone freezeContentHeight calls
        ca--;
    }
    function j(a) {
    ...
    function l() {
      ...
      X =
        "number" == typeof O.contentHeight
          ...
          ? O.height - (S ? S.outerHeight(!0) : 0)
          : Math.round(T.width() / Math.max(O.aspectRatio, 0.5));
    }
    function m(a) {
      !ca &&
        a.target === window &&
	...
	-----------------------------------------------------------------------------*/
    function u() {
      R.updateTitle(W.title);
    }
    function v() {
      var a = N.getNow();
      a.isWithin(W.intervalStart, W.intervalEnd)
        ? R.disableButton("today")
        : R.enableButton("today");
    } /* Selection
	-----------------------------------------------------------------------------*/
    ...
    (N.render = e),
      ...
      (N.rerenderEvents = o), // `renderEvents` serves as a rerender. an API method
    ...
    (P._fullCalendar_weekCalc = (function (a) {
      ...
      (N.moment = function () {
        ...
        return (
          "local" === O.timezone
            ? ((a = Ta.moment.apply(null, arguments)), a.hasTime() && a.local())
            : (a =
                "UTC" === O.timezone
                  ? Ta.moment.utc.apply(null, arguments)
...
----------------------------------------------------------------------------------------------------------------------*/
        ...
        f &&
          a.each(f.split(" "), function (d) {
            ...
            a.each(this.split(","), function (d, e) {
              var f, i, j, k, l, m, o, q, r, s; // the element
              "title" == e
                ? ((g = g.add(a("<h2>&nbsp;</h2>"))), (h = !1))
  ...
  function Ra(c) {
    ...
    function g(b, d) {
      ...
      if (i)
        ...
        if (j) {
          ...
          var o = a.extend({}, k || {}),
            p = _(b.startParam, c.startParam),
            q = _(b.endParam, c.endParam),
            r = _(b.timezoneParam, c.timezoneParam);
          p && (o[p] = I.format()),
            q && (o[q] = M.format()),
      ...
      if (
        ...
        for (
          ...
          c.className
            ...
            a.isArray(c.events) &&
              ((c.origArray = c.events), // for removeEventSource
    ...
    function m(a) {
      ...
      (a.start = H.moment(a.start)),
        a.end ? (a.end = H.moment(a.end)) : (a.end = null),
        x(a, n(a)), // will handle start/end/allDay normalization
        N(S);
    }
    ...
    function p(a, b) {
      ...
      if (f) {
        for (c = w(f), d = 0; d < c.length; d++)
          (e = c[d]),
            e.source || (b && (O.events.push(e), (e.source = O)), S.push(e));
        return N(S), c;
      }
      return [];
    }
    function q(b) {
      var c, d; // inverse=true
      // Remove events from array sources.
      // This works because they have been converted to official Event Objects up front.
      // (and as a result, event._id has been calculated).
      for (
        null == b // null or undefined. remove all events
          ? (b = function () {
              return !0;
            })
          : a.isFunction(b) ||
    ...
    function s(d, e) {
      ...
      if (
        ...
        a.extend(i, d),
        e && (i.source = e),
        (i._id = d._id || (void 0 === d.id ? "_fc" + Bb++ : d.id + "")),
        d.className
        ...
        g && ((g = H.moment(g)), g.isValid() || (g = null)),
          (h = d.allDay),
          void 0 === h && // still undefined? fallback to default
            (h = _(e ? e.allDayDefault : void 0, c.allDayDefault)),
          t(f, g, h, i);
      }
      return i;
    }
    ...
    function t(a, b, c, d) {
      (d.start = a), (d.end = b), (d.allDay = c), u(d), Sa(d);
    }
      ...
      v(a),
        ...
        a.end ||
          (c.forceEventDuration
            ? (a.end = H.getDefaultEventEnd(a.allDay, a.start))
            : (a.end = null));
    }
        ...
        a.allDay
          ? (a.start.stripTime(),
            a.end &&
              ...
              a.end.stripTime())
          : (a.start.hasTime() || (a.start = H.applyTimezone(a.start.time(0))),
            a.end &&
              !a.end.hasTime() &&
              (a.end = H.applyTimezone(a.end.time(0))));
    }
    ...
    function x(b, c, d) {
      ...
      function e(a, b) {
        // date1 - date0
        // date1 - date0
        return d ? L(a, b, d) : c.allDay ? K(a, b) : J(a, b);
      }
      var f,
        g,
        h,
      ...
      return (
        ...
        (f = {
          start: b._start.clone(),
            ...
            ? b._end.clone()
            : H.getDefaultEventEnd(b._allDay, b._start),
          allDay: c.allDay,
        }),
        u(f),
        ...
        a.each(b, function (b, j) {
          ...
          (k = {
            ...
            c
              ...
              : f &&
                !l.end &&
                (l.end = H.getDefaultEventEnd(l.allDay, l.start)),
    ...
    function z(b) {
      var d,
        ...
        g = H.getView(); // `true` (which means "use the defaults") or an override object
    ...
    function A(a, b) {
      var d = b.source || {},
        e = _(b.constraint, d.constraint, c.eventConstraint),
        f = _(b.overlap, d.overlap, c.eventOverlap);
      return D(a, e, f, b);
    }
    ...
    function D(a, b, c, d) {
      ...
      for (g = H.getPeerEvents(a, d), h = 0; h < g.length; h++)
        ...
        if (((i = g[h]), G(i, a))) {
          ...
          if (d) {
            if (((j = _(i.overlap, (i.source || {}).overlap)), j === !1))
              return !1;
    ...
    (H.isFetchNeeded = d),
      (H.fetchEvents = e),
      (H.addEventSource = h),
      (H.removeEventSource = j),
      (H.updateEvent = m),
      (H.renderEvent = p),
      (H.removeEvents = q),
      (H.clientEvents = r),
      (H.mutateEvent = x),
      (H.normalizeEventDates = u),
      (H.normalizeEventTimes = v);
    // imports
    var I,
      M,
      N = H.reportEvents,
      ...
      Q = 0,
      R = 0,
      S = []; // holds events that have already been expanded
    a.each(
	...
	-----------------------------------------------------------------------------------------*/,
      (H.isEventSpanAllowed = A),
      (H.isExternalSpanAllowed = B),
      (H.isSelectionSpanAllowed = C),
      (H.getEventCache = function () {
        return S;
      });
  }
  ...
  var Ta = (a.fullCalendar = { version: "2.7.1", internalApiVersion: 3 }),
    Ua = (Ta.views = {});
  (Ta.isTouch = "ontouchstart" in document),
    (a.fn.fullCalendar = function (b) {
      var c = Array.prototype.slice.call(arguments, 1),
        d = this; // what this function will return (this jQuery object by default)
      return (
        this.each(function (e, f) {
          // loop each DOM element involved
          var g,
            h = a(f),
            i = h.data("fullCalendar"); // the returned value of this single method call
          // a method call
          "string" == typeof b
            ? i &&
              a.isFunction(i[b]) &&
            ...
            : i || ((i = new vb(h, b)), h.data("fullCalendar", i), i.render());
        }),
        d
      );
    });
  ...
  (Ta.intersectRanges = I),
    ...
    (Ta.cssToStr = ca),
    (Ta.proxy = ga),
    (Ta.capitaliseFirstLetter = da) /* Element Geom Utilities
----------------------------------------------------------------------------------------------------------------------*/,
    (Ta.getOuterRect = n),
    (Ta.getClientRect = o),
    (Ta.getContentRect = p),
    (Ta.getScrollbarWidths = q);
...
----------------------------------------------------------------------------------------------------------------------*/,
    (Ta.parseFieldSpecs = E),
    (Ta.compareByFieldSpecs = F),
    (Ta.compareByFieldSpec = G),
    (Ta.flexibleCompare = H) /* Date Utilities
----------------------------------------------------------------------------------------------------------------------*/,
    (Ta.computeIntervalUnit = M),
    (Ta.divideRangeByDuration = O),
    (Ta.divideDurationByDuration = P),
    (Ta.multiplyDuration = Q),
    (Ta.durationHasTime = R);
  var Xa = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
    Ya = [
      "year",
      "month",
      "week",
...
----------------------------------------------------------------------------------------------------------------------*/
  var Za,
    ...
    db = b.fn,
    eb = a.extend({}, db); // function defined below
  // Creating
  // -------------------------------------------------------------------------------------------------
  ...
  (Ta.moment = function () {
    ...
    (Ta.moment.utc = function () {
      var a = ia(arguments, !0);
    ...
    (Ta.moment.parseZone = function () {
      return ia(arguments, !0, !0);
    }),
    // A clone method that works with the flags related to our enhanced functionality.
    // In the future, use moment.momentProperties
    (db.clone = function () {
      var a = eb.clone.apply(this, arguments);
    ...
    (db.week = db.weeks =
      function (a) {
        ...
        return null == a && "function" == typeof b
          ? b(this)
          : "ISO" === b
          ? eb.isoWeek.apply(this, arguments)
          : eb.week.apply(this, arguments);
      }),
    // Time-of-day
    // -------------------------------------------------------------------------------------------------
    // GETTER
    ...
    (db.time = function (a) {
      ...
      if (!this._fullCalendar) return eb.time.apply(this, arguments);
      if (null == a)
        // getter
        return b.duration({
          hours: this.hours(),
    ...
    (db.format = function () {
      return this._fullCalendar && arguments[0]
        ...
        ? ma(this, "YYYY-MM-DD")
        : this._ambigZone
        ? ma(this, "YYYY-MM-DD[T]HH:mm:ss")
        : eb.format.apply(this, arguments);
    }),
    (db.toISOString = function () {
      return this._ambigTime
        ? ma(this, "YYYY-MM-DD")
        : this._ambigZone
        ? ma(this, "YYYY-MM-DD[T]HH:mm:ss")
        : eb.toISOString.apply(this, arguments);
    }),
    // Querying
    // -------------------------------------------------------------------------------------------------
    // Is the moment within the specified range? `end` is exclusive.
    // FYI, this method is not a standard Moment method, so always do our enhanced logic.
    (db.isWithin = function (a, b) {
      var c = ja([this, a, b]);
      return c[0] >= c[1] && c[0] < c[2];
    }),
    // When isSame is called with units, timezone ambiguity is normalized before the comparison happens.
    // If no units specified, the two moments must be identically the same, with matching ambig flags.
    (db.isSame = function (a, b) {
      var c;
      // only do custom logic if this is an enhanced moment
      // only do custom logic if this is an enhanced moment
      return this._fullCalendar
        ? b
          ? ((c = ja([this, a], !0)), eb.isSame.call(c[0], c[1], b))
          : ((a = Ta.moment.parseZone(a)),
            eb.isSame.call(this, a) &&
              Boolean(this._ambigTime) === Boolean(a._ambigTime) &&
              Boolean(this._ambigZone) === Boolean(a._ambigZone))
        : eb.isSame.apply(this, arguments);
    }),
    ...
    a.each(["isBefore", "isAfter"], function (a, b) {
      db[b] = function (a, c) {
        ...
        // only do custom logic if this is an enhanced moment
        return this._fullCalendar
          ? ((d = ja([this, a])), eb[b].call(d[0], d[1], c))
          : eb[b].apply(this, arguments);
      };
    }),
    (Za = "_d" in b() && "updateOffset" in b),
    ($a = Za
      ? function (a, c) {
  ...
  (Ta.Class = va),
    ...
    (va.extend = function () {
      var a,
        b,
        c = arguments.length;
      for (a = 0; c > a; a++) (b = arguments[a]), c - 1 > a && xa(this, b);
      return wa(this, b || {});
    }),
	...
	*/,
      loopCallbacks: function (a, b, c) {
        ...
        for (d = 0; d < g.length; d++)
          (e = g[d]),
            e &&
              ((f = this.ensureCallbackObj((d ? "." : "") + e)),
              f[b].apply(f, c));
      },
      ensureCallbackObj: function (b) {
        return (
          this.callbackHash || (this.callbackHash = {}),
          this.callbackHash[b] || (this.callbackHash[b] = a.Callbacks()),
          this.callbackHash[b]
        );
      },
    }),
    jb = (Ta.ListenerMixin = (function () {
      var b = 0,
        c = {
          listenerId: null /*
		...
		*/,
          listenTo: function (b, c, d) {
            if ("object" == typeof c)
              ...
              "string" == typeof c &&
                b.on(
                  c + "." + this.getListenerNamespace(), // use event namespacing to identify this object
                  a.proxy(d, this)
                );
          } /*
		...
		*/,
          getListenerNamespace: function () {
            return (
              null == this.listenerId && (this.listenerId = b++),
    ...
    mb = (Ta.DragListener = va.extend(jb, {
      options: null,
      ...
      startInteraction: function (b, c) {
        ...
        this.isInteracting ||
          ((c = c || {}),
          (this.delay = _(c.delay, this.options.delay, 0)),
          (this.minDistance = _(c.distance, this.options.distance, 0)),
      ...
      endInteraction: function (a) {
        this.isInteracting &&
          ...
          this.handleInteractionEnd(a));
      },
      handleInteractionEnd: function (a) {
        this.trigger("interactionEnd", a);
      },
      // Binding To DOM
      // -----------------------------------------------------------------------------------------------------------------
        ...
        this.isTouch
          ? (this.listenTo(a(document), {
              ...
              touchstart: function (a) {
                c // bindHandlers is called from within a touchstart,
                  ? c--
                  : b.endInteraction(a);
              },
            }),
          ...
          this.listenTo(a(document), {
            selectstart: z, // don't allow selection while dragging
            contextmenu: z,
          });
      },
      ...
      startDrag: function (a, b) {
        this.startInteraction(a, b), // ensure interaction began
      ...
      handleMove: function (a) {
        var b,
          c = v(a) - this.originX,
          d = w(a) - this.originY,
          e = this.minDistance; // current distance from the origin, squared
        this.isDistanceSurpassed ||
          ((b = c * c + d * d), b >= e * e && this.handleDistanceSurpassed(a)),
      ...
      trigger: function (a) {
        this.options[a] &&
          ...
          this["_" + a] &&
            this["_" + a].apply(this, Array.prototype.slice.call(arguments, 1));
      },
    })); /*
...
*/
  mb.mixin({
    ...
    initAutoScroll: function () {
      var a = this.scrollEl;
      (this.isAutoScroll =
        this.options.scroll && a && !a.is(window) && !a.is(document)),
        this.isAutoScroll &&
          // debounce makes sure rapid calls don't happen
          this.listenTo(a, "scroll", ha(this.handleDebouncedScroll, 100));
    },
      ...
      (this.scrollTopVel = a),
        ...
        (!this.scrollTopVel && !this.scrollLeftVel) ||
          ...
          (this.scrollIntervalId = setInterval(
            ga(this, "scrollIntervalFunc"), // scope to `this`
    ...
    constrainScrollVel: function () {
      ...
      this.scrollTopVel < 0 // scrolling up?
        ? a.scrollTop() <= 0 && // already scrolled all the way up?
          (this.scrollTopVel = 0)
        : this.scrollTopVel > 0 &&
          a.scrollTop() + a[0].clientHeight >= a[0].scrollHeight && // already scrolled all the way down?
          (this.scrollTopVel = 0),
        this.scrollLeftVel < 0 // scrolling left?
          ? a.scrollLeft() <= 0 && // already scrolled all the left?
            (this.scrollLeftVel = 0)
          : this.scrollLeftVel > 0 &&
            a.scrollLeft() + a[0].clientWidth >= a[0].scrollWidth && // already scrolled all the way right?
            (this.scrollLeftVel = 0);
    },
    // This function gets called during every iteration of the scrolling animation loop
    scrollIntervalFunc: function () {
      var a = this.scrollEl,
        b = this.scrollIntervalMs / 1e3; // considering animation frequency, what the vel should be mult'd by
...
*/
  var nb = mb.extend({
      ...
      constructor: function (a, b) {
        mb.call(this, b), // call the super-constructor
          (this.component = a);
      },
          ...
          a
            ? ((c = { left: v(a), top: w(a) }),
              ...
              e &&
                ...
                (this.origHit && (b = A(this.origHit, b) || b), (d = C(b))),
              (this.coordAdjust = D(d, c)))
      ...
      handleDragStart: function (a) {
        var b;
        mb.prototype.handleDragStart.apply(this, arguments),
      ...
      handleDrag: function (a, b, c) {
        var d;
        mb.prototype.handleDrag.apply(this, arguments),
          (d = this.queryHit(v(c), w(c))),
          ya(d, this.hit) ||
            (this.hit && this.handleHitOut(), d && this.handleHitOver(d));
      },
      // Called when dragging has been stopped
      handleDragEnd: function () {
        this.handleHitDone(), mb.prototype.handleDragEnd.apply(this, arguments);
      },
      // Called when a the mouse has just moved over a new hit
      handleHitOver: function (a) {
        var b = ya(a, this.origHit);
      ...
      handleInteractionEnd: function () {
        mb.prototype.handleInteractionEnd.apply(this, arguments), // call the super-method
          (this.origHit = null),
          (this.hit = null),
      ...
      // Called when scrolling has stopped, whether through auto scroll, or the user scrolling
      handleScrollEnd: function () {
        mb.prototype.handleScrollEnd.apply(this, arguments), // call the super-method
          this.computeCoords();
      },
    ...
    ob = va.extend(jb, {
      ...
      isFollowing: !1,
      isHidden: !1,
      isAnimating: !1, // doing the revert animation?
      ...
      stop: function (b, c) {
        ...
        this.isFollowing &&
          !this.isAnimating && // disallow more than one stop animation at a time
          ((this.isFollowing = !1),
          this.stopListeningTo(a(document)),
          b && f && !this.isHidden // do a revert animation?
            ? ((this.isAnimating = !0),
              this.el.animate(
      ...
      getEl: function () {
        var a = this.el; // hack to force IE8 to compute correct bounding box
    ...
    pb = (Ta.Grid = va.extend(jb, {
      ...
      constructor: function (a) {
        (this.view = a), (this.isRTL = a.opt("isRTL")), (this.elsByFill = {});
      } /* Options
	------------------------------------------------------------------------------------------------------------------*/,
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      diffDates: function (a, b) {
        return this.largeUnit ? L(a, b, this.largeUnit) : J(a, b);
      } /* Hit Area
	------------------------------------------------------------------------------------------------------------------*/,
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      bindDayHandler: function (b, c) {
        ...
        this.el.on(b, function (b) {
          return a(b.target).is(".fc-event-container *, .fc-more") ||
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      dayMousedown: function (a) {
        this.clearDragListeners(),
          this.buildDayDragListener().startInteraction(a, {});
      },
      ...
      buildDayDragListener: function () {
        var a,
          ...
          d = this.view,
          e = d.opt("selectable"),
          f = (this.dayDragListener = new nb(this, {
            ...
            hitOver: function (d, f, h) {
              h && // click needs to have started on a hit
            ...
            interactionEnd: function (e) {
              a && d.triggerDayClick(c.getHitSpan(a), c.getHitEl(a), e),
                b &&
                  // the selection will already have been rendered. just report it
                  d.reportSelection(b, e),
                h(),
                (c.dayDragListener = null);
            },
          }));
        return f;
      },
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      fabricateHelperEvent: function (a, b) {
        var c = b ? V(b.event) : {}; // mask the original event object if possible
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      computeSelectionSpan: function (a, b) {
        var c = [a.start, a.end, b.start, b.end]; // sorts chronologically. works with Moments
        return c.sort(ea), { start: c[0].clone(), end: c[3].clone() };
      } /* Highlight
	------------------------------------------------------------------------------------------------------------------*/,
  ...
  pb.mixin({
    ...
    renderEvents: function (a) {
      var b,
        c = [],
        d = [];
      for (b = 0; b < a.length; b++) (Aa(a[b]) ? c : d).push(a[b]);
      this.segs = [].concat(
        // record all segs
        this.renderBgEvents(c),
        this.renderFgEvents(d)
      );
    },
    ...
    renderFgSegEls: function (b, c) {
      ...
      if (b.length) {
        ...
        a(f).each(function (c, d) {
          ...
          h &&
            (h.data("fc-seg", f), // used by handlers
            (f.el = h),
            g.push(f));
        });
      }
    ...
    bindSegHandler: function (b, c) {
      ...
      this.el.on(b, ".fc-event-container > *", function (b) {
        var e = a(this).data("fc-seg"); // grab segment data. put there by View::renderEvents
    ...
    handleSegTouchStart: function (a, b) {
      ...
      f &&
        ...
        (i = this.startSegResize(a, b)),
        i ||
          (!g && !h) || // allowed to be selected?
          (this.clearDragListeners(),
          (c = g ? this.buildSegDragListener(a) : new mb()),
          (c._dragStart = function () {
            f || d.selectEvent(e);
          }),
    ...
    handleSegMousedown: function (a, b) {
      ...
      !c &&
        this.view.isEventDraggable(a.event) &&
        (this.clearDragListeners(),
        this.buildSegDragListener(a).startInteraction(b, { distance: 5 }));
    },
      ...
      return a(c.target).is(".fc-resizer")
        ? (this.clearDragListeners(),
          this.buildSegResizeListener(
            b,
            a(c.target).is(".fc-start-resizer")
    ...
    buildSegDragListener: function (a) {
      var b,
        ...
        j = a.el,
        k = a.event,
        l = (this.segDragListener = new nb(f, {
          ...
          hitOver: function (b, h, j) {
            ...
            a.hit && (j = a.hit),
              (d = e.computeEventDrop(
                j.component.getHitSpan(j),
    ...
    computeEventDrop: function (a, b, c) {
      var d,
        ...
        g = a.start,
        h = b.start; // zoned event date properties
    ...
    listenToExternalDrag: function (a, b, c) {
      var d,
        ...
        f = this.view.calendar,
        i = Fa(a),
        j = (e.externalDragListener = new nb(this, {
          interactionStart: function () {
            e.isDraggingExternal = !0;
          },
          hitOver: function (a) {
            (d = e.computeExternalDrop(
              a.component.getHitSpan(a), // since we are querying the parent view, might not belong to this grid
              i
            )),
              d &&
          ...
          interactionEnd: function (b) {
            d && // element was dropped on a valid hit
              e.view.reportExternalDrop(i, d, a, b, c),
    ...
    computeExternalDrop: function (a, b) {
      var c = this.view.calendar,
        d = {
          start: c.applyTimezone(a.start), // simulate a zoned event start date
          end: null,
        };
    ...
    buildSegResizeListener: function (a, b) {
      var c,
        ...
        k = a.event,
        l = i.getEventEnd(k),
        m = (this.segResizeListener = new nb(this, {
          scroll: f.opt("dragScroll"),
          subjectEl: j,
          interactionStart: function () {
            c = !1;
          ...
          interactionEnd: function (b) {
            c && e.segResizeStop(a, b),
              d && // valid date to resize to?
                f.reportEventResize(k, d, this.largeUnit, j, b),
    ...
    computeEventResize: function (a, b, c, d) {
      ...
      return (
        ...
        e.allDay && R(h) && ((e.allDay = !1), g.normalizeEventTimes(e)),
        e[a].add(h),
    ...
    getSegClasses: function (a, b, c) {
      var d = this.view,
        ...
        ].concat(e.className, e.source ? e.source.className : []);
      // event is currently selected? attach a className.
      return (
        b && f.push("fc-draggable"),
        ...
        a.each(e, function (a, b) {
          ...
          if (Ba(b[0]))
            for (g = d.invertRanges(g), e = 0; e < g.length; e++)
              f.push.apply(
                f, // append to
                d.eventRangeToSegs(g[e], b[0], c)
              );
          else
            for (e = 0; e < g.length; e++)
              f.push.apply(
                f, // append to
                d.eventRangeToSegs(g[e], b[e], c)
              );
        }),
        f
      );
    ...
    sortEventSegs: function (a) {
      a.sort(ga(this, "compareEventSegs"));
    },
    ...
    compareEventSegs: function (a, b) {
      ...
      return (
        ...
        F(a.event, b.event, this.view.eventOrderSpecs)
      );
    },
  }),
    (Ta.isBgEvent = Aa) /* External-Dragging-Element Data
----------------------------------------------------------------------------------------------------------------------*/,
...
*/
  var qb = (Ta.DayTableMixin = {
      breakOnWeeks: !1, // should create a new row for each week?
      ...
      updateDayTable: function () {
        for (
          var a,
            ...
            g = [],
            h = [];
          e.isBefore(this.end); // loop each day from start to end
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      sliceRangeByRow: function (a) {
        var b,
          ...
          k = []; // inclusive day-index range for segment
      ...
      sliceRangeByDay: function (a) {
        var b,
          ...
          l = []; // inclusive day-index range for segment
        for (b = 0; b < this.rowCnt; b++)
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      renderHeadDateCellHtml: function (a, b, c) {
        ...
        return (
          ...
          (c ? " " + c : "") +
          ">" +
          aa(a.format(this.colHeadFormat)) +
          "</th>"
        );
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      renderBgCellHtml: function (a, b) {
        var c = this.view,
          d = this.getDayClasses(a); // if date has a time, won't format it
        return (
    ...
    rb = (Ta.DayGrid = pb.extend(qb, {
      numbersVisible: !1, // should render a row for day/week numbers? set by outside view. TODO: make internal
      ...
      renderDates: function (a) {
        ...
        for (
          this.el.html(g),
            ...
            this.rowCoordCache = new lb({ els: this.rowEls, isVertical: !0 }),
            this.colCoordCache = new lb({
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      renderHelper: function (b, c) {
        var d,
          e = [],
          f = this.eventToSegs(b); // assigns each seg's el and returns a subset of segs that were rendered
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      renderFill: function (b, c, d) {
        var e,
          f,
          g,
          h = []; // assignes `.el` to each seg. returns successfully rendered segs
...
----------------------------------------------------------------------------------------------------------------------*/
  rb.mixin({
    ...
    // Retrieves all rendered segment objects currently rendered on the grid
    getEventSegs: function () {
      return pb.prototype.getEventSegs
        .call(this)
    ...
    renderBgSegs: function (b) {
      ...
      return pb.prototype.renderBgSegs.call(this, c);
    },
    ...
    fgSegHtml: function (a, b) {
      ...
      return (
        ...
        a.isStart &&
          ...
          c && (l = '<span class="fc-time">' + aa(c) + "</span>")),
        (d =
          '<span class="fc-title">' +
          (aa(f.title || "") || "&nbsp;") +
          "</span>"),
    ...
    renderSegRow: function (b, c) {
      ...
      function d(b) {
        for (; b > g; )
          (k = (r[e - 1] || [])[g]),
            k
              ? k.attr("rowspan", parseFloat(k.attr("rowspan") || 1, 10) + 1)
              : ((k = a("<td/>")), h.append(k)),
            (q[e][g] = k),
            (r[e][g] = k),
            g++;
            ...
            for (
              ...
              j = f[i],
                ...
                j.leftCol != j.rightCol
                  ? k.attr("colspan", j.rightCol - j.leftCol + 1) // a single-column segment
                  : (r[e][g] = k);
              g <= j.rightCol;
    ...
    buildSegLevels: function (a) {
      ...
      for (d = 0; d < e.length; d++) e[d].sort(Ha);
      return e;
    },
      ...
      limitRow: function (b, c) {
        ...
        if (c && c < u.segLevels.length) {
          ...
          for (
            ...
            for (
              i = e[h],
                d(i.leftCol), // process empty cells before the segment
            ...
            if (k) {
              ...
              for (
                ...
                (q = a('<td class="fc-more-cell"/>').attr("rowspan", n)),
                  ...
                  o.push(q[0]),
                  v.push(q[0]);
              m.addClass("fc-limited").after(a(o)), // hide original <td> and inject replacements
                g.push(m[0]);
            }
          }
          d(this.colCnt), // finish off the level
      ...
      resliceDaySegs: function (b, c) {
        ...
        return (
          (b = this.eventsToSegs(d, function (a) {
            var b = I(a, g); // undefind if no intersection
            return b ? [b] : [];
          })),
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  var sb = (Ta.TimeGrid = pb.extend(qb, {
    ...
    constructor: function () {
      pb.apply(this, arguments), // call the super-constructor
        this.processOptions();
    },
    ...
    renderDates: function () {
      this.el.html(this.renderHtml()),
        ...
        (this.colCoordCache = new lb({ els: this.colEls, isHorizontal: !0 })),
        (this.slatCoordCache = new lb({ els: this.slatEls, isVertical: !0 })),
      ...
      for (
        ...
        (a = this.start.clone().time(h)),
          ...
          (d =
            ...
            e.axisStyleAttr() +
            ">" +
            (c ? "<span>" + aa(a.format(this.labelFormat)) + "</span>" : "") +
            "</td>"),
          (g +=
            '<tr data-time="' +
            a.format("HH:mm:ss") +
    ...
    computeLabelInterval: function (a) {
      ...
      for (c = Jb.length - 1; c >= 0; c--)
        if (((d = b.duration(Jb[c])), (e = P(d, a)), fa(e) && e > 1)) return d;
      return b.duration(a);
    },
    // Computes a default event time formatting string if `timeFormat` is not explicitly defined
    computeEventTimeFormat: function () {
...
----------------------------------------------------------------------------------------------------------------------*/
  sb.mixin({
    ...
    renderHelperSegs: function (b, c) {
      ...
      for (
        b = this.renderFgSegsIntoContainers(b, this.helperContainerEls), d = 0;
        d < b.length;
        d++
      )
        (e = b[d]),
    ...
    fgSegHtml: function (a, b) {
      var c,
        ...
        l = ca(this.getSegSkinCss(a)); // just the start time text
        ...
        '<a class="' +
          ...
          (c
            ? '<div class="fc-time" data-start="' +
              ...
              "</span></div>"
            : "") +
          (g.title ? '<div class="fc-title">' + aa(g.title) + "</div>" : "") +
          '</div><div class="fc-bg"/>' +
    ...
    updateFgSegCoords: function (a) {
      this.computeSegVerticals(a), // horizontals relies on this
    ...
    computeFgSegHorizontals: function (a) {
      var b, c, d;
      if ((this.sortEventSegs(a), (b = Ia(a)), Ja(b), (c = b[0]))) {
        for (d = 0; d < c.length; d++) Ka(c[d]);
      ...
      if (void 0 === a.forwardCoord)
        ...
        for (
          ...
          e.length
            ...
            a.backwardCoord =
              a.forwardCoord -
              (a.forwardCoord - c) / // available width for series
                (b + 1),
            d = 0;
          d < e.length;
          d++
    ...
    sortForwardSegs: function (a) {
      a.sort(ga(this, "compareForwardSegs"));
    },
    ...
    generateFgSegHorizontalCss: function (a) {
      var b,
        ...
        e = a.backwardCoord,
        f = a.forwardCoord,
        g = this.generateSegVerticalCss(a); // amount of space from right edge, a fraction of the total width
...
----------------------------------------------------------------------------------------------------------------------*/
  var tb = (Ta.View = va.extend(ib, jb, {
      ...
      isRTL: !1,
      isSelected: !1, // boolean whether a range of time is user-selected or not
      selectedEvent: null,
      ...
      constructor: function (a, c, d, e) {
        (this.calendar = a),
          (this.type = this.name = c), // .name is deprecated
          (this.options = d),
          ...
          (this.eventOrderSpecs = E(this.opt("eventOrder"))),
          this.initialize();
      },
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      setRange: function (b) {
        a.extend(this, b), // assigns every property to this object's member variables
          this.updateTitle();
      },
      ...
      computeRange: function (a) {
        var b,
          c,
          d = M(this.intervalDuration),
          e = a.clone().startOf(d),
          f = e.clone().add(this.intervalDuration); // exclusively move backwards
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      formatRange: function (a, b, c) {
        ...
        return (
          ...
          qa(a.start, d, b, c, this.opt("isRTL"))
        );
      } /* Rendering
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      bindGlobalHandlers: function () {
        this.listenTo(a(document), "mousedown", this.handleDocumentMousedown),
          ...
          this.listenTo(a(document), "touchend", this.handleDocumentTouchEnd);
      },
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      startNowIndicator: function () {
        var a,
          c,
          d,
          e = this; // ms wait value
        this.opt("nowIndicator") &&
          ((a = this.getNowIndicatorUnit()),
          a &&
            ((c = ga(this, "updateNowIndicator")),
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      updateHeight: function (a) {
        var b = this.calendar; // we poll the calendar for height information
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      resolveEventEl: function (b, c) {
        var d = this.trigger("eventRender", b, b, c); // means don't render at all
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      triggerSelect: function (a, b) {
        this.trigger(
          "select",
          null,
          this.calendar.applyTimezone(a.start), // convert to calendar's tz for external API
	...
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      handleDocumentMousedown: function (a) {
        ...
        !this.calendar.isTouch &&
          u(a) &&
          (this.processRangeUnselect(a), this.processEventUnselect(a));
      },
      handleDocumentTouchStart: function (a) {
        this.processRangeUnselect(a);
      },
      handleDocumentTouchEnd: function (a) {
      ...
      processEventUnselect: function (b) {
        this.selectedEvent &&
          (a(b.target).closest(".fc-selected").length || this.unselectEvent());
      } /* Day Click
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      triggerDayClick: function (a, b, c) {
        this.trigger(
          "dayClick",
          b,
          this.calendar.applyTimezone(a.start), // convert to calendar's timezone for external API
          c
        );
      } /* Date Utils
	------------------------------------------------------------------------------------------------------------------*/,
      ...
      computeDayRange: function (a) {
        var b,
          ...
          d = a.end,
          e = null; // the beginning of the day the range exclusively ends
      ...
      isMultiDayEvent: function (a) {
        var b = this.computeDayRange(a); // event is range-ish
        return b.end.diff(b.start, "days") > 1;
      },
    })),
    ub = (Ta.Scroller = va.extend({
    ...
    vb = (Ta.Calendar = va.extend({
      ...
      initOptions: function (a) {
        ...
        (a = d(a)),
          (b = a.lang),
          (e = wb[b]),
          e || ((b = vb.defaults.lang), (e = wb[b] || {})),
          (f = _(a.isRTL, e.isRTL, vb.defaults.isRTL)),
          (g = f ? vb.rtlDefaults : {}),
          (this.dirDefaults = g),
          (this.langDefaults = e),
          (this.overrides = a),
          (this.options = c([vb.defaults, g, e, a])),
          Oa(this.options),
          (this.isTouch =
            null != this.options.isTouch ? this.options.isTouch : Ta.isTouch),
          (this.viewSpecCache = {});
      },
        ...
        for (
          ...
          (d = Ua[l]),
            ...
            d &&
              ...
              (f = f || d.duration),
              (l = l || d.type)),
            e && (k.unshift(e), (f = f || e.duration), (l = l || e.type)); // valid?
      ...
      buildViewSpecButtonText: function (a, b) {
        ...
        (a.buttonTextOverride =
          c(this.overrides) || // constructor-specified buttonText lookup hash takes precedence
          a.overrides.buttonText), // `buttonText` for view-specific options is a string
          // highest to lowest priority. mirrors buildViewSpecOptions
          (a.buttonTextDefault =
            c(this.langDefaults) ||
            c(this.dirDefaults) ||
            a.defaults.buttonText || // a single string. from ViewSubclass.defaults
            c(vb.defaults) ||
            (a.duration ? this.humanizeDuration(a.duration) : null) || // like "3 days"
            b);
      },
  ...
  var wb = (Ta.langs = {}); // initialize and expose
  ...
  (Ta.datepickerLang = function (b, c, d) {
    ...
    (Ta.lang = function (b, d) {
      var e, f;
      (e = wb[b] || (wb[b] = {})),
        d && (e = wb[b] = c([e, d])),
        (f = Pa(b)),
        a.each(yb, function (a, b) {
          null == e[a] && (e[a] = b(f, e));
        }),
        (vb.defaults.lang = b);
    });
  ...
  var xb = {
    ...
    yb = {
      ...
      dayOfMonthFormat: function (a, b) {
        var c = a.longDateFormat("l"); // for the format like "M/D/YYYY"
  ...
  Ta.lang("en", vb.englishDefaults),
    (Ta.sourceNormalizers = []),
    (Ta.sourceFetchers = []);
  var Ab = { dataType: "json", cache: !1 },
    Bb = 1;
  // Returns a list of events that the given event should be compared against when being considered for a move to
  // the specified span. Attached to the Calendar's prototype because EventManager is a mixin for a Calendar.
  vb.prototype.getPeerEvents = function (a, b) {
    var c,
      d,
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  var Cb = (Ta.BasicView = tb.extend({
      scroller: null,
      dayGridClass: rb, // class the dayGrid will be instantiated from (overridable by subclasses)
      ...
      initialize: function () {
        (this.dayGrid = this.instantiateDayGrid()),
          (this.scroller = new ub({ overflowX: "hidden", overflowY: "auto" }));
      },
      // Generates the DayGrid object this view needs. Draws from this.dayGridClass
      instantiateDayGrid: function () {
        // generate a subclass on the fly with BasicView-specific behavior
        // TODO: cache this subclass
        var a = this.dayGridClass.extend(Db);
        return new a(this);
      },
      // Sets the display range and computes all necessary dates
      setRange: function (a) {
        tb.prototype.setRange.call(this, a), // call the super-method
      ...
      computeRange: function (a) {
        var b = tb.prototype.computeRange.call(this, a); // get value from the super-method
    ...
    Db = {
      ...
      renderHeadIntroHtml: function () {
        var a = this.view; // needed for matchCellWidths
      ...
      renderNumberIntroHtml: function (a) {
        var b = this.view; // needed for matchCellWidths
    ...
    Eb = (Ta.MonthView = Cb.extend({
      ...
      computeRange: function (a) {
        var b,
          c = Cb.prototype.computeRange.call(this, a);
        // ensure 6 weeks
      ...
      isFixedWeeks: function () {
        var a = this.opt("weekMode"); // LEGACY: weekMode is deprecated
        // LEGACY: weekMode is deprecated
        return a ? "fixed" === a : this.opt("fixedWeekCount");
      },
    }));
  (Ua.basic = { class: Cb }),
    (Ua.basicDay = { type: "basic", duration: { days: 1 } }),
    (Ua.basicWeek = { type: "basic", duration: { weeks: 1 } }),
    (Ua.month = {
      class: Eb,
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  var Fb = (Ta.AgendaView = tb.extend({
      scroller: null,
      timeGridClass: sb, // class used to instantiate the timeGrid. subclasses can override
      ...
      instantiateTimeGrid: function () {
        var a = this.timeGridClass.extend(Gb);
        return new a(this);
      },
	...
	------------------------------------------------------------------------------------------------------------------*/,
      updateSize: function (a) {
        this.timeGrid.updateSize(a), tb.prototype.updateSize.call(this, a);
      },
      // Refreshes the horizontal dimensions of the view
      updateWidth: function () {
    ...
    Gb = {
      ...
      renderHeadIntroHtml: function () {
        var a,
          b = this.view; // needed for matchCellWidths
    ...
    Hb = {
      ...
      renderBgIntroHtml: function () {
        ...
        return (
          ...
          a.axisStyleAttr() +
          "><span>" +
          (a.opt("allDayHtml") || aa(a.opt("allDayText"))) +
          "</span></td>"
        );
      },
      // Generates the HTML that goes before all other types of cells.
  ...
  return (
    ...
    (Ua.agendaDay = { type: "agenda", duration: { days: 1 } }),
    (Ua.agendaWeek = { type: "agenda", duration: { weeks: 1 } }),
    Ta
  );
});
