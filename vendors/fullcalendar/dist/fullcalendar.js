	...
	*/
    loopCallbacks: function (name, methodName, args) {
      ...
      for (i = 0; i < parts.length; i++) {
        part = parts[i];
        if (part) {
          // in case no event name like "click"
...
*/
  var CoordCache = (FC.CoordCache = Class.extend({
    ...
    getHorizontalIndex: function (leftOffset) {
      ...
      if (
        !boundingRect ||
        (leftOffset >= boundingRect.left && leftOffset < boundingRect.right)
      ) {
        for (i = 0; i < len; i++) {
    ...
    getVerticalIndex: function (topOffset) {
      ...
      if (
        !boundingRect ||
        (topOffset >= boundingRect.top && topOffset < boundingRect.bottom)
      ) {
        for (i = 0; i < len; i++) {
    ...
    renderSegRow: function (row, rowSegs) {
      ...
      function emptyCellsUntil(endCol) {
        while (col < endCol) {
          ...
          if (td) {
            td.attr("rowspan", parseFloat(td.attr("rowspan") || 1, 10) + 1);
          } else {
            td = $("<td/>");
            tr.append(td);
          }
...
*/
  ...
  var Calendar = (FC.Calendar = Class.extend({
    ...
    initOptions: function (overrides) {
      ...
      this.isTouch =
        this.options.isTouch != null ? this.options.isTouch : FC.isTouch;
  ...
  function Calendar_constructor(element, overrides) {
    ...
    function initialRender() {
      ...
      element.addClass(t.isTouch ? "fc-touch" : "fc-cursor");
    ...
    function destroy() {
      ...
      content.remove();
      element.removeClass(
        "fc fc-touch fc-cursor fc-ltr fc-rtl fc-unthemed ui-widget"
      );
        ...
        $.each(buttonStr.split(" "), function (i) {
          ...
          $.each(this.split(","), function (j, buttonName) {
            ...
            if (buttonName == "title") {
              ...
              if (
                (customButtonProps = (calendar.options.customButtons || {})[
                  buttonName
                ])
              ) {
