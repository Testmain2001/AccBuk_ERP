...
!(function (a) {
  ...
  var k = (a.event.special.mousewheel = {
    ...
    getLineHeight: function (b) {
      ...
      return (
        d.length || (d = a("body")),
        parseFloat(d.css("fontSize"), 10) ||
          parseFloat(c.css("fontSize"), 10) ||
          16
      );
    },
    ...
    var t,
      ...
      S = function () {
        var t = e(this),
          ...
          c = [
            parseFloat(r[0].css("min-height")),
            Math.round(l[0] * r[0].parent().height()),
            parseFloat(r[1].css("min-width")),
        ...
        function r(e) {
          if ($(e) && !c && !O(e)[2]) {
            ...
            if (!(v - g > 30)) {
              ...
              var y = parseFloat(T.contentTouchScroll) || 0;
              (w[0] = u[0] > y ? w[0] : 0),
                (w[1] = u[1] > y ? w[1] : 0),
          ...
          if ((N(o), !A(o, t.target))) {
            var r =
                "auto" !== i.mouseWheel.deltaFactor
                  ? parseFloat(i.mouseWheel.deltaFactor)
                  : s && t.deltaFactor < 100
                  ? 100
                  : t.deltaFactor || 100,
              d = i.scrollInertia;
            if ("x" === i.axis || "x" === i.mouseWheel.axis)
              var u = "x",
                f = [
                  ...
                  parseFloat(i.mouseWheel.scrollAmount),
                ],
                h =
      ...
      F = function (t, o, n, i, r) {
        function l(e) {
          ...
          var o = "stepped" !== f.type,
            ...
            v =
              "x" === f.dir[0]
                ? s[1] + f.dir[1] * parseFloat(f.scrollAmount)
                : s[0] + f.dir[1] * parseFloat(f.scrollAmount),
        ...
        if (null != t && "undefined" != typeof t) {
          ...
          switch (c) {
            ...
            case "number":
              ...
              if (-1 !== t.indexOf("%"))
                return Math.abs((d * parseFloat(t)) / 100);
              if (-1 !== t.indexOf("-="))
                return Math.abs(f - parseFloat(t.split("-=")[1]));
              if (-1 !== t.indexOf("+=")) {
                var p = f + parseFloat(t.split("+=")[1]);
