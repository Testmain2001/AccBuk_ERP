...
(function (global, factory) {
  ...
  ParsleyUI.Field = {
    ...
    _actualizeTriggers: function _actualizeTriggers() {
      ...
      if (this._failedOnce)
        ...
        (trigger = ParsleyUtils__default.namespaceEvents(
  ...
  ParsleyForm.prototype = {
    ...
    whenValidate: function whenValidate() {
      ...
      return (_$$when$done$fail$always = $.when
    ...
    _bindFields: function _bindFields() {
      ...
      this._withoutReactualizingFormOptions(function () {
        _this7.$element
          .find(_this7.options.inputs)
          .not(_this7.options.excluded)
          .each(function (_, element) {
            ...
            if (
              ...
              if (
                "undefined" ===
                typeof _this7.fieldsMappedById[
                  fieldInstance.__class__ + "-" + fieldInstance.__id__
                ]
              ) {
                _this7.fieldsMappedById[
                  fieldInstance.__class__ + "-" + fieldInstance.__id__
                ] = fieldInstance;
  ...
  ParsleyField.prototype = {
    ...
    _validateConstraint: function _validateConstraint(value, constraint) {
      ...
      return $.when(result).fail(function (errorMessage) {
        if (!(_this11.validationResult instanceof Array))
          _this11.validationResult = [];
      ...
      if ("undefined" !== typeof name) {
        $('input[name="' + name + '"]').each(function (i, input) {
          if ($(input).is("input[type=radio], input[type=checkbox]"))
            $(input).attr(
              _this12.options.namespace + "multiple",
              _this12.options.multiple
            );
        });
      }
      ...
      behavesOk: function behavesOk(evt) {
        if (_this13.isNativeEvent(evt)) {
          $(document) // Simply unbinds the testing handler
            .off("input.inputevent", evt.data.selector, _this13.behavesOk)
            .off("change.inputevent", evt.data.selector, _this13.misbehaves);
        }
      },
