!(function (a, b) {
  ...
  function z(a) {
    if (((a = parseFloat(a, 10)), isNaN(a))) return !1;
    if (0 > a) return !0;
  ...
  var _ =
        ...
        translate: function (a, b, c) {
          ...
          return 1 === c.length
            ? b
              ? d[0]
              : d[1]
            : a + " " + Ka.correctGrammaticalCase(a, d);
        },
      }),
    La =
      (a.defineLocale("me", {
    ...
    Ta =
      (a.defineLocale("nl", {
        ...
        monthsShort: function (a, b) {
          return /-MMM-/.test(b) ? Sa[a.month()] : Ra[a.month()];
        },
        monthsParseExact: !0,
        weekdays:
    ...
    Za = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_"),
    $a =
      (a.defineLocale("sk", {
        months: Ya,
        monthsShort: Za,
        ...
        translate: function (a, b, c) {
          ...
          return 1 === c.length
            ? b
              ? d[0]
              : d[1]
            : a + " " + $a.correctGrammaticalCase(a, d);
        },
      }),
    _a =
        ...
        translate: function (a, b, c) {
          ...
          return 1 === c.length
            ? b
              ? d[0]
              : d[1]
            : a + " " + _a.correctGrammaticalCase(a, d);
        },
      }),
    ab =
      (a.defineLocale("sr", {
