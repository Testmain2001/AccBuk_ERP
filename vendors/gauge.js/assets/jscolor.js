    ...
    this.fromString = function (hex, flags) {
      ...
      if (!m) {
        ...
        if (m[1].length === 6) {
          // 6-char notation
          this.fromRGB(
            parseFloat(m[1].substr(0, 2), 16) / 255,
            parseFloat(m[1].substr(2, 2), 16) / 255,
            parseFloat(m[1].substr(4, 2), 16) / 255,
            flags
          );
        } else {
          // 3-char notation
          this.fromRGB(
            parseFloat(m[1].charAt(0) + m[1].charAt(0), 16) / 255,
            parseFloat(m[1].charAt(1) + m[1].charAt(1), 16) / 255,
            parseFloat(m[1].charAt(2) + m[1].charAt(2), 16) / 255,
            flags
          );
        }
        return true;
