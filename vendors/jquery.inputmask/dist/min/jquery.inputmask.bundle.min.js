        ...
        if (((k = j[0]), r)) h();
          ...
          switch (k.charAt(0)) {
            ...
            case c.quantifiermarker.start:
              ...
              k = k.replace(/[{}]/g, "");
              var x = k.split(","),
                y = isNaN(x[0]) ? x[0] : parseFloat(x[0]),
                z = 1 === x.length ? y : isNaN(x[1]) ? x[1] : parseFloat(x[1]);
              if (
                (("*" === z || "+" === z) && (y = "*" === z ? 0 : 1),
      ...
      b.extendAliases({
        "dd/mm/yyyy": {
          ...
          isInYearRange: function (a, b, c) {
            if (isNaN(a)) return !1;
            var d = parseFloat(a.concat(b.toString().slice(a.length))),
              e = parseFloat(a.concat(c.toString().slice(a.length)));
            return (
              (isNaN(d) ? !1 : d >= b && c >= d) ||
              (isNaN(e) ? !1 : e >= b && c >= e)
            );
            ...
            2: {
              validator: function (a, b, c, d, e) {
                ...
                if (e.mask.indexOf("2") === e.mask.length - 1 && g) {
                  ...
                  var i = parseFloat(b.buffer.join("").substr(0, 4), 10);
                  return i % 4 === 0
                    ? i % 100 === 0
                      ? i % 400 === 0
                        ? !0
        ...
        datetime: {
          ...
          definitions: {
            h: {
              validator: function (a, b, c, d, e) {
                if ("24" === e.hourFormat && 24 === parseFloat(a, 10))
                  return (
                    (b.buffer[c - 1] = "0"),
                    (b.buffer[c] = "0"),
        ...
        numeric: {
            ...
            return (
              ...
              (f +=
                a.integerOptional === !0
                  ...
                  : "~{" + a.integerDigits + "}"),
              void 0 !== a.digits &&
                (isNaN(a.digits) || parseFloat(a.digits) > 0) &&
          ...
          radixHandler: function (b, c, d, e, f) {
            if (
              ...
              b === f.radixPoint &&
              void 0 !== f.digits &&
              (isNaN(f.digits) || parseFloat(f.digits) > 0)
            ) {
          ...
          leadingZeroHandler: function (b, c, d, e, f, g) {
            if (!e)
              if (f.numericInput === !0) {
                ...
                if (k && (-1 === j || j >= d)) {
                  var l =
                    -1 === j ? 0 : parseFloat(c.buffer.slice(j + 1).join(""));
                  if (
                    0 ===
                      k[0].indexOf(
          ...
          onBeforeMask: function (a, c) {
            ...
            if (
              ...
              if (parseFloat(c.digits) < g.toString().length) {
                var h = Math.pow(10, parseFloat(c.digits));
                  ...
                  for (f.regexTokens = []; (a = f.tokenizer.exec(f.regex)); )
                    switch (((b = a[0]), b.charAt(0))) {
                      ...
                      case "*":
                        ...
                        b = b.replace(/[{}]/g, "");
                        var h = b.split(","),
                          i = isNaN(h[0]) ? h[0] : parseFloat(h[0]),
                          j =
                            1 === h.length
                              ? i
                              : isNaN(h[1])
