      ...
      return "number" == typeof a
        ...
        : ((c = a.match(/^(\d+) Q(\d)$/)),
          ...
          c
            ...
            : h
            ? ((k = new Date(parseFloat(h[1], 10), 0, 1)),
              4 !== k.getDay() && k.setMonth(0, 1 + ((4 - k.getDay() + 7) % 7)),
              k.getTime() + 6048e5 * parseFloat(h[2], 10))
            : i
            ? i[6]
              ? ((g = 0),
                "Z" !== i[6] &&
                  ((g = 60 * parseFloat(i[8], 10) + parseFloat(i[9], 10)),
                  "+" === i[7] && (g = 0 - g)),
                Date.UTC(
                  parseFloat(i[1], 10),
                  parseFloat(i[2], 10) - 1,
            ...
            ? ((l = parseFloat(j[6])),
              ...
              j[8]
                ? ((g = 0),
                  "Z" !== j[8] &&
                    ((g = 60 * parseFloat(j[10], 10) + parseFloat(j[11], 10)),
                    "+" === j[9] && (g = 0 - g)),
                  Date.UTC(
                    parseFloat(j[1], 10),
                    parseFloat(j[2], 10) - 1,
            ...
            : new Date(parseFloat(a, 10), 0, 1).getTime());
    }),
    (b.Hover = (function () {
      function c(c) {
        null == c && (c = {}),
        ...
        (c.prototype.moveTo = function (a, b) {
          ...
          return (
            ...
            null != b
              ...
              : (h = f / 2 - c / 2),
            this.el.css({ left: e + "px", top: parseFloat(h) + "px" })
          );
        }),
