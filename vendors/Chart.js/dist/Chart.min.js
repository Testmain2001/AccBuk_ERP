...
})(
  {
      ...
      function (t, e, i) {
        ...
        function l(t) {
          ...
          var o = 0.4124 * e + 0.3576 * i + 0.1805 * a,
            s = 0.2126 * e + 0.7152 * i + 0.0722 * a,
            n = 0.0193 * e + 0.1192 * i + 0.9505 * a;
          return [100 * o, 100 * s, 100 * n];
        }
        function c(t) {
          var e,
            i,
        ...
        function I(t) {
          var e,
            ...
            r = t[3] / 100;
          return (
            (e = 1 - Math.min(1, o * (1 - r) + r)),
            (i = 1 - Math.min(1, s * (1 - r) + r)),
        ...
        function R(t) {
          var e,
            ...
            n = t[2] / 100;
          return (
            (e = 3.2406 * o + -1.5372 * s + n * -0.4986),
            (i = o * -0.9689 + 1.8758 * s + 0.0415 * n),
            (a = 0.0557 * o + s * -0.204 + 1.057 * n),
            (e =
              e > 0.0031308
        ...
        function W(t) {
          ...
          return (
            8 >= s
              ? ((i = (100 * s) / 903.3), (o = 7.787 * (i / 100) + 16 / 116))
              : ((i = 100 * Math.pow((s + 16) / 116, 3)),
                (o = Math.pow(i / 100, 1 / 3))),
            (e =
              0.008856 >= e / 95.047
                ? (e = (95.047 * (n / 500 + o - 16 / 116)) / 7.787)
                : 95.047 * Math.pow(n / 500 + o, 3)),
            (a =
              0.008859 >= a / 108.883
                ? (a = (108.883 * (o - r / 200 - 16 / 116)) / 7.787)
                : 108.883 * Math.pow(o - r / 200, 3)),
            [e, i, a]
          );
        }
        function z(t) {
        ...
        var Z = {
          ...
          G = {};
        for (var $ in Z) G[JSON.stringify(Z[$])] = $;
      },
      {},
    ],
    3: [
    ...
    4: [
      function (t, e, i) {
          ...
          if (t) {
            ...
            if (h) {
              ...
              for (var l = 0; l < n.length; l++)
                n[l] = parseFloat(h[l] + h[l], 16);
            } else if ((h = t.match(i))) {
              h = h[1];
              for (var l = 0; l < n.length; l++)
                n[l] = parseFloat(h.slice(2 * l, 2 * l + 2), 16);
            } else if ((h = t.match(a))) {
              for (var l = 0; l < n.length; l++) n[l] = parseFloat(h[l + 1]);
              r = parseFloat(h[4]);
            } else if ((h = t.match(o))) {
              for (var l = 0; l < n.length; l++)
        ...
        function h(t) {
          var e = a(t);
          return e ? e[3] : (e = o(t)) ? e[3] : (e = s(t)) ? e[3] : void 0;
        }
        function l(t) {
        ...
        (s.prototype = {
          ...
          (s.prototype.setValues = function (t, e) {
            ...
            if ("alpha" == t) s = e;
              ...
              (this.values[t] = e.slice(0, t.length)), (s = e[t.length]);
            ...
            if (
              ((this.values.alpha = Math.max(
                0,
                Math.min(1, void 0 !== s ? s : this.values.alpha)
              )),
              "alpha" != t)
            ) {
              for (var n = 0; n < t.length; n++) {
                var h = Math.max(0, Math.min(o[t][n], this.values[t][n]));
                this.values[t][n] = Math.round(h);
              }
              for (var l in i) {
                l != t && (this.values[l] = a[t][l](this.values[t]));
                for (var n = 0; n < l.length; n++) {
                  var h = Math.max(0, Math.min(o[l][n], this.values[l][n]));
          ...
          (s.prototype.setChannel = function (t, e, i) {
            return void 0 === i
              ? this.values[t][e]
              : ((this.values[t][e] = i),
    ...
    13: [
      function (t, e, i) {
        ...
        e.exports = function (t) {
          var e = t.helpers,
            i = { aspectRatio: 1 };
          t.Radar = function (a, o) {
            return (
              (o.options = e.configMerge(i, o.options)),
              (o.type = "radar"),
              new t(a, o)
            );
          };
            ...
            (t.controllers.bar = t.DatasetController.extend({
              ...
              addElementAndReset: function (e) {
                var i = new t.elements.Rectangle({
                  ...
                  a = this.getBarCount();
                this.getMeta().data.splice(e, 0, i),
              ...
              updateElement: function (t, i, a, o) {
                ...
                (s =
                  h.min < 0 && h.max < 0
                    ? h.getPixelForValue(h.max)
                    : h.min > 0 && h.max > 0
                    ? h.getPixelForValue(h.min)
                    : h.getPixelForValue(0)),
                  e.extend(t, {
                    _chart: this.chart.chart,
                    _xScale: r,
                    _yScale: h,
              ...
              calculateBarBase: function (t, e) {
                var i = this.getMeta(),
                  a =
                    (this.getScaleForId(i.xAxisID),
                    this.getScaleForId(i.yAxisID)),
                  o = 0;
                if (a.options.stacked) {
                  var s = this.chart.data.datasets[t].data[e];
                  if (0 > s)
                    for (var n = 0; t > n; n++) {
                    ...
                    for (var l = 0; t > l; l++) {
                      ...
                      d.bar &&
                        d.yAxisID === a.id &&
                        this.chart.isDatasetVisible(l) &&
                        (o += c.data[e] > 0 ? c.data[e] : 0);
                    }
                  return a.getPixelForValue(o);
                }
                return (
                  (o = a.getPixelForValue(a.min)),
                  a.beginAtZero ||
                  (a.min <= 0 && a.max >= 0) ||
                  (a.min >= 0 && a.max <= 0)
                    ? (o = a.getPixelForValue(0, 0))
                    : a.min < 0 && a.max < 0 && (o = a.getPixelForValue(a.max)),
                  o
                );
              },
              getRuler: function () {
                var t = this.getMeta(),
                  ...
                  a = function () {
                    for (
                      var t = e.getPixelForTick(1) - e.getPixelForTick(0),
                        i = 2;
                      i < this.getDataset().data.length;
                      i++
                    )
                      t = Math.min(
                        e.getPixelForTick(i) - e.getPixelForTick(i - 1),
                        t
                      );
                    return t;
                  }.call(this),
              ...
              getBarIndex: function (t) {
                ...
                for (i = 0; t > i; ++i)
                  (e = this.chart.getDatasetMeta(i)),
                    e.bar && this.chart.isDatasetVisible(i) && ++a;
                return a;
              },
              calculateBarX: function (t, e) {
                ...
                return (
                  (n -= this.chart.isCombo ? s.tickWidth / 2 : 0),
                  a.options.stacked
                    ? n + s.categoryWidth / 2 + s.categorySpacing
                    : n +
                      s.barWidth / 2 +
                      s.categorySpacing +
                      s.barWidth * o +
            ...
            (t.controllers.horizontalBar = t.controllers.bar.extend({
              updateElement: function (t, i, a, o) {
                ...
                (s =
                  ...
                  e.extend(t, {
                    ...
                    _index: i,
                    _model: {
                      x: a ? s : this.calculateBarX(i, this.index),
                      y: this.calculateBarY(i, this.index),
                      label: this.chart.data.labels[i],
                      datasetLabel: this.getDataset().label,
                      base: a ? s : this.calculateBarBase(this.index, i),
                      height: this.calculateBarHeight(o),
                      backgroundColor:
                        t.custom && t.custom.backgroundColor
                          ? t.custom.backgroundColor
                          : e.getValueAtIndexOrDefault(
              ...
              calculateBarBase: function (t, e) {
                var i = this.getMeta(),
                  ...
                  o = (this.getScaleForId(i.yAxisID), 0);
                if (a.options.stacked) {
                  var s = this.chart.data.datasets[t].data[e];
                  if (0 > s)
                    for (var n = 0; t > n; n++) {
              ...
              getRuler: function () {
                var t = this.getMeta(),
                  e =
                    (this.getScaleForId(t.xAxisID),
                    this.getScaleForId(t.yAxisID)),
                  i = this.getBarCount(),
                  a = function () {
                    for (
                      var t = e.getPixelForTick(1) - e.getPixelForTick(0),
              ...
              calculateBarX: function (t, e) {
                var i = this.getMeta(),
                  a = this.getScaleForId(i.xAxisID),
                  o =
                    (this.getScaleForId(i.yAxisID), this.getDataset().data[t]);
                if (a.options.stacked) {
                  for (var s = 0, n = 0, r = 0; e > r; r++) {
                    var h = this.chart.data.datasets[r],
                      l = this.chart.getDatasetMeta(r);
              ...
              calculateBarY: function (t, e) {
                var i = this.getMeta(),
                  ...
                  n = a.getPixelForValue(null, t, e, this.chart.isCombo);
                return (
                  (n -= this.chart.isCombo ? s.tickHeight / 2 : 0),
                  a.options.stacked
                    ? n + s.categoryHeight / 2 + s.categorySpacing
                    : n +
                      s.barHeight / 2 +
                      s.categorySpacing +
                      s.barHeight * o +
          ...
          (t.defaults.bubble = {
            ...
            (t.controllers.bubble = t.DatasetController.extend({
              ...
              updateElement: function (t, i, a) {
                ...
                (o =
                  n.min < 0 && n.max < 0
                    ? n.getPixelForValue(n.max)
                    : n.min > 0 && n.max > 0
                    ? n.getPixelForValue(n.min)
                    : n.getPixelForValue(0)),
                  e.extend(t, {
                    _chart: this.chart.chart,
                    _xScale: r,
                    _yScale: n,
                  ...
                  return i.labels.length && i.datasets.length
                    ? i.labels.map(function (a, o) {
                        var s = t.getDatasetMeta(0),
                          ...
                          r = s.data[o],
                          h =
                            r.custom && r.custom.backgroundColor
                              ? r.custom.backgroundColor
                              : e.getValueAtIndexOrDefault(
                                  n.backgroundColor,
                                  o,
                          ...
                          l =
                            r.custom && r.custom.borderColor
                              ? r.custom.borderColor
                              : e.getValueAtIndexOrDefault(
                                  n.borderColor,
                                  o,
                          ...
                          c =
                            r.custom && r.custom.borderWidth
                              ? r.custom.borderWidth
                              : e.getValueAtIndexOrDefault(
                                  n.borderWidth,
                                  o,
                        ...
                        return {
                          ...
                          strokeStyle: l,
                          lineWidth: c,
                          hidden: isNaN(n.data[o]) || s.data[o].hidden,
                          index: o,
                        };
                      }, this)
                    : [];
              ...
              onClick: function (t, e) {
                ...
                for (i = 0, a = (n.data.datasets || []).length; a > i; ++i)
                  (o = n.getDatasetMeta(i)),
                    (o.data[s].hidden = !o.data[s].hidden);
                n.update();
              },
            },
            cutoutPercentage: 50,
              ...
              t.DatasetController.extend({
                ...
                addElementAndReset: function (i, a) {
                  ...
                  a &&
                    ...
                    this.getMeta().data.splice(i, 0, o),
                    this.updateElement(o, i, !0);
                },
                ...
                update: function (t) {
                  ...
                  if (this.chart.options.circumference < 2 * Math.PI) {
                    ...
                    (o = Math.min(i / b.width, a / b.height)),
                      (s = { x: (m.x + p.x) * -0.5, y: (m.y + p.y) * -0.5 });
                  }
                  (this.chart.outerRadius = Math.max(o / 2, 0)),
                    ...
                    (this.chart.offsetX = s.x * this.chart.outerRadius),
                    (this.chart.offsetY = s.y * this.chart.outerRadius),
                ...
                updateElement: function (t, i, a) {
                  ...
                  e.extend(t, {
                    ...
                    _index: i,
                    _model: {
                      x: o + this.chart.offsetX,
                      y: s + this.chart.offsetY,
                      startAngle: n,
                      endAngle: r,
                      circumference: h,
                      outerRadius: c,
                    ...
                    (a && this.chart.options.animation.animateRotate) ||
                      (0 === i
                        ? (t._model.startAngle = this.chart.options.rotation)
                        : (t._model.startAngle =
          ...
          (t.defaults.line = {
            ...
            (t.controllers.line = t.DatasetController.extend({
              ...
              update: function (t) {
                ...
                (i =
                  ...
                  this.chart.options.showLines &&
                    ...
                    (o._children = s),
                    void 0 !== this.getDataset().tension &&
                      void 0 === this.getDataset().lineTension &&
                      (this.getDataset().lineTension =
                        this.getDataset().tension),
                    (o._model = {
                      tension:
                        o.custom && o.custom.tension
                          ? o.custom.tension
                          : e.getValueOrDefault(
                              this.getDataset().lineTension,
              ...
              getPointBackgroundColor: function (t, i) {
                ...
                return (
                  t.custom && t.custom.backgroundColor
                    ...
                    : o.backgroundColor && (a = o.backgroundColor),
                  a
                );
              },
              ...
              getPointBorderWidth: function (t, i) {
                ...
                return (
                  t.custom && void 0 !== t.custom.borderWidth
                    ...
                    : void 0 !== o.pointBorderWidth
                    ? (a = e.getValueAtIndexOrDefault(o.pointBorderWidth, i, a))
                    : void 0 !== o.borderWidth && (a = o.borderWidth),
                  a
                );
              },
              updateElement: function (t, i, a) {
                ...
                (o =
                  ...
                  (t._index = i),
                  void 0 !== this.getDataset().radius &&
                    void 0 === this.getDataset().pointRadius &&
                    (this.getDataset().pointRadius = this.getDataset().radius),
                  void 0 !== this.getDataset().hitRadius &&
                    void 0 === this.getDataset().pointHitRadius &&
                    (this.getDataset().pointHitRadius =
                      this.getDataset().hitRadius),
                  (t._model = {
                    x: r.getPixelForValue(
                      this.getDataset().data[i],
                      i,
                      this.index,
                      this.chart.isCombo
              ...
              calculatePointY: function (t, e, i, a) {
                var o = this.getMeta(),
                  s =
                    (this.getScaleForId(o.xAxisID),
                    this.getScaleForId(o.yAxisID));
                if (s.options.stacked) {
                  for (var n = 0, r = 0, h = 0; i > h; h++) {
                    var l = this.chart.data.datasets[h],
                      c = this.chart.getDatasetMeta(h);
                    "line" === c.type &&
                      this.chart.isDatasetVisible(h) &&
                      (l.data[e] < 0
                        ? (r += l.data[e] || 0)
                        : (n += l.data[e] || 0));
                  }
                  return 0 > t
                    ? s.getPixelForValue(r + t)
              ...
              updateBezierControlPoints: function () {
                ...
                e.each(
                  ...
                  function (i, a) {
                    var o = e.splineCurve(
                      e.previousItem(t.data, a)._model,
                      i._model,
                      e.nextItem(t.data, a)._model,
                      t.dataset._model.tension
                    );
                    (i._model.controlPointPreviousX = Math.max(
                      Math.min(o.previous.x, this.chart.chartArea.right),
                      this.chart.chartArea.left
                    )),
                      (i._model.controlPointPreviousY = Math.max(
                        Math.min(o.previous.y, this.chart.chartArea.bottom),
                        this.chart.chartArea.top
                      )),
                      (i._model.controlPointNextX = Math.max(
                        Math.min(o.next.x, this.chart.chartArea.right),
                        this.chart.chartArea.left
                      )),
                      (i._model.controlPointNextY = Math.max(
                        Math.min(o.next.y, this.chart.chartArea.bottom),
                        this.chart.chartArea.top
                      )),
                      i.pivot();
                  },
            ...
            (t.controllers.polarArea = t.DatasetController.extend({
              ...
              update: function (t) {
                ...
                (this.chart.outerRadius = Math.max(
                  (a - this.chart.options.elements.arc.borderWidth / 2) / 2,
                  0
                )),
                  (this.chart.innerRadius = Math.max(
                    this.chart.options.cutoutPercentage
                  ...
                  (this.innerRadius =
                    this.outerRadius - this.chart.radiusLength),
                  (i.count = this.countVisibleElements()),
                  e.each(
                    i.data,
                    function (e, i) {
                      this.updateElement(e, i, t);
              ...
              updateElement: function (t, i, a) {
                for (
                  var o = this.calculateCircumference(
                      this.getDataset().data[i]
                    ),
                    s =
                      (this.chart.chartArea.left + this.chart.chartArea.right) /
          ...
          (t.defaults.radar = {
            ...
            (t.controllers.radar = t.DatasetController.extend({
              ...
              update: function (t) {
                ...
                (i =
                  n.min < 0 && n.max < 0
                    ? n.getPointPositionForValue(0, n.max)
                    : n.min > 0 && n.max > 0
                    ? n.getPointPositionForValue(0, n.min)
                    : n.getPointPositionForValue(0, 0)),
                  void 0 !== this.getDataset().tension &&
                    void 0 === this.getDataset().lineTension &&
              ...
              updateElement: function (t, i, a) {
                var o = this.chart.scale.getPointPositionForValue(
                  i,
                  this.getDataset().data[i]
                );
                e.extend(t, {
                  ...
                  _scale: this.chart.scale,
                  _model: {
                    x: a ? this.chart.scale.xCenter : o.x,
                    y: a ? this.chart.scale.yCenter : o.y,
                    tension:
              ...
              updateBezierControlPoints: function () {
                ...
                e.each(
                  ...
                  function (i, a) {
                    var o = e.splineCurve(
                      e.previousItem(t.data, a, !0)._model,
                      i._model,
                      e.nextItem(t.data, a, !0)._model,
                      i._model.tension
                    );
                    (i._model.controlPointPreviousX = Math.max(
                      Math.min(o.previous.x, this.chart.chartArea.right),
              ...
              addAnimation: function (t, e, i, a) {
                ...
                for (var o = 0; o < this.animations.length; ++o)
                  if (this.animations[o].chartInstance === t)
                    return void (this.animations[o].animationObject = e);
        ...
        e.exports = function (t) {
          ...
          (t.types = {}),
            ...
            e.extend(t.Controller.prototype, {
              initialize: function () {
                return (
                  t.pluginService.notifyPlugins("beforeInit", [this]),
                  this.bindEvents(),
                  ...
                  this.initToolTip(),
                  this.update(),
                  t.pluginService.notifyPlugins("afterInit", [this]),
                  this
                );
              },
              clear: function () {
              ...
              resize: function (t) {
                var i = this.chart.canvas,
                  ...
                  s = this.chart.width !== a || this.chart.height !== o;
                return s
                  ...
                  this.options.scales &&
                    (this.options.scales.xAxes &&
                      ...
                      e.each(
                        this.options.scales.xAxes,
                        function (i, a) {
                          var o = e.getValueOrDefault(i.type, "category"),
                    ...
                    this.options.scales.yAxes &&
                      ...
                      e.each(
                        this.options.scales.yAxes,
                        function (i, a) {
                          var o = e.getValueOrDefault(i.type, "linear"),
                            s = t.scaleService.getScaleConstructor(o);
                          if (s) {
                            var n = new s({
                              ctx: this.chart.ctx,
              ...
              buildOrUpdateControllers: function () {
                ...
                if (
                  (e.each(
                    this.data.datasets,
                    function (e, o) {
                      var s = this.getDatasetMeta(o);
                      s.type || (s.type = e.type || this.config.type),
                        i.push(s.type),
                        s.controller
                          ? s.controller.updateIndex(o)
                          : ((s.controller = new t.controllers[s.type](
                              this,
                              o
                            )),
                            a.push(s.controller));
              ...
              update: function (i, a) {
                t.pluginService.notifyPlugins("beforeUpdate", [this]),
                ...
                e.each(
                  ...
                  this.render(i, a),
                  t.pluginService.notifyPlugins("afterUpdate", [this]);
              },
              render: function (i, a) {
                if (
                  ...
                  (o.numSteps = (i || this.options.animation.duration) / 16.66),
                    (o.easing = this.options.animation.easing),
                    (o.render = function (t, i) {
                      var a = e.easingEffects[i.easing],
                        o = i.currentStep / i.numSteps,
                        s = a(o);
                      t.draw(s, o, i.currentStep);
                    }),
                    (o.onAnimationProgress = this.options.animation.onProgress),
                    (o.onAnimationComplete = this.options.animation.onComplete),
                    t.animationService.addAnimation(this, o, i, a);
                } else
                  this.draw(),
                    this.options.animation &&
              ...
              draw: function (i) {
                var a = i || 1;
                this.clear(),
                  t.pluginService.notifyPlugins("beforeDraw", [this, a]),
                  e.each(
                    this.boxes,
                    function (t) {
                  ...
                  e.each(
                    ...
                    function (t, e) {
                      this.isDatasetVisible(e) &&
                        this.getDatasetMeta(e).controller.draw(i);
                    },
                    this,
                    !0
                  ),
                  ...
                  t.pluginService.notifyPlugins("afterDraw", [this, a]);
              },
              ...
              destroy: function () {
                ...
                (i.width = this.chart.width),
                  ...
                  t.pluginService.notifyPlugins("destroy", [this]),
              ...
              eventHandler: function (t) {
                ...
                if (
                  ...
                  switch (this.options.hover.mode) {
                    ...
                    case "label":
                    case "dataset":
                      for (var o = 0; o < this.lastActive.length; o++)
                        this.lastActive[o] &&
                          this.getDatasetMeta(
                            this.lastActive[o]._datasetIndex
                          ).controller.removeHoverStyle(
                            this.lastActive[o],
                            this.lastActive[o]._datasetIndex,
                            this.lastActive[o]._index
                          );
                  }
                  ...
                  switch (this.options.hover.mode) {
                    ...
                    case "dataset":
                      for (var s = 0; s < this.active.length; s++)
                        this.active[s] &&
                          this.getDatasetMeta(
                            this.active[s]._datasetIndex
                          ).controller.setHoverStyle(this.active[s]);
                  }
                if (
            ...
            e.extend(t.DatasetController.prototype, {
              ...
              buildOrUpdateElements: function () {
                var t = this.getMeta(),
                  ...
                  i = t.data.length;
                if (i > e) t.data.splice(e, i - e);
                else if (e > i)
                  for (var a = i; e > a; ++a) this.addElementAndReset(a);
              },
              addElements: e.noop,
    ...
    25: [
      function (t, e, i) {
        ...
        e.exports = function (t) {
          ...
          function i(t, i, a) {
            var o,
              s = document.defaultView.getComputedStyle(t)[i],
            ...
            return (
              (r || h) &&
                (o = Math.min(
                  r ? e(s, t, a) : Number.POSITIVE_INFINITY,
          ...
          (o.each = function (t, e, i, a) {
            ...
            if (o.isArray(t))
              ...
              else for (s = 0; n > s; s++) e.call(i, t[s], s);
            else if ("object" == typeof t) {
              var r = Object.keys(t);
              for (n = r.length, s = 0; n > s; s++) e.call(i, t[r[s]], r[s]);
            }
          }),
            (o.clone = function (t) {
              var e = {};
              return (
                o.each(t, function (i, a) {
                  t.hasOwnProperty(a) &&
                    (o.isArray(i)
                      ? (e[a] = i.slice(0))
            ...
            (o.configMerge = function (e) {
              ...
              return (
                o.each(Array.prototype.slice.call(arguments, 1), function (e) {
                  o.each(e, function (a, s) {
                    if (e.hasOwnProperty(s))
                      if ("scales" === s)
                        i[s] = o.scaleMerge(i.hasOwnProperty(s) ? i[s] : {}, a);
                      else if ("scale" === s)
                        i[s] = o.configMerge(
            ...
            (o.extendDeep = function (t) {
              function e(t) {
                return (
                  o.each(arguments, function (i) {
                    i !== t &&
                      o.each(i, function (i, a) {
                      ...
                      ? a.hasOwnProperty(s)
                        ? o.each(e, function (e, i) {
                            var n = o.getValueOrDefault(
                                e.type,
                                "xAxes" === s ? "category" : "linear"
                              ),
                              r = t.scaleService.getScaleDefaults(n);
                            i >= a[s].length || !a[s][i].type
                              ? a[s].push(o.configMerge(r, e))
                              : e.type && e.type !== a[s][i].type
                              ? (a[s][i] = o.configMerge(a[s][i], r, e))
                              : (a[s][i] = o.configMerge(a[s][i], e));
                          })
                        : ((a[s] = []),
                          o.each(e, function (e) {
                            var i = o.getValueOrDefault(
                              e.type,
                              "xAxes" === s ? "category" : "linear"
                            );
                            a[s].push(
            ...
            (o.splineCurve = function (t, e, i, a) {
              ...
              return {
                ...
                next: { x: s.x + u * (n.x - o.x), y: s.y + u * (n.y - o.y) },
              };
            }),
          ...
          (o.requestAnimFrame = (function () {
            ...
            (o.getRelativePosition = function (t, e) {
              ...
              s.touches && s.touches.length > 0
                ? ((i = s.touches[0].clientX), (a = s.touches[0].clientY))
                : ((i = s.clientX), (a = s.clientY));
              var h = parseFloat(o.getStyle(n, "padding-left")),
              ...
              t.events || (t.events = {}),
                o.each(e, function (e) {
                  (t.events[e] = function () {
                    ...
                    o.addEvent(t.chart.canvas, e, t.events[e]);
                });
            }),
            (o.unbindEvents = function (t, e) {
              o.each(e, function (e, i) {
                o.removeEvent(t.chart.canvas, i, e);
              });
            }),
            ...
            (o.getMaximumWidth = function (t) {
              var e = t.parentNode,
                i =
                  parseFloat(o.getStyle(e, "padding-left")) +
                  parseFloat(o.getStyle(e, "padding-right")),
                a = e.clientWidth - i,
                s = o.getConstraintWidth(t);
              return void 0 !== s && (a = Math.min(a, s)), a;
            }),
            (o.getMaximumHeight = function (t) {
              var e = t.parentNode,
                i =
                  parseFloat(o.getStyle(e, "padding-top")) +
                  parseFloat(o.getStyle(e, "padding-bottom")),
                a = e.clientHeight - i,
                s = o.getConstraintHeight(t);
              return void 0 !== s && (a = Math.min(a, s)), a;
            }),
            ...
            (o.drawRoundedRectangle = function (t, e, i, a, o, s) {
              t.beginPath(),
                t.moveTo(e + s, i),
                t.lineTo(e + a - s, i),
                t.quadraticCurveTo(e + a, i, e + a, i + s),
                t.lineTo(e + a, i + o - s),
                t.quadraticCurveTo(e + a, i + o, e + a - s, i + o),
                t.lineTo(e + s, i + o),
            ...
            (o.pushAllIfDefined = function (t, e) {
              "undefined" != typeof t &&
                (o.isArray(t) ? e.push.apply(e, t) : e.push(t));
            }),
        ...
        e.exports = function () {
          var t = function (e, i) {
            (this.config = i),
              ...
              (this.width =
                e.canvas.width ||
                parseFloat(t.helpers.getStyle(e.canvas, "width")) ||
                t.helpers.getMaximumWidth(e.canvas)),
              (this.height =
                e.canvas.height ||
                parseFloat(t.helpers.getStyle(e.canvas, "height")) ||
          ...
          t.layoutService = {
            ...
            update: function (t, i, a) {
              ...
              function s(t) {
                ...
                if (i)
                  if (t.isHorizontal()) {
                    var a = { left: w, right: D, top: 0, bottom: 0 };
              ...
              function n(t) {
                var i = e.findNextWhere(C, function (e) {
                  ...
                  a = { left: 0, right: 0, top: M, bottom: A };
                i && t.update(i.minSize.width, S, a);
              }
              function r(t) {
                t.isHorizontal()
                  ? ((t.left = t.options.fullWidth ? h : w),
                    (t.right = t.options.fullWidth ? i - h : w + k),
                    (t.top = P),
                    (t.bottom = P + t.height),
                    (P = t.bottom))
                  : ((t.left = F),
        ...
        e.exports = function (t) {
          ...
          (t.defaults.global.legend = {
            ...
            onClick: function (t, e) {
              ...
              (a.hidden =
                null === a.hidden ? !this.chart.data.datasets[i].hidden : null),
                this.chart.update();
            },
            labels: {
              boxWidth: 40,
                    ...
                    e.each(
                      ...
                      function (t, e) {
                        ...
                        this.lineWidths[this.lineWidths.length - 1] +
                          ...
                          (this.lineWidths[this.lineWidths.length] =
                            this.left)),
                    ...
                    e.each(
                      ...
                      function (e, o) {
                        var n = i.measureText(e.text).width,
                          r = this.options.labels.boxWidth + s / 2 + n;
                        a.x + r >= this.width &&
                          ((a.y += s + this.options.labels.padding),
                          a.line++,
                          (a.x =
                            this.left +
                        ...
                        (i.fillStyle = h(
                          ...
                          i.fillRect(a.x, a.y, this.options.labels.boxWidth, s),
                          i.restore(),
                          (this.legendHitBoxes[o].left = a.x),
                          (this.legendHitBoxes[o].top = a.y),
                          i.fillText(
                            e.text,
                            this.options.labels.boxWidth + s / 2 + a.x,
                            a.y
                          ),
                          e.hidden &&
                            (i.beginPath(),
                            ...
                            i.lineTo(
                              this.options.labels.boxWidth + s / 2 + a.x + n,
                              a.y + s / 2
                            ),
                            i.stroke()),
                ...
                if (
                  (this.isHorizontal()
                    ? (this.minSize.width = this.isFullWidth()
                        ...
                        : this.maxWidth)
                    : (this.minSize.width =
                        this.options.gridLines.tickMarkLength),
                  this.isHorizontal()
                    ? (this.minSize.height =
                        this.options.gridLines.tickMarkLength)
                    : (this.minSize.height = this.maxHeight),
                  ...
                  if (this.isHorizontal()) {
                    ...
                    var p = this.maxWidth - this.minSize.width;
              ...
              draw: function (i) {
                if (this.options.display) {
                  ...
                  if (((this.ctx.fillStyle = c), this.isHorizontal())) {
                    ...
                    if (
                      ((o = !1),
                      (S / 2 + this.options.ticks.autoSkipPadding) *
                        this.ticks.length >
                      ...
                      for (; !o || this.ticks.length / (o || 1) > r; )
                        o || (o = 1), (o += 1);
                    l || (o = !1),
                      e.each(
                        this.ticks,
                        function (t, s) {
                          var n = this.ticks.length === s + 1,
                            r =
                              (o > 1 && s % o > 0) ||
                              (s % o === 0 && s + o > this.ticks.length);
                          if ((!r || n) && void 0 !== t && null !== t) {
                            var l = this.getPixelForTick(s),
                            ...
                            this.options.gridLines.display &&
                              ...
                              ("undefined" != typeof this.zeroLineIndex
                                ...
                                : a &&
                                  ((this.ctx.lineWidth =
                                    this.options.gridLines.lineWidth),
                                  (this.ctx.strokeStyle =
                                    this.options.gridLines.color),
                                  (a = !1)),
                              (l += e.aliasPixel(this.ctx.lineWidth)),
                              this.ctx.beginPath(),
                              this.options.gridLines.drawTicks &&
                                (this.ctx.moveTo(l, C), this.ctx.lineTo(l, w)),
                      ...
                      this.options.scaleLabel.display &&
                        ...
                        (this.ctx.font = y),
                        (s = this.left + (this.right - this.left) / 2),
                        (n =
                          "bottom" === this.options.position
                            ? this.bottom - b / 2
                            : this.top + b / 2),
                                ...
                                ("undefined" != typeof this.zeroLineIndex
                                  ...
                                  : a &&
                                    ...
                                    (this.ctx.strokeStyle =
                                      this.options.gridLines.color),
                                    (a = !1)),
                                (s += e.aliasPixel(this.ctx.lineWidth)),
                                this.ctx.beginPath(),
                                this.options.gridLines.drawTicks &&
                                  (this.ctx.moveTo(D, s),
                                  this.ctx.lineTo(M, s)),
                                this.options.gridLines.drawOnChartArea &&
                                  (this.ctx.moveTo(i.left, s),
                                  this.ctx.lineTo(i.right, s)),
                                this.ctx.stroke()),
                              this.options.ticks.display)
                            ) {
                              var n,
                  ...
                  this.isHorizontal()
                    ? ((F = P =
                      ...
                      (P += e.aliasPixel(this.ctx.lineWidth)))
                    : ((_ = I =
                        "left" === this.options.position
                          ? this.right
                          : this.left),
                      (_ += e.aliasPixel(this.ctx.lineWidth)),
            ...
            (t.Title = t.Element.extend({
              ...
              draw: function () {
                if (this.options.display) {
                  ...
                  if (((o.fillStyle = s), (o.font = l), this.isHorizontal()))
                    (o.textAlign = "center"),
                      (o.textBaseline = "middle"),
                      (i = this.left + (this.right - this.left) / 2),
                      (a = this.top + (this.bottom - this.top) / 2),
                      o.fillText(this.options.text, i, a);
                  else {
                    (i =
                      "left" === this.options.position
                        ? this.left + n / 2
                    ...
                    o.save(),
                      ...
                      (o.textAlign = "center"),
                      (o.textBaseline = "middle"),
                      o.fillText(this.options.text, 0, 0),
                      o.restore();
                  }
                }
              },
          ...
          (t.defaults.global.tooltips = {
            ...
            (t.Tooltip = t.Element.extend({
              ...
              getAveragePosition: function (t) {
                ...
                for (var o = 0, s = 0, n = 0; n < e.length; n++)
                  (o += e[n]), (s += a[n]);
                return {
                  x: Math.round(o / e.length),
                  y: Math.round(s / e.length),
                };
              },
              update: function (t) {
                if (this._active.length) {
                          ...
                          if (o) {
                            ...
                            s.push({
                              xLabel: o._xScale
                                ...
                                : "",
                              yLabel: n
                                ? n.getLabelForIndex(o._index, o._datasetIndex)
                                : "",
                              index: a._index,
                              datasetIndex: e,
                            });
                  ...
                  i.extend(this._model, {
                    title: this.getTitle(s, this._data),
                    beforeBody: this.getBeforeBody(s, this._data),
                    body: this.getBody(s, this._data),
                    afterBody: this.getAfterBody(s, this._data),
                    footer: this.getFooter(s, this._data),
                  }),
                    i.extend(this._model, {
                      x: Math.round(e.x),
                      y: Math.round(e.y),
                  ...
                  e(this._model.x)
                    ? ((this._model.xAlign = "left"),
                      a(this._model.x) &&
                        ...
                        (this._model.yAlign = s(this._model.y))))
                    : i(this._model.x) &&
              ...
              drawCaret: function (t, e, a, o) {
                ...
                "center" === d.yAlign
                  ? ("left" === d.xAlign
                      ? ((s = t.x), (n = s - d.caretSize), (r = s))
                      : ((s = t.x + e.width), (n = s + d.caretSize), (r = s)),
                    (l = t.y + e.height / 2),
                    (h = l - d.caretSize),
                    (c = l + d.caretSize))
                  : ("left" === d.xAlign
                      ? ((s = t.x + d.cornerRadius),
                        (n = s + d.caretSize),
                        (r = n + d.caretSize))
                      : "right" === d.xAlign
                      ? ((s = t.x + e.width - d.cornerRadius),
                        (n = s - d.caretSize),
                        (r = n - d.caretSize))
                      : ((n = t.x + e.width / 2),
                        (s = n - d.caretSize),
              ...
              drawTitle: function (t, e, a, o) {
                if (e.title.length) {
                  ...
                  var s = i.color(e.titleColor);
                  (a.fillStyle = s.alpha(o * s.alpha()).rgbString()),
                    (a.font = i.fontString(
                      e.titleFontSize,
                      e._titleFontStyle,
                      e._titleFontFamily
                ...
                if (0 !== e.opacity) {
                  ...
                  if (this._options.tooltips.enabled) {
                    ...
                    (t.fillStyle = r.alpha(n * r.alpha()).rgbString()),
                      ...
                      t.fill(),
                      this.drawCaret(s, o, n, a),
                      (s.x += e.xPadding),
                      (s.y += e.yPadding),
                      this.drawTitle(s, e, t, n),
                      this.drawBody(s, e, t, n),
                      this.drawFooter(s, e, t, n);
                  }
                }
              },
            }));
          ...
          (t.defaults.global.elements.arc = {
            ...
            (t.elements.Arc = t.Element.extend({
              ...
              inRange: function (t, e) {
                ...
                if (a) {
                  for (
                    var o = i.getAngleFromPoint(a, { x: t, y: e }),
                      s = a.startAngle,
                      n = a.endAngle;
                    s > n;
                    ...
                    n += 2 * Math.PI;
                  for (; o.angle > n; ) o.angle -= 2 * Math.PI;
                  for (; o.angle < s; ) o.angle += 2 * Math.PI;
                  var r = o.angle >= s && o.angle <= n,
                    h =
                      o.distance >= a.innerRadius &&
                      o.distance <= a.outerRadius;
                  return r && h;
                }
                return !1;
              },
              ...
              draw: function () {
                function i(t) {
                  n._view.skip || r._view.skip
                    ? t && s.lineTo(a._view.scaleZero.x, a._view.scaleZero.y)
                    : s.bezierCurveTo(
                ...
                s.save(),
                  this._children.length > 0 &&
                    ...
                    e.each(
                      ...
                      function (t, i) {
                        ...
                        0 === i
                          ? (this._loop
                              ? s.moveTo(o.scaleZero.x, o.scaleZero.y)
                              : s.moveTo(t._view.x, o.scaleZero),
                            t._view.skip
                              ? this._loop ||
                                s.moveTo(n._view.x, this._view.scaleZero)
                              : s.lineTo(t._view.x, t._view.y))
                          : this.lineToNextPoint(
                              ...
                              function (t, e, i) {
                                this._loop
                                  ...
                                  : (s.lineTo(t._view.x, this._view.scaleZero),
                                    s.moveTo(i._view.x, this._view.scaleZero));
                              },
                              function (t, e) {
                                s.lineTo(e._view.x, e._view.y);
                              }
                    ...
                    this._loop
                      ...
                      : (s.lineTo(
                        ...
                        s.lineTo(this._children[0]._view.x, o.scaleZero)),
                    (s.fillStyle =
                      o.backgroundColor || t.defaults.global.defaultColor),
                    s.closePath(),
                    s.fill()),
                  (s.lineCap =
                    o.borderCapStyle ||
                  ...
                  s.setLineDash &&
                    s.setLineDash(
                      o.borderDash || t.defaults.global.elements.line.borderDash
                    ),
                  (s.lineDashOffset =
                    o.borderDashOffset ||
                    t.defaults.global.elements.line.borderDashOffset),
                  ...
                  (s.lineWidth =
                    ...
                    t.defaults.global.elements.line.borderWidth),
                  (s.strokeStyle =
                    o.borderColor || t.defaults.global.defaultColor),
                  s.beginPath(),
                  e.each(
                    this._children,
                    function (t, i) {
                      ...
                      0 === i
                        ? s.moveTo(t._view.x, t._view.y)
                        : this.lineToNextPoint(
                            a,
                            t,
                            o,
                            function (t, e, i) {
                              s.moveTo(i._view.x, i._view.y);
                            },
                            function (t, e) {
                              s.moveTo(e._view.x, e._view.y);
                            }
                          );
                    },
                    this
                    ...
                    switch (i.pointStyle) {
                      ...
                      case "crossRot":
                        a.beginPath(),
                          ...
                          a.moveTo(i.x - o, i.y - s),
                          a.lineTo(i.x + o, i.y + s),
                          a.moveTo(i.x - o, i.y + s),
                          a.lineTo(i.x + o, i.y - s),
                          a.closePath();
                        break;
            ...
            a = t.Scale.extend({
              ...
              getValueForPixel: function (t) {
                var e,
                  ...
                  s = o / i;
                return (
                  this.options.gridLines.offsetGridLines && (t -= s / 2),
                  (t -= a ? this.paddingLeft : this.paddingTop),
                  (e = 0 >= t ? 0 : Math.round(t / s))
                );
              },
            });
          ...
          var e = t.helpers,
              ...
              ticks: {
                callback: function (t, i, a) {
                  ...
                  Math.abs(o) > 1 &&
                    t !== Math.floor(t) &&
                    (o = t - Math.floor(t));
                  var s = e.log10(Math.abs(o)),
                    n = "";
                  if (0 !== t) {
                    var r = -1 * Math.floor(s);
            ...
            a = t.Scale.extend({
              determineDataLimits: function () {
                if (
                  ...
                  e.each(
                    this.chart.data.datasets,
                    function (o, s) {
                      var n = this.chart.getDatasetMeta(s);
                      void 0 === t[n.type] &&
                        (t[n.type] = {
                          positiveValues: [],
                          negativeValues: [],
                    ...
                    e.each(
                      ...
                      function (t) {
                        ...
                        (this.min =
                          ...
                          (this.max =
                            null === this.max ? o : Math.max(this.max, o));
                      },
                      this
                    );
                } else
              ...
              buildTicks: function () {
                ...
                var r = Math.floor(this.min / o) * o,
                  h = Math.ceil(this.max / o) * o,
                  l = (h - r) / o;
                (l = e.almostEquals(l, Math.round(l), o / 1e3)
                  ? Math.round(l)
                  : Math.ceil(l)),
                  this.ticks.push(
                    void 0 !== this.options.ticks.min
                ...
                for (var c = 1; l > c; ++c) this.ticks.push(r + c * o);
                this.ticks.push(
              ...
              getPixelForValue: function (t, e, i, a) {
                ...
                if (this.isHorizontal()) {
                  ...
                  return (
                    (o = this.left + (r / n) * (s - this.start)),
                    Math.round(o + this.paddingLeft)
                  );
                }
                var h = this.height - (this.paddingTop + this.paddingBottom);
                return (
            ...
            i = {
              ...
              ticks: {
                callback: function (e, i, a) {
                  var o = e / Math.pow(10, Math.floor(t.helpers.log10(e)));
                  return 1 === o ||
                    2 === o ||
                    5 === o ||
                    0 === i ||
            ...
            a = t.Scale.extend({
              determineDataLimits: function () {
                if (
                  ...
                  e.each(
                    this.chart.data.datasets,
                    function (i, a) {
                      var o = this.chart.getDatasetMeta(a);
              ...
              getValueForPixel: function (t) {
                ...
                if (this.isHorizontal()) {
                  ...
                  i =
                    this.start *
                    Math.pow(10, ((t - this.left - this.paddingLeft) * a) / o);
                } else {
                  var s = this.height - (this.paddingTop + this.paddingBottom);
                  i =
                    Math.pow(
                      10,
                      ((this.bottom - this.paddingBottom - t) * a) / s
                    ) / this.start;
                }
                return i;
              },
          ...
          var e = t.helpers,
            ...
            a = t.Scale.extend({
              ...
              buildTicks: function () {
                ...
                for (var l = 1; h > l; ++l) this.ticks.push(n + l * s);
                this.ticks.push(
                    ...
                    (e.each(
                      ...
                      function (a, o) {
                        if (o > 0 || this.options.reverse) {
                          var s = this.getDistanceFromCenterForValue(
                              this.ticks[o]
                            ),
                            n = this.yCenter - s;
            ...
            var e = t.helpers,
              ...
              s = t.Scale.extend({
                ...
                determineDataLimits: function () {
                  ...
                  this.chart.data.labels && this.chart.data.labels.length > 0
                    ...
                    e.each(
                      ...
                      function (i, o) {
                        var s = [],
                          n = this.chart.isDatasetVisible(o);
                ...
                buildTicks: function (a) {
                  ...
                  if (
                    ...
                    for (var f = 0, p = i.units[f]; f < i.units.length; ) {
                      if (
                        ((this.unitScale = 1),
                        e.isArray(p.steps) &&
                          Math.ceil(this.scaleSizeInUnits / g) < e.max(p.steps))
                      ) {
                        for (var m = 0; m < p.steps.length; ++m)
                          if (
                            p.steps[m] >= Math.ceil(this.scaleSizeInUnits / g)
                          ) {
                            this.unitScale = e.getValueOrDefault(
                              this.options.time.unitStepSize,
                              p.steps[m]
                      ...
                      if (
                        p.maxStep === !1 ||
                        Math.ceil(this.scaleSizeInUnits / g) < p.maxStep
                      ) {
                        this.unitScale = e.getValueOrDefault(
                          this.options.time.unitStepSize,
                      ...
                      (this.scaleSizeInUnits =
                        this.lastTick.diff(this.firstTick, this.tickUnit, !0) +
                        b +
                        x),
                        (this.displayFormat =
                  ...
                  if (
                    (this.options.time.min
                      ? (v = this.firstTick.clone().startOf(this.tickUnit))
                      : (this.firstTick.startOf(this.tickUnit),
                        (v = this.firstTick)),
                    !this.options.time.max)
                  ) {
                    var y = this.lastTick.clone().startOf(this.tickUnit);
                    0 !== y.diff(this.lastTick, this.tickUnit, !0) &&
                      this.lastTick
                        .add(1, this.tickUnit)
                        .startOf(this.tickUnit);
                  }
                  ...
                  for (var k = 1; k <= this.scaleSizeInUnits; ++k) {
                    var S = v.clone().add(k, this.tickUnit);
                    if (
                      this.options.time.max &&
                      S.diff(this.lastTick, this.tickUnit, !0) >= 0
                    )
                      break;
                    k % this.unitScale === 0 && this.ticks.push(S);
                  }
                  var C = this.ticks[this.ticks.length - 1].diff(
                    this.lastTick,
                    this.tickUnit
                  );
                ...
                getPixelForValue: function (t, e, i, a) {
                  ...
                  if (o) {
                    var s = o.diff(this.firstTick, this.tickUnit, !0),
                      n = s / this.scaleSizeInUnits;
                    if (this.isHorizontal()) {
                      var r =
                          this.width - (this.paddingLeft + this.paddingRight),
                        h =
                          (r / Math.max(this.ticks.length - 1, 1),
                    ...
                    var l =
                        this.height - (this.paddingTop + this.paddingBottom),
                      c =
                        (l / Math.max(this.ticks.length - 1, 1),
                        l * n + this.paddingTop);
                ...
                getValueForPixel: function (t) {
                  ...
                  return (
                    ...
                    this.firstTick
                      .clone()
                      .add(a.duration(i, this.tickUnit).asSeconds(), "seconds")
                  );
                },
