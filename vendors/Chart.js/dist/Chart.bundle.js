...
(function e(t, n, r) {
  ...
  compute it */
      ...
      function (require, module, exports) {
        ...
        function getRgba(string) {
          ...
          if (match) {
            ...
            for (var i = 0; i < rgb.length; i++) {
              rgb[i] = parseFloat(match[i] + match[i], 16);
            }
          } else if ((match = string.match(hex))) {
            match = match[1];
            for (var i = 0; i < rgb.length; i++) {
              rgb[i] = parseFloat(match.slice(i * 2, i * 2 + 2), 16);
            }
        ...
        function getHsla(string) {
          ...
          if (match) {
            ...
            var h = scale(parseFloat(match[1]), 0, 360),
    ...
    5: [
      ...
      { "color-convert": 2, "color-string": 3 },
    ],
    6: [
      function (require, module, exports) {
        //! moment.js
          ...
          Chart.controllers.bar = Chart.DatasetController.extend({
            ...
            updateElement: function updateElement(
              ...
              helpers.extend(rectangle, {
                ...
                _model: {
                  ...
                  y: reset
                    ? yScalePoint
                    : this.calculateBarY(index, this.index),
                  ...
                  backgroundColor:
                    rectangle.custom && rectangle.custom.backgroundColor
                  ...
                  borderSkipped:
                    rectangle.custom && rectangle.custom.borderSkipped
                  ...
                  borderWidth:
                    rectangle.custom && rectangle.custom.borderWidth
                      ? rectangle.custom.borderWidth
                      : helpers.getValueAtIndexOrDefault(
            ...
            setHoverStyle: function (rectangle) {
              ...
              rectangle._model.backgroundColor =
                rectangle.custom && rectangle.custom.hoverBackgroundColor
                  ? rectangle.custom.hoverBackgroundColor
                  : helpers.getValueAtIndexOrDefault(
                      dataset.hoverBackgroundColor,
                      index,
                      helpers
                        .color(rectangle._model.backgroundColor)
                        .saturate(0.5)
                        .darken(0.1)
                        .rgbString()
                    );
              rectangle._model.borderColor =
                rectangle.custom && rectangle.custom.hoverBorderColor
                  ...
                  : helpers.getValueAtIndexOrDefault(
                      ...
                      index,
                      helpers
                        .color(rectangle._model.borderColor)
                        .saturate(0.5)
                        .darken(0.1)
                        .rgbString()
                    );
              rectangle._model.borderWidth =
                rectangle.custom && rectangle.custom.hoverBorderWidth
                  ? rectangle.custom.hoverBorderWidth
                  : helpers.getValueAtIndexOrDefault(
          ...
          Chart.controllers.horizontalBar = Chart.controllers.bar.extend({
            ...
            getRuler: function () {
              ...
              var tickHeight = function () {
                ...
                for (var i = 2; i < this.getDataset().data.length; i++) {
                  min = Math.min(
                    yScale.getPixelForTick(i) - yScale.getPixelForTick(i - 1),
                    min
                  );
                }
                return min;
        ...
        module.exports = function (Chart) {
          ...
          Chart.controllers.bubble = Chart.DatasetController.extend({
            ...
            updateElement: function (point, index, reset) {
              ...
              helpers.extend(point, {
                ...
                _model: {
                  ...
                  radius: reset
                    ? 0
                    : point.custom && point.custom.radius
                    ? point.custom.radius
                    : this.getRadius(this.getDataset().data[index]),
                  backgroundColor:
                    point.custom && point.custom.backgroundColor
                      ? point.custom.backgroundColor
                      : helpers.getValueAtIndexOrDefault(
                          this.getDataset().backgroundColor,
                          index,
                  ...
                  borderColor:
                    point.custom && point.custom.borderColor
                      ? point.custom.borderColor
                      : helpers.getValueAtIndexOrDefault(
                          this.getDataset().borderColor,
                          index,
                  ...
                  borderWidth:
                    point.custom && point.custom.borderWidth
                      ? point.custom.borderWidth
                      : helpers.getValueAtIndexOrDefault(
                          this.getDataset().borderWidth,
                          index,
                  ...
                  // Tooltip
                  hitRadius:
                    point.custom && point.custom.hitRadius
                      ? point.custom.hitRadius
                      : helpers.getValueAtIndexOrDefault(
              ...
              point._model.skip =
                point.custom && point.custom.skip
                  ? point.custom.skip
            ...
            setHoverStyle: function (point) {
              ...
              point._model.radius =
                point.custom && point.custom.hoverRadius
                  ? point.custom.hoverRadius
                  : helpers.getValueAtIndexOrDefault(
                      dataset.hoverRadius,
                      index,
                      this.chart.options.elements.point.hoverRadius
                    ) + this.getRadius(this.getDataset().data[point._index]);
              point._model.backgroundColor =
                point.custom && point.custom.hoverBackgroundColor
                  ? point.custom.hoverBackgroundColor
                  : helpers.getValueAtIndexOrDefault(
                      dataset.hoverBackgroundColor,
                      index,
                      helpers
                        .color(point._model.backgroundColor)
                        .saturate(0.5)
                        .darken(0.1)
                        .rgbString()
                    );
              point._model.borderColor =
                point.custom && point.custom.hoverBorderColor
                  ? point.custom.hoverBorderColor
                  : helpers.getValueAtIndexOrDefault(
                      dataset.hoverBorderColor,
                      index,
                      helpers
                        .color(point._model.borderColor)
                        .saturate(0.5)
                        .darken(0.1)
                        .rgbString()
                    );
              point._model.borderWidth =
                point.custom && point.custom.hoverBorderWidth
                  ? point.custom.hoverBorderWidth
                  : helpers.getValueAtIndexOrDefault(
                      dataset.hoverBorderWidth,
                      index,
                      point._model.borderWidth
                ...
                generateLabels: function (chart) {
                  ...
                  if (data.labels.length && data.datasets.length) {
                    return data.labels.map(function (label, i) {
                      ...
                      var arc = meta.data[i];
                      var fill =
                        arc.custom && arc.custom.backgroundColor
                          ? arc.custom.backgroundColor
                          : helpers.getValueAtIndexOrDefault(
                              ds.backgroundColor,
                              i,
                      ...
                      var stroke =
                        arc.custom && arc.custom.borderColor
                          ? arc.custom.borderColor
                          : helpers.getValueAtIndexOrDefault(
                              ds.borderColor,
                              i,
                      ...
                      var bw =
                        arc.custom && arc.custom.borderWidth
                          ? arc.custom.borderWidth
                          : helpers.getValueAtIndexOrDefault(
                              ds.borderWidth,
                              i,
          ...
          Chart.controllers.doughnut = Chart.controllers.pie =
            Chart.DatasetController.extend({
              ...
              addElementAndReset: function (index, colorForNewElement) {
                ...
                if (
                  colorForNewElement &&
                  helpers.isArray(this.getDataset().backgroundColor)
                ) {
                  this.getDataset().backgroundColor.splice(
                    index,
                    0,
                    colorForNewElement
                  );
              ...
              update: function update(reset) {
                ...
                if (this.chart.options.circumference < Math.PI * 2.0) {
                  var startAngle =
                    this.chart.options.rotation % (Math.PI * 2.0);
                  startAngle +=
                    Math.PI *
                    2.0 *
                    (startAngle >= Math.PI
                ...
                this.chart.radiusLength =
                  ...
                  this.chart.getVisibleDatasetCount();
              ...
              updateElement: function (arc, index, reset) {
                ...
                var circumference =
                  reset && this.chart.options.animation.animateRotate
                    ? 0
                    : arc.hidden
                    ? 0
                    : this.calculateCircumference(
                      ...
                      (this.chart.options.circumference / (2.0 * Math.PI));
                var innerRadius =
                  reset && this.chart.options.animation.animateScale
                    ? 0
                    : this.innerRadius;
                var outerRadius =
                  reset && this.chart.options.animation.animateScale
                ...
                helpers.extend(arc, {
                  ...
                  _model: {
                    ...
                    hoverBackgroundColor:
                      arc.custom && arc.custom.hoverBackgroundColor
                        ? arc.custom.hoverBackgroundColor
                        : helpers.getValueAtIndexOrDefault(
                            this.getDataset().hoverBackgroundColor,
                            index,
                            this.chart.options.elements.arc.hoverBackgroundColor
                          ),
                    borderWidth:
                      arc.custom && arc.custom.borderWidth
                        ? arc.custom.borderWidth
                    ...
                    label: helpers.getValueAtIndexOrDefault(
                ...
                if (!reset || !this.chart.options.animation.animateRotate) {
                  ...
                  arc._model.endAngle =
                    arc._model.startAngle + arc._model.circumference;
                }
                ...
                arc._model.backgroundColor =
                  arc.custom && arc.custom.hoverBackgroundColor
                    ...
                    : helpers.getValueAtIndexOrDefault(
                        ...
                        index,
                        helpers
                          .color(arc._model.backgroundColor)
                          .saturate(0.5)
                          .darken(0.1)
                          .rgbString()
                      );
                arc._model.borderColor =
                  arc.custom && arc.custom.hoverBorderColor
                    ? arc.custom.hoverBorderColor
                    : helpers.getValueAtIndexOrDefault(
                        dataset.hoverBorderColor,
                        index,
                        helpers
                          .color(arc._model.borderColor)
                          .saturate(0.5)
                          .darken(0.1)
                          .rgbString()
                      );
                arc._model.borderWidth =
                  arc.custom && arc.custom.hoverBorderWidth
                    ? arc.custom.hoverBorderWidth
                    : helpers.getValueAtIndexOrDefault(
                        dataset.hoverBorderWidth,
                        index,
                        arc._model.borderWidth
          ...
          Chart.controllers.line = Chart.DatasetController.extend({
            ...
            update: function update(reset) {
              ...
              if (this.chart.options.showLines) {
                ...
                if (
                  this.getDataset().tension !== undefined &&
                  this.getDataset().lineTension === undefined
                ) {
                ...
                line._model = {
                  // Appearance
                  tension:
                    line.custom && line.custom.tension
                      ? line.custom.tension
                  ...
                  backgroundColor:
                    line.custom && line.custom.backgroundColor
                      ? line.custom.backgroundColor
                      : this.getDataset().backgroundColor ||
                        this.chart.options.elements.line.backgroundColor,
                  borderWidth:
                    line.custom && line.custom.borderWidth
                      ? line.custom.borderWidth
                      : this.getDataset().borderWidth ||
                        this.chart.options.elements.line.borderWidth,
                  borderColor:
                    line.custom && line.custom.borderColor
                      ? line.custom.borderColor
                      : this.getDataset().borderColor ||
                        this.chart.options.elements.line.borderColor,
                  borderCapStyle:
                    line.custom && line.custom.borderCapStyle
                      ? line.custom.borderCapStyle
                      : this.getDataset().borderCapStyle ||
                        this.chart.options.elements.line.borderCapStyle,
                  borderDash:
                    line.custom && line.custom.borderDash
                      ? line.custom.borderDash
                      : this.getDataset().borderDash ||
                        this.chart.options.elements.line.borderDash,
                  borderDashOffset:
                    line.custom && line.custom.borderDashOffset
                      ? line.custom.borderDashOffset
                      : this.getDataset().borderDashOffset ||
                        this.chart.options.elements.line.borderDashOffset,
                  borderJoinStyle:
                    line.custom && line.custom.borderJoinStyle
                      ? line.custom.borderJoinStyle
                      : this.getDataset().borderJoinStyle ||
                        this.chart.options.elements.line.borderJoinStyle,
                  fill:
                    line.custom && line.custom.fill
                      ? line.custom.fill
                      : this.getDataset().fill !== undefined
            ...
            updateElement: function (point, index, reset) {
              ...
              // Compatibility: If the properties are defined with only the old name, use those values
              if (
                this.getDataset().radius !== undefined &&
                this.getDataset().pointRadius === undefined
              ) {
                this.getDataset().pointRadius = this.getDataset().radius;
              }
              if (
                this.getDataset().hitRadius !== undefined &&
                this.getDataset().pointHitRadius === undefined
              ) {
              ...
              point._model = {
                ...
                pointStyle:
                  point.custom && point.custom.pointStyle
                    ? point.custom.pointStyle
                    : helpers.getValueAtIndexOrDefault(
                ...
                hitRadius:
                  point.custom && point.custom.hitRadius
                    ? point.custom.hitRadius
                    : helpers.getValueAtIndexOrDefault(
                        this.getDataset().pointHitRadius,
                        index,
                        this.chart.options.elements.point.hitRadius
                      ),
              };
            ...
            updateBezierControlPoints: function () {
              ...
              helpers.each(
                ...
                function (point, index) {
                  ...
                  point._model.controlPointPreviousX = Math.max(
                    Math.min(
                  ...
                  point._model.controlPointPreviousY = Math.max(
                    Math.min(
                  ...
                  point._model.controlPointNextX = Math.max(
                    Math.min(controlPoints.next.x, this.chart.chartArea.right),
                    this.chart.chartArea.left
                  );
                  point._model.controlPointNextY = Math.max(
                    Math.min(controlPoints.next.y, this.chart.chartArea.bottom),
                    this.chart.chartArea.top
                  );
            ...
            removeHoverStyle: function (point) {
              ...
              point._model.backgroundColor = this.getPointBackgroundColor(
                point,
                index
              );
          ...
          Chart.controllers.polarArea = Chart.DatasetController.extend({
            ...
            update: function update(reset) {
              ...
              this.chart.outerRadius = Math.max(
                (minSize - this.chart.options.elements.arc.borderWidth / 2) / 2,
                0
              );
              this.chart.innerRadius = Math.max(
                this.chart.options.cutoutPercentage
              ...
              this.outerRadius =
                this.chart.outerRadius - this.chart.radiusLength * this.index;
              this.innerRadius = this.outerRadius - this.chart.radiusLength;
            ...
            updateElement: function (arc, index, reset) {
              var circumference = this.calculateCircumference(
                this.getDataset().data[index]
              );
              var centerX =
                (this.chart.chartArea.left + this.chart.chartArea.right) / 2;
              ...
              var resetModel = {
                ...
                startAngle: this.chart.options.animation.animateRotate
                  ? Math.PI * -0.5
                  : startAngle,
                endAngle: this.chart.options.animation.animateRotate
                  ? Math.PI * -0.5
                  : endAngle,
      ...
      function (require, module, exports) {
        ...
        module.exports = function (Chart) {
          ...
          Chart.controllers.radar = Chart.DatasetController.extend({
            ...
            updateElement: function (point, index, reset) {
              var pointPosition = this.chart.scale.getPointPositionForValue(
                index,
                this.getDataset().data[index]
              );
              ...
              helpers.extend(point, {
                ...
                _model: {
                  ...
                  // Appearance
                  tension:
                    point.custom && point.custom.tension
                      ? point.custom.tension
                      : helpers.getValueOrDefault(
          ...
          helpers.extend(Chart.Controller.prototype, {
                ...
                if (
                  ...
                  helpers.each(
                    ...
                    function (xAxisOptions, index) {
                      xAxisOptions.id =
                        xAxisOptions.id || defaultXAxisID + index;
                    }
                  );
                }
                ...
                if (
                  ...
                  helpers.each(
                    ...
                    function (yAxisOptions, index) {
                      yAxisOptions.id =
                        yAxisOptions.id || defaultYAxisID + index;
                    }
                  );
                }
              }
              ...
              if (this.options.scales) {
                if (
                  ...
                  helpers.each(
                    this.options.scales.xAxes,
                    function (xAxisOptions, index) {
                      var xType = helpers.getValueOrDefault(
                        xAxisOptions.type,
                        "category"
                      );
                      var ScaleClass =
                        Chart.scaleService.getScaleConstructor(xType);
                      if (ScaleClass) {
                ...
                if (
                  ...
                  helpers.each(
                    this.options.scales.yAxes,
                    function (yAxisOptions, index) {
                      var yType = helpers.getValueOrDefault(
                        yAxisOptions.type,
                        "linear"
                      );
                      var ScaleClass =
                        Chart.scaleService.getScaleConstructor(yType);
                      if (ScaleClass) {
                        var scale = new ScaleClass({
                          ctx: this.chart.ctx,
            ...
            render: function render(duration, lazy) {
              ...
              if (
                ...
                animation.numSteps =
                  (duration || this.options.animation.duration) / 16.66; //60 fps
                ...
                animation.onAnimationProgress =
                  this.options.animation.onProgress;
            ...
            eventHandler: function eventHandler(e) {
              ...
              if (e.type === "mouseout") {
                ...
                this.tooltipActive = getItemsForMode(
                  this.options.tooltips.mode
                );
              }
                  ...
                  case "dataset":
                    for (var i = 0; i < this.lastActive.length; i++) {
                      if (this.lastActive[i])
                        this.getDatasetMeta(
                          this.lastActive[i]._datasetIndex
                        ).controller.removeHoverStyle(
                          this.lastActive[i],
                          this.lastActive[i]._datasetIndex,
                          this.lastActive[i]._index
                        );
                    }
                    break;
                  default:
                ...
                switch (this.options.hover.mode) {
                  ...
                  case "dataset":
                    for (var j = 0; j < this.active.length; j++) {
                      if (this.active[j])
                        this.getDatasetMeta(
                          this.active[j]._datasetIndex
                        ).controller.setHoverStyle(this.active[j]);
                    }
                    break;
                  default:
                  // Don't change anything
              ...
              helpers.each(
                ...
                function (value, key) {
                  ...
                  // Color transitions if possible
                    ...
                    try {
                      var color = helpers
                        .color(this._start[key])
                        .mix(helpers.color(this._model[key]), ease);
        ...
        module.exports = function (Chart) {
          ...
          function parseMaxStyle(styleValue, node, parentProperty) {
            ...
            if (typeof styleValue === "string") {
              valueInPixels = parseFloat(styleValue, 10);
          ...
          function getConstraintDimension(
            ...
            var constrainedNode =
              document.defaultView.getComputedStyle(domNode)[maxStyle];
            var constrainedContainer = document.defaultView.getComputedStyle(
              domNode.parentNode
            )[maxStyle];
            var hasCNode =
              constrainedNode !== null && constrainedNode !== "none";
            var hasCContainer =
              constrainedContainer !== null && constrainedContainer !== "none";

            if (hasCNode || hasCContainer) {
              constrainedDimension = Math.min(
                hasCNode
          ...
          helpers.getMaximumWidth = function (domNode) {
            ...
            var padding =
              parseFloat(helpers.getStyle(container, "padding-left")) +
              parseFloat(helpers.getStyle(container, "padding-right"));
          ...
          helpers.getMaximumHeight = function (domNode) {
            var container = domNode.parentNode;
            var padding =
              parseFloat(helpers.getStyle(container, "padding-top")) +
              parseFloat(helpers.getStyle(container, "padding-bottom"));
        ...
        module.exports = function () {
          ...
          var Chart = function (context, config) {
            ...
            this.width =
              ...
              parseFloat(Chart.helpers.getStyle(context.canvas, "width")) ||
              Chart.helpers.getMaximumWidth(context.canvas);
            this.height =
              context.canvas.height ||
              parseFloat(Chart.helpers.getStyle(context.canvas, "height")) ||
              ...
              if (this.options.display) {
                if (this.isHorizontal()) {
                  ...
                  var totalHeight = this.legendItems.length
                    ? fontSize + this.options.labels.padding
                    : 0;
                  ...
                  helpers.each(
                    ...
                    function (legendItem, i) {
                      ...
                      this.lineWidths[this.lineWidths.length - 1] +=
                        width + this.options.labels.padding;
                    },
                    this
                  );
                ...
                if (this.isHorizontal()) {
                  ...
                  helpers.each(
                    ...
                    function (legendItem, i) {
                      ...
                      var width =
                        this.options.labels.boxWidth + fontSize / 2 + textWidth;
                      ...
                      if (cursor.x + width >= this.width) {
                        ...
                        cursor.x =
                          this.left +
                          (this.width - this.lineWidths[cursor.line]) / 2;
                      }
                      ...
                      ctx.lineWidth = itemOrDefault(
                        ...
                        Chart.defaults.global.elements.line.borderWidth
                      );
                      ...
                      ctx.fillText(
                        legendItem.text,
                        this.options.labels.boxWidth + fontSize / 2 + cursor.x,
                        cursor.y
                      );
              ...
              if (
                ...
                for (var i = 0; i < this.legendHitBoxes.length; ++i) {
                  ...
                  if (
                    ...
                    position.x <= hitBox.left + hitBox.width &&
                    position.y >= hitBox.top &&
                    position.y <= hitBox.top + hitBox.height
                  ) {
                    // Touching an element
                    if (this.options.onClick) {
        ...
        module.exports = function (Chart) {
          ...
          Chart.Scale = Chart.Element.extend({
            ...
            calculateTickRotation: function () {
              ...
              var lastWidth = this.ctx.measureText(
              ...
              if (this.options.ticks.display && this.options.display) {
                ...
                if (this.isHorizontal()) {
                  ...
                  this.minSize.height = Math.min(
                    this.maxHeight,
                    this.minSize.height + labelHeight
                  );
                  this.ctx.font = tickLabelFont;
            ...
            draw: function (chartArea) {
              if (this.options.display) {
                ...
                if (this.isHorizontal()) {
                  ...
                  if (
                    (longestRotatedLabel / 2 +
                      this.options.ticks.autoSkipPadding) *
                      this.ticks.length >
                    this.width - (this.paddingLeft + this.paddingRight)
                  ) {
                    skipRatio =
                  ...
                  helpers.each(
                    ...
                    function (label, index) {
                      ...
                      ); // x values for ticks (need to consider offsetLabel option)
                      ...
                      if (this.options.gridLines.display) {
                        if (
                          ...
                          this.ctx.lineWidth =
                            this.options.gridLines.zeroLineWidth;
                      ...
                      if (this.options.ticks.display) {
                        ...
                        this.ctx.rotate(
                          helpers.toRadians(this.labelRotation) * -1
                        );
                        this.ctx.font = tickLabelFont;
                    ...
                    function (label, index) {
                      ...
                      if (this.options.ticks.display) {
                        ...
                        if (this.options.position === "left") {
                          if (this.options.ticks.mirror) {
                            xLabelValue =
                              this.right + this.options.ticks.padding;
                ...
                if (this.isHorizontal()) {
                  y1 = y2 =
                    this.options.position === "top" ? this.bottom : this.top;
                  y1 += helpers.aliasPixel(this.ctx.lineWidth);
                  y2 += helpers.aliasPixel(this.ctx.lineWidth);
                } else {
                  x1 = x2 =
                    this.options.position === "left" ? this.right : this.left;
            ...
            draw: function () {
              if (this.options.display) {
                ...
                if (this.isHorizontal()) {
                  ...
                  titleX =
                    this.options.position === "left"
                      ? this.left + fontSize / 2
                      : this.right - fontSize / 2;
      ...
      function (require, module, exports) {
        ...
        module.exports = function (Chart) {
          ...
          Chart.Tooltip = Chart.Element.extend({
              ...
              helpers.extend(this, {
                _model: {
                  ...
                  _bodyFontFamily: helpers.getValueOrDefault(
                    options.tooltips.bodyFontFamily,
                    Chart.defaults.global.defaultFontFamily
                  ),
                  _bodyFontStyle: helpers.getValueOrDefault(
                    options.tooltips.bodyFontStyle,
                    Chart.defaults.global.defaultFontStyle
                  ),
                  _bodyAlign: options.tooltips.bodyAlign,
                  bodyFontSize: helpers.getValueOrDefault(
                    options.tooltips.bodyFontSize,
                    Chart.defaults.global.defaultFontSize
                  ),
                  ...
                  _titleFontFamily: helpers.getValueOrDefault(
                    options.tooltips.titleFontFamily,
                    Chart.defaults.global.defaultFontFamily
                  ),
                  _titleFontStyle: helpers.getValueOrDefault(
                    options.tooltips.titleFontStyle,
                    Chart.defaults.global.defaultFontStyle
                  ),
                  titleFontSize: helpers.getValueOrDefault(
                    options.tooltips.titleFontSize,
                    Chart.defaults.global.defaultFontSize
                  ),
                  ...
                  _footerFontFamily: helpers.getValueOrDefault(
                    options.tooltips.footerFontFamily,
                    Chart.defaults.global.defaultFontFamily
                  ),
                  _footerFontStyle: helpers.getValueOrDefault(
                    options.tooltips.footerFontStyle,
                    Chart.defaults.global.defaultFontStyle
                  ),
                  footerFontSize: helpers.getValueOrDefault(
                    options.tooltips.footerFontSize,
                    Chart.defaults.global.defaultFontSize
                  ),
            ...
            getTitle: function () {
              var beforeTitle =
                  this._options.tooltips.callbacks.beforeTitle.apply(
                    this,
                    arguments
                  ),
            ...
            getFooter: function () {
              var beforeFooter =
                this._options.tooltips.callbacks.beforeFooter.apply(
                  this,
                  arguments
                );
              ...
              var afterFooter =
                this._options.tooltips.callbacks.afterFooter.apply(
                  this,
                  arguments
                );
                ...
                if (this._options.tooltips.mode === "single") {
                  ...
                  helpers.each(
                    ...
                    function (dataset, datasetIndex) {
                      ...
                      var meta =
                        this._chartInstance.getDatasetMeta(datasetIndex);
          ...
          Chart.elements.Arc = Chart.Element.extend({
            ...
            inRange: function (chartX, chartY) {
              ...
              if (vm) {
                ...
                var betweenAngles =
                    pointRelativePosition.angle >= startAngle &&
                    pointRelativePosition.angle <= endAngle,
                  withinRadius =
                    pointRelativePosition.distance >= vm.innerRadius &&
                    pointRelativePosition.distance <= vm.outerRadius;
          ...
          Chart.elements.Line = Chart.Element.extend({
            ...
            draw: function () {
              ...
              if (this._children.length > 0 && vm.fill) {
                ...
                ctx.fillStyle =
                  vm.backgroundColor || Chart.defaults.global.defaultColor;
                ctx.closePath();
                ctx.fill();
              }
              ...
              ctx.lineWidth =
                ...
                Chart.defaults.global.elements.line.borderWidth;
              ctx.strokeStyle =
                vm.borderColor || Chart.defaults.global.defaultColor;
              ctx.beginPath();
        ...
        module.exports = function (Chart) {
          ...
          Chart.elements.Point = Chart.Element.extend({
            ...
            draw: function () {
              ...
              if (
                typeof vm.pointStyle === "object" &&
                (vm.pointStyle.toString() === "[object HTMLImageElement]" ||
                  vm.pointStyle.toString() === "[object HTMLCanvasElement]")
              ) {
                ctx.drawImage(
                  vm.pointStyle,
                  vm.x - vm.pointStyle.width / 2,
                  vm.y - vm.pointStyle.height / 2
                );
                return;
              }
              ...
              if (!isNaN(vm.radius) && vm.radius > 0) {
                ...
                ctx.lineWidth = helpers.getValueOrDefault(
                  vm.borderWidth,
                  Chart.defaults.global.elements.point.borderWidth
                );
                ...
                switch (vm.pointStyle) {
                  ...
                  case "rect":
                    ctx.fillRect(
                      vm.x - (1 / Math.SQRT2) * radius,
                      vm.y - (1 / Math.SQRT2) * radius,
                      (2 / Math.SQRT2) * radius,
                      (2 / Math.SQRT2) * radius
                    );
                    ctx.strokeRect(
        ...
        module.exports = function (Chart) {
          ...
          var LinearScale = Chart.Scale.extend({
              ...
              if (this.options.stacked) {
                ...
                helpers.each(
                  ...
                  function (dataset, datasetIndex) {
                    ...
                    if (
                      ...
                      (this.isHorizontal()
                        ? meta.xAxisID === this.id
                        : meta.yAxisID === this.id)
                    ) {
                      helpers.each(
                        dataset.data,
                ...
                helpers.each(
                  ...
                  function (valuesForType) {
                    ...
                    this.min =
                      this.min === null ? minVal : Math.min(this.min, minVal);
                    this.max =
                      this.max === null ? maxVal : Math.max(this.max, maxVal);
                  },
                  this
                );
              } else {
            ...
            buildTicks: function () {
              ...
              if (this.isHorizontal()) {
                ...
                maxTicks = Math.min(
                  this.options.ticks.maxTicksLimit
                    ? this.options.ticks.maxTicksLimit
                    : 11,
                  Math.ceil(this.height / (2 * tickFontSize))
                );
              }
              ...
              if (fixedStepSizeSet) {
                spacing = helpers.getValueOrDefault(
                  this.options.ticks.fixedStepSize,
                  this.options.ticks.stepSize
                );
              } else {
            ...
            getPixelForValue: function (
              ...
              if (this.isHorizontal()) {
                var innerWidth =
                  this.width - (this.paddingLeft + this.paddingRight);
                pixel =
                  this.left + (innerWidth / range) * (rightValue - this.start);
                ...
                pixel =
                  this.bottom -
                  this.paddingBottom -
                  (innerHeight / range) * (rightValue - this.start);
            ...
            getValueForPixel: function (pixel) {
              ...
              if (this.isHorizontal()) {
                ...
                var innerHeight =
                  this.height - (this.paddingTop + this.paddingBottom);
                offset =
                  (this.bottom - this.paddingBottom - pixel) / innerHeight;
              }
          ...
          var LogarithmicScale = Chart.Scale.extend({
            determineDataLimits: function () {
              ...
              if (this.min === this.max) {
                if (this.min !== 0 && this.min !== null) {
                  this.min = Math.pow(
                    10,
                    Math.floor(helpers.log10(this.min)) - 1
                  );
                  this.max = Math.pow(
                    10,
                    Math.floor(helpers.log10(this.max)) + 1
                  );
                } else {
                  this.min = 1;
                  this.max = 10;
            ...
            buildTicks: function () {
              ...
              var tickVal =
                this.options.ticks.min !== undefined
                  ? this.options.ticks.min
                  : Math.pow(10, Math.floor(helpers.log10(this.min)));
              ...
              if (this.isHorizontal()) {
                if (newVal === 0) {
                  ...
                  pixel =
                    this.left +
                    (innerWidth / range) *
                      (helpers.log10(newVal) - helpers.log10(this.start));
            ...
            getValueForPixel: function (pixel) {
              ...
              if (this.isHorizontal()) {
                ...
                value =
                  ...
                  Math.pow(
                    10,
                    ((pixel - this.left - this.paddingLeft) * range) /
                      innerWidth
                  );
              } else {
                var innerHeight =
                ...
                value =
                  Math.pow(
                    10,
                    ((this.bottom - this.paddingBottom - pixel) * range) /
                      innerHeight
                  ) / this.start;
              }
          ...
          var LinearRadialScale = Chart.Scale.extend({
            ...
            setDimensions: function () {
              ...
              this.drawingArea = this.options.display
                ? minSize / 2 -
                  (tickFontSize / 2 + this.options.ticks.backdropPaddingY)
                : minSize / 2;
            },
            determineDataLimits: function () {
              this.min = null;
                ...
                while (unitDefinitionIndex < time.units.length) {
                  ...
                  if (
                    ...
                    var leadingUnitBuffer = this.firstTick.diff(
                      this.firstTick.clone().startOf(this.tickUnit),
                      this.tickUnit,
                      true
                    );
                    var trailingUnitBuffer = this.lastTick
                      .clone()
                      .add(1, this.tickUnit)
                      .startOf(this.tickUnit)
