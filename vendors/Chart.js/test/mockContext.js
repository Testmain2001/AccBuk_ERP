(function () {
  ...
  function acquireChart(config, style) {
    ...
    canvas.height = canvas.style.height && parseFloat(canvas.style.height);
    canvas.width = canvas.style.width && parseFloat(canvas.style.width);
    ...
    options.responsive =
      options.responsive === undefined ? false : options.responsive;
