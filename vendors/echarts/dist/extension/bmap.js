(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === "object" && typeof module === "object")
        ...
        (root["echarts"] = root["echarts"] || {}),
            (root["echarts"]["bmap"] = factory(root["echarts"]));
                    ...
                    BMapCoordSys.create = function (ecModel, api) {
                        ...
                        ecModel.eachComponent("bmap", function (bmapModel) {
                            ...
                            if (!bmapModel.__bmap) {
                                ...
                                bmapRoot.style.cssText =
                                    "width:100%;height:100%";
                                // Not support IE8
                                bmapRoot.classList.add("ec-extension-bmap");
                                root.appendChild(bmapRoot);
                                var bmap = (bmapModel.__bmap = new BMap.Map(
                                    bmapRoot
                                ));
                            ...
                            bmapCoordSys.setMapOffset(
                                bmapModel.__mapOffset || [0, 0]
                            );
                        ...
                        ecModel.eachSeries(function (seriesModel) {
                            if (
                                seriesModel.get("coordinateSystem") === "bmap"
                            ) {
                    ...
                    return __webpack_require__(1).extendComponentView({
                        ...
                        render: function (bMapModel, ecModel, api) {
                            ...
                            var moveHandler = function (type, target) {
                                ...
                                var offsetEl =
                                    viewportRoot.parentNode.parentNode
                                        .parentNode;
                                var mapOffset = [
                                    -parseFloat(offsetEl.style.left, 10) || 0,
                                    -parseFloat(offsetEl.style.top, 10) || 0,
                                ];
