!(function (e, t) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? (exports.bmap = t(require("echarts")))
        : ((e.echarts = e.echarts || {}), (e.echarts.bmap = t(e.echarts)));
})(this, function (e) {
    return (function (e) {
        function t(n) {
        ...
        function (e, t, o) {
            ...
            (n = function (e) {
                return (
                    o(1).registerCoordinateSystem("bmap", o(2)),
                    o(3),
                    o(4),
                    o(1).registerAction(
                        {
        ...
        function (e, t, o) {
            ...
            (n = function (e) {
                ...
                function n() {
                    ...
                    return (
                        ...
                        (e.prototype.initialize = function (e) {
                            return (
                                e.getPanes().labelPane.appendChild(this._root),
                                this._root
                            );
                        }),
                ...
                var r = o(1);
                (t.prototype.dimensions = ["lng", "lat"]),
                    (t.prototype.setMapOffset = function (e) {
                        this._mapOffset = e;
                    }),
                    ...
                    (t.prototype.getViewRect = function () {
                        var e = this._api;
                        return new r.graphic.BoundingRect(
                            0,
                            0,
                            e.getWidth(),
                            e.getHeight()
                ...
                var a;
                return (
                    (t.dimensions = t.prototype.dimensions),
                    (t.create = function (e, o) {
                        ...
                        e.eachComponent("bmap", function (e) {
                            ...
                            (r = new t(c, o)),
                                r.setMapOffset(e.__mapOffset || [0, 0]),
                ...
                return o(1).extendComponentView({
                    ...
                    render: function (e, t, o) {
                            ...
                            s = function (t, n) {
                                if (!r) {
                                    var a = i.parentNode.parentNode.parentNode,
                                        s = [
                                            -parseFloat(a.style.left, 10) || 0,
                                            -parseFloat(a.style.top, 10) || 0,
                                        ];
                                    (i.style.left = s[0] + "px"),
                                        (i.style.top = s[1] + "px"),
                                        p.setMapOffset(s),
                        ...
                        var m = e.__mapStyle,
                            ...
                            d = JSON.stringify(l);
                        JSON.stringify(m) !== d &&
                            (a.setMapStyle(l), (e.__mapStyle = JSON.parse(d))),
                            (r = !1);
                    },
                });
            }.call(t, o, t, e)),
