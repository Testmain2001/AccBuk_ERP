!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, i) {
            ...
            function h() {
                return D || (D = F.createCanvas().getContext("2d")), D;
            }
            function c(t, e) {
                if (t) {
            ...
            function A(t) {
                return !!P[O.call(t)] || t instanceof L;
            }
            function T(t) {
            ...
            function l(t, e) {
                for (
                    var i = "component" === t,
                        ...
                        r = i ? this._componentsMap : this._chartsMap,
                        o = this._zr,
                        a = 0;
                    a < n.length;
                    a++
            ...
            (O.showLoading = function (t, e) {
                ...
                (O.dispatchAction = function (t, e) {
                    ...
                    if (i) {
                        ...
                        t.batch &&
                            ((a = !0),
                            (o = T.map(t.batch, function (e) {
                                return (
                                    (e = T.defaults(T.extend({}, e), t)),
                                    (e.batch = null),
                                    e
                                );
                            })));
                        ...
                        t.on(
                            ...
                            function (t) {
                                ...
                                if (n && null != n.dataIndex) {
                                    var r =
                                            n.dataModel ||
                                            i.getSeriesByIndex(n.seriesIndex),
                                        o =
                                            (r &&
                                                r.getDataParams(n.dataIndex)) ||
                                            {};
                                    (o.event = t),
                                        (o.type = e),
                                        this.trigger(e, o);
        ...
        function (t, e, i) {
                ...
                if (!t.__isHover) {
                    if (t.__hoverStlDirty) {
                        var e = t.style.stroke,
                            ...
                            r = v.lift;
                        (n.fill =
                            n.fill || (i && (i instanceof _ ? i : r(i, -0.1)))),
                            (n.stroke =
                                n.stroke ||
                                (e && (e instanceof _ ? e : r(e, -0.1))));
                        var o = {};
                        for (var a in n)
                            n.hasOwnProperty(a) && (o[a] = t.style[a]);
            ...
            (b.Group = i(26)),
                ...
                (b.BezierCurve = i(146)),
                (b.Arc = i(145)),
                (b.LinearGradient = i(76)),
                (b.RadialGradient = i(141)),
                (b.BoundingRect = i(8)),
                ...
                (b.subPixelOptimizeLine = function (t) {
                    ...
                    return (
                        g(2 * i.x1) === g(2 * i.x2) &&
                            (i.x1 = i.x2 = e(i.x1, n, !0)),
                        g(2 * i.y1) === g(2 * i.y2) &&
                            (i.y1 = i.y2 = e(i.y1, n, !0)),
                        t
                    );
                }),
                ...
                (b.updateProps = f.curry(d, !0)),
                (b.initProps = f.curry(d, !1)),
                (b.getTransform = function (t, e) {
                    for (var i = y.identity([]); t && t !== e; )
                        y.mul(i, t.getLocalTransform(), i), (t = t.parent);
                    return i;
                }),
                (b.applyTransform = function (t, e, i) {
                    return (
                        i && (e = y.invert([], e)), x.applyTransform([], t, e)
                    );
                }),
        ...
        function (t, e) {
            ...
            (n.linearMap = function (t, e, i, n) {
                ...
                (n.nice = function (t, e) {
                    var i,
                        n = Math.floor(Math.log(t) / Math.LN10),
                        r = Math.pow(10, n),
                        o = t / r;
                    return (
                        (i = e
            ...
            (o.prototype = {
                ...
                brush: function (t) {
                    ...
                    var s = e.lineDash,
                        l = e.lineDashOffset,
                        h = !!t.setLineDash;
                    this.__dirtyPath || (s && !h && o)
                        ? ((i = this.path.beginPath(t)),
                          s && !h && (i.setLineDash(s), i.setLineDashOffset(l)),
                          this.buildPath(i, this.shape),
                          (this.__dirtyPath = !1))
                        : (t.beginPath(), this.path.rebuildPath(t)),
                        a && i.fill(t),
                        s && h && (t.setLineDash(s), (t.lineDashOffset = l)),
                        o && i.stroke(t),
                        null != e.text &&
                ...
                getBoundingRect: function () {
                    ...
                    if (i) {
                        var o = this.path;
                        this.__dirtyPath &&
                            (o.beginPath(), this.buildPath(o, this.shape)),
                            (t = o.getBoundingRect());
                    }
                    if (((this._rect = t), r(e))) {
                        var a = this._rectWithStroke;
                        if (this.__dirty || i) {
                            var a =
        ...
        function (t, e, i) {
            ...
            (l.createNameEach = function (t, e) {
                ...
                (l.eachAxisDim = l.createNameEach(s, [
                    "axisIndex",
                    "axis",
                    "index",
                ])),
                ...
                (l.dataFormatMixin = {
                    ...
                    getFormattedLabel: function (t, e, i) {
                        ...
                        return (
                            null == i && (i = o.get(["label", e, "formatter"])),
                            "function" == typeof i
                                ? ((a.status = e), i(a))
                                : "string" == typeof i
                                ? n.formatTpl(i, a)
            ...
            (n.prototype = {
                ...
                union: function (t) {
                    ...
                    (this.width = h(t.x + t.width, this.x + this.width) - e),
                        (this.height =
                            h(t.y + t.height, this.y + this.height) - i),
                        (this.x = e),
                        (this.y = i);
                },
        ...
        function (t, e, i) {
            function n(t) {
                var e = [];
                return (
                    o.each(c.getClassesByMainType(t), function (t) {
            ...
            l.enableClassExtend(c, function (t, e, i, n) {
                ...
                l.enableClassManagement(c, { registerWhenExtend: !0 }),
            ...
            (c.box = n),
                ...
                (c.getLayoutRect = function (t, e, i) {
                    ...
                    switch (
                        ...
                        isNaN(d) &&
                            isNaN(f) &&
                            (m > n / r ? (d = 0.8 * n) : (f = 0.8 * r)),
                        null != m &&
                            (isNaN(d) && (d = m * f), isNaN(f) && (f = d / m)),
                        isNaN(a) && (a = n - c - d - g),
                        isNaN(h) && (h = r - u - f - p),
                        t.left || t.right)
                    ) {
        ...
        function (t, e, i) {
            ...
            (n.prototype = {
                ...
                get: function (t, e) {
                    ...
                    for (
                        var i = this.option, n = this.parentModel, r = 0;
                        r < t.length &&
                        ((i = i && "object" == typeof i ? i[t[r]] : null),
                        null != i);
                        r++
                    );
            ...
            var n = i(1),
                ...
                h = a.extend({
                    ...
                    mergeDefaultAndTheme: function (t, e) {
                        ...
                        for (var i = t.data || [], r = 0; r < i.length; r++)
                            i[r] &&
                                i[r].label &&
                                o.defaultEmphasis(i[r].label, [
                                    "position",
                                    "show",
                                    "textStyle",
                                    "distance",
                    ...
                    formatTooltip: function (t, e) {
                        var i = this._data,
                            r = this.getRawValue(t),
                            o = n.isArray(r) ? n.map(r, l).join(", ") : l(r),
                            a = i.getName(t),
        ...
        function (t, e, i) {
            (function (e) {
                ...
                function r(t, e) {
                    ...
                    for (
                        var r = (n._storage = {}), o = t._storage, a = 0;
                        a < i.length;
                        a++
                    ) {
                        var s = i[a],
                            l = o[s];
                        d.indexOf(e, s) >= 0
                            ? (r[s] = new l.constructor(o[s].length))
                            : (r[s] = o[s]);
                    }
                    return n;
                }
                ...
                (y.type = "list"),
                    ...
                    (y.getDataExtent = function (t, e) {
                        ...
                        e = n && n.stackable && e;
                        var r,
                            o = (this._extent || (this._extent = {}))[t + !!e];
                        if (o) return o;
                        if (i) {
                            for (
                                var a = 1 / 0,
                    ...
                    (y.getSum = function (t, e) {
                        var i = this._storage[t],
                            n = 0;
                        if (i)
                            for (var r = 0, o = this.count(); o > r; r++) {
                    ...
                    (y.getItemModel = function (t) {
                        ...
                        return (
                            (t = this.indices[t]),
                            new c(this._rawData[t], e, e.ecModel)
                        );
                    }),
                    (y.diff = function (t) {
                        var e = this._idList,
        ...
        function (t, e, i) {
            function n(t, e) {
                ...
                for (
                    ...
                    r = Math.max(p.measureText(n[o], e).width, r);
            ...
            function s(t, e, i, r) {
                for (var o = 0; ; o++) {
                    ...
                    var s =
                        0 === o ? l(t, i, r) : Math.floor((t.length * i) / a);
        ...
        function (t, e, i) {
            ...
            function o(t, e, i, n, r) {
                var o = 1 - r;
                return (
                    o * o * (o * t + 3 * r * e) + r * r * (r * n + 3 * o * i)
                );
            }
            function a(t, e, i, n, r) {
                var o = 1 - r;
                return (
                    3 * (((e - t) * o + 2 * (i - e) * r) * o + (n - i) * r * r)
                );
            }
                        ...
                        f >= 0 && y > g
                            ...
                            : ((I[0] = o(t, i, r, s, p)),
                              ...
                              1 >= p && y > m
                                  ...
                                  : (v *= 0.5));
                return (
                    u && ((u[0] = o(t, i, r, s, d)), (u[1] = o(e, n, a, l, d))),
                    b(y)
                );
            }
            function u(t, e, i, n) {
            ...
            function m(t, e, i, n, r, o, a, s, l) {
                ...
                for (var g = 0; 32 > g && !(M > c); g++) {
                    ...
                    if (m >= 0 && d > p) (h = m), (d = p);
                        ...
                        var y = x(I, T);
                        1 >= v && d > y ? ((h = v), (d = y)) : (c *= 0.5);
                    }
                }
                return (
                    l && ((l[0] = u(t, i, r, h)), (l[1] = u(e, n, o, h))), b(d)
                );
            }
            var v = i(5),
                y = v.create,
        ...
        function (t, e, i) {
            ...
            (a.prototype = {
                ...
                off: function (t, e) {
                    ...
                    if (e) {
                        if (i[t]) {
                            for (var n = [], r = 0, o = i[t].length; o > r; r++)
                ...
                trigger: function (t) {
                    if (this._$handlers[t]) {
                        ...
                        i > 3 && (e = n.call(e, 1));
                        for (
                            var r = this._$handlers[t], o = r.length, a = 0;
                            o > a;
        ...
        function (t, e) {
            ...
            function h(t) {
                if (t) {
                    ...
                    if ("#" !== e.charAt(0)) {
                        ...
                        if (4 === e.length) {
                            var h = parseFloat(e.substr(1), 16);
            ...
            function g(t, e, n) {
                if (e && e.length && t >= 0 && 1 >= t) {
                    ...
                    return n
                        ? { color: f, leftIndex: a, rightIndex: s, value: o }
                        : f;
                }
            }
            function m(t, e) {
                if (!(2 !== t.length || t[1] < t[0])) {
                    for (
                        var i = g(t[0], e, !0),
                            n = g(t[1], e, !0),
                            r = [{ color: i.color, offset: 0 }],
                            o = n.value - i.value,
                            a = Math.max(i.value, i.rightIndex),
                            s = Math.min(n.value, n.leftIndex),
                            l = a;
                        o > 0 && s >= l;
                        l++
                    )
                        r.push({ color: e[l], offset: (l - i.value) / o });
        ...
        function (t, e, i) {
            ...
            (h.getScaleExtent = function (t, e) {
                ...
                (h.niceScaleExtent = function (t, e) {
                    ...
                    i.setExtent(n[0], n[1]),
                        i.niceExtent(e.get("splitNumber"), r, o);
                    var a = e.get("interval");
                    null != a && i.setInterval && i.setInterval(a);
                }),
                (h.createScaleByModel = function (t, e) {
                    if ((e = e || t.get("type")))
                        switch (e) {
                            case "category":
                                return new n(t.getCategories(), [
                                    1 / 0,
                                    -(1 / 0),
                                ]);
                            case "value":
                ...
                (h.getFormattedLabels = function (t, e) {
                    ...
                    return "string" == typeof e
                        ...
                        ? s.map(
                              ...
                              function (n, r) {
                                  return e(
                                      "category" === t.type ? i.getLabel(n) : n,
                                      r
                                  );
                              },
                              this
        ...
        function (t, e, i) {
            ...
            var f = n.extendShape({
                    ...
                    buildPath: function (t, e) {
                        ...
                        "none" !== e.symbolType &&
                            (n || ((i = "rect"), (n = u[i])),
                            c[i](e.x, e.y, e.width, e.height, n.shape),
            ...
            (a.prototype = {
                ...
                _doAdd: function (t) {
                    ...
                    e &&
                        e !== t.__storage &&
                        (e.addToMap(t),
                        t instanceof a && t.addChildrenToStorage(e)),
                        i && i.refresh();
                },
                remove: function (t) {
                    var e = this.__zr,
        ...
        function (t, e, i) {
            ...
            (y.prototype = {
                ...
                arc: function (t, e, i, n, r, o) {
                    return (
                        this.addData(s.A, t, e, i, i, n, r - n, 0, o ? 0 : 1),
                ...
                appendPath: function (t) {
                    ...
                    for (
                        var e = t.length, i = 0, n = this._len, r = 0;
                        e > r;
                        r++
                    )
                        i += t[r].len();
                ...
                _dashedBezierTo: function (t, e, i, r, o, a) {
                    ...
                    for (0 > f && (f = d + f), f %= d, s = 0; 1 > s; s += 0.1)
                        (l = x(v, t, i, o, s + 0.1) - x(v, t, i, o, s)),
                            (h = x(y, e, r, a, s + 0.1) - x(y, e, r, a, s)),
                            (_ += m(l * l + h * h));
                    for (; w > b && ((M += p[b]), !(M > f)); b++);
                    for (s = (M - f) / _; 1 >= s; )
                        (c = x(v, t, i, o, s)),
                ...
                getBoundingRect: function () {
                    ...
                    for (
                        var t = this.data, e = 0, i = 0, n = 0, d = 0, f = 0;
                        f < t.length;
                        ...
                        switch (
                            ...
                            case s.R:
                                ...
                                var S = t[f++],
                                    A = t[f++];
                                o.fromLine(n, d, n + S, d + A, c, u);
                                break;
                            case s.Z:
                                (e = n), (i = d);
                        }
                        r.min(l, l, c), r.max(h, h, u);
                    }
                    return (
                        0 === f && (l[0] = l[1] = h[0] = h[1] = 0),
                        new a(l[0], l[1], h[0] - l[0], h[1] - l[1])
                    );
                },
                        ...
                        switch (n) {
                            ...
                            case s.A:
                                var r = e[i++],
                                    ...
                                    p = a > l ? 1 : a / l,
                                    g = a > l ? l / a : 1,
                                    m = Math.abs(a - l) > 0.001;
                                m
                                    ? (t.translate(r, o),
                                      t.rotate(u),
                                      t.scale(p, g),
                                      t.arc(0, 0, f, h, h + c, 1 - d),
                                      t.scale(1 / p, 1 / g),
                                      t.rotate(-u),
                                      t.translate(-r, -o))
                                    : t.arc(r, o, f, h, h + c, 1 - d);
                                break;
                            case s.R:
        ...
        function (t, e) {
            ...
            (i.prototype = {
                ...
                update: function (t, e) {
                    for (
                        var i = this._coordinateSystems, n = 0;
                        n < i.length;
                        n++
                    )
        ...
        function (t, e, i) {
            ...
            function o(t, e, i) {
                ...
                var n = e.get("coordinateSystem"),
                    ...
                    d = s && s.dimensions;
                d ||
                    ((d = (a && a.dimensions) || ["x", "y"]),
                    (d = c(d, t, d.concat(["value"]))));
                var v,
                ...
                m = {
                    cartesian2d: function (t, e, i) {
                        var n = i.getComponent("xAxis", e.get("xAxisIndex")),
                            ...
                            l = r.get("type"),
                            h = [
                                { name: "x", type: s(o), stackable: a(o) },
                                { name: "y", type: s(l), stackable: a(l) },
                            ],
                            u = "category" === o;
                        return (
                            c(h, t, ["x", "y", "z"]),
                    ...
                    polar: function (t, e, i) {
                        var n = e.get("polarIndex") || 0,
                            ...
                            u = o.get("type"),
                            d = [
                                { name: "radius", type: s(h), stackable: a(h) },
                                { name: "angle", type: s(u), stackable: a(u) },
                            ],
                            f = "category" === u;
                        return (
                            c(d, t, ["radius", "angle", "value"]),
                            {
                                dimensions: d,
                                categoryIndex: f ? 1 : 0,
                                categoryAxisModel: f
                ...
                t
                    ...
                    .update(function (l, h) {
                        ...
                        return r(t, l, e)
                            ? (c
                                  ? (c.updateData(t, l),
                                    o.updateProps(c, { position: u }, n))
                                  : ((c = new s(t, l)), c.attr("position", u)),
                              i.add(c),
                              void t.setItemGraphicEl(l, c))
                            : void i.remove(c);
                    })
                    .remove(function (t) {
        ...
        function (t, e, i) {
            function n(t) {
                var e = {};
                return (
                    c(["start", "end", "startValue", "endValue"], function (i) {
                        e[i] = t[i];
                    }),
                    e
                );
                        ...
                        t &&
                            ...
                            t &&
                                this.ecModel.eachSeries(function (t) {
                                    this._isSeriesHasAllAxesTypeOf(
                                        t,
                                        "value"
                                    ) &&
                                        u(function (e) {
                        ...
                        return (
                            u(function (e) {
                                if (null == t) {
                                    ...
                                    i.length &&
                                        (t =
                                            this.dependentModels[e.axis][i[0]]);
                                }
                            }, this),
                            t
                        );
            ...
            t.exports = n.extend({
                ...
                getTargetInfo: function () {
                    ...
                    return (
                        ...
                        { cartesians: n, polars: r, axisModels: o }
                    );
                },
            });
        },
                        ...
                        return (
                            n.each(t, function (s) {
                                ...
                                (l.entryCount = c.length),
                                    ...
                                    n.each(c, function (t) {
                                        n.indexOf(l.predecessor, t) < 0 &&
                                            l.predecessor.push(t);
                                        var e = r(i, t);
                                        n.indexOf(e.successor, t) < 0 &&
                                            e.successor.push(s);
                                    });
                            }),
                        ...
                        if (t.length) {
                            ...
                            for (
                                ...
                                var d = c.pop(),
                                    ...
                                    p = !!u[d];
                                p &&
                                    (r.call(o, d, f.originalDeps.slice()),
                                    delete u[d]),
                        ...
                        n.isSeriesFiltered(t) ||
                            ...
                            r.each(function (t) {
                                ...
                                null != i && r.setItemVisual(t, "symbol", i),
                                    null != n &&
                                        r.setItemVisual(t, "symbolSize", n);
                            }));
                });
            };
        },
            ...
            (n.prototype = {
                ...
                brush: function (t) {
                    var e,
                        ...
                        n = i.image;
                    if (
                        ((e = "string" == typeof n ? this._image : n), !e && n)
                    ) {
                        var r = h.get(n);
                        if (!r)
                            return (
        ...
        function (t, e, i) {
            ...
            (c._createSymbol = function (t, e, i) {
                ...
                var r = e.hostModel,
                    ...
                    h = s.createSymbol(t, -0.5, -0.5, 1, 1, a);
                h.attr({
            ...
            (c._updateCommon = function (t, e, i) {
                ...
                for (
                    var b,
                        ...
                        A = S.pop();
                    "ordinal" === (b = t.getDimensionInfo(A).type) ||
                    "time" === b;
                ...
                w.get("show")
                    ...
                    M.getShallow("show")
                        ? (l.setText(v, M, g),
                          (v.text = a.retrieve(
                              o.getFormattedLabel(e, "emphasis"),
                              t.get(A, e)
                          )))
                        : (v.text = "");
                        ...
                        : ((r = "middle"),
                          (n =
                              o > 0 && d > o
                                  ...
                                  ? "left"
                                  : "right")),
                    { rotation: o, textAlign: n, verticalAlign: r }
                );
            }
            function o(t, e, i) {
                var n,
                ...
                return (
                    u(o - d / 2)
                        ? ((r = s ? "bottom" : "top"), (n = "center"))
                        : u(o - 1.5 * d)
                        ? ((r = s ? "top" : "bottom"), (n = "center"))
                        : ((r = "middle"),
                          (n =
                              1.5 * d > o && o > d / 2
                                  ? s
            ...
            var p = {
                ...
                g = (f.ifIgnoreOnTick = function (t, e, i) {
                    ...
                    return (
                        "ordinal" === r.type &&
                        ("function" == typeof i
                            ? ((n = r.getTicks()[e]), !i(n, r.getLabel(n)))
                            : e % (i + 1))
                    );
                }),
        ...
        function (t, e, i) {
            ...
            function s(t, e, i, n, r) {
                ...
                if (1 == r) for (var s = 0; a > s; s++) n[s] = o(t[s], e[s], i);
                    ...
                    for (var l = t[0].length, s = 0; a > s; s++)
                        for (var h = 0; l > h; h++)
            ...
            function h(t, e, i) {
                ...
                if (1 === i) {
                    ...
                    for (var o = t[0].length, r = 0; n > r; r++)
                        for (var a = 0; o > a; a++)
            ...
            function c(t, e, i, n, r, o, a, s, l) {
                ...
                if (1 == l)
                    for (var c = 0; h > c; c++)
                        s[c] = u(t[c], e[c], i[c], n[c], r, o, a);
                else
                    for (var d = t[0].length, c = 0; h > c; c++)
                        for (var f = 0; d > f; f++)
                            s[c][f] = u(
                                t[c][f],
                                e[c][f],
            ...
            (_.prototype = {
                ...
                _doneCallback: function () {
                    ...
                    for (
                        var t = this._doneList, e = t.length, i = 0;
                        e > i;
                        i++
                    )
                        t[i].call(this);
            ...
            t.exports = {
                buildPath: function (t, e) {
                    ...
                    i + n > l && ((u = i + n), (i *= l / u), (n *= l / u)),
                        ...
                        t.lineTo(a + l, s + h - r),
                        0 !== r &&
                            t.quadraticCurveTo(a + l, s + h, a + l - r, s + h),
                        t.lineTo(a + o, s + h),
            ...
            (a.prototype = {
                ...
                brush: function (t) {
                    ...
                    if ((null != r && (r += ""), r)) {
                        ...
                        for (
                            var h = o.measureText("国", t.font).width,
                                c = r.split("\n"),
                                u = 0;
                            u < c.length;
                            u++
                        )
                            a && t.fillText(c[u], i, n),
        ...
        function (t, e, i) {
            ...
            function r(t) {
                if (
                    this._dragging &&
                    (d.stop(t.event), "pinch" !== t.gestureEvent)
                ) {
            ...
            function l(t, e, i, n) {
                ...
                if (r && r.contain(i, n)) {
                    ...
                    if (o) {
                        ...
                        (h *= e),
                            a && (h = Math.max(Math.min(a.max, h), a.min));
                        var c = h / this.zoom;
                        (this.zoom = h),
                            (s[0] -= (i - s[0]) * (c - 1)),
                            (s[1] -= (n - s[1]) * (c - 1)),
        ...
        function (t, e, i) {
            var n = i(1),
                ...
                a = n.defaults({ boundaryGap: [0, 0], splitNumber: 5 }, r),
                s = n.defaults(
        ...
        function (t, e, i) {
            ...
            (o.prototype = {
                ...
                updateCanvasGradient: function (t, e) {
                    for (
                        var i = t.getBoundingRect(),
                            n = this.x * i.width + i.x,
                            r = this.x2 * i.width + i.x,
                            o = this.y * i.height + i.y,
                            a = this.y2 * i.height + i.y,
                            s = e.createLinearGradient(n, o, r, a),
                            l = this.colorStops,
                            h = 0;
                        h < l.length;
                        h++
                ...
                (h.updateTransform = function () {
                    ...
                    return i || e
                        ? ((n = n || r.create()),
                          ...
                          e &&
                              (i
                                  ? r.mul(n, t.transform, n)
                                  : r.copy(n, t.transform)),
                          (this.transform = n),
                          (this.invTransform = this.invTransform || r.create()),
                          void r.invert(this.invTransform, n))
                        : void (n && a(n));
                }),
            ...
            function s() {
                ...
                if (this.__dirty || e.__dirty) {
                    ...
                    u.normalize(h, h),
                        i &&
                            (i.attr("position", o),
                            a(i) && i.attr("rotation", l(s, o))),
                        n &&
                            (n.attr("position", s),
                            a(n) && n.attr("rotation", l(o, s))),
                        r.attr("position", s);
                    var c, d, f;
                    "end" === r.__position
                        ? ((c = [5 * h[0] + s[0], 5 * h[1] + s[1]]),
                          (d =
                              h[0] > 0.8
                                  ? "left"
                                  : h[0] < -0.8
                        ...
                        r.attr({
                            style: {
                                textVerticalAlign: r.__verticalAlign || f,
                                textAlign: r.__textAlign || d,
                            },
                            position: c,
                        });
                }
            ...
            (m.beforeUpdate = s),
                (m._createLine = function (t, e, i, o) {
                    var a = t.hostModel,
                        ...
                        l = r(s);
                    (l.shape.percent = 0),
                        f.initProps(l, { shape: { percent: 1 } }, a),
                        this.add(l);
                    var h = new f.Text({ name: "label" });
                    if ((this.add(h), e)) {
                        var c = n("fromSymbol", e, o);
                        this.add(c),
                            (this._fromSymbolType = e.getItemVisual(
                                o,
                                "symbol"
                            ));
                    }
                    if (i) {
                        var u = n("toSymbol", i, o);
                        this.add(u),
                            (this._toSymbolType = i.getItemVisual(o, "symbol"));
                    }
                    this._updateCommonStl(t, e, i, o);
                }),
                (m.updateData = function (t, e, i, r) {
                    var a = t.hostModel,
                        s = this.childOfName("line"),
                        l = t.getItemLayout(r),
                        h = { shape: {} };
                    if ((o(h.shape, l), f.updateProps(s, h, a), e)) {
                        var c = e.getItemVisual(r, "symbol");
                        if (this._fromSymbolType !== c) {
                            var u = n("fromSymbol", e, r);
                ...
                (m._updateCommonStl = function (t, e, i, n) {
                    var r = t.hostModel,
                        ...
                        u = g.round(r.getRawValue(n));
                    isNaN(u) && (u = t.getName(n)),
                        o.setStyle(
                            p.extend(
                    ...
                    d.setStyle({
                        text: s.get("show")
                            ? p.retrieve(r.getFormattedLabel(n, "normal"), u)
                            : "",
                        textFont: l.getFont(),
                        ...
                        (d.hoverStyle = {
                            text: h.get("show")
                                ? p.retrieve(
                                      r.getFormattedLabel(n, "emphasis"),
                                      u
                                  )
                                : "",
                            textFont: c.getFont(),
        ...
        function (t, e, i) {
            ...
            i(86),
                ...
                r.registerProcessor("statistic", n.curry(i(122), "line")),
                i(34);
        },
        function (t, e, i) {
            "use strict";
        ...
        function (t, e, i) {
            ...
            function h(t, e, i) {
                ...
                i.get("clipOverflow") ||
                    (a ? ((l -= c), (c *= 3)) : ((s -= h), (h *= 3)));
                var u = new m.Rect({
                    shape: { x: s, y: l, width: h, height: c },
                });
                return (
                    e &&
                        ((u.shape[a ? "width" : "height"] = 0),
                        m.initProps(u, { shape: { width: h, height: c } }, i)),
                    u
                );
            }
            function c(t, e, i) {
                ...
                return (
                    e &&
                        ...
                        m.initProps(l, { shape: { endAngle: -a[1] * s } }, i)),
                    l
                );
            }
            function u(t, e, i) {
            ...
            t.exports = y.extend({
                ...
                render: function (t, e, i) {
                    ...
                    A &&
                        A.eachItemGraphicEl(function (t, e) {
                            t.__temp &&
                                (a.remove(t), A.setItemGraphicEl(e, null));
                        }),
                        M || m.remove(),
                        a.add(x),
                        v && g.type === o.type
                            ? (b && !y
                                  ? (y = this._newPolygon(f, w, o, _))
                                  : y &&
                                    !b &&
                                    (x.remove(y), (y = this._polygon = null)),
                              x.setClipPath(u(o, !1, t)),
                              M && m.updateData(l, S),
                              l.eachItemGraphicEl(function (t) {
                                  t.stopAnimation(!0);
                              }),
                              (n(this._stackedOnPoints, w) &&
                                  n(this._points, f)) ||
                                  (_
                                      ? this._updateAnimation(l, w, o, i)
                                      : (v.setShape({ points: f }),
                                        y &&
                                            y.setShape({
                                                points: f,
                            ...
                            : (M && m.updateData(l, S),
                              ...
                              b && (y = this._newPolygon(f, w, o, _)),
                              x.setClipPath(u(o, !0, t))),
                        v.setStyle(
                ...
                _getSymbolIgnoreFunc: function (t, e) {
                    ...
                    return i && i.isLabelIgnored
                        ? d.bind(i.isLabelIgnored, i)
                        : void 0;
                },
                _updateAnimation: function (t, e, i, n) {
                    ...
                    (r.shape.points = s.current),
                        m.updateProps(r, { shape: { points: s.next } }, a),
                        o &&
                            (o.setShape({
                                points: s.current,
                    ...
                    this._lineGroup.removeAll(),
                        ...
                        i &&
                            i.eachItemGraphicEl(function (t, n) {
                                t.__temp &&
                                    (e.remove(t), i.setItemGraphicEl(n, null));
                            }),
                        (this._polyline =
                            this._polygon =
                            this._coordSys =
        ...
        function (t, e, i) {
            function n(t, e, i, n, r, o, p, g, m, v) {
                for (var y = i, x = 0; r > x; x++) {
                    var _ = e[y];
                    if (y >= n || 0 > y || isNaN(_[0]) || isNaN(_[1])) break;
                    if (y === i)
                        t[o > 0 ? "moveTo" : "lineTo"](_[0], _[1]), c(d, _);
                    else if (m > 0) {
                        var b = y - o,
                            w = y + o,
                            M = 0.5,
                        ...
                        if (
                            (o > 0 &&
                                (y === r - 1 || isNaN(A[0]) || isNaN(A[1]))) ||
                            (0 >= o && (0 === y || isNaN(A[0]) || isNaN(A[1])))
                        )
                            c(f, _);
                        else {
                            ...
                            if ("x" === v || "y" === v) {
                                ...
                                (T = Math.abs(_[I] - S[I])),
                                    (C = Math.abs(_[I] - A[I]));
                            } else (T = a.dist(_, S)), (C = a.dist(_, A));
                            (M = C / (C + T)), h(f, _, u, -m * (1 - M));
                        }
                        s(d, d, g),
                            l(d, d, p),
                            s(f, f, g),
        ...
        function (t, e, i) {
            ...
            i(91),
                ...
                r.registerVisualCoding("chart", n.curry(i(63), "pie")),
                r.registerLayout(n.curry(i(94), "pie")),
                r.registerProcessor("filter", n.curry(i(62), "pie"));
        },
        function (t, e, i) {
            "use strict";
            var n = i(14),
        ...
        function (t, e, i) {
            ...
            function a(t, e, i, n, r) {
                ...
                return {
                    fill:
                        o.getTextColor() ||
                        (a ? "#fff" : t.getItemVisual(e, "color")),
                    textFont: o.getFont(),
                    text: l.retrieve(
                        t.hostModel.getFormattedLabel(e, i),
                        t.getName(e)
                    ),
                };
            }
            ...
            (h.updateData = function (t, e, i) {
                ...
                function o() {
                    a.stopAnimation(!0),
                        a.animateTo({ shape: { r: u.r } }, 300, "elasticOut");
                }
                var a = this.childAt(0),
                    h = t.hostModel,
                    c = t.getItemModel(e),
                ...
                (d.label = null),
                    i
                        ? (a.setShape(d),
                          (a.shape.endAngle = u.startAngle),
                          s.updateProps(
                              a,
                              { shape: { endAngle: u.endAngle } },
                              h
                          ))
                        : s.updateProps(a, { shape: d }, h);
                ...
                (h._updateLabel = function (t, e) {
                    ...
                    s.updateProps(
                        ...
                        s.updateProps(n, { style: { x: h.x, y: h.y } }, r),
                        n.attr({
                            style: {
        ...
        function (t, e, i) {
            ...
            function n(t, e, i, n, r, o, a) {
                ...
                function l(e, i) {
                    for (
                        ...
                        n >= 0 &&
                        ((t[n].y -= i),
                        !(n > 0 && t[n].y > t[n - 1].y + t[n - 1].height));
                        n--
                    );
                }
                function h(t, e, i, n, r, o) {
            ...
            t.exports = function (t, e, i, n) {
                ...
                l.each(function (i) {
                    ...
                    if ("center" === m) (n = f.cx), (r = f.cy), (d = "center");
                    else {
                    ...
                    var D = g.getModel("textStyle").getFont(),
                        L = g.get("rotate") ? (0 > b ? -_ + Math.PI : -_) : 0,
                        P = t.getFormattedLabel(i, "normal") || l.getName(i),
                        O = o.getBoundingRect(P, D, d, "top");
                    (c = !!L),
                        (f.label = {
                            x: n,
                            y: r,
        ...
        function (t, e, i) {
            ...
            o.registerAction("dataZoom", function (t, e) {
                var i = r.createLinkedNodesFinder(
            ...
            var o = i(1),
                ...
                c = function (t, e) {
                    ...
                    if (
                        ...
                        if (
                            ((e = o.clone(e)),
                            e.type && h[e.type] && r.baseAxis && r.valueAxis)
                        ) {
                            var a = n.dimensions,
                        ...
                        null != t.valueIndex || null != t.valueDim
                            ? ((r.valueDataDim =
                              ...
                              (r.valueAxis = i.getAxis(
                                  n.dataDimToCoordDim(r.valueDataDim)
                              )),
                              (r.baseAxis = i.getOtherAxis(r.valueAxis)),
                              (r.baseDataDim = n.coordDimToDataDim(
                                  r.baseAxis.dim
                              )[0]))
                            : ((r.baseAxis = n.getBaseAxis()),
                              ...
                              (r.valueDataDim = n.coordDimToDataDim(
                                  r.valueAxis.dim
                              )[0])),
                        r
                    );
        ...
        function (t, e, i) {
            ...
            function o(t, e, i) {
                var o = r(
                        a.filter(e.getSeriesByType(t), function (t) {
                            return (
            ...
            function a(t, e) {
                ...
                p(e, function (t, e) {
                    ...
                    p(e, function (e, n) {
                        ...
                        if (
                            (u.assert(
                                !r || null == r.id || !i[r.id] || i[r.id] === e,
                                "id duplicates: " + (r && r.id)
                            ),
                            r && null != r.id && (i[r.id] = e),
                            x(r))
                        ) {
                            var o = s(t, r, e.exist);
                    ...
                    mergeOption: function (t) {
                        function e(e, r) {
                            ...
                            (i[e] = []),
                                ...
                                "series" === e &&
                                    (this._seriesIndices = l(n.series));
                        }
                        var i = this.option,
            ...
            (n.prototype = {
                ...
                setOption: function (t, e) {
                    ...
                    var i = this._optionBackup,
                        n = (this._newOptionBackup = r.call(this, t, e));
                    i
            ...
            t.exports = function (t) {
                if (t) {
                    ...
                    if (e) {
                        ...
                        var o = t.markPoint;
                        if (o && o.data)
                            for (var a = o.data, i = 0; i < a.length; i++)
                                n(a[i]);
                        var s = t.markLine;
                        if (s && s.data)
                    ...
                    function (t) {
                        ...
                        if ("cartesian2d" === o.type && r) {
                            ...
                            if (c > 1) {
                                ...
                                "string" == typeof r
                                    ? (u = i[r])
                                    : "function" == typeof r && (u = r),
                                    u &&
                                        ((e = e.downSample(s.dim, 1 / c, u, n)),
                                        t.setData(e));
                            }
                        }
                    },
        ...
        function (t, e, i) {
            ...
            function a(t, e, i) {
                if (t[t.rectHover ? "rectContain" : "contain"](e, i)) {
                    for (var n = t; n; ) {
                        if (
                            n.silent ||
                            (n.clipPath && !n.clipPath.contain(e, i))
                        )
                            return !1;
                        n = n.parent;
                    }
            ...
            function c(t) {
                return "mousewheel" === t && u.browser.firefox
                    ? "DOMMouseScroll"
                    : t;
            }
            var u = i(15),
                ...
                S = {
                    mousemove: function (t) {
                        ...
                        (this._hovered = n),
                            ...
                            n &&
                                n !== r &&
                                this._dispatchProxy(n, "mouseover", t);
                    },
                    mouseout: function (t) {
                        t = M(this.root, t);
            ...
            (A.prototype = {
                ...
                dispose: function () {
                    for (
                        var t = this.root, e = v.concat(y), i = 0;
                        i < e.length;
                        i++
                    ) {
                        var n = e[i];
                ...
                _dispatchProxy: function (t, e, i) {
                    for (
                        var r = "on" + e, o = n(e, t, i), a = t;
                        a &&
                        (a[r] && (o.cancelBubble = a[r].call(a, o)),
                        a.trigger(e, o),
                        (a = a.parent),
                        !o.cancelBubble);
                ...
                findHover: function (t, e, i) {
                    for (
                        var n = this.storage.getDisplayList(), r = n.length - 1;
                        r >= 0;
                        r--
                    )
                        if (
        ...
        function (t, e, i) {
            ...
            (v.prototype = {
                ...
                getLayer: function (t) {
                    ...
                    return (
                        e ||
                            ...
                            (e.isBuildin = !0),
                            this._layerConfig[t] &&
                                u.merge(e, this._layerConfig[t], !0),
                ...
                getRenderedCanvas: function (t) {
                    ...
                    for (
                        var n = this.storage.getDisplayList(!0), r = 0;
                        r < n.length;
                        r++
                    ) {
                        var o = n[r];
                        o.invisible ||
                            (o.beforeBrush && o.beforeBrush(i),
                            o.brush(i, !1),
                ...
                _pathToImage: function (t, e, n, r, o) {
                    ...
                    (e.position = [0, 0, 0]),
                        ...
                        e && e.brush(s);
                    var h = i(46),
                        c = new h({ id: t, style: { x: 0, y: 0, image: a } });
                    return (
                        null != l.position &&
                            (c.position = e.position = l.position),
                        null != l.rotation &&
                            (c.rotation = e.rotation = l.rotation),
            ...
            (a.prototype = {
                ...
                delRoot: function (t) {
                    ...
                    if (t instanceof Array)
                        ...
                        s >= 0 &&
                            (this.delFromMap(a.id),
                            this._roots.splice(s, 1),
                            a instanceof o && a.delChildrenFromStorage(this));
                    }
                },
                addToMap: function (t) {
                    return (
                        t instanceof o && (t.__storage = this),
                        t.dirty(),
        ...
        function (t, e, i) {
            ...
            t.exports = {
                containStroke: function (t, e, i, r, o, a, s, l, h, c, u) {
                    ...
                    var d = h;
                    if (
                        (u > e + d && u > r + d && u > a + d && u > l + d) ||
                        (e - d > u && r - d > u && a - d > u && l - d > u) ||
                        (c > t + d && c > i + d && c > o + d && c > s + d) ||
                        (t - d > c && i - d > c && o - d > c && s - d > c)
                    )
                        return !1;
                    var f = n.cubicProjectPoint(
                        t,
                        e,
                        i,
                        r,
        ...
        function (t, e, i) {
            ...
            function o(t, e, i, n, o, a, s, l, h, c) {
                ...
                for (var d, f, p = 0, m = -1, v = 0; u > v; v++) {
                    ...
                    h > x ||
                        (0 > m &&
                            ((m = g.cubicExtrema(e, n, a, l, b)),
                            b[1] < b[0] && m > 1 && r(),
                            (d = g.cubicAt(e, n, a, l, b[0])),
                            m > 1 && (f = g.cubicAt(e, n, a, l, b[1]))),
                        (p +=
                            2 == m
                                ? y < b[0]
                                    ? e > d
            ...
            function a(t, e, i, n, r, o, a, s) {
                ...
                if (h >= 0 && 1 >= h) {
                    for (
                        var c = 0, u = g.quadraticAt(e, n, o, h), d = 0;
                        l > d;
                        d++
                    ) {
                        var f = g.quadraticAt(t, i, r, _[d]);
                        a > f ||
                            (c += _[d] < h ? (e > u ? 1 : -1) : u > o ? 1 : -1);
                    }
                    return c;
                }
            ...
            (a.put = function (t, e) {
                ...
                (a.get = function (t) {
                    var e = this._map[t],
                        i = this._list;
                    return null != e
                        ? (e !== i.tail && (i.remove(e), i.insertEntry(e)),
                          e.value)
                        : void 0;
                }),
                (a.clear = function () {
                ...
                updateCanvasGradient: function (t, e) {
                    for (
                        var i = t.getBoundingRect(),
                            ...
                            s = this.y * r + i.y,
                            l = this.r * o,
                            h = e.createRadialGradient(a, s, 0, a, s, l),
                            c = this.colorStops,
                            u = 0;
                        u < c.length;
                        u++
                    )
                        h.addColorStop(c[u].offset, c[u].color);
        ...
        function (t, e) {
            ...
            n.prototype = {
                ...
                bind: function (t, e) {
                    for (
                        var n = this.fill, r = this.stroke, o = 0;
                        o < i.length;
                        o++
                    ) {
                        var a = i[o];
                    ...
                    null != n &&
                        (t.fillStyle = n.canvasGradient ? n.canvasGradient : n),
                        null != r &&
        ...
        function (t, e, i) {
            ...
            var r = i(5);
            t.exports = function (t, e) {
                for (var i = t.length, o = [], a = 0, s = 1; i > s; s++)
                ...
                for (var s = 0; l > s; s++) {
                    ...
                    var m = p * p,
                        v = p * m;
                    o.push([
                        n(h[0], g[0], c[0], u[0], p, m, v),
                        n(h[1], g[1], c[1], u[1], p, m, v),
                    ]);
                }
                return o;
            };
            ...
            t.exports = i(6).extend({
                ...
                pointAt: function (t) {
                    ...
                    return null === i || null === n
                        ? [a(e.x1, e.cpx1, e.x2, t), a(e.y1, e.cpy1, e.y2, t)]
                        : [
        ...
        function (t, e, i) {
            ...
            (h.prototype = {
                ...
                stopAnimation: function (t) {
                    for (
                        var e = this.animators, i = e.length, n = 0;
                        i > n;
                        n++
                    )
                        e[n].stop(t);
        ...
        function (t, e, i) {
            ...
            function r(t) {
                ...
                for (e = 0; e < c.length; e++)
                    i = i.replace(new RegExp(c[e], "g"), "|" + c[e]);
                var r,
                    o = i.split("|"),
                    a = 0,
                    l = 0,
        ...
        function (t, e, i) {
            ...
            function o(t, e) {
                ...
                return (
                    !this._containerRect ||
                    this._containerRect.contain(i[0], i[1])
                );
            }
            function a(t) {
                var e = t.event;
            ...
            function c(t, e) {
                ...
                if (o.call(this, i, n)) {
                    ...
                    var r = u.call(this)
                        ? I[this.type].getRanges.call(this)
                        : [];
                    d.call(this, r),
        ...
        function (t, e, i) {
            ...
            t.exports = n.extendShape({
                ...
                buildPath: function (t, e) {
                    (null == e.cpx1 || null == e.cpy1 ? r : o).buildPath(t, e);
                },
                pointAt: function (t) {
                    var e = this.shape;
                    return null == e.cpx1 || null == e.cpy1
                        ? r.pointAt.call(this, t)
                        : o.pointAt.call(this, t);
                },
            });
        },
        function (t, e, i) {
        ...
        function (t, e, i) {
            ...
            function r(t, e, i) {
                ...
                return (
                    ...
                    h([0, 1], function (t) {
                        ...
                        null != o || null == n
                            ? (null == o && (o = a[t]),
                              (n = r.parse(l.linearMap(o, a, e, !0))))
                            : (o = l.linearMap(n, e, a, !0)),
                            (u[t] = i(n)),
                            (s[t] = i(o));
                    }),
            ...
            function o(t, e, i) {
                return (
                    h(["min", "max"], function (n, r) {
                        var o = e.get(n, !0);
                        null != o &&
                            (o + "").toLowerCase() !== "data" + n &&
                            (t[r] = i.parse(o));
                    }),
                    e.get("scale", !0) ||
            ...
            function a(t, e) {
                ...
                if (n) {
                    ...
                    i.setRange &&
                        i.setRange(
                            h ? null : +r[0].toFixed(a),
                            h ? null : +r[1].toFixed(a)
                        );
                }
            }
            var s = i(1),
                ...
                getTargetSeriesModels: function () {
                    ...
                    return (
                        this.ecModel.eachSeries(function (e) {
                            this._axisIndex ===
                                e.get(this._dimName + "AxisIndex") && t.push(e);
                        }, this),
                        t
                    );
                },
                ...
                A = s.extend({
                                        ...
                                        function (t) {
                                            if (
                                                ...
                                                i = {
                                                    ...
                                                    otherDim: l,
                                                    otherAxisInverse:
                                                        t.coordinateSystem.getOtherAxis(
                                                            h
                                                        ).inverse,
                                                };
                                            }
                    ...
                    _updateDataInfo: function () {
                        ...
                        if (e.get("showDetail")) {
                            ...
                            e.eachTargetAxis(function (t, i) {
                                s ||
                                    ((s = e
                                        .getAxisProxy(t.name, i)
                                        .getDataValueWindow()),
                                    (l = this.ecModel.getComponent(
                                        t.axis,
                                        i
                                    ).axis));
                            }, this),
                    ...
                    _findCoordRect: function () {
                        ...
                        if (e.cartesians.length)
                            t =
                                e.cartesians[0].model.coordinateSystem.getRect();
                        else {
        ...
        function (t, e, i) {
            ...
            function r(t, e, i) {
                var n = new u(t.getZr());
                return (
                    n.enable(), n.on("pan", f(a, i)), n.on("zoom", f(s, i)), n
                );
            }
            function o(t) {
                c.each(t, function (e, i) {
                    e.count ||
                        (e.controller.off("pan").off("zoom"), delete t[i]);
                });
            }
            function a(t, e, i) {
                l(t, function (n) {
            ...
            var c = i(1),
                ...
                g = {
                    register: function (t, e) {
                        ...
                        l ||
                            ((l = i[s] =
                                { coordId: s, dataZoomInfos: {}, count: 0 }),
                            (l.controller = r(t, e, l)),
                            (l.dispatchAction = c.curry(h, t))),
                            (l.controller.rect = e.coordinateSystem
                                .getRect()
                                .clone()),
                            d.createOrUpdate(
                                l,
            ...
            var n = i(1),
                ...
                o = i(2).extendComponentModel({
                    ...
                    isSelected: function (t) {
                        ...
                        return (
                            !(t in e && !e[t]) &&
                            n.indexOf(this._availableNames, t) >= 0
                        );
                    },
                    defaultOption: {
                        zlevel: 0,
        ...
        function (t, e, i) {
            ...
            t.exports = i(2).extendComponentView({
                                ...
                                if (!f[h])
                                    if (p) {
                                        var g = p.getData(),
                                            m = g.getVisual("color");
                                        "function" == typeof m &&
                                            (m = m(p.getDataParams(0)));
                                        var v =
                                                g.getVisual("legendSymbol") ||
                                                "roundRect",
                ...
                _createItem: function (t, e, i, n, r, o, a, h) {
                    ...
                    if (
                        ((n = m || n),
                        p.add(s.createSymbol(n, 0, 0, c, d, f ? a : u)),
                        !m && r && (r !== n || "none" == r))
                    ) {
                        var v = 0.8 * d;
                        "none" === r && (r = "circle"),
                    ...
                    mergeOption: function (t, e, i, o) {
                        i ||
                            e.eachSeries(function (t) {
                                ...
                                if (a) a.mergeOption(i, e, !0);
                                else {
                                    o &&
                                        n.defaultEmphasis(i.label, [
                                            "position",
                                            "show",
                                            "textStyle",
                                            "distance",
        ...
        function (t, e, i) {
            ...
            function r(t, e, i, n, r, o, a) {
                var s,
                    l = o.coordinateSystem,
                    h = t.getItemModel(e),
                    u = h.get("x"),
                    d = h.get("y");
                if (null != u && null != d)
                    s = [
                        c.parsePercent(u, a.getWidth()),
                        c.parsePercent(d, a.getHeight()),
                    ];
                else {
                    ...
                    if (n && "cartesian2d" === l.type) {
                        var m =
                            null != r
                                ? l.getAxis(1 === r ? "x" : "y")
                                : l.getAxesByScale("ordinal")[0];
                        m &&
                            m.onBand &&
                            (s["x" === m.dim ? 0 : 1] = m.toGlobalCoord(
                                m.getExtent()[i ? 0 : 1]
                            ));
                    }
                }
            ...
            function o(t, e, i) {
                ...
                var o = new s(r, i),
                    l = new s(r, i),
                    h = new s([], i),
                    c = a.map(i.get("data"), a.curry(g, e, t, i));
            ...
            var a = i(1),
                ...
                g = function (t, e, i, n) {
                    ...
                    if (
                        !a.isArray(n) &&
                        ("min" === o || "max" === o || "average" === o)
                    ) {
                        var s = f.getAxisInfo(n, r, e, t),
                            l = s.baseAxis.dim + "Axis",
                            h = s.valueAxis.dim + "Axis",
                            c = s.baseAxis.scale.getExtent(),
                            u = a.clone(n),
                            d = {};
                        (u.type = null), (u[l] = c[0]), (d[l] = c[1]);
                        var p = f.numCalculate(r, s.valueDataDim, o);
                        ...
                        g >= 0 && (p = +p.toFixed(g)),
                            ...
                            (n = [
                                u,
                                d,
                                { type: o, valueIndex: n.valueIndex, value: p },
                            ]);
                    }
                    return (
                        (n = [
                            f.dataTransform(t, n[0]),
                            f.dataTransform(t, n[1]),
                            a.extend({}, n[2]),
                        ]),
                        (n[2].type = n[2].type || ""),
                        a.merge(n[2], n[0]),
                ...
                m = {
                    formatTooltip: function (t) {
                        var e = this._data,
                            ...
                            n = a.isArray(i) ? a.map(i, u).join(", ") : u(i),
                            r = e.getName(t);
                        return (
                            this.name + "<br />" + ((r ? d(r) + " : " : "") + n)
                        );
                    },
                    getRawDataArray: function () {
                        return this.option.data;
            ...
            a.defaults(m, h.dataFormatMixin),
                i(2).extendComponentView({
                    type: "markLine",
                    init: function () {
                        this._markLineMap = {};
                    ...
                    render: function (t, e, i) {
                        ...
                        for (var r in n)
                            n[r].__keep || this.group.remove(n[r].group);
                    },
                    ...
                    _renderSeriesML: function (t, e, i, n) {
                        function s(e, i, o, a, s) {
                            var l = e.getItemModel(i);
                            r(e, i, o, a, s, t, n),
                                e.setItemVisual(i, {
                                    symbolSize:
                                        l.get("symbolSize") || _[o ? 0 : 1],
                        ...
                        var l = t.coordinateSystem,
                            ...
                            u = this._markLineMap,
                            d = u[h];
                        d || (d = u[h] = new p()), this.group.add(d.group);
                        var f = o(l, t, e),
                            g = f.from,
                            v = f.to,
                            y = f.line;
        ...
        function (t, e, i) {
            ...
            function r(t, e, i) {
                ...
                return (
                    t && (o = a.filter(o, a.curry(f.dataFilter, t))),
                    r.initData(
                        o,
                        null,
                        t
            ...
            a.defaults(p, l.dataFormatMixin),
                i(2).extendComponentView({
                    ...
                    render: function (t, e, i) {
                        ...
                        for (var r in n)
                            n[r].__keep ||
                                (n[r].remove(), this.group.remove(n[r].group));
                    },
                    updateLayout: function (t, e, i) {
                        e.eachSeries(function (t) {
                            var e = t.markPointModel;
                        ...
                        function d(n, r, s) {
                            ...
                            o.each(h, function (s, h) {
                                ...
                                a.setHoverStyle(v),
                                    ...
                                    v.trigger(
                                        n.get("iconStatus." + h) || "normal"
                                    ),
                                    f.add(v),
                                    v.on(
                                        "click",
                                        o.bind(r.onclick, r, e, i, h)
                                    ),
                                    (g[h] = v);
                            });
                        }
                                    ...
                                    if (n && e) {
                                        var r = c.getBoundingRect(e, n.font),
                                            ...
                                            a =
                                                ...
                                                p,
                                            s = !1;
                                        a + r.height > i.getHeight() &&
                                            ((n.textPosition = "top"),
                                            (s = !0));
                                        var l = s ? -5 - r.height : p + 8;
                                        o + r.width / 2 > i.getWidth()
        ...
        function (t, e, i) {
            function n(t) {
                ...
                return (
                    t.eachRawSeries(function (t) {
                        ...
                        if (
                            !r ||
                            ("cartesian2d" !== r.type && "polar" !== r.type)
                        )
                            i.push(t);
                        else {
                            var o = r.getBaseAxis();
            ...
            function a(t) {
                ...
                return {
                    value: p
                        .filter(
                            [r(e.seriesGroupByCategoryAxis), o(e.other)],
                            function (t) {
                                return t.replace(/[\n\t\s]/g, "");
                            }
                        )
            ...
            (d.defaultOption = {
                ...
                (d.prototype.onclick = function (t, e) {
                    ...
                    g.addEventListener(w, "click", i),
                        ...
                        _.appendChild(w),
                        g.addEventListener(c, "keydown", function (t) {
                            if (9 === (t.keyCode || t.which)) {
                                var e = this.value,
                                    i = this.selectionStart,
                                    n = this.selectionEnd;
                                (this.value =
                                    e.substring(0, i) + v + e.substring(n)),
                ...
                i(2).registerAction(
                    ...
                    function (t, e) {
                        ...
                        p.each(t.newOption.series, function (t) {
                            ...
                            e.mergeOption(
                                p.defaults({ series: i }, t.newOption)
                            );
                    }
                ),
                (t.exports = d);
            ...
            function r(t, e) {
                ...
                return (
                    ...
                    e.eachComponent(
                        ...
                        function (t, n) {
                            o("xAxis", i[0].axisModel, t, e) &&
                                (i[0].dataZoomModel = t),
                                o("yAxis", i[1].axisModel, t, e) &&
                                    (i[1].dataZoomModel = t);
                        }
                    ),
                    i
            ...
            var _ = {
                zoom: function (t, e, i, n) {
                    ...
                    g[r ? "take" : "release"]("globalPan", o),
                        ...
                        r
                            ? (o.setDefaultCursorStyle("crosshair"),
                              this._createController(t, e, i, n))
                            : (o.setDefaultCursorStyle("default"),
                              this._disposeController());
                },
        ...
        function (t, e, i) {
            ...
            function r(t) {
                ...
                return (
                    ...
                    i &&
                        e.push("line-height:" + Math.round((3 * i) / 2) + "px"),
            ...
            function o(t) {
                ...
                return (
                    i && e.push(n(i)),
                    o &&
                        (e.push("background-Color:" + h.toHex(o)),
                    ...
                    d(["width", "color", "radius"], function (i) {
                        var n = "border-" + i,
                            ...
                            o = t.get(r);
                        null != o &&
                            e.push(n + ":" + o + ("color" === i ? "" : "px"));
                    }),
                    e.push(r(a)),
                    null != s &&
                        e.push(
                            "padding:" +
                                u.normalizeCssArray(s).join("px ") +
                                "px"
                        ),
                    e.join(";") + ";"
                );
            ...
            function a(t, e) {
                ...
                (i.onmouseenter = function () {
                    r.enterable &&
                        (clearTimeout(r._hideTimeout), (r._show = !0)),
                        (r._inContent = !0);
                }),
        ...
        function (t, e, i) {
            ...
            function h(t, e, i, n, r, o, a) {
                ...
                if (
                    (o && u.applyTransform(o.transform),
                    "function" == typeof t && (t = t([e, i], r, u)),
                    f.isArray(t))
                )
                    (e = m(t[0], h)), (i = m(t[1], c));
            ...
            i(2).extendComponentView({
                    ...
                    if (!v.node) {
                        ...
                        n.update(),
                            ...
                            (this._seriesGroupByAxis =
                                this._prepareAxisTriggerData(t, e));
                        ...
                        a.off("click", this._tryShow),
                            ...
                            "click" === t.get("triggerOn")
                                ? a.on("click", this._tryShow, this)
                                : (a.on("mousemove", this._mousemove, this),
                                  a.on("mouseout", this._hide, this),
                                  a.on("globalout", this._hide, this));
                    }
                },
                    ...
                    if (t.from !== this.uid) {
                        ...
                        if (null == t.x || null == t.y) {
                            if (
                                ...
                                var s,
                                    l,
                                    h = a.getItemGraphicEl(n),
                                    u = r.coordinateSystem;
                                if (u && u.dataToPoint) {
                                    var d = u.dataToPoint(
                                        a.getValues(
                                            f.map(u.dimensions, function (t) {
                                                return r.coordDimToDataDim(
                                                    t
                                                )[0];
                                            }),
                                            n,
                ...
                _tryShow: function (t) {
                    ...
                    if (i)
                        if (
                            ...
                            var a =
                                    e.dataModel ||
                                    r.getSeriesByIndex(e.seriesIndex),
                                s = e.dataIndex,
                                l = a.getData().getItemModel(s);
                            "axis" === (l.get("tooltip.trigger") || n)
                                ? this._showAxisTooltip(i, r, t)
                                : ((this._ticket = ""),
                                  this._hideAxisPointer(),
                                  this._resetLastHover(),
                                  this._showItemTooltipContent(a, s, t)),
                                o.dispatchAction({
                                    type: "showTip",
                                    from: this.uid,
                ...
                _showAxisTooltip: function (t, e, i) {
                    ...
                    f.each(
                        ...
                        function (t) {
                            ...
                            if (!a.containPoint(s))
                                return void this._hideAxisPointer(a.name);
                            h = !1;
                            var l = a.dimensions,
                                c = a.pointToData(s, !0);
                            s = a.dataToPoint(c);
                            ...
                            var p = !1,
                                g = this._lastHover;
                            if ("cross" === o)
                                n(g.data, c) && (p = !0), (g.data = c);
                            else {
                                var m = f.indexOf(l, d);
                                g.data === c[m] && (p = !0), (g.data = c[m]);
                            }
                            "cartesian2d" !== a.type || p
                                ? "polar" !== a.type || p
                                    ? "single" !== a.type ||
                                      p ||
                                      this._showSinglePointer(r, a, d, s)
                                    : this._showPolarPointer(r, a, d, s)
                                : this._showCartesianPointer(r, a, d, s),
                                "cross" !== o &&
                ...
                _showCartesianPointer: function (t, e, i, n) {
                    ...
                    var l = this,
                        ...
                        c = "cross" !== h;
                    if ("cross" === h)
                        a("x", n, e.getAxis("y").getGlobalExtent()),
                ...
                _dispatchAndShowSeriesTooltipContent: function (t, e, i, n, r) {
                        ...
                        l = f.map(e, function (t) {
                            return {
                                ...
                                dataIndex: t.getAxisTooltipDataIndex
                                    ? t.getAxisTooltipDataIndex(
                                          t.coordDimToDataDim(s.dim),
                                          n,
                                          s
                                      )
                                    : t
                    ...
                    if (
                        ...
                        r ||
                            (u.dispatchAction({ type: "highlight", batch: l }),
                            (c.payloadBatch = l)),
                        u.dispatchAction({
                            type: "showTip",
                ...
                _showItemTooltipContent: function (t, e, i) {
                    ...
                    if (
                        (l.parentModel
                            ? (l.parentModel.parentModel = a)
                            : (l.parentModel = this._tooltipModel),
                        l.get("showContent"))
                    ) {
                        var c,
                            u = l.get("formatter"),
                            ...
                            f = t.getDataParams(e);
                        if (u) {
                            if ("string" == typeof u) c = p.formatTpl(u, f);
        ...
        function (t, e, i) {
            ...
            r.prototype = {
                ...
                _paintList: function (t) {
                    ...
                    this._firstPaint &&
                        (this._vmlViewport.appendChild(e),
                        (this._firstPaint = !1));
                },
                resize: function () {
                    ...
                    B = function (t, e, i) {
                        ...
                        if (null != n)
                            if (n instanceof f) {
                                ...
                                for (
                                    var T = A.length, C = [], I = [], k = 0;
                                    T > k;
                                    k++
                                ) {
                                    var D = A[k],
                                        L = R(D.color);
                                    I.push(D.offset * l + s + " " + L[0]),
                                        (0 !== k && k !== T - 1) || C.push(L);
                                }
                                if (T >= 2) {
                                    var P = C[0][0],
                    ...
                    V = function (t, e, i, n) {
                        ...
                        (r || (!r && i.lineWidth))
                            ? ((t[r ? "filled" : "stroked"] = "true"),
                              i[e] instanceof f && P(t, o),
                              o || (o = p.createNode(e)),
                              r ? B(o, i, n) : N(o, i),
                              L(t, o))
                            : ((t[r ? "filled" : "stroked"] = "false"),
                              P(t, o));
                    },
                    F = [[], [], []],
                    G = function (t, e) {
                ...
                (c.prototype.brushVML = function (t) {
                    ...
                    if (r) {
                        ...
                        var G = this._imageEl,
                            Z = this._cropEl;
                        G ||
                            ((G = p.doc.createElement("div")),
                            (this._imageEl = G));
                        var H = G.style;
                        if (S) {
                            if (e && i)
                                (H.width = g((D * e * u) / f) + "px"),
                                    (H.height = g((P * i * d) / v) + "px");
                            else {
                                var q = new Image(),
                                    j = this;
                                (q.onload = function () {
                            ...
                            (H.width = g(D * u) + "px"),
                                ...
                                Z &&
                                    Z.parentNode &&
                                    (A.removeChild(Z), (this._cropEl = null));
                        var U = "",
                            Y = n.opacity;
                ...
                var Z,
                    ...
                    Y = function (t) {
                        ...
                        if (!e) {
                            ...
                            (e = {
                                style: n.fontStyle || H,
                                variant: n.fontVariant || H,
                                weight: n.fontWeight || H,
                            ...
                            if (o) {
                                ...
                                if (
                                    ...
                                    if (v instanceof Array)
                                        ...
                                        var x = s.adjustTextPositionOnRect(
                                            v,
                                            e,
                                            i,
                                            y
