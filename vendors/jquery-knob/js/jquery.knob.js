...
(function (factory) {
  ...
  k.o = function () {
    ...
    this._carve = function () {
      if (this.relative) {
        var w = this.relativeWidth
            ? (this.$div.parent().width() * parseFloat(this.o.width)) / 100
            : this.$div.parent().width(),
          h = this.relativeHeight
            ? (this.$div.parent().height() * parseFloat(this.o.height)) / 100
    ...
    this.h2rgba = function (h, a) {
      ...
      h = h.substring(1, 7);
      rgb = [
        parseFloat(h.substring(0, 2), 16),
        parseFloat(h.substring(2, 4), 16),
        parseFloat(h.substring(4, 6), 16),
      ];
