      ...
      if (g.isPlainObject(d)) w(d);
        ...
        if (o) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            -1 !== f.indexOf(":") &&
              (i.push({ name: f, value: j }), c.removeAttribute(f));
          }
          e = 0;
    ...
    z = function (a, b) {
      for (
        var d = y(b),
          ...
          n = b.footer && c.footer ? d + k(c.footer) : "",
          m = [],
          h = 0,
          p = c.body.length;
        h < p;
        ...
        m.push(k(c.body[h]));
      return { str: l + m.join(d) + n, rows: m.length };
    },
    t = {
      available: function () {
        return i.hasFlash();
  ...
  h.ext.buttons.excelFlash = g.extend({}, t, {
    ...
    action: function (a, b, d, c) {
      ...
      var m = function (a, b) {
          ...
          c[0].appendChild(
            n(f, "mergeCell", { attr: { ref: "A" + a + ":" + v(b) + a } })
          );
      ...
      for (var r = 0, o = j.body.length; r < o; r++) h(j.body[r], e);
      c.footer &&
        j.footer &&
        (h(j.footer, e), g("row:last c", f).attr("s", "2"));
      b.messageBottom && (h([b.messageBottom], e), m(e, j.header.length - 1));
      h = n(f, "cols");
      g("worksheet", f).prepend(h);
      m = 0;
      for (r = j.header.length; m < r; m++)
        h.appendChild(
          n(f, "col", {
            attr: { min: m + 1, max: m + 1, width: B(j, m), customWidth: 1 },
          })
        );
