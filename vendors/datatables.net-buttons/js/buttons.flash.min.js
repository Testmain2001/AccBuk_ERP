(function (g) {
  ...
  e.Client.prototype = {
    ...
    glue: function (a, b) {
      ...
      this.domElement.style.zIndex &&
        (d = parseFloat(this.domElement.style.zIndex, 10) + 1);
    ...
    getHTML: function (a, b) {
      ...
      if (navigator.userAgent.match(/MSIE/))
        var j = location.href.match(/^https/i) ? "https://" : "http://",
          d =
            d +
  ...
  e.hasFlash = function () {
    try {
      ...
      if (
        navigator.mimeTypes &&
        navigator.mimeTypes["application/x-shockwave-flash"] !== m &&
  ...
  var o = function (a, b) {
    ...
    n = function (a, b) {
      ...
      -1 !== d.indexOf("*") && (d = d.replace("*", g("title").text()));
    ...
    p = function (a, b) {
      for (
        var d = b.newline
          ...
          g = b.fieldSeparator,
          h = RegExp(e, "g"),
          s = b.escapeChar !== m ? b.escapeChar : "\\",
          f = function (a) {
            for (var b = "", c = 0, d = a.length; c < d; c++)
              0 < c && (b += g),
                (b += e ? e + ("" + a[c]).replace(h, s + e) + e : a[c]);
            return b;
          },
          t = b.header ? f(c.header) + d : "",
          i = b.footer && c.footer ? d + f(c.footer) : "",
          k = [],
          l = 0,
          n = c.body.length;
        l < n;
        ...
        k.push(f(c.body[l]));
      return { str: t + k.join(d) + i, rows: k.length };
    },
    l = {
      available: function () {
        return e.hasFlash();
