!(function () {
  ...
  (function () {
    function X(e) {
      ...
      function w(j) {
        if (
          !(j.type == "readystatechange" && x.readyState != "complete") &&
          ((j.type == "load" ? n : x)[z](i + j.type, w, !1), !m && (m = !0))
        )
          e.call(n, j.type || j);
      }
    ...
    for (
      var n = window,
        ...
        x = document,
        J = x.documentElement,
        L = x.head || x.getElementsByTagName("head")[0] || J,
        z = "",
        A = x.scripts,
        m = A.length;
      --m >= 0;
    ...
    for (z = D.length; m < z; ++m)
      (function () {
          ...
          e.onreadystatechange =
            function () {
              if (e && (!e.readyState || /loaded|complete/.test(e.readyState)))
                (e.onerror = e.onload = e.onreadystatechange = r),
                  --R,
                  R || P(Q, 0),
        ...
        e.src =
          "https://google-code-prettify.googlecode.com/svn/loader/lang-" +
          encodeURIComponent(D[m]) +
          ".js";
        L.insertBefore(e, L.firstChild);
      })(D[m]);
    for (var R = D.length, A = [], m = 0, z = N.length; m < z; ++m)
      A.push(
        "https://google-code-prettify.googlecode.com/svn/loader/skins/" +
          encodeURIComponent(N[m]) +
          ".css"
      );
    A.push(
    ...
    var $ = (function () {
      ...
      (function () {
        function j(a) {
          function d(f) {
            ...
            return (b = i[a])
              ? b
              : "0" <= a && a <= "7"
              ? parseFloat(f.substring(1), 8)
              : a === "u" || a === "x"
              ? parseFloat(f.substring(2), 16)
              : f.charCodeAt(1);
          }
          function h(f) {
          ...
          function b(f) {
            ...
            for (var a = a ? 1 : 0, g = b.length; a < g; ++a) {
              ...
              if (/\\[bdsw]/i.test(k)) c.push(k);
                ...
                o < 65 ||
                  ...
                  (o < 65 ||
                    k > 90 ||
                    f.push([Math.max(65, k) | 32, Math.min(o, 90) | 32]),
                  o < 97 ||
                    k > 122 ||
                    f.push([Math.max(97, k) & -33, Math.min(o, 122) & -33]));
              }
            }
            f.sort(function (f, a) {
            ...
            for (a = 0; a < b.length; ++a)
              (k = b[a]),
                c.push(h(k[0])),
                k[1] > k[0] &&
                  (k[1] + 1 > k[0] && c.push("-"), c.push(h(k[1])));
            c.push("]");
            return c.join("");
          }
          function e(f) {
            for (
              var a = f.source.match(
              ...
              for (g = 0; g < c; ++g)
                (o = a[g]),
                  ...
                  o.length >= 2 && f === "["
                    ? (a[g] = b(o))
                    : f !== "\\" &&
                      (a[g] = o.replace(/[A-Za-z]/g, function (a) {
                        a = a.charCodeAt(0);
          ...
          for (var j = 0, F = !1, l = !1, I = 0, c = a.length; I < c; ++I) {
            ...
            if (p.ignoreCase) l = !0;
              ...
              /[a-z]/i.test(
                p.source.replace(/\\u[\da-f]{4}|\\x[\da-f]{2}|\\[^UXux]/gi, "")
              )
            ) {
              F = !0;
              l = !1;
          ...
          for (
            var i = { b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 },
              q = [],
              I = 0,
              c = a.length;
            I < c;
        ...
        function C(a, d) {
          function h(a) {
            for (
              ...
              if (typeof y === "string") g = !1;
                ...
                if (
                  (g = y.length >= 5 && "lang-" === y.substring(0, 5)) &&
                  !(u && typeof u[1] === "string")
                )
                  (g = !1), (y = "src");
                g || (m[B] = y);
          ...
          (function () {
            for (
              var h = a.concat(d), l = [], i = {}, c = 0, p = h.length;
              c < p;
              ++c
            ) {
              var m = h[c],
        ...
        function z(a, d, h) {
          ...
          for (
            var d = Math.max(0, (d - 1) | 0) || 0, p = 0, q = c.length;
            p < q;
            ++p
          )
            (i = c[p]),
              (i.className = "L" + ((p + d) % 10)),
              i.firstChild || i.appendChild(l.createTextNode("\u00a0")),
              n.appendChild(i);
          a.appendChild(n);
        }
        function i(a, d) {
            ...
            try {
              for (; b < n; ) {
                ...
                if (E.nodeType !== 1 && (W = i.substring(h, u))) {
                  ...
                  s.appendChild(E);
                  h < o &&
                    ((l[b + 1] = E = Z.createTextNode(i.substring(u, o))),
                    z.insertBefore(E, s.nextSibling));
                }
                h = u;
                h >= o && (b += 2);
                h >= H && (t += 2);
        ...
        i(C([], [["atv", /^[\S\s]+/]]), ["uq.val"]);
        i(t({ keywords: J, hashComments: !0, cStyleComments: !0, types: Q }), [
          "c",
          "cc",
          "cpp",
          "cxx",
        ...
        i(t({ keywords: G, hashComments: !0, multiLineStrings: !0 }), [
          "bash",
          "bsh",
          "csh",
          "sh",
        ...
        i(t({ keywords: O, cStyleComments: !0, regexLiterals: !0 }), [
          "javascript",
          "js",
        ]);
        i(
        ...
        i(t({ keywords: R, cStyleComments: !0, multilineStrings: !0 }), [
          "rc",
          "rs",
          "rust",
        ]);
          ...
          prettyPrint:
            (e = e =
              function (a, d) {
                function e() {
                  for (
                    var b = V.PR_SHOULD_USE_CONTINUATION
                      ? c.now() + 250
                      : Infinity;
                    p < j.length && c.now() < b;
                    p++
                          ...
                          var s = d.currentStyle,
                            ...
                            s =
                              (s = s
                                ...
                                ? v
                                    .getComputedStyle(d, r)
                                    .getPropertyValue("white-space")
                                : 0) && "pre" === s.substring(0, 3);
                        v = m.linenums;
                        if (!(v = v === "true" || +v))
                          v = (v = l.match(/\blinenums\b(?::(\d+))?/))
                            ? v[1] && v[1].length
                              ? +v[1]
                              : !0
                            : !1;
