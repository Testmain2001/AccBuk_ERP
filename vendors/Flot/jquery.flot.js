...
(function ($) {
  ...
  $.color.make = function (r, g, b, a) {
    ...
    o.normalize = function () {
      ...
      o.r = clamp(0, parseFloat(o.r), 255);
      o.g = clamp(0, parseFloat(o.g), 255);
      o.b = clamp(0, parseFloat(o.b), 255);
      o.a = clamp(0, o.a, 1);
      return o;
    };
    o.clone = function () {
  ...
  $.color.parse = function (str) {
    ...
    if ((res = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(str)))
      return m(
        parseFloat(res[1] + res[1], 16),
        parseFloat(res[2] + res[2], 16),
        parseFloat(res[3] + res[3], 16)
      );
  ...
  function Plot(placeholder, data_, options_, plugins) {
    ...
    function triggerClickHoverEvent(eventname, event, seriesFilter) {
      ...
      if (item) {
        ...
        item.pageX = parseFloat(
          item.series.xaxis.p2c(item.datapoint[0]) +
            offset.left +
            plotOffset.left,
          10
        );
        item.pageY = parseFloat(
