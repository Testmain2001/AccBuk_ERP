...
(function () {
  ...
  timezoneJS.timezone = new (function () {
    ...
    function parseTimeString(str) {
      ...
      hms[1] = parseFloat(hms[1], 10);
      hms[2] = hms[2] ? parseFloat(hms[2], 10) : 0;
      hms[3] = hms[3] ? parseFloat(hms[3], 10) : 0;
    ...
    function processZone(z) {
      ...
      var yea = parseFloat(z[3], 10);
      var mon = 11;
      var dat = 31;
      if (z[4]) {
        mon = SHORT_MONTHS[z[4].substr(0, 3)];
        dat = parseFloat(z[5], 10) || 1;
      }
        ...
        if (l.length > 3) {
          ...
          switch (chunk) {
            ...
            case "Rule":
              ...
              arr[0] = parseFloat(arr[0], 10);
              arr[1] = parseFloat(arr[1], 10) || arr[1];
