...
(function (factory) {
  ...
  function _fnAjaxUpdateDraw(settings, json) {
    ...
    settings._iRecordsTotal = parseFloat(recordsTotal, 10);
    settings._iRecordsDisplay = parseFloat(recordsFiltered, 10);
  ...
  DataTable.versionCheck = DataTable.fnVersionCheck = function (version) {
    ...
    for (var i = 0, iLen = aThat.length; i < iLen; i++) {
      iThis = parseFloat(aThis[i], 10) || 0;
      iThat = parseFloat(aThat[i], 10) || 0;
