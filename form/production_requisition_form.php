        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body ">
                ...
                <div class="text-center mb-4">
                    <h3 class="role-title">Production Requisition</h3>
                </div>
                
                <form id="" data-parsley-validate class="row g-3" action="../production_requisition_list.php"  method="post" data-rel="myForm">
                    ...
                    <input type="hidden"  name="table" id="table" value="<?php echo "production_requisition"; ?>"/>
                    ...
                    <table class="table table-bordered" id="myTable"> 
                        ...
                        <?php
                            ...
                            if($_REQUEST['PTask']=='update' || $_REQUEST['PTask']=='view' ) { 
                                ...
                                $record5=$utilObj->getMultipleRow("production_requisition_details","parent_id='".$_REQUEST['id']."' ");
                            } else {
