  ...
  <div class="card-datatable table-responsive pt-0">
	...
	<tbody>
	   <?php
			...
			{
				$stock_group1=$utilObj->getSingleRow("stock_ledger","id='".$info['stock_gruop']."'");
				...
				<?php } ?>
					...
					<?php if($j==1){ ?>
						<div id="select_div_<?php echo $i;?>">
							<select id="particulars_<?php echo $i;?>" name="particulars_<?php echo $i;?>" <?php echo $disabled;?> class="select2 form-select required" data-allow-clear="true" >	
								<?php 
