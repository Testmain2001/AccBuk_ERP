...
{
	$id=$_REQUEST['id'];
	$rows=$utilObj->getSingleRow("cost_centre","id ='".$id."'"); 
    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body ">
        ...
        <div class="text-center mb-4">
          <h3 class="role-title">Add Cost Center</h3>
          
        </div>
        <!-- Add role form -->
		
          <form id="" data-parsley-validate class="row g-3" action="../cost_centre_list.php"  method="post" data-rel="myForm">
			...
			<input type="hidden"  name="table" id="table" value="<?php echo "cost_centre"; ?>"/>
		  ...
		  <div class="col-md-6">
			...
			<select id="under_group" name="under_group" <?php echo $disabled;?> class="select2 form-select " data-allow-clear="true" >
					...
					<?php 
					$record=$utilObj->getMultipleRow("cost_centre","1 group by name");
