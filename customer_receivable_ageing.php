			...
			<table class="datatables-basic table border-top" id="datatable-buttons" role="grid">
				...
				<?php
					...
					foreach($data as $info) {
						...
						$curpuchase = $utilObj->getSum("sale_invoice","customer='".$info['id']."' ","grandtotal");
                        ...
                        $curpayment1 = $utilObj->getSum(
                            "sale_receipt",
                            "customer='".$info['id']."' AND receiptdate BETWEEN '".$startDate1."' AND '".$endDate1."'",
                            "amt_pay"
                        );
                        ...
                        $curpayment2 = $utilObj->getSum(
                            "sale_receipt",
                            "customer='".$info['id']."' AND receiptdate BETWEEN '".$startDate2."' AND '".$endDate2."'",
                            "amt_pay"
                        );
                        ...
                        $curpayment3 = $utilObj->getSum(
                            "sale_receipt",
                            "customer='".$info['id']."' AND receiptdate BETWEEN '".$startDate3."' AND '".$endDate3."'",
                            "amt_pay"
                        );
                        ...
                        $curpayment4 = $utilObj->getSum(
                            "sale_receipt",
                            "customer='".$info['id']."' AND receiptdate <= '".$endDate4."'",
                            "amt_pay"
                        );
