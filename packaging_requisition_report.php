...
<div class="container-xxl flex-grow-1 container-p-y ">
    ...
    <div class="row">     
        <div class="col-md-4">       
            <h4 class="fw-bold mb-4" style="padding-top:2px;">Packaging Requisition Report</h4>
        </div>
    </div>
	        ...
	        <table class="datatables-basic table border-top" id="datatable-buttons" role="grid">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center;" width='20%'>Send Requisition</th>
                    </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <?php } ?>
                            <div id = "DIVBOM_<?php echo $i; ?>" style="display:none;padding-left:30px;padding-right:30px;">
                                ...
                                <br>
                                <button class="btn btn-primary mr-2 btn-sm" data-bs-target="#porequi" data-bs-toggle="modal" data-bs-dismiss="modal" id="add_new_<?php echo $i; ?>" onclick="packrequi('<?php echo $info1['id']; ?>','<?php echo $i; ?>','<?php echo $rqqty; ?>');">Add New</button>
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
...
<script>
    ...
    function Search() {
        ...
        window.location="packaging_requisition_report.php?FromDate="+fromdate+"&location="+location+"&ToDate="+todate+"&Task=filter";
