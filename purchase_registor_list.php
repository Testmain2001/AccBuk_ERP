...
<div class="container-xxl flex-grow-1 container-p-y ">
	...
	<div class="row">     
		<div class="col-md-3">       
		<h4 class="fw-bold mb-4" style="padding-top:2px;">Purchase Registor </h4>
		</div>
			...
			<table class="datatables-basic table border-top" id="datatable-buttons" role="grid">
				...
				?>
					<tr>
						...
						<td>
							<?php echo $info['pur_invoice_code']; ?>
						</td>
...
<script>
	...
	function Search() {
		...
		window.location="purchase_registor_list.php?FromDate="+fromdate+"&ToDate="+todate+"&supplier="+supplier+"&Task=filter";
	}
