...
<div class="container-xxl flex-grow-1 container-p-y ">
    ...
    <div class="row">     
        <div class="col-md-2">       
        <h4 class="fw-bold mb-4" style="padding-top:2px;">Credit Note Accounting</h4>
        </div>
        <div class="col-md-2">
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0" style="overflow-x: auto;">
                ...
                <table class="datatables-basic table border-top" id="datatable-buttons" role="grid">
                    ...
                    <?php
                    $i=0;
                    $data=$utilObj->getMultipleRow("creditnote_acc","1");
                    foreach($data as $info)
                    {
                        $i++;
                        $j=0;
                        $href= 'credit_note_list.php?id='.$info['id'].'&PTask=view';
                        ...
                        $data1=$utilObj->getMultipleRow("creditnote_acc_details","parent_id='".$info['id']."'");
                            ...
                            <tr>
                                ...
                                // echo $d1;
                                    ...
                                    <?php if((CheckEditMenu())==1) {  ?>
                                        <a class="dropdown-item" href="credit_note_list.php?id=<?php echo $info['id'];?>&PTask=update"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                    <?php } ?>
                                    <?php if((CheckDeleteMenu())==1){ ?>
                                        <a class="dropdown-item" href="credit_note_list.php?id=<?php echo $info['id'];?>&PTask=delete"><i class="bx bx-trash me-1"></i> Delete</a>
                                    <?php } ?>
                                    </div>
                                    <!--/div-->
                                <?php } ?>
    ...
    <?php
        ...
        if($_REQUEST['PTask']=='update' || $_REQUEST['PTask']=='view'){
            $id=$_REQUEST['id'];
            $rows=$utilObj->getSingleRow("creditnote_acc","id ='".$id."'");
    ...
    <div class="container flex-grow-1 container-p-y " style="display:none; "  id="u_form">
        <div class="row form-validate">
            <div class="col-12">
				<div class="card">
                    <div class="card-body" >
                        <form id="demo-form2" data-parsley-validate class="row g-3" action="credit_note_list.php"  method="post" data-rel="myForm">
                            ...
                            <input type="hidden" name="table" id="table" value="<?php echo "creditnote_acc"; ?>"/>
...
<script>
    ...
    { 
        ...
        else
        {
            ...
            $(".add_new").val("Add New");
            $('#demo-form2').show();		
            window.location="credit_note_list.php";
    ...
    function CheckDelete()
    {
        ...
        else
        {
            ...
            window.location="credit_note_list.php?PTask=delete&id="+val; 
    ...
    function savedata()
    {
        ...
        jQuery.ajax({url:'handler/credit_note_form.php', type:'POST',
    ...
    function get_sservice_code() {
        ...
        jQuery.ajax({url:'get_ajax_values.php', type:'POST',
            data: { Type:'get_sservice_code1',voucher_type:voucher_type},
            success:function(data)
            {	
                //alert(data);
    ...
    function sservice_rowtable() {	
        ...
        jQuery.ajax({url:'get_ajax_values.php', type:'POST',
            data: { Type:'sservice_rowtable1',id:id,PTask:PTask,supplier:supplier,state:state },
            success:function(data)
            {	
                // alert(data);
                $("#table_div").html(data);	
    ...
    function adjustentry() {
		...
		jQuery.ajax({url:'get_ajax_values.php', type:'POST',
			data: { Type:'adjust_credit_note',id:id,supplier:supplier, invoicenumber:invoicenumber,PTask:PTask },
			success:function(data)
			{	
