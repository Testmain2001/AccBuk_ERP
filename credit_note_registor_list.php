...
<div class="container-xxl flex-grow-1 container-p-y ">
	...
	<div class="row">     
		<div class="col-md-3">       
			<h4 class="fw-bold mb-4" style="padding-top:2px;">Credit Note Registor </h4>
		</div>
	</div>
		...
		<div class="card-datatable table-responsive pt-0" style="overflow-x: auto;">
			<table class="datatables-basic table border-top" id="datatable-buttons" role="grid">
				...
				<?php
					...
					$data=$utilObj->getMultipleRow("creditnote_acc"," $cnd");
					foreach($data as $info) {
...
<script>
	...
	function Search() {
		...
		window.location="credit_note_registor_list.php?FromDate="+fromdate+"&ToDate="+todate+"&supplier="+supplier+"&Task=filter";
	}
