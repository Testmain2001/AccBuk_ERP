...
!(function () {
  ...
  var a = {
    ...
    i = document.querySelector("#orderChart"),
    n = {
      chart: {
        height: 80,
        type: "area",
  ...
  (i = document.querySelector("#profitChart")),
    (n = {
      ...
      dataLabels: { enabled: !1 },
      stroke: { show: !0, width: 5, colors: o },
      legend: { show: !1 },
      xaxis: {
  ...
  (i = document.querySelector("#sessionsChart")),
    (n = {
      chart: {
        height: 90,
        type: "area",
  ...
  (i = document.querySelector("#expensesChart")),
    (n = {
      chart: {
        sparkline: { enabled: !0 },
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            name: { show: !1 },
            value: { fontSize: "22px", color: t, fontWeight: 500, offsetY: 0 },
          },
        },
      },
  ...
  (i = document.querySelector("#visitorsChart")),
    (n = {
      chart: {
        height: 120,
        width: 200,
  ...
  (i = document.querySelector("#activityChart")),
    (n = {
      chart: {
        height: 120,
        width: 220,
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { style: { fontSize: "13px", colors: s } },
      },
      yaxis: { labels: { show: !1 } },
    });
  if (null !== i) {
