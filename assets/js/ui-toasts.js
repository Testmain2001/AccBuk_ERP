      ...
      $("#showtoast").click(function () {
        var p = $("#toastTypeGroup input:radio:checked").val(),
          ...
          e =
            ...
            o.val().length &&
              (toastr.options.showDuration = parseFloat(o.val())),
            s.val().length &&
              (toastr.options.hideDuration = parseFloat(s.val())),
            a.val().length &&
              (toastr.options.timeOut = l ? 0 : parseFloat(a.val())),
            n.val().length &&
              (toastr.options.extendedTimeOut = l ? 0 : parseFloat(n.val())),
