...
!(function () {
  ...
  const t = document.querySelectorAll(".chart-progress");
  t &&
  ...
  if (null !== a) {
    const c = new ApexCharts(a, s);
    c.render();
  }
  (a = document.querySelector("#reportBarChart")),
    (s = {
  ...
  if (null !== a) {
    const h = new ApexCharts(a, s);
    h.render();
  }
  (a = document.querySelector("#conversionRateChart")),
    (s = {
      chart: {
        height: 80,
        width: 140,
  ...
  const d = new ApexCharts(a, s),
    n = (d.render(), document.querySelector(".credit-card-payment")),
    i = document.querySelector(".expiry-date-payment"),
    l = document.querySelectorAll(".cvv-code-payment");
  n &&
    new Cleave(n, {
      creditCard: !0,
    ...
    i && new Cleave(i, { date: !0, delimiter: "/", datePattern: ["m", "y"] }),
    l &&
      l.forEach(function (o) {
        new Cleave(o, { numeral: !0, numeralPositiveOnly: !0 });
      });
})();
