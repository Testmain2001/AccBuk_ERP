...
document.addEventListener("DOMContentLoaded", function (e) {
  {
    ...
    return (
      setTimeout(() => {
        ...
        e &&
          e.addEventListener("click", function () {
            (offCanvasEl = new bootstrap.Offcanvas(a)),
              (a.querySelector(".dt-full-name").value = ""),
              (a.querySelector(".dt-post").value = ""),
              (a.querySelector(".dt-email").value = ""),
              (a.querySelector(".dt-date").value = ""),
              (a.querySelector(".dt-salary").value = ""),
              offCanvasEl.show();
          });
      }, 200),
      (fv = FormValidation.formValidation(a, {
        fields: {
          basicFullname: {
      ...
      void flatpickr(a.querySelector('[name="basicDate"]'), {
        enableTime: !1,
        dateFormat: "m/d/Y",
        onChange: function () {
                  ...
                  return (
                    ...
                    (l
                      ...
                      : '<span class="avatar-initial rounded-circle bg-label-' +
                        ...
                        (l = (
                          ((l =
                            (n = t.full_name).match(/\b\w/g) || []).shift() ||
                            "") + (l.pop() || "")
                        ).toUpperCase()) +
                        "</span>") +
        ...
        t.DataTable({
          ...
          columnDefs: [
            ...
            },
            {
              ...
              orderable: !1,
              render: function (e, a, t, s) {
                return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></a><div class="dropdown-menu dropdown-menu-end"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div><a href="javascript:;" class="dropdown-item text-danger delete-record">Delete</a></div></div><a href="javascript:;" class="btn btn-sm btn-icon item-edit"><i class="bx bxs-edit"></i></a>';
              },
            },
          ],
