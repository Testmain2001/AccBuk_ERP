...
!(function () {
    ...
    (d = {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            show: !0,
            name: { offsetY: 60, show: !0, color: t, fontSize: "15px" },
            value: {
  ...
  if (null !== l) {
    const h = new ApexCharts(l, d);
    h.render();
  }
  (l = document.querySelector("#salesAnalyticsChart")),
    (d = {
      chart: {
        height: 350,
        type: "heatmap",
        ...
        heatmap: {
          ...
          colorScale: {
            ranges: [
              ...
              { from: 1001, to: 2e3, name: "2k", color: s },
              { from: 2001, to: 3e3, name: "3k", color: n },
      ...
      legend: { show: !1 },
      grid: { show: !1, padding: { top: -15, left: 10, bottom: -7 } },
      xaxis: {
        labels: { show: !0, style: { colors: t, fontSize: "13px" } },
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
      },
      yaxis: { labels: { style: { colors: t, fontSize: "13px" } } },
      responsive: [
        {
          breakpoint: 1441,
          options: {
  ...
  (l = document.querySelector("#totalIncomeChart")),
    (d = {
      chart: {
        height: 220,
        type: "area",
  ...
  (l = document.querySelector("#incomeChart")),
    (d = {
  ...
  (l = document.querySelector("#expensesOfWeek")),
    (d = {
      series: [65],
      chart: { width: 50, height: 50, type: "radialBar" },
      plotOptions: {
        radialBar: {
          startAngle: 0,
          endAngle: 360,
  ...
  if (null !== l) {
    const b = new ApexCharts(l, d);
    b.render();
  }
  (l = document.querySelector("#performanceChart")),
    (d = {
      series: [
  ...
  if (null !== l) {
    const x = new ApexCharts(l, d);
    x.render();
  }
  (l = document.querySelector("#totalBalanceChart")),
    (d = {
  ...
  (l = document.querySelector("#sessionOverviewChart")),
    (d = {
      series: [78],
      labels: ["Loss Rate"],
      ...
      plotOptions: {
        radialBar: {
          ...
          endAngle: 140,
          hollow: { size: "70%" },
          track: { strokeWidth: "40%", background: a },
          dataLabels: {
            name: {
              offsetY: 60,
              color: t,
  ...
  if (null !== l) {
    const k = new ApexCharts(l, d);
    k.render();
  }
  (l = document.querySelector("#scoreChart")),
    (d = {
      series: [78],
      labels: ["Out of 100"],
      chart: { height: 195, type: "radialBar" },
      plotOptions: {
        radialBar: {
          size: 150,
          offsetY: 10,
  ...
  if (null !== l) {
    const w = new ApexCharts(l, d);
    w.render();
  }
  (l = document.querySelector("#totalRevenueChart")),
    (d = {
      series: [
  ...
  (l = document.querySelector("#growthChart")),
    (d = {
      series: [78],
      labels: ["Growth"],
