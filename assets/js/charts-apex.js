...
!(function () {
  ...
  var n = document.querySelector("#lineAreaChart"),
    c = {
      ...
      grid: { borderColor: r, xaxis: { lines: { show: !0 } } },
  ...
  (n = document.querySelector("#barChart")),
    (c = {
      chart: {
        height: 400,
        type: "bar",
  ...
  (n = document.querySelector("#scatterChart")),
    (c = {
      chart: {
        height: 400,
        type: "scatter",
  ...
  (n = document.querySelector("#lineChart")),
    (c = {
      chart: {
        height: 400,
        type: "line",
  ...
  (n = document.querySelector("#horizontalBarChart")),
    (c = {
  ...
  (n = document.querySelector("#candleStickChart")),
    (c = {
      chart: {
        height: 410,
        type: "candlestick",
  ...
  (n = document.querySelector("#heatMapChart")),
    (c = {
      chart: {
        height: 350,
        type: "heatmap",
      ...
      xaxis: {
        labels: { show: !1, style: { colors: s, fontSize: "13px" } },
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
      },
      yaxis: { labels: { style: { colors: s, fontSize: "13px" } } },
  ...
  (n = document.querySelector("#radialBarChart")),
    (c = {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            ...
            value: { fontSize: "1.2rem", color: o, fontFamily: "Public Sans" },
            total: {
              show: !0,
              fontSize: "1.3rem",
              color: t.series1,
      ...
      grid: { borderColor: r, padding: { top: -25, bottom: -20 } },
      legend: {
        show: !0,
        position: "bottom",
        labels: { colors: "#aab3bf", useSeriesColors: !1 },
  ...
  (n = document.querySelector("#radarChart")),
    (c = {
      chart: {
        height: 350,
        type: "radar",
  ...
  (n = document.querySelector("#donutChart")),
    (c = {
      chart: { height: 390, type: "donut" },
      labels: ["Operational", "Networking", "Hiring", "R&D"],
      series: [85, 15, 50, 50],
      colors: [t.series1, t.series4, t.series3, t.series2],
      stroke: { show: !1, curve: "straight" },
      dataLabels: {
        enabled: !0,
      ...
      plotOptions: {
        pie: {
          donut: {
            labels: {
              show: !0,
              name: { fontSize: "2rem", color: s, fontFamily: "Public Sans" },
              value: {
                fontSize: "1.2rem",
                color: s,
