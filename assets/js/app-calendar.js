  ...
  document.addEventListener("DOMContentLoaded", function () {
    {
      ...
      u.length &&
        ...
        v.length &&
          v.wrap('<div class="position-relative"></div>').select2({
            placeholder: "Select value",
      ...
      let i = new Calendar(x, {
        ...
        eventClick: function (e) {
          (e = e),
            ...
            null !== a.end
              ? b.setDate(a.end, !0, "Y-m-d")
              : b.setDate(a.start, !0, "Y-m-d"),
            u.val(a.extendedProps.calendar).trigger("change"),
            void 0 !== a.extendedProps.location &&
              (C.value = a.extendedProps.location),
            void 0 !== a.extendedProps.guests &&
              v.val(a.extendedProps.guests).trigger("change"),
