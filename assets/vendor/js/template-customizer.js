  ...
  (function (t) {
    ...
    199: function (t, e, s) {
      ...
      var l = [
        ...
        g = c.contains("layout-menu-offcanvas")
          ? "static-offcanvas"
          : c.contains("layout-menu-fixed")
          ? "fixed"
          : c.contains("layout-menu-fixed-offcanvas")
          ? "fixed-offcanvas"
          : "static",
        v = (function () {
          function t(e) {
              ...
              if (
                ...
                -1 !== L &&
                  (this.settings.controls = this.settings.controls
                    .slice(0, L)
                    .concat(this.settings.controls.slice(L + 1)));
              }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (t =
                    ...
                    this._hasControls("style") ||
                      (this.settings.style = c.contains("dark-style")
                        ? "dark"
                        : "light"),
                    this._hasControls("layoutType") ||
    ...
    6: function (t, e, s) {
      ...
      function r(t, e) {
        for (var s = {}, i = [], o = 0; o < t.length; o++) {
          ...
          -1 !== d
            ? (n[d].references++, n[d].updater(h))
            : n.push({ identifier: u, updater: f(h, e), references: 1 }),
            i.push(u);
        }
        return i;
      }
