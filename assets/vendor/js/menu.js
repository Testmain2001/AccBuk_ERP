        ...
        a = (function () {
          function e(t) {
            ...
            if (
              ...
              t.classList[this._animate ? "remove" : "add"](
                "menu-no-animation"
              ),
              this._horizontal)
            ) {
              ...
              },
              {
                ...
                value: function (t, n, i) {
                  ...
                  if (t) {
                    ...
                    s
                      ? u + this._innerPosition + 2 * c > l &&
                        c < l &&
                        c >= d &&
                        (o.style.left = [this._rtl ? "100%" : "-100%"])
                      : u + this._innerPosition + c > l &&
                        c < l &&
                        c > d &&
                    ...
                    if ((i[r].classList.add("open"), this._accordion))
                      for (
                        ...
                        if (l[a] !== i[r] && (l[a].classList.remove("open"), n))
                          for (
                            var d = l[a].querySelectorAll(".menu-item.open"),
                              c = 0,
                              h = d.length;
                            c < h;
                            c++
