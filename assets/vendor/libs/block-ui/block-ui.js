              ...
              typeof (n = function (e) {
                ...
                function a(a, d) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      (u = e.extend({}, e.blockUI.defaults.css, d.css || {})),
                ...
                function c(t, o, n) {
                  var i = o == window,
                    s = e(o);
                  if (
                    (t || ((!i || l) && (i || s.data("blockUI.isBlocked")))) &&
                ...
                function u(t) {
                  ...
                  return (
                    ...
                    r.parents("div." + a.blockMsgClass).length > 0 ||
                      0 === r.parents().children().filter("div.blockUI").length
                  );
                }
                function f(e) {
                  if (s) {
                ...
                function p(t, o) {
                  return parseFloat(e.css(t, o), 10) || 0;
                }
              })
                ? n.apply(t, i)
                : n) || (e.exports = l);
