                            ...
                            (r = function (e, t, n, i) {
                              ...
                              if (
                                ...
                                for (
                                  ...
                                  if ("require" === (o = (p = s(t[h], f)).f))
                                    w[h] = a.require(e);
                                  else if ("exports" === o)
                                    (w[h] = a.exports(e)), (m = !0);
                                  else if ("module" === o)
                                    r = w[h] = a.module(e);
                                  else if (g(l, o) || g(c, o) || g(d, o))
                                    w[h] = _(o);
                                  else {
                                    if (!p.p)
                                      throw new Error(e + " missing " + o);
                                    p.p.load(p.n, v(i, !0), y(o), {}),
                                      (w[h] = l[o]);
                                  }
                                (u = n ? n.apply(l[e], w) : void 0),
                                  e &&
                                    (r &&
                                    void 0 !== r.exports &&
                                    r.exports !== l[e]
                    ...
                    (function (t) {
                      ...
                      var a = (e.event.special.mousewheel = {
                        ...
                        getLineHeight: function (t) {
                          ...
                          return (
                            i.length || (i = e("body")),
                            parseFloat(i.css("fontSize"), 10) ||
                              parseFloat(n.css("fontSize"), 10) ||
                              16
                          );
                        },
