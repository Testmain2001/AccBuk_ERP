!(function (e, t) {
  ...
  (function (e) {
    ...
    ***************************************************************************** */ var e =
        ...
        function x(g, h) {
                  ...
                  if (
                    ...
                    (D.daysContainer.style.width = t + "px"),
                      (D.calendarContainer.style.width =
                        t +
                        (void 0 !== D.weekWrapper
                          ? D.weekWrapper.offsetWidth
                          : 0) +
                        "px"),
          ...
          function S() {
            if (void 0 !== D.hourElement && void 0 !== D.minuteElement) {
              var e,
                t,
                n = (parseFloat(D.hourElement.value.slice(-2), 10) || 0) % 24,
                a = (parseFloat(D.minuteElement.value, 10) || 0) % 60,
                i =
                  void 0 !== D.secondElement
                    ? (parseFloat(D.secondElement.value, 10) || 0) % 60
                    : 0;
              void 0 !== D.amPM &&
                ((e = n),
                (t = D.amPM.textContent),
                (n = (e % 12) + 12 * r(t === D.l10n.amPM[1])));
              var o =
                void 0 !== D.config.minTime ||
                (D.config.minDate &&
                  D.minDateHasTime &&
                  D.latestSelectedDateObj &&
                  0 === y(D.latestSelectedDateObj, D.config.minDate, !0));
              if (
                void 0 !== D.config.maxTime ||
                (D.config.maxDate &&
                  D.maxDateHasTime &&
                  D.latestSelectedDateObj &&
                  0 === y(D.latestSelectedDateObj, D.config.maxDate, !0))
              ) {
                var l =
                  void 0 !== D.config.maxTime
                    ? D.config.maxTime
          ...
          function I(e, t, n) {
            void 0 !== D.latestSelectedDateObj &&
              D.latestSelectedDateObj.setHours(e % 24, t, n || 0, 0),
              D.hourElement &&
                D.minuteElement &&
                !D.isMobile &&
                ...
                void 0 !== D.amPM &&
                  (D.amPM.textContent = D.l10n.amPM[r(e >= 12)]),
                void 0 !== D.secondElement && (D.secondElement.value = o(n)));
          }
          function O(e) {
            var t = m(e),
              n = parseFloat(t.value) + (e.delta || 0);
            (n / 1e3 > 1 ||
          ...
          function N(e) {
            ...
            ~t.className.indexOf("arrow") &&
              Y(e, t.classList.contains("arrowUp") ? 1 : -1);
          }
          function Y(e, t, n) {
            var a = e && m(e),
          ...
          function j(e, t, n, a) {
            ...
            return (
              ...
              o.setAttribute(
                "aria-label",
                D.formatDate(t, D.config.ariaDateFormat)
              ),
              -1 === e.indexOf("hidden") &&
                0 === y(t, D.now) &&
                ((D.todayDateElem = o),
                  ...
                  he(t) &&
                    ...
                    "range" === D.config.mode &&
                      (s(
                        o,
                        "startRange",
                        D.selectedDates[0] && 0 === y(t, D.selectedDates[0], !0)
                      ),
                      s(
                        o,
                        "endRange",
                        D.selectedDates[1] && 0 === y(t, D.selectedDates[1], !0)
                      ),
              ...
              "range" === D.config.mode &&
                (function (e) {
                  return (
                    ...
                    y(e, D.selectedDates[0]) >= 0 &&
                    y(e, D.selectedDates[1]) <= 0
                  );
                })(t) &&
                !he(t) &&
          ...
          function L(e) {
            for (
              var t = e > 0 ? 0 : D.config.showMonths - 1,
                n = e > 0 ? D.config.showMonths : -1,
                a = t;
              a != n;
              a += e
            )
          ...
          function R(e, t) {
            for (
              var n =
                  (new Date(e, t, 1).getDay() - D.l10n.firstDayOfWeek + 7) % 7,
            ...
            for (
              var f = i + 1;
              f <= 42 - n && (1 === D.config.showMonths || u % 7 != 0);
              f++, u++
            )
          ...
          function J() {
            if (
              !(
                D.config.showMonths > 1 ||
                "dropdown" !== D.config.monthSelectorType
              )
            ) {
              var e = function (e) {
                return !(
              ...
              for (var t = 0; t < 12; t++)
                if (e(t)) {
                  ...
                  (n.value = new Date(D.currentYear, t).getMonth().toString()),
                    (n.textContent = p(
                      t,
                      D.config.shorthandCurrentMonth,
                      D.l10n
                    )),
                    (n.tabIndex = -1),
          ...
          function K() {
            ...
            i.setAttribute("aria-label", D.l10n.yearAriaLabel),
              D.config.minDate &&
                i.setAttribute(
                  "min",
                  D.config.minDate.getFullYear().toString()
                ),
              D.config.maxDate &&
                (i.setAttribute(
                  "max",
                  D.config.maxDate.getFullYear().toString()
                ),
                (i.disabled =
                  !!D.config.minDate &&
          ...
          function U() {
            u(D.monthNav),
              ...
              D.config.showMonths &&
                ((D.yearElements = []), (D.monthElements = []));
          ...
          function q() {
            D.weekdayContainer
              ...
              : (D.weekdayContainer = d("div", "flatpickr-weekdays"));
            for (var e = D.config.showMonths; e--; ) {
          ...
          function Q(e, t) {
            ...
            if (
              (D.config.minDate &&
                a &&
                y(a, D.config.minDate, void 0 !== t ? t : !D.minDateHasTime) <
                  0) ||
              (D.config.maxDate &&
                a &&
                y(a, D.config.maxDate, void 0 !== t ? t : !D.maxDateHasTime) >
                  0)
            )
              return !1;
            ...
            for (
              var i = !!D.config.enable,
                o =
                  null !== (n = D.config.enable) && void 0 !== n
                    ? n
                    : D.config.disable,
                r = 0,
                l = void 0;
          ...
          function ee(e) {
            e.target !== D._input ||
              !(D.selectedDates.length > 0 || D._input.value.length > 0) ||
              ...
              if (a)
                return (
                  D.setDate(
                    D._input.value,
                    !0,
                    t === D.altInput ? D.config.altFormat : D.config.dateFormat
                  ),
                  t.blur()
                );
              D.open();
          ...
          function ne(e) {
            if (
              ...
              for (var s = 0; s < D.config.showMonths; s++)
                for (
                  var d = D.daysContainer.children[s],
                    u = function (a, i) {
                      var c,
                        s,
                        u,
                        ...
                        : ([
                          ...
                          void (
                            ...
                            m >= r &&
                              ...
                              ((s = n),
                              (u = t),
                              (c = m) > Math.min(s, u) && c < Math.max(s, u)) &&
          ...
          function ie(e) {
            return function (t) {
              var n = (D.config["_" + e + "Date"] = D.parseDate(
                  t,
                  D.config.dateFormat
                )),
              ...
              void 0 !== n &&
                ...
                D.selectedDates &&
                  ...
                  D.selectedDates.length || "min" !== e || _(n),
                  be()),
                D.daysContainer &&
                  (ce(),
                  void 0 !== n
                    ? (D.currentYearElement[e] = n.getFullYear().toString())
          ...
          function re() {
            "object" != typeof D.config.locale &&
              void 0 === k.l10ns[D.config.locale] &&
              ...
              (v.K =
                ...
                ")"),
              void 0 ===
                e(e({}, h), JSON.parse(JSON.stringify(g.dataset || {})))
                  .time_24hr &&
                void 0 === k.defaultConfig.time_24hr &&
                (D.config.time_24hr = D.l10n.time_24hr),
              (D.formatDate = b(D)),
              (D.parseDate = w({ config: D.config, l10n: D.l10n }));
          }
          function le(e) {
            if ("function" != typeof D.config.position) {
              if (void 0 !== D.calendarContainer) {
                ...
                if (
                  (s(D.calendarContainer, "arrowTop", !d),
                  s(D.calendarContainer, "arrowBottom", d),
                  !D.config.inline)
                ) {
                  ...
                  "center" === r
                    ...
                    s(D.calendarContainer, "arrowLeft", !m && !g),
                    s(D.calendarContainer, "arrowCenter", m),
                    s(D.calendarContainer, "arrowRight", g);
                  var p =
                  ...
                  if (
                    (s(D.calendarContainer, "rightMost", h), !D.config.static)
                  )
                    if (((D.calendarContainer.style.top = u + "px"), h))
                      if (v) {
                        ...
                        s(D.calendarContainer, "rightMost", !1),
                          s(D.calendarContainer, "centerMost", !0),
                          b.insertRule(
                            ".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" +
                              M,
                            C
                          ),
                          (D.calendarContainer.style.left = y + "px"),
          ...
          function de(e) {
            ...
            if (void 0 !== t) {
              ...
              if (((D.selectedDateElem = n), "single" === D.config.mode))
                ...
                var o = he(a);
                o
                  ? D.selectedDates.splice(parseFloat(o), 1)
          ...
          (D.parseDate = w({ config: D.config, l10n: D.l10n })),
            ...
            (D.destroy = function () {
              ...
              if (((D._handlers = []), D.mobileInput))
                ...
                if (D.config.static && D.calendarContainer.parentNode) {
                  ...
                  D.calendarContainer.parentNode.removeChild(
                    D.calendarContainer
                  );
              D.altInput &&
                ((D.input.type = "text"),
            ...
            (D.open = function (e, t) {
              if (
                (void 0 === t && (t = D._positionElement), !0 === D.isMobile)
              ) {
                if (e) {
                  e.preventDefault();
                  var n = m(e);
                ...
                (D.isOpen = !0),
                  ...
                  !0 === D.config.enableTime &&
                    ...
                    (!1 !== D.config.allowInput ||
                      (void 0 !== e &&
                        D.timeContainer.contains(e.relatedTarget)) ||
                      setTimeout(function () {
            ...
            clickOpens: [
              function () {
                !0 === D.config.clickOpens
                  ...
                  : (D._input.removeEventListener("focus", D.open),
                    D._input.removeEventListener("click", D.open));
              },
            ],
          };
          function fe(e, t) {
          ...
          function ve() {
            D.config.noCalendar ||
              ...
              (D.yearElements.forEach(function (e, t) {
                ...
                n.setMonth(D.currentMonth + t),
                  D.config.showMonths > 1 ||
                  "static" === D.config.monthSelectorType
                    ? (D.monthElements[t].textContent =
                        p(
                          n.getMonth(),
                          D.config.shorthandCurrentMonth,
                          D.l10n
                        ) + " ")
                    : (D.monthsDropdownContainer.value = n
                        .getMonth()
                        .toString()),
          ...
          function be(e) {
            void 0 === e && (e = !0),
              ...
              void 0 !== D.altInput &&
                (D.altInput.value = De(D.config.altFormat)),
              ...
              (D.element = D.input = g),
                ...
                (function () {
                  var t = [
                    ...
                    i = e(
                      e({}, JSON.parse(JSON.stringify(g.dataset || {}))),
                      h
                    ),
                    o = {};
                  ...
                  var d = function (e) {
                    return function (t) {
                      D.config["min" === e ? "_minTime" : "_maxTime"] =
                        D.parseDate(t, "H:i:S");
                    };
                  };
                  ...
                  for (var u = 0; u < t.length; u++)
                    D.config[t[u]] =
                      !0 === D.config[t[u]] || "true" === D.config[t[u]];
                  for (
                    n
                      .filter(function (e) {
                    ...
                    for (var m in f)
                      n.indexOf(m) > -1
                        ? (D.config[m] = c(f[m]).map(x).concat(D.config[m]))
                ...
                D.isMobile ||
                  (function () {
                    ...
                    if (
                      ((D.calendarContainer = d("div", "flatpickr-calendar")),
                      (D.calendarContainer.tabIndex = -1),
                      !D.config.noCalendar)
                    ) {
                      if (
                        (e.appendChild(
                          ((D.monthNav = d("div", "flatpickr-months")),
                          (D.yearElements = []),
                          (D.monthElements = []),
                          (D.prevMonthNav = d("span", "flatpickr-prev-month")),
                          (D.prevMonthNav.innerHTML = D.config.prevArrow),
                          (D.nextMonthNav = d("span", "flatpickr-next-month")),
                          ...
                          Object.defineProperty(D, "_hidePrevMonthArrow", {
                            ...
                            set: function (e) {
                              D.__hidePrevMonthArrow !== e &&
                                (s(D.prevMonthNav, "flatpickr-disabled", e),
                                (D.__hidePrevMonthArrow = e));
                            },
                          }),
                          Object.defineProperty(D, "_hideNextMonthArrow", {
                            ...
                            set: function (e) {
                              D.__hideNextMonthArrow !== e &&
                                (s(D.nextMonthNav, "flatpickr-disabled", e),
                                (D.__hideNextMonthArrow = e));
                            },
                          }),
                      ...
                      (D.rContainer = d("div", "flatpickr-rContainer")),
                        D.rContainer.appendChild(q()),
                        D.daysContainer ||
                          ((D.daysContainer = d("div", "flatpickr-days")),
                    ...
                    D.config.enableTime &&
                      e.appendChild(
                        (function () {
                          ...
                          var e = M(D.config);
                          (D.timeContainer = d("div", "flatpickr-time")),
                          ...
                          if (
                            ...
                            (D.hourElement.tabIndex = D.minuteElement.tabIndex =
                              -1),
                            (D.hourElement.value = o(
                              D.latestSelectedDateObj
                  ...
                  if (
                    ...
                    (D._debouncedChange = l(P, 300)),
                      ...
                      void 0 !== window.ontouchstart
                        ...
                        : F(window.document, "mousedown", V),
                      F(window.document, "focus", V, { capture: !0 }),
                      !0 === D.config.clickOpens &&
                        (F(D._input, "focus", D.open),
                        F(D._input, "click", D.open)),
                      void 0 !== D.daysContainer &&
                        (F(D.monthNav, "click", we),
                        F(D.monthNav, ["keyup", "increment"], O),
                        F(D.daysContainer, "click", de)),
                      void 0 !== D.timeContainer &&
                        void 0 !== D.minuteElement &&
                        void 0 !== D.hourElement &&
                        (F(D.timeContainer, ["increment"], T),
                        F(D.timeContainer, "blur", T, { capture: !0 }),
                        F(D.timeContainer, "click", N),
                        F(
                ...
                (D.selectedDates.length || D.config.noCalendar) &&
                  (D.config.enableTime &&
                    _(D.config.noCalendar ? D.latestSelectedDateObj : void 0),
                  be(!1)),
                E();
        ...
        var k = function (e, t) {
          return "string" == typeof e
            ? E(window.document.querySelectorAll(e), t)
            : e instanceof Node
            ? E([e], t)
            : E(e, t);
        };
        return (
          ...
          (Date.prototype.fp_incr = function (e) {
            return new Date(
              this.getFullYear(),
              this.getMonth(),
              this.getDate() + ("string" == typeof e ? parseFloat(e, 10) : e)
            );
          }),
