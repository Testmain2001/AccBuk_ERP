        ...
        const t = Object.freeze({
          ...
          M = () => {
            const t = n(
                ...
                (t = parseFloat(t.getAttribute("tabindex"))) >
                (e = parseFloat(e.getAttribute("tabindex")))
                  ? 1
                  : t < e
                  ? -1
                  : 0
          ...
          K = (t, e, n) => {
            n === "".concat(parseFloat(n)) && (n = parseFloat(n)),
              n || 0 === parseFloat(n)
        ...
        (vt.text =
          ...
          (vt.textarea = (t, e) => {
            if (
              ...
              const e = parseFloat(window.getComputedStyle(y()).width);
              new MutationObserver(() => {
                const n =
                  t.offsetWidth +
                  ((o = t),
                  parseFloat(window.getComputedStyle(o).marginLeft) +
                    parseFloat(window.getComputedStyle(o).marginRight));
                var o;
          ...
          It = () => {
            if (Mt.timeout)
              return (
                (() => {
                  const t = L(),
                    e = parseFloat(window.getComputedStyle(t).width);
                  t.style.removeProperty("transition"),
                    (t.style.width = "100%");
                  const n = parseFloat(window.getComputedStyle(t).width),
                    o = parseFloat((e / n) * 100);
                  t.style.removeProperty("transition"),
        ...
        const $t = (t) => {
          ...
          Gt = () => {
            null === H.previousBodyPadding &&
              ...
              ((H.previousBodyPadding = parseFloat(
                window
            ...
            D() &&
              ...
              (() => {
                if (V(document.body, m.iosfix)) {
                  const t = parseFloat(document.body.style.top, 10);
