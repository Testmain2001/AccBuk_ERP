!(function (l, n) {
  ...
  (function (l) {
    ...
    return (
      ...
      (u.c = n),
      (u.d = function (l, n, t) {
        u.o(l, n) || Object.defineProperty(l, n, { enumerable: !0, get: t });
      }),
      (u.r = function (l) {
    ...
    33: function (l, n, u) {
      (function (l) {
        (function () {
          ...
          function B(l) {
            for (var n = l.f.length, u = 0; u < n; ++u) {
              ...
              if (-1 != d.indexOf("|")) e = !1;
                ...
                var a;
                (d = (d = d.replace(tl, "\\d")).replace(el, "\\d")),
                  t(e.m),
                  (a = e);
                var o = s(o, 2),
                ...
                c.length < a.a.b.length
                  ? (a = "")
                  : (a = (a = c.replace(new RegExp(d, "g"), o)).replace(
                      RegExp("9", "g"),
                      " "
                    )),
          ...
          function C(l, n) {
            for (
              var u = [], t = n.length - 3, e = l.f.length, r = 0;
              r < e;
              ++r
            ) {
              var i = l.f[r];
          ...
          function D(l) {
            for (var n = l.a.toString(), u = l.f.length, t = 0; t < u; ++t) {
              ...
              if (new RegExp("^(?:" + r + ")$").test(n))
                return (
                  (l.B = il.test(f(e, 4))),
                  G(l, (n = n.replace(new RegExp(r, "g"), f(e, 2))))
                );
            }
            return "";
          }
          ...
          function P(l) {
            ...
            if (3 <= n.length) {
              for (
                ...
                var r = u[e];
                (0 < l.h.length && w(s(r, 4)) && !f(r, 6) && null == r.a[5]) ||
                  ((0 != l.h.length || l.o || w(s(r, 4)) || f(r, 6)) &&
                    rl.test(s(r, 2)) &&
                    l.f.push(r));
              }
              return (
                C(l, n),
                0 < (n = D(l)).length ? n : B(l) ? I(l) : l.i.toString()
              );
            }
            return G(l, n);
          }
            ...
            l: {
              if (0 != (n = l.a.toString()).length && "0" != n.charAt(0))
                for (var r, i = n.length, d = 1; 3 >= d && d <= i; ++d)
                  if ((r = parseFloat(n.substring(0, d), 10)) in Z) {
                ...
                l ||
                  (X = l =
                    h(m, {
                      ...
                      19: { name: "number_format", v: !0, c: 11, type: g },
                      20: { name: "intl_number_format", v: !0, c: 11, type: g },
                      22: {
          ...
          (M.prototype.K = function () {
            (this.C = ""),
              ...
              (this.f = []),
              (this.B = !1),
              this.g != this.J && (this.g = j(this, this.D));
          }),
            (M.prototype.L = function (l) {
              return (this.C = (function (l, n) {
                ...
                var u,
                  e = n;
                if (
                  (ll.test(e) || (1 == l.i.b.length && W.test(e))
                    ? ("+" == (e = n)
                        ? ((u = e), l.u.a(e))
                        : ((u = Q[e]), l.u.a(u), l.a.a(u)),
                      (n = u))
                    : ((l.l = !1), (l.F = !0)),
                  !l.l)
                ) {
                ...
                switch (l.u.b.length) {
                  ...
                  default:
                    return l.A
                      ? ($(l) && (l.A = !1), l.b.toString() + l.a.toString())
                      : 0 < l.f.length
                      ? ((e = R(l, n)),
                        0 < (u = D(l)).length
                          ? u
                          : (C(l, l.a.toString()),
                            B(l) ? I(l) : l.l ? G(l, e) : l.i.toString()))
                      : P(l);
                }
              })(this, l));
            }),
