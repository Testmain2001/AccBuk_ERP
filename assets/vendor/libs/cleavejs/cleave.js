      ...
      (r = function () {
        return (function (e) {
          ...
          function i(r) {
            ...
            return (
              e[r].call(n.exports, n, n.exports, i), (n.loaded = !0), n.exports
            );
          }
            ...
            (function (t) {
              ...
              var r = function (e, t) {
                ...
                (t.initValue = this.element.value),
                  (this.properties = r.DefaultProperties.assign({}, t)),
                  this.init();
              };
              (r.prototype = {
                init: function () {
                  ...
                  0 !== e.blocksLength ||
                  e.prefix
                    ? ((e.maxLength = r.Util.getMaxLength(e.blocks)),
                ...
                initNumeralFormatter: function () {
                  var e = this.properties;
                  e.numeral &&
                    (e.numeralFormatter = new r.NumeralFormatter(
                ...
                onCut: function (e) {
                  r.Util.checkFullSelection(this.element.value) &&
                    ...
                    t.phone
                      ...
                      : (t.date && (e = t.dateFormatter.getValidatedDate(e)),
                        ...
                        0 === t.blocksLength)
                          ...
                          : (t.creditCard &&
                              this.updateCreditCardPropsByValue(e),
                ...
                (("object" == typeof t && t ? t : window).Cleave = r),
                (e.exports = r);
            }).call(
              t,
              (function () {
          ...
          function (e, t) {
            ...
            var i = function (e, t, r, n, a, s, o, l, c, u) {
              (this.numeralDecimalMark = e || "."),
                ...
                (this.numeralThousandsGroupStyle = n || i.groupStyle.thousand),
                ...
                (this.delimiterRE = u ? new RegExp("\\" + u, "g") : "");
            };
            (i.groupStyle = {
              thousand: "thousand",
              lakh: "lakh",
              ...
              (i.prototype = {
                ...
                format: function (e) {
                  ...
                  return this.tailPrefix
                    ? r +
                        a.toString() +
                        (this.numeralDecimalScale > 0 ? s.toString() : "") +
                        this.prefix
                    : n +
                        a.toString() +
                        (this.numeralDecimalScale > 0 ? s.toString() : "");
              ...
              getFixedDateString: function (e) {
                ...
                return (
                  4 === e.length &&
                    ...
                    "y" !== a[1].toLowerCase() &&
                    ((d = 2 - (u = "d" === a[0] ? 0 : 2)),
                    (t = parseFloat(e.slice(u, u + 2), 10)),
                    (i = parseFloat(e.slice(d, d + 2), 10)),
                  ...
                  0 === s.length
                    ...
                    : a.reduce(function (e, t) {
                        switch (t) {
                          case "d":
                            return (
                              e + (0 === s[0] ? "" : n.addLeadingZero(s[0]))
                            );
                          case "m":
                            return (
                              e + (0 === s[1] ? "" : n.addLeadingZero(s[1]))
                            );
                          case "y":
                            return (
                              e + (m ? n.addLeadingZeroForYear(s[2], !1) : "")
                            );
                          case "Y":
                            return (
                              e + (m ? n.addLeadingZeroForYear(s[2], !0) : "")
                            );
                        }
                      }, "")
                );
          ...
          function (e, t) {
            ...
            (i.prototype = {
                  ...
                  t.blocks.forEach(function (n, a) {
                    if (e.length > 0) {
                      ...
                      switch (t.timePattern[a]) {
                        case "h":
                          parseFloat(o, 10) > r.maxHourFirstDigit
                            ? (s = "0" + o)
                            : parseFloat(s, 10) > r.maxHours &&
                              (s = r.maxHours + "");
                          break;
                        case "m":
                        case "s":
                          parseFloat(o, 10) > r.maxMinutesFirstDigit
                            ? (s = "0" + o)
                            : parseFloat(s, 10) > r.maxMinutes &&
                              (s = r.maxMinutes + "");
                      }
                      (i += s), (e = l);
                    }
              ...
              getFixedTime: function (e, t, i) {
                return (
                  (i = Math.min(parseFloat(i || 0, 10), 60)),
                  (t = Math.min(t, 60)),
                  [(e = Math.min(e, 60)), t, i]
                );
              },
            ...
            var i = {
              ...
              getInfo: function (e, t) {
                ...
                for (var a in ((t = !!t), n))
                  if (n[a].test(e)) {
                    var s = r[a];
                    return { type: a, blocks: t ? this.getStrictBlocks(s) : s };
                  }
                return {
                  type: "unknown",
            ...
            var i = {
              ...
              getPositionOffset: function (e, t, i, r, n) {
                ...
                return (
                  ...
                  0 != (o = a.length - s.length) ? o / Math.abs(o) : 0
                );
              },
              ...
              var i = {
                assign: function (e, i) {
                  return (
                    ...
                    (e.creditCardStrictMode = !!i.creditCardStrictMode),
                    (e.creditCardType = ""),
                    (e.onCreditCardTypeChanged =
                      i.onCreditCardTypeChanged || function () {}),
                    (e.phone = !!i.phone),
                    (e.phoneRegionCode = i.phoneRegionCode || "AU"),
                    (e.phoneFormatter = {}),
                    (e.time = !!i.time),
                    (e.timePattern = i.timePattern || ["h", "m", "s"]),
                    (e.timeFormat = i.timeFormat || "24"),
                    (e.timeFormatter = {}),
                    (e.date = !!i.date),
                    (e.datePattern = i.datePattern || ["d", "m", "Y"]),
                    (e.dateMin = i.dateMin || ""),
                    (e.dateMax = i.dateMax || ""),
                    (e.dateFormatter = {}),
                    (e.numeral = !!i.numeral),
                    (e.numeralIntegerScale =
                      i.numeralIntegerScale > 0 ? i.numeralIntegerScale : 0),
                    (e.numeralDecimalScale =
                      i.numeralDecimalScale >= 0 ? i.numeralDecimalScale : 2),
                    (e.numeralDecimalMark = i.numeralDecimalMark || "."),
                    (e.numeralThousandsGroupStyle =
                      i.numeralThousandsGroupStyle || "thousand"),
                    (e.numeralPositiveOnly = !!i.numeralPositiveOnly),
                    (e.stripLeadingZeroes = !1 !== i.stripLeadingZeroes),
                    (e.signBeforePrefix = !!i.signBeforePrefix),
                    (e.tailPrefix = !!i.tailPrefix),
                    (e.swapHiddenInput = !!i.swapHiddenInput),
                    (e.numericOnly = e.creditCard || e.date || !!i.numericOnly),
                    (e.uppercase = !!i.uppercase),
                    (e.lowercase = !!i.lowercase),
                    (e.prefix = e.creditCard || e.date ? "" : i.prefix || ""),
                    ...
                    (e.initValue =
                      void 0 !== i.initValue && null !== i.initValue
                    ...
                    (e.backspace = !1),
                    (e.result = ""),
                    (e.onValueChanged = i.onValueChanged || function () {}),
                    e
                  );
                },
              };
