          ...
          void 0 ===
              ...
              typeof (i = function (e, t) {
                ...
                (e.jstree = {
                  ...
                  (e.jstree.create = function (t, i) {
                    var s = new e.jstree.core(++r),
                      a = i;
                    return (
                      (i = e.extend(!0, {}, e.jstree.defaults, i)),
                      a && a.plugins && (i.plugins = a.plugins),
                      e.each(i.plugins, function (e, t) {
                        "core" !== e && (s = s.plugin(t, i[t]));
                      }),
                      e(t).data("jstree", s),
                      s.init(t, i),
                      s
                    ...
                    return (
                      ...
                      (i = i.data("jstree"))
                        ...
                        : e(".jstree").each(function () {
                            ...
                            if (i && i._model.data[t]) return (r = i), !1;
                          }),
                      r
                    );
                  }),
                    ...
                    return (
                      ...
                      (this.each(function () {
                        var n = e.jstree.reference(this),
                          o = i && n ? n[r] : null;
                        if (
                          ((a = i && o ? o.apply(n, s) : null),
                          n ||
                            i ||
                            (r !== t && !e.isPlainObject(r)) ||
                            e.jstree.create(this, r),
                          ((n && !i) || !0 === r) && (a = n || !1),
                          null !== a && a !== t)
                        )
                          return !1;
                  ...
                  (e.expr.pseudos.jstree = e.expr.createPseudo(function (r) {
                    return function (r) {
                      return (
                        e(r).hasClass("jstree") && e(r).data("jstree") !== t
                      );
                    };
                  })),
                    ...
                    keyboard: {
                      ...
                      left: function (t) {
                        if ((t.preventDefault(), this.is_open(t.currentTarget)))
                          ...
                          var r = this.get_parent(t.currentTarget);
                          r &&
                            r.id !== e.jstree.root &&
                            this.get_node(r, !0)
                      ...
                      right: function (t) {
                        if (
                          (t.preventDefault(), this.is_closed(t.currentTarget))
                        )
                          ...
                          var r = this.get_node(t.currentTarget, !0).children(
                            ".jstree-children"
                          )[0];
                          r &&
                            e(this._firstChild(r))
                              .children(".jstree-anchor")
                              .focus();
                        }
                      },
                  ...
                  (e.jstree.core.prototype = {
                      ...
                      this.element
                        ...
                        .on(
                          ...
                          e.proxy(function (i) {
                            if (
                              i.target.tagName &&
                              "input" === i.target.tagName.toLowerCase()
                            )
                              return !0;
                            r && clearTimeout(r),
                            ...
                            var s = String.fromCharCode(i.which).toLowerCase(),
                              a = this.element
                                .find(".jstree-anchor")
                                .filter(":visible"),
                            ...
                            if ((t += s).length > 1) {
                              if (
                                (a.slice(n).each(
                                  e.proxy(function (r, i) {
                                    if (
                                      0 === e(i).text().toLowerCase().indexOf(t)
                                    )
                                      return e(i).focus(), (o = !0), !1;
                                  }, this)
                                ),
                                o)
                              )
                            ...
                            if (
                              ...
                              if (
                                (a.slice(n + 1).each(
                                  e.proxy(function (t, r) {
                                    if (
                                      e(r).text().toLowerCase().charAt(0) === s
                                    )
                                      return e(r).focus(), (o = !0), !1;
                                  }, this)
                                ),
                                o)
                              )
                        ...
                        .on(
                          ...
                          ".jstree-anchor",
                          e.proxy(function (t) {
                            var r = this.get_node(t.currentTarget);
                            r && r.id && (this._data.core.focused = r.id),
                              this.element
                                .find(".jstree-hovered")
                                .not(t.currentTarget)
                                .trigger("mouseleave"),
                    ...
                    get_path: function (t, r, i) {
                      ...
                      var s,
                        ...
                        n = [];
                      for (
                        n.push(i ? t.id : t.text), s = 0, a = t.parents.length;
                        s < a;
                        s++
                      )
                        n.push(i ? t.parents[s] : this.get_text(t.parents[s]));
                      return (n = n.reverse().slice(1)), r ? n.join(r) : n;
                    },
                    ...
                    is_loading: function (e) {
                      return (
                        (e = this.get_node(e)) && e.state && e.state.loading
                      );
                    },
                    is_open: function (e) {
                    ...
                    load_node: function (t, r) {
                      var i, s, a, n, o;
                      if (e.isArray(t))
                        return this._load_nodes(t.slice(), r), !0;
                      if (!(t = this.get_node(t)))
                        return r && r.call(this, t, !1), !1;
                      if (t.state.loaded) {
                        for (
                          ...
                          this._model.data[t.parents[a]].children_d =
                            e.vakata.array_filter(
                              this._model.data[t.parents[a]].children_d,
                              function (r) {
                                return -1 === e.inArray(r, t.children_d);
                              }
                            );
                        for (i = 0, s = t.children_d.length; i < s; i++)
                        ...
                        this._load_node(
                          ...
                          e.proxy(function (e) {
                            ...
                            var i,
                              ...
                              n = this._model.data,
                              o = !1;
                            for (a = 0, i = t.children.length; a < i; a++)
                              if (
                                n[t.children[a]] &&
                          ...
                          ? s.url
                            ? ((s = e.extend(!0, {}, s)),
                              ...
                              e
                                .ajax(s)
                                .done(
                                  e.proxy(function (i, s, n) {
                                    var o = n.getResponseHeader("Content-Type");
                                    return (o && -1 !== o.indexOf("json")) ||
                                      "object" == typeof i
                    ...
                    _append_html_data: function (t, r, i) {
                      ((t = this.get_node(t)).children = []),
                        (t.children_d = []);
                      var s,
                        a,
                        n,
                        o = r.is("ul") ? r.children() : r,
                        d = t.id,
                        c = [],
                        l = [],
                        h = this._model.data,
                      ...
                      for (
                        ...
                        h[_.parents[a]].children_d =
                          h[_.parents[a]].children_d.concat(l);
                    ...
                    _append_json_data: function (t, r, i, s) {
                          ...
                          d = function (e, t) {
                            ...
                            if (
                              ...
                              for (i = 0, s = n.length; i < s; i++)
                                n[i].children || (n[i].children = []),
                                  n[i].state || (n[i].state = {}),
                                  (f[n[i].id.toString()] = n[i]);
                              for (i = 0, s = n.length; i < s; i++)
                                f[n[i].parent.toString()]
                                  ? (f[n[i].parent.toString()].children.push(
                                      n[i].id.toString()
                                    ),
                                    p.children_d.push(n[i].id.toString()))
                                  : void 0 !== o &&
                              ...
                              for (i = 0, s = p.children.length; i < s; i++)
                                (r = v(
                                  f[p.children[i]],
                                  d,
                                  p.parents.concat()
                                  ...
                                  l.push(r),
                                  f[r].children_d.length &&
                                    (l = l.concat(f[r].children_d));
                              for (i = 0, s = p.parents.length; i < s; i++)
                                f[p.parents[i]].children_d =
                                  f[p.parents[i]].children_d.concat(l);
                              a = {
                                cnt: g,
                                mod: f,
                                sel: m,
                            ...
                            if (null !== this.element) {
                              ...
                              if (((this._model.data = t.mod), r)) {
                                ...
                                if (
                                  ((a = this._model.data),
                                  l.length !== h.length ||
                                    e.vakata.array_unique(l.concat(h))
                                      .length !== l.length)
                                ) {
                                  for (s = 0, n = l.length; s < n; s++)
                                    -1 === e.inArray(l[s], d) &&
                                      -1 === e.inArray(l[s], h) &&
                                      (a[l[s]].state.selected = !1);
                                  for (s = 0, n = h.length; s < n; s++)
                                    -1 === e.inArray(h[s], l) &&
                                      (a[h[s]].state.selected = !0);
                                }
                              }
                              t.add.length &&
                                (this._data.core.selected =
                                  this._data.core.selected.concat(t.add)),
                                this.trigger("model", {
                                  nodes: t.dpc,
                                  parent: t.par,
                                }),
                    ...
                    _parse_model_from_html: function (r, i, s) {
                      (s = s ? [].concat(s) : []), i && s.unshift(i);
                      var a,
                        n,
                        o,
                        d,
                      ...
                      if (
                        ((d = e.vakata.attributes(r, !0)),
                        e.each(d, function (t, r) {
                          if (!(r = e.vakata.trim(r)).length) return !0;
                          (h.li_attr[t] = r),
                            "id" === t && (h.id = r.toString());
                        }),
                        (d = r.children("a").first()).length &&
                          ((d = e.vakata.attributes(d, !0)),
                          e.each(d, function (t, r) {
                            (r = e.vakata.trim(r)).length && (h.a_attr[t] = r);
                          })),
                        (d = r.children("a").first().length
                          ? r.children("a").first().clone()
                          : r.clone())
                          .children("ins, i, ul")
                          .remove(),
                        (d = d.html()),
                        ...
                        (h.state.opened = r.hasClass("jstree-open")),
                        (h.state.selected = r
                          .children("a")
                      ...
                      (d = r.children("a").children(".jstree-themeicon"))
                        .length &&
                        (h.icon =
                    ...
                    _parse_model_from_flat_json: function (e, r, i) {
                      ...
                      for (
                        ...
                        (o =
                          ...
                          h.children_d.push(n),
                          o.children_d.length &&
                            (h.children_d = h.children_d.concat(o.children_d));
                      return (
                        delete e.data,
                        delete e.children,
                        (c[h.id].original = e),
                    ...
                    draw_children: function (t) {
                      ...
                      if (
                        ...
                        (t = t[0]),
                        r.children.length && r.state.loaded)
                      ) {
                        for (
                          ...
                          a.appendChild(
                            this.redraw_node(r.children[i], !0, !0)
                          );
                        t.appendChild(a);
                      }
                    },
                    redraw_node: function (t, r, i, s) {
                      ...
                      if (
                        ...
                        (t = e(t)),
                          i ||
                            ((n = t.parent().parent()[0]) === this.element[0] &&
                              (n = null),
                            (o = t.index())),
                          r ||
                            !a.children.length ||
                            ...
                            (r = !0),
                          r || (c = t.children(".jstree-children")[0]),
                          (p =
                      ...
                      if (
                        (u.length &&
                          (t.childNodes[1].className = "jstree-anchor " + u),
                        ...
                        for (
                          (_ = g.createElement("UL")).setAttribute(
                            "role",
                            "group"
                          ),
                          ...
                          _.appendChild(this.redraw_node(a.children[l], r, !0));
                        t.appendChild(_);
                      }
                      if ((c && t.appendChild(c), !i)) {
                        for (
                          n || (n = this.element[0]),
                            l = 0,
                        ...
                        m ||
                          ((m = g.createElement("UL")).setAttribute(
                            "role",
                            "group"
                          ),
                    ...
                    open_node: function (r, i, s) {
                      var a, n, o, d;
                      if (e.isArray(r)) {
                        for (a = 0, n = (r = r.slice()).length; a < n; a++)
                          this.open_node(r[a], i, s);
                        return !0;
                      }
                      return (
                        !(!(r = this.get_node(r)) || r.id === e.jstree.root) &&
                        ...
                        this.is_closed(r)
                          ? this.is_loaded(r)
                            ? ((o = this.get_node(r, !0)),
                              ...
                              o.length &&
                                (s &&
                                  o.children(".jstree-children").length &&
                                  o.children(".jstree-children").stop(!0, !0),
                                r.children.length &&
                                  !this._firstChild(
                                    o.children(".jstree-children")[0]
                                  ) &&
                                  this.draw_children(r),
                                s
                                  ? (this.trigger("before_open", { node: r }),
                                    o
                                      .children(".jstree-children")
                                      .css("display", "none")
                                      .end()
                              ...
                              o.length ||
                                this.trigger("before_open", { node: r }),
                              this.trigger("open_node", { node: r }),
                              (s && o.length) ||
                                this.trigger("after_open", { node: r }),
                              !0)
                            : this.is_loading(r)
                            ? setTimeout(
                                e.proxy(function () {
                                  this.open_node(r, i, s);
                                }, this),
                                500
                              )
                            : void this.load_node(r, function (e, t) {
                                return t
                                  ? this.open_node(e, i, s)
                                  : !!i && i.call(this, e, !1);
                              })
                          : (i && i.call(this, r, !1), !1))
                      );
                    ...
                    _open_to: function (t) {
                      ...
                      for (r = 0, i = s.length; r < i; r += 1)
                        r !== e.jstree.root && this.open_node(s[r], !1, 0);
                      return e(
                        "#" + t.id.replace(e.jstree.idregex, "\\$&"),
                        this.element
                      );
                    ...
                    close_node: function (r, i) {
                      var s, a, n, o;
                      if (e.isArray(r)) {
                        for (s = 0, a = (r = r.slice()).length; s < a; s++)
                          this.close_node(r[s], i);
                        return !0;
                      }
                      return (
                        !(!(r = this.get_node(r)) || r.id === e.jstree.root) &&
                        ...
                        (o = this.get_node(r, !0)),
                        (r.state.opened = !1),
                        this.trigger("close_node", { node: r }),
                        void (o.length
                          ? i
                            ? o
                                .children(".jstree-children")
                            ...
                            : ((o[0].className = o[0].className.replace(
                              ...
                              o
                                ...
                                .attr("aria-expanded", !1),
                              o.children(".jstree-children").remove(),
                              this.trigger("after_close", { node: r }))
                          : this.trigger("after_close", { node: r })))
                      );
                    },
                    toggle_node: function (t) {
                      var r, i;
                      if (e.isArray(t)) {
                        for (r = 0, i = (t = t.slice()).length; r < i; r++)
                          this.toggle_node(t[r]);
                        return !0;
                      }
                      ...
                      if (!o.length) {
                        for (s = 0, a = t.children_d.length; s < a; s++)
                          this.is_closed(this._model.data[t.children_d[s]]) &&
                            (this._model.data[t.children_d[s]].state.opened =
                              !0);
                      ...
                      (i = i || o),
                        ...
                        (o = this.is_closed(t)
                          ...
                          n.open_node(
                            this,
                            function (e, t) {
                              t && this.is_parent(e) && this.open_all(e, r, i);
                            },
                            r || 0
                          );
                        }),
                        0 === i.find(".jstree-closed").length &&
                          this.trigger("open_all", { node: this.get_node(i) });
                    },
                    close_all: function (t, r) {
                      if ((t || (t = e.jstree.root), !(t = this.get_node(t))))
                        return !1;
                      var i,
                        s,
                    ...
                    hide_node: function (t, r) {
                      var i, s;
                      if (e.isArray(t)) {
                        for (i = 0, s = (t = t.slice()).length; i < s; i++)
                          this.hide_node(t[i], !0);
                    ...
                    show_node: function (t, r) {
                      var i, s;
                      if (e.isArray(t)) {
                        for (i = 0, s = (t = t.slice()).length; i < s; i++)
                          this.show_node(t[i], !0);
                        return r || this.redraw(), !0;
                      }
                      if (!(t = this.get_node(t)) || t.id === e.jstree.root)
                        return !1;
                    ...
                    activate_node: function (e, r) {
                      ...
                      if (
                        ...
                        this.settings.core.multiple &&
                          (r.metaKey || r.ctrlKey || r.shiftKey) &&
                          (!r.shiftKey ||
                            (this._data.core.last_clicked &&
                              this.get_parent(e) &&
                              this.get_parent(e) ===
                        ...
                        if (r.shiftKey) {
                          ...
                          for (i = 0, s = o.length; i < s; i += 1)
                            o[i] === a && (d = !d),
                              o[i] === n && (d = !d),
                              this.is_disabled(o[i]) ||
                              (!d && o[i] !== a && o[i] !== n)
                                ? this.deselect_node(o[i], !0, r)
                                : this.is_hidden(o[i]) ||
                                  this.select_node(o[i], !0, !1, r);
                          this.trigger("changed", {
                            action: "select_node",
                          ...
                          this.is_selected(e)
                            ? this.deselect_node(e, !1, r)
                            : this.select_node(e, !1, !1, r);
                      else
                        !this.settings.core.multiple &&
                        (r.metaKey || r.ctrlKey || r.shiftKey) &&
                        this.is_selected(e)
                    ...
                    hover_node: function (e) {
                      ...
                      t && t.length && this.dehover_node(t),
                        ...
                        setTimeout(function () {
                          r.attr("aria-activedescendant", e[0].id);
                        }, 0);
                    },
                    ...
                    select_node: function (t, r, i, s) {
                      var a, n, o;
                      if (e.isArray(t)) {
                        for (n = 0, o = (t = t.slice()).length; n < o; n++)
                          this.select_node(t[n], r, i, s);
                        return !0;
                      }
                      if (!(t = this.get_node(t)) || t.id === e.jstree.root)
                        return !1;
                    ...
                    deselect_node: function (t, r, i) {
                      var s, a, n;
                      if (e.isArray(t)) {
                        for (s = 0, a = (t = t.slice()).length; s < a; s++)
                          this.deselect_node(t[s], r, i);
                        return !0;
                      }
                      if (!(t = this.get_node(t)) || t.id === e.jstree.root)
                        return !1;
                    ...
                    select_all: function (t) {
                      ...
                      for (
                        ...
                        this._model.data[this._data.core.selected[r]] &&
                          (this._model.data[
                            this._data.core.selected[r]
                          ].state.selected = !0);
                      this.redraw(!0),
                    ...
                    deselect_all: function (e) {
                      ...
                      for (
                        t = 0, r = this._data.core.selected.length;
                        t < r;
                        t++
                      )
                    ...
                    get_top_selected: function (t) {
                      var r,
                        ...
                        o = {};
                      for (r = 0, i = n.length; r < i; r++) o[n[r].id] = n[r];
                      for (r = 0, i = n.length; r < i; r++)
                        for (s = 0, a = n[r].children_d.length; s < a; s++)
                          o[n[r].children_d[s]] && delete o[n[r].children_d[s]];
                      for (r in ((n = []), o)) o.hasOwnProperty(r) && n.push(r);
                      return t
                        ? e.map(
                            n,
                            e.proxy(function (e) {
                    ...
                    get_bottom_selected: function (t) {
                      var r,
                        ...
                        a = [];
                      for (r = 0, i = s.length; r < i; r++)
                        s[r].children.length || a.push(s[r].id);
                      return t
                        ? e.map(
                            a,
                            e.proxy(function (e) {
					...
					*/
                    ...
                    set_state: function (r, i) {
                      if (r) {
                        if (
                          (r.core &&
                            r.core.selected &&
                            r.core.initial_selection === t &&
                            (r.core.initial_selection = this._data.core.selected
                              .concat([])
                              .sort()
                              .join(",")),
                          r.core)
                          ...
                          if (r.core.loaded)
                            return (
                              this.settings.core.loaded_state &&
                              e.isArray(r.core.loaded) &&
                              r.core.loaded.length
                                ? this._load_nodes(r.core.loaded, function (e) {
                                    delete r.core.loaded, this.set_state(r, i);
                                  })
                                : (delete r.core.loaded, this.set_state(r, i)),
                              !1
                            );
                          if (r.core.open)
                            return (
                              e.isArray(r.core.open) && r.core.open.length
                                ? this._load_nodes(r.core.open, function (e) {
                                    this.open_node(e, !1, 0),
                                      delete r.core.open,
                                      this.set_state(r, i);
                                  })
                                : (delete r.core.open, this.set_state(r, i)),
                              !1
                            );
                          if (r.core.scroll)
                            return (
                              r.core.scroll &&
                                r.core.scroll.left !== t &&
                                this.element.scrollLeft(r.core.scroll.left),
                              r.core.scroll &&
                                r.core.scroll.top !== t &&
                                this.element.scrollTop(r.core.scroll.top),
                              delete r.core.scroll,
                              this.set_state(r, i),
                              !1
                            );
                          if (r.core.selected)
                            return (
                              (s = this),
                              (r.core.initial_selection !== t &&
                                r.core.initial_selection !==
                                  this._data.core.selected
                                    .concat([])
                                    .sort()
                                    .join(",")) ||
                                (this.deselect_all(),
                                e.each(r.core.selected, function (e, t) {
                                  s.select_node(t, !1, !0);
                                })),
                              delete r.core.initial_selection,
                              delete r.core.selected,
                              this.set_state(r, i),
                              !1
                            );
                          for (a in r)
                            r.hasOwnProperty(a) &&
                              "core" !== a &&
                              -1 === e.inArray(a, this.settings.plugins) &&
                              delete r[a];
                          if (e.isEmptyObject(r.core))
                            return delete r.core, this.set_state(r, i), !1;
                        }
                        return (
                          !e.isEmptyObject(r) ||
                          ((r = null),
                    ...
                    refresh: function (t, r) {
                      ...
                      t ||
                        ...
                        this.load_node(e.jstree.root, function (t, r) {
                          r &&
                    ...
                    refresh_node: function (t) {
                      ...
                      var r = [],
                        ...
                        s = this._data.core.selected.concat([]);
                      i.push(t.id),
                        !0 === t.state.opened && r.push(t.id),
                        this.get_node(t, !0)
                          .find(".jstree-open")
                          .each(function () {
                            i.push(this.id), r.push(this.id);
                          }),
                        this._load_nodes(
                          i,
                          e.proxy(function (e) {
                            this.open_node(r, !1, 0),
                              this.select_node(s),
                    ...
                    set_id: function (t, r) {
                      ...
                      return (
                        -1 !==
                          (i = e.inArray(t.id, this._data.core.selected)) &&
                          (this._data.core.selected[i] = r),
                        (i = this.get_node(t.id, !0)) &&
                          (i.attr("id", r),
                          this.element.attr("aria-activedescendant") === t.id &&
                            this.element.attr("aria-activedescendant", r)),
                        delete a[t.id],
                        (t.id = r),
                        (t.li_attr.id = r),
                        (a[r] = t),
                    ...
                    set_text: function (t, r) {
                      ...
                      return (
                        ...
                        this.trigger("set_text", { obj: t, text: r }),
                        !0)
                      );
                    },
                    get_json: function (t, r, i) {
                      ...
                      var s,
                        ...
                        n = {
                          ...
                          data:
                            (!r || !r.no_data) &&
                            e.extend(!0, e.isArray(t.data) ? [] : {}, t.data),
                        };
                      if (
                        (r && r.flat
                          ? (n.parent = t.parent)
                        ...
                        for (s in t.state)
                          t.state.hasOwnProperty(s) &&
                            (n.state[s] = t.state[s]);
                      if (
                        (r && r.no_li_attr && delete n.li_attr,
                        r && r.no_a_attr && delete n.a_attr,
                        r &&
                          r.no_id &&
                          (delete n.id,
                          n.li_attr && n.li_attr.id && delete n.li_attr.id,
                          n.a_attr && n.a_attr.id && delete n.a_attr.id),
                        r && r.flat && t.id !== e.jstree.root && i.push(n),
                        !r || !r.no_children)
                      )
                        for (s = 0, a = t.children.length; s < a; s++)
                          r && r.flat
                            ? this.get_json(t.children[s], r, i)
                            : n.children.push(this.get_json(t.children[s], r));
                      return r && r.flat
                        ? i
                        : t.id === e.jstree.root
                        ? n.children
                    ...
                    create_node: function (r, i, s, a, n) {
                      if (
                        (null === r && (r = e.jstree.root),
                        !(r = this.get_node(r)))
                      )
                        return !1;
                      if (
                      ...
                      switch (
                        ...
                        (i =
                          "string" == typeof i
                            ? { text: i }
                            : e.extend(!0, {}, i)).text === t &&
                          (i.text = this.get_string("New node")),
                        r.id === e.jstree.root &&
                          ("before" === s && (s = "first"),
                          "after" === s && (s = "last")),
                        s)
                        ...
                        case "before":
                          (o = this.get_node(r.parent)),
                            (s = e.inArray(r.id, o.children)),
                            (r = o);
                          break;
                        case "after":
                          (o = this.get_node(r.parent)),
                            (s = e.inArray(r.id, o.children) + 1),
                            (r = o);
                          break;
                        case "inside":
                        case "first":
                      ...
                      if (
                        (s > r.children.length && (s = r.children.length),
                        i.id || (i.id = !0),
                        !this.check("create_node", i, r, s))
                      )
                        return (
                          this.settings.core.error.call(
                            this,
                      ...
                      for (
                        o = this.get_node(i),
                          ...
                          this.trigger("model", { nodes: d, parent: r.id }),
                          r.children_d = r.children_d.concat(d),
                          c = 0,
                          l = r.parents.length;
                        c < l;
                        c++
                        ...
                        this._model.data[r.parents[c]].children_d =
                          this._model.data[r.parents[c]].children_d.concat(d);
                      for (
                        i = o, o = [], c = 0, l = r.children.length;
                        c < l;
                        c++
                      )
                        o[c >= s ? c + 1 : c] = r.children[c];
                      return (
                        (o[s] = i.id),
                        (r.children = o),
                    ...
                    rename_node: function (t, r) {
                      ...
                      if (e.isArray(t)) {
                        for (i = 0, s = (t = t.slice()).length; i < s; i++)
                          this.rename_node(t[i], r);
                        return !0;
                      }
                      return (
                        !(!(t = this.get_node(t)) || t.id === e.jstree.root) &&
                        ((a = t.text),
                        this.check("rename_node", t, this.get_parent(t), r)
                          ? (this.set_text(t, r),
                    ...
                    delete_node: function (t) {
                      var r, i, s, a, n, o, d, c, l, h, _, u;
                      if (e.isArray(t)) {
                        for (r = 0, i = (t = t.slice()).length; r < i; r++)
                          this.delete_node(t[r]);
                        return !0;
                      }
                      if (!(t = this.get_node(t)) || t.id === e.jstree.root)
                        return !1;
                    ...
                    move_node: function (r, i, s, a, n, o, d) {
                      var c, l, h, _, u, g, f, p, m, v, j, y, k, x;
                      if (((i = this.get_node(i)), (s = s === t ? 0 : s), !i))
                        return !1;
                      if (
                        ...
                        return this.load_node(i, function () {
                          this.move_node(r, i, s, a, !0, !1, d);
                        });
                      if (e.isArray(r)) {
                        if (1 !== r.length) {
                          for (c = 0, l = r.length; c < l; c++)
                            (m = this.move_node(r[c], i, s, a, n, !1, d)) &&
                              ((i = m), (s = "after"));
                      ...
                      if (
                        ...
                        return !1;
                      if (
                        ((h = (r.parent || e.jstree.root).toString()),
                        (u =
                          s.toString().match(/^(before|after)$/) &&
                          i.id !== e.jstree.root
                        ...
                        (f =
                          !(g =
                            d ||
                            (this._model.data[r.id]
                              ? this
                              : e.jstree.reference(r.id))) ||
                          !g._id ||
                          this._id !== g._id),
                        (_ =
                          g &&
                          ...
                          h &&
                          g._model.data[h] &&
                          g._model.data[h].children
                            ? e.inArray(r.id, g._model.data[h].children)
                            : -1),
                        g && g._id && (r = g._model.data[r.id]),
                        f)
                      )
                        return (
                          !!(m = this.copy_node(r, i, s, a, n, !1, d)) &&
                          (g && g.delete_node(r), m)
                        );
                      switch (
                        (i.id === e.jstree.root &&
                        ...
                        case "before":
                          s = e.inArray(i.id, u.children);
                          break;
                        case "after":
                          s = e.inArray(i.id, u.children) + 1;
                          break;
                        case "inside":
                        case "first":
                          s = 0;
                      ...
                      if (r.parent === u.id) {
                        for (
                          p = u.children.concat(),
                            -1 !== (m = e.inArray(r.id, p)) &&
                              ((p = e.vakata.array_remove(p, m)), s > m && s--),
                            m = [],
                            v = 0,
                            j = p.length;
                          v < j;
                        ...
                        for (
                          (m = r.children_d.concat()).push(r.id),
                            v = 0,
                            j = r.parents.length;
                          v < j;
                          v++
                          ...
                          for (
                            p = [],
                              y = 0,
                              k = (x = g._model.data[r.parents[v]].children_d)
                                .length;
                            y < k;
                            y++
                          )
                            -1 === e.inArray(x[y], m) && p.push(x[y]);
                          g._model.data[r.parents[v]].children_d = p;
                        }
                        for (
                          g._model.data[h].children =
                            e.vakata.array_remove_item(
                          ...
                          this._model.data[u.parents[v]].children_d =
                            this._model.data[u.parents[v]].children_d.concat(m);
                        for (p = [], v = 0, j = u.children.length; v < j; v++)
                          p[v >= s ? v + 1 : v] = u.children[v];
                        for (
                          p[s] = r.id,
                            u.children = p,
                            u.children_d.push(r.id),
                            u.children_d = u.children_d.concat(r.children_d),
                            r.parent = u.id,
                            ...
                            m = m.concat(),
                            v = 0,
                            j = r.children_d.length;
                          v < j;
                          v++
                        )
                          (this._model.data[r.children_d[v]].parents =
                            this._model.data[r.children_d[v]].parents.slice(
                              0,
                              -1 * x
                            )),
                        ...
                        (h !== e.jstree.root && u.id !== e.jstree.root) ||
                          (this._model.force_full_redraw = !0),
                          this._model.force_full_redraw ||
                            (this._node_changed(h), this._node_changed(u.id)),
                          o || this.redraw();
                      }
                      return (
                        a && a.call(this, r, u, s),
                    ...
                    copy_node: function (r, i, s, a, n, o, d) {
                      ...
                      if (
                        ...
                        return this.load_node(i, function () {
                          this.copy_node(r, i, s, a, !0, !1, d);
                        });
                      if (e.isArray(r)) {
                        if (1 !== r.length) {
                          for (c = 0, l = r.length; c < l; c++)
                            (_ = this.copy_node(r[c], i, s, a, n, !0, d)) &&
                              ((i = _), (s = "after"));
                          return this.redraw(), !0;
                        }
                        r = r[0];
                      ...
                      if (
                        ...
                        return !1;
                      switch (
                        ((p = (r.parent || e.jstree.root).toString()),
                        (m =
                          s.toString().match(/^(before|after)$/) &&
                          i.id !== e.jstree.root
                            ? this.get_node(i.parent)
                        ...
                        case "before":
                          s = e.inArray(i.id, m.children);
                          break;
                        case "after":
                          s = e.inArray(i.id, m.children) + 1;
                          break;
                        case "inside":
                        case "first":
                          s = 0;
                      ...
                      for (
                        ...
                        this._model.data[m.parents[u]].children_d =
                          this._model.data[m.parents[u]].children_d.concat(h);
                      for (h = [], u = 0, g = m.children.length; u < g; u++)
                        ...
                        this.trigger("copy_node", {
                          ...
                          old_position:
                            ...
                            v._model.data[p].children
                              ? e.inArray(r.id, v._model.data[p].children)
                              : -1,
                          is_multi: v && v._id && v._id !== this._id,
                          is_foreign: !v || !v._id,
                          old_instance: v,
			...
			*/
                            ...
                            (h = e("<input />", {
                              ...
                              blur: e.proxy(function (r) {
                                r.stopImmediatePropagation(),
                                  r.preventDefault();
                                var s,
                                  a = o.children(".jstree-rename-input").val(),
                              ...
                              keyup: function (e) {
                                h.width(
                                  Math.min(l.text("pW" + this.value).width(), a)
                                );
                              },
                              keypress: function (e) {
                            ...
                            h
                              .css(_)
                              .width(
                                Math.min(l.text("pW" + h[0].value).width(), a)
                              )[0]
                              .select(),
                            void e(d).one(
                      ...
                      return (
                        ...
                        !1 === i
                          ...
                          ? (n
                              ...
                              .css("background", "")
                              .removeAttr("rel"),
                            !1 === o && this.show_icon(r))
                          : -1 === i.indexOf("/") && -1 === i.indexOf(".")
                          ? (n.removeClass(o).css("background", ""),
                            n
                              .addClass(i + " jstree-themeicon-custom")
                              .attr("rel", i),
                            !1 === o && this.show_icon(r))
                          : (n.removeClass(o).css("background", ""),
                            n
                  ...
                  (e.vakata = {}),
                  (e.vakata.attributes = function (t, r) {
                    t = e(t)[0];
                    var i = r ? {} : [];
                    return (
                      t &&
                        ...
                        e.each(t.attributes, function (t, s) {
                          -1 ===
                            ...
                            (r ? (i[s.name] = s.value) : i.push(s.name));
                        }),
                      i
                    );
                  }),
                  ...
                  (e.vakata.array_filter = function (e, t, r, i, s) {
                  ...
                  (e.jstree.plugins.changed = function (e, t) {
                    ...
                    (this.trigger = function (e, i) {
                      var s, a;
                      if (
                        (i || (i = {}), "changed" === e.replace(".jstree", ""))
                      ) {
                        i.changed = { selected: [], deselected: [] };
                        var n = {};
                        for (s = 0, a = r.length; s < a; s++) n[r[s]] = 1;
                        for (s = 0, a = i.selected.length; s < a; s++)
                          n[i.selected[s]]
                            ? (n[i.selected[s]] = 2)
                            : i.changed.selected.push(i.selected[s]);
                        for (s = 0, a = r.length; s < a; s++)
                          1 === n[r[s]] && i.changed.deselected.push(r[s]);
                        r = i.selected.slice();
                      }
                      t.trigger.call(this, e, i);
                    }),
                      (this.refresh = function (e, i) {
                        return (r = []), t.refresh.apply(this, arguments);
                      });
                  });
                var h,
                  _,
                ...
                (u.className = "jstree-icon jstree-checkbox"),
                  ...
                  (e.jstree.plugins.checkbox = function (r, i) {
                    (this.bind = function () {
                      i.bind.call(this),
                            ...
                            e.proxy(function (e, t) {
                              ...
                              for (r = 0, i = a.length; r < i; r++)
                                (s[a[r]].state.checked =
                                  s[a[r]].state.checked ||
                                  (s[a[r]].original &&
                                    s[a[r]].original.state &&
                                    s[a[r]].original.state.checked)),
                                  s[a[r]].state.checked &&
                                    this._data.checkbox.selected.push(a[r]);
                            }, this)
                          ),
                        (-1 === this.settings.checkbox.cascade.indexOf("up") &&
                          -1 ===
                            this.settings.checkbox.cascade.indexOf("down")) ||
                          this.element
                            .on(
                              "model.jstree",
                              e.proxy(function (t, r) {
                                  ...
                                  if (l.state[g ? "selected" : "checked"]) {
                                    ...
                                    for (s = 0, a = h.length; s < a; s++)
                                      if (
                                        ...
                                        for (
                                          n = 0, o = c[h[s]].children_d.length;
                                          n < o;
                                          n++
                                        )
                                          c[c[h[s]].children_d[n]].state[
                                            g ? "selected" : "checked"
                                          ] = !0;
                                        this._data[
                                          g ? "core" : "checkbox"
                                          ...
                                          g ? "core" : "checkbox"
                                        ].selected.concat(c[h[s]].children_d);
                                      }
                                if (-1 !== u.indexOf("up")) {
                                  for (
                                    ...
                                    c[l.children_d[s]].children.length ||
                                      _.push(c[l.children_d[s]].parent);
                                  for (
                                    n = 0,
                                      o = (_ = e.vakata.array_unique(_)).length;
                                    n < o;
                                    n++
                                  )
                                    for (
                                      ...
                                      for (
                                        i = 0, s = 0, a = l.children.length;
                                        s < a;
                                        s++
                                      )
                                        i +=
                                          c[l.children[s]].state[
                                            g ? "selected" : "checked"
                                          ];
                                      if (i !== a) break;
                                      (l.state[g ? "selected" : "checked"] =
                                        !0),
                                        this._data[
                                          g ? "core" : "checkbox"
                                        ].selected.push(l.id),
                                ...
                                this._data[g ? "core" : "checkbox"].selected =
                              ...
                              e.proxy(function (t, r) {
                                ...
                                if (-1 !== l.indexOf("up"))
                                  for (; c && c.id !== e.jstree.root; ) {
                                    for (
                                      a = 0, i = 0, s = c.children.length;
                                      i < s;
                                      i++
                                    )
                                      a +=
                                        d[c.children[i]].state[
                                          h ? "selected" : "checked"
                                        ];
                                    if (a !== s) break;
                                ...
                                for (i in ((u = []), _))
                                  _.hasOwnProperty(i) && u.push(i);
                                this._data[h ? "core" : "checkbox"].selected =
                                  u;
                              }, this)
                            )
                            .on(
                              ...
                              e.proxy(function (t, r) {
                                var i,
                                  ...
                                  o = this._model.data;
                                for (i = 0, s = n.children_d.length; i < s; i++)
                                  (a = o[n.children_d[i]]) &&
                                    a.original &&
                                    a.original.state &&
                            ...
                            .on(
                              ...
                              e.proxy(function (t, r) {
                                ...
                                if (
                                  ...
                                  for (i = 0, s = n.parents.length; i < s; i++)
                                    ((a = this._model.data[n.parents[i]]).state[
                                      d ? "selected" : "checked"
                                    ] = !1),
                                      a &&
                                        a.original &&
                            ...
                            .on(
                              ...
                              e.proxy(function (t, r) {
                                for (
                                  ...
                                  o &&
                                  o.id !== e.jstree.root &&
                                  !o.state[c ? "selected" : "checked"];

                                ) {
                                  for (
                                    a = 0, i = 0, s = o.children.length;
                                    i < s;
                                    i++
                                  )
                                    a +=
                                      d[o.children[i]].state[
                                        c ? "selected" : "checked"
                                      ];
                                  if (!(s > 0 && a === s)) break;
                              ...
                              e.proxy(function (t, r) {
                                ...
                                if (!d)
                                  for (
                                    ...
                                    i &&
                                    i.id !== e.jstree.root &&
                                    !i.state[_ ? "selected" : "checked"];

                                  ) {
                                    for (
                                      s = 0, a = 0, n = i.children.length;
                                      a < n;
                                      a++
                                    )
                                      s +=
                                        h[i.children[a]].state[
                                          _ ? "selected" : "checked"
                                        ];
                                    if (!(n > 0 && s === n)) break;
                                ...
                                for (i = l; i && i.id !== e.jstree.root; ) {
                                  ...
                                  if (s === n)
                                    ...
                                    if (!i.state[_ ? "selected" : "checked"])
                                      break;
                                    (i.state[_ ? "selected" : "checked"] = !1),
                                      (this._data[
                                        _ ? "core" : "checkbox"
                      ...
                      (this.get_undetermined = function (r) {
                        if (
                          -1 ===
                        ...
                        for (i = 0, s = l.length; i < s; i++)
                          if (d[l[i]] && d[l[i]].parents)
                            for (
                              a = 0, n = d[l[i]].parents.length;
                              a < n && o[d[l[i]].parents[a]] === t;
                              a++
                            )
                              d[l[i]].parents[a] !== e.jstree.root &&
                                ((o[d[l[i]].parents[a]] = !0),
                                h.push(d[l[i]].parents[a]));
                        for (
                          this.element
                            .find(".jstree-closed")
                            ...
                            .each(function () {
                              ...
                              if (c)
                                if (c.state.loaded) {
                                  for (
                                    i = 0, s = c.children_d.length;
                                    i < s;
                                    i++
                                  )
                                    if (
                                      !(r = d[c.children_d[i]]).state.loaded &&
                                      r.original &&
                                      r.original.state &&
                          ...
                          d[h[i]].state[c ? "selected" : "checked"] ||
                            u.push(r ? d[h[i]] : h[i]);
                        return u;
                      }),
                      ...
                      (this.redraw_node = function (t, r, s, a) {
                        if ((t = i.redraw_node.apply(this, arguments))) {
                          ...
                          d &&
                            (!this.settings.checkbox.tie_selection &&
                              this._model.data[t.id].state.checked &&
                              (d.className += " jstree-checked"),
                            (c = u.cloneNode(!1)),
                            this._model.data[t.id].state.checkbox_disabled &&
                              (c.className += " jstree-checkbox-disabled"),
                      ...
                      (this.is_undetermined = function (t) {
                        ...
                        if (
                          ...
                          return !0;
                        for (r = 0, i = t.children_d.length; r < i; r++)
                          if (
                            -1 !== e.inArray(t.children_d[r], n) ||
                            (!o[t.children_d[r]].state.loaded &&
                              o[t.children_d[r]].original.state.undetermined)
                          )
                            return !0;
                        return !1;
                      }),
                      ...
                      (this.activate_node = function (t, r) {
                        return (
                          !e(r.target).hasClass("jstree-checkbox-disabled") &&
                          (this.settings.checkbox.tie_selection &&
                            (this.settings.checkbox.whole_node ||
                              e(r.target).hasClass("jstree-checkbox")) &&
                            (r.ctrlKey = !0),
                          this.settings.checkbox.tie_selection ||
                          (!this.settings.checkbox.whole_node &&
                            !e(r.target).hasClass("jstree-checkbox"))
                      ...
                      (this._cascade_new_checked_state = function (e, t) {
                        ...
                        if (
                          ...
                          if (n.children)
                            for (r = 0, i = n.children.length; r < i; r++) {
                              var c = n.children[r];
                          ...
                          n.original &&
                            ...
                            h
                              ? ((n.state[a ? "selected" : "checked"] = !1),
                                l
                                  .attr("aria-selected", !1)
                                  .children(".jstree-anchor")
                                  .removeClass(
                                    a ? "jstree-clicked" : "jstree-checked"
                                  ))
                              : t && d.length === n.children.length
                              ? ((n.state[a ? "selected" : "checked"] = t),
                                o.push(n.id),
                                l
                                  .attr("aria-selected", !0)
                                  .children(".jstree-anchor")
                      ...
                      (this.get_checked_descendants = function (t) {
                        var r = this,
                          i = r.settings.checkbox.tie_selection,
                          s = r._model.data[t];
                        return e.vakata.array_filter(
                          s.children_d,
                          function (e) {
                            return r._model.data[e].state[
                              i ? "selected" : "checked"
                            ];
                          }
                        );
                      }),
                      (this.check_node = function (t, r) {
                        if (this.settings.checkbox.tie_selection)
                          return this.select_node(t, !1, !0, r);
                        var i, s, a;
                        if (e.isArray(t)) {
                          for (s = 0, a = (t = t.slice()).length; s < a; s++)
                            this.check_node(t[s], r);
                          return !0;
                        }
                        if (!(t = this.get_node(t)) || t.id === e.jstree.root)
                          return !1;
                      ...
                      (this.uncheck_node = function (t, r) {
                        if (this.settings.checkbox.tie_selection)
                          return this.deselect_node(t, !1, r);
                        var i, s, a;
                        if (e.isArray(t)) {
                          for (i = 0, s = (t = t.slice()).length; i < s; i++)
                            this.uncheck_node(t[i], r);
                          return !0;
                        }
                        if (!(t = this.get_node(t)) || t.id === e.jstree.root)
                          return !1;
                      ...
                      (this.check_all = function () {
                        ...
                        for (
                          this._data.checkbox.selected =
                            this._model.data[e.jstree.root].children_d.concat(),
                            t = 0,
                            r = this._data.checkbox.selected.length;
                          t < r;
                          t++
                        )
                      ...
                      (this.uncheck_all = function () {
                        ...
                        var e,
                          t,
                          r = this._data.checkbox.selected.concat([]);
                        for (
                      ...
                      (this.get_top_checked = function (t) {
                        ...
                        for (r = 0, i = n.length; r < i; r++)
                          for (s = 0, a = n[r].children_d.length; s < a; s++)
                            o[n[r].children_d[s]] &&
                              delete o[n[r].children_d[s]];
                        for (r in ((n = []), o))
                          o.hasOwnProperty(r) && n.push(r);
                        return t
                          ? e.map(
                              n,
                              e.proxy(function (e) {
                      ...
                      (this.get_state = function () {
                        var e = i.get_state.apply(this, arguments);
                        return (
                          this.settings.checkbox.tie_selection ||
                      ...
                      (this.set_state = function (t, r) {
                        var s = i.set_state.apply(this, arguments);
                        if (s && t.checkbox) {
                          if (!this.settings.checkbox.tie_selection) {
                            this.uncheck_all();
                            var a = this;
                          ...
                          return delete t.checkbox, this.set_state(t, r), !1;
                        }
                        return s;
                      }),
                  ...
                  (e.jstree.plugins.conditionalselect = function (e, t) {
                    this.activate_node = function (e, r) {
                      if (
                        ...
                        return t.activate_node.call(this, e, r);
                    };
                  }),
                    ...
                    items: function (t, r) {
                      return {
                        create: {
                          ...
                          label: "Create",
                          action: function (t) {
                            var r = e.jstree.reference(t.reference),
                              i = r.get_node(t.reference);
                        ...
                        .on(
                          ...
                          function (i) {
                            i.originalEvent &&
                              ...
                              ((t = i.originalEvent.changedTouches[0].clientX),
                              (r = i.originalEvent.changedTouches[0].clientY),
                              (a = setTimeout(function () {
                                e(i.currentTarget).trigger("contextmenu", !0);
                              }, 750)));
                          }
                        )
			...
			*/
                        e(d).on(
                          ...
                          e.proxy(function (t, r) {
                            (this._data.contextmenu.visible = !1),
                              e(r.reference).removeClass("jstree-context");
                          }, this)
                        );
                    }),
                      ...
                      (this.show_contextmenu = function (r, i, s, a) {
                        if (!(r = this.get_node(r)) || r.id === e.jstree.root)
                          return !1;
                        var n = this.settings.contextmenu,
                          o = this.get_node(r, !0).children(".jstree-anchor"),
                          d = !1,
                          c = !1;
                        (n.show_at_node || i === t || s === t) &&
                          ((d = o.offset()),
                          (i = d.left),
                          (s = d.top + this._data.core.li_height)),
                          this.settings.contextmenu.select_node &&
                            !this.is_selected(r) &&
                            this.activate_node(r, a),
                          (c = n.items),
                          e.isFunction(c) &&
                            (c = c.call(
                              this,
                              r,
                              e.proxy(function (e) {
                                this._show_contextmenu(r, i, s, e);
                              }, this)
                            )),
                          e.isPlainObject(c) &&
                            this._show_contextmenu(r, i, s, c);
                      }),
                      (this._show_contextmenu = function (t, r, i, s) {
                        ...
                        e(d).one(
                          ...
                          e.vakata.context.show(a, { x: r, y: i }, s),
                    ...
                    (e.vakata.context = {
                      ...
                      _parse: function (t, i) {
                        ...
                        return (
                          ...
                          e.each(t, function (t, i) {
                            ...
                            r.items.push(i),
                              ...
                              (a +=
                                ...
                                "</a>"),
                              i.submenu &&
                                (s = e.vakata.context._parse(i.submenu, !0)) &&
                                (a += s),
                              (a += "</li>"),
                              i.separator_after &&
                                ((a +=
                          ...
                          i && (a += "</ul>"),
                          i ||
                            ((r.html = a), e.vakata.context._trigger("parse")),
                          a.length > 10 && a
                        );
                      },
                      _show_submenu: function (r) {
                        if ((r = e(r)).length && r.children("ul").length) {
                          var i = r.children("ul"),
                            s = r.offset().left,
                            a = s + r.outerWidth(),
                            n = r.offset().top,
                          ...
                          t
                            ...
                            n + d + 10 > l && i.css("bottom", "-1px"),
                            r.hasClass("vakata-context-right")
                              ? s < o && i.css("margin-right", s - o)
                              : c - a < o && i.css("margin-left", c - a - o),
                            i.show();
                        }
                      },
                      show: function (i, s, a) {
                        var n, o, c, l, h, _, u, g;
                        switch (
                          (r.element && r.element.length && r.element.width(""),
                          !0)
                        ) {
                          case !s && !i:
                            return !1;
                          ...
                          case !s && !!i:
                            (r.reference = i),
                              (n = i.offset()),
                              (r.position_x = n.left + i.outerHeight()),
                              (r.position_y = n.top);
                            break;
                          case !!s && !i:
                        ...
                        i &&
                          !a &&
                          e(i).data("vakata_contextmenu") &&
                          (a = e(i).data("vakata_contextmenu")),
                          e.vakata.context._parse(a) && r.element.html(r.html),
                          r.items.length &&
                            (r.element.appendTo(d.body),
                            (o = r.element),
                            (c = r.position_x),
                            (l = r.position_y),
                            (h = o.width()),
                          ...
                          r.element
                            ...
                            .on("keydown", function (e) {
                              ...
                              var t = r.element
                                ...
                                .parent();
                              t.parent().not(".vakata-context-disabled") &&
                                t.click();
                            }),
                          e(d)
                            .on("mousedown.vakata.jstree", function (t) {
                              r.is_visible &&
                                r.element[0] !== t.target &&
                                !e.contains(r.element[0], t.target) &&
                                e.vakata.context.hide();
                            })
                            .on("context_show.vakata.jstree", function (e, i) {
                              r.element
                                .find("li:has(ul)")
                                .children("a")
                  ...
                  (e.jstree.plugins.dnd = function (t, r) {
                    (this.init = function (e, t) {
                        ...
                        r.bind.call(this),
                          this.element.on(
                            ...
                            e.proxy(function (t) {
                              if (
                                this.settings.dnd.large_drag_target &&
                                e(t.target).closest(".jstree-node")[0] !==
                                  t.currentTarget
                              )
                                return !0;
                              if (
                              ...
                              if (
                                ...
                                if (
                                  ((h = {
                                    ...
                                    nodes:
                                      i > 1 ? this.get_top_selected() : [r.id],
                                  }),
                                  (_ = t.currentTarget),
                                  !this.settings.dnd.use_html5)
                                )
                      ...
                      (this.redraw_node = function (e, t, i, s) {
                        if (
                          (e = r.redraw_node.apply(this, arguments)) &&
                          this.settings.dnd.use_html5
                        )
                        ...
                        if (
                          ...
                          if (N && N._data && N._data.dnd)
                            if (
                              ...
                              (w =
                                d.data.origin &&
                                (d.data.origin.settings.dnd.always_copy ||
                                  (d.data.origin.settings.dnd.copy &&
                                    (d.event.metaKey || d.event.ctrlKey)))),
                              d.helper
                                .children()
                                .attr(
                                  "class",
                                ...
                                .first()
                                [w ? "show" : "hide"](),
                              (d.event.target !== N.element[0] &&
                                d.event.target !== N.get_container_ul()[0]) ||
                              ...
                              if (
                                ...
                                (S =
                                  (d.event.pageY !== t
                                    ? d.event.pageY
                                    : d.event.originalEvent.pageY) - O.top),
                                (_ = T.outerHeight()),
                                (f =
                                  S < _ / 3
                                    ? ["b", "i", "a"]
                                  ...
                                  if (
                                    ...
                                    return (
                                      ...
                                      d.event.originalEvent &&
                                        ...
                                        (d.event.originalEvent.dataTransfer.dropEffect =
                                          w ? "copy" : "move"),
                                      (i = {}),
                                      (f = !0),
                                      !1
                                ...
                                (p =
                                  ...
                                  N.check(
                                    d.data.origin &&
                                      ...
                                      : "move_node",
                                    d.data.origin && d.data.origin !== N
                                      ? d.data.origin.get_node(d.data.nodes[m])
                                      : d.data.nodes[m],
                                    e.jstree.root,
                                    "last",
                                    {
                        ...
                        if (
                          ...
                          if (r) {
                            for (d = 0, c = o.data.nodes.length; d < c; d++)
                              l[d] = o.data.origin
                                ? o.data.origin.get_node(o.data.nodes[d])
                                : o.data.nodes[d];
                            r.ins[
                              o.data.origin &&
                              (o.data.origin.settings.dnd.always_copy ||
                                (o.data.origin.settings.dnd.copy &&
                                  (o.event.metaKey || o.event.ctrlKey)))
                                ? "copy_node"
                                : "move_node"
                            ](l, r.par, r.pos, !1, !1, !1, o.data.origin);
                          } else
                            (d = e(o.event.target).closest(".jstree")).length &&
                              i &&
                              i.error &&
                              "check" === i.error &&
                              (d = d.jstree(!0)) &&
                              d.settings.core.error.call(this, i);
                          (s = !1), (r = !1);
                        }
                      })
                  ...
                  (function (e) {
                    ...
                    e.vakata.dnd = {
                      ...
                      _trigger: function (r, i, s) {
                        s === t && (s = e.vakata.dnd._get()),
                          (s.event = i),
                          e(d).triggerHandler("dnd_" + r + ".vakata", s);
                      },
                      _get: function () {
                        return {
                          data: r.data,
                      ...
                      _clean: function () {
                        r.helper && r.helper.remove(),
                          r.scroll_i &&
                            (clearInterval(r.scroll_i), (r.scroll_i = !1)),
                          (r = {
                            element: !1,
                            target: !1,
                            is_down: !1,
                      ...
                      _scroll: function (t) {
                        if (!r.scroll_e || (!r.scroll_l && !r.scroll_t))
                          return (
                            r.scroll_i &&
                              (clearInterval(r.scroll_i), (r.scroll_i = !1)),
                            !1
                        ...
                        if (!0 === t) return !1;
                        var i = r.scroll_e.scrollTop(),
                          s = r.scroll_e.scrollLeft();
                        r.scroll_e.scrollTop(
                          i + r.scroll_t * e.vakata.dnd.settings.scroll_speed
                        ),
                          r.scroll_e.scrollLeft(
                            s + r.scroll_l * e.vakata.dnd.settings.scroll_speed
                          ),
                          (i === r.scroll_e.scrollTop() &&
                            s === r.scroll_e.scrollLeft()) ||
                            e.vakata.dnd._trigger("scroll", r.scroll_e);
                      },
                      start: function (t, i, s) {
                        ...
                        return (
                          ...
                          (r.data = i),
                          (r.is_down = !0),
                          (r.element = t.currentTarget),
                          (r.target = t.target),
                          (r.is_touch = "touchstart" === t.type),
                          !1 !== s &&
                            (r.helper = e("<div id='vakata-dnd'></div>")
                              .html(s)
                              .css({
                                display: "block",
                                margin: "0",
                      ...
                      drag: function (t) {
                        if (
                          ...
                          if (!r.is_drag) {
                            if (
                              !(
                                Math.abs(t.pageX - r.init_x) >
                                  (r.is_touch
                                    ? e.vakata.dnd.settings.threshold_touch
                                    : e.vakata.dnd.settings.threshold) ||
                                Math.abs(t.pageY - r.init_y) >
                                  (r.is_touch
                                    ? e.vakata.dnd.settings.threshold_touch
                                    : e.vakata.dnd.settings.threshold)
                              )
                              ...
                              return;
                            r.helper &&
                              (r.helper.appendTo(d.body),
                              (r.helper_w = r.helper.outerWidth())),
                              (r.is_drag = !0),
                              e(r.target).one("click.vakata", !1),
                              e.vakata.dnd._trigger("start", t);
                          }
                          var i = !1,
                            s = !1,
                          ...
                          return (
                            ...
                            e(
                              ...
                              .each(function () {
                                ...
                                if (
                                  (this.scrollHeight > this.offsetHeight &&
                                    (s.top + i.height() - t.pageY <
                                      e.vakata.dnd.settings.scroll_proximity &&
                                      (r.scroll_t = 1),
                                    t.pageY - s.top <
                                      e.vakata.dnd.settings.scroll_proximity &&
                                      (r.scroll_t = -1)),
                                  this.scrollWidth > this.offsetWidth &&
                                    (s.left + i.width() - t.pageX <
                                      e.vakata.dnd.settings.scroll_proximity &&
                                      (r.scroll_l = 1),
                                    t.pageX - s.left <
                                      e.vakata.dnd.settings.scroll_proximity &&
                                      (r.scroll_l = -1)),
                                  r.scroll_t || r.scroll_l)
                                )
                                  return (r.scroll_e = e(this)), !1;
                              }),
                            r.scroll_e ||
                              ((i = e(d)),
                              (s = e(window)),
                              ...
                              o > c &&
                                c - (t.pageX - h) <
                                  e.vakata.dnd.settings.scroll_proximity &&
                                (r.scroll_l = 1),
                              (r.scroll_t || r.scroll_l) && (r.scroll_e = i)),
                            r.scroll_e && e.vakata.dnd._scroll(!0),
                            r.helper &&
                              ((_ = parseFloat(
                                t.pageY + e.vakata.dnd.settings.helper_top,
                                10
                              )),
                              (u = parseFloat(
                              ...
                              o &&
                                u + r.helper_w > o &&
                                (u = o - (r.helper_w + 2)),
                              r.helper.css({ left: u + "px", top: _ + "px" })),
                            e.vakata.dnd._trigger("move", t),
                            !1
                          );
                        }
                  ...
                  (e.jstree.plugins.massload = function (t, r) {
                    (this.init = function (e, t) {
                      (this._data.massload = {}), r.init.call(this, e, t);
                    }),
                      (this._load_nodes = function (t, i, s, a) {
                        var n,
                          o,
                          d,
                        ...
                        if (!s) {
                          for (n = 0, o = t.length; n < o; n++)
                            (h[t[n]] &&
                              (h[t[n]].state.loaded || h[t[n]].state.failed) &&
                              !a) ||
                              (l.push(t[n]),
                                  ...
                                  for (n = 0, o = t.length; n < o; n++)
                                    (d = this.get_node(t[n], !0)) &&
                                      ...
                                      d
                                        .removeClass("jstree-loading")
                                        .attr("aria-busy", !1);
                                  r._load_nodes.call(this, t, i, s, a);
                                }, this)
                              );
                                  ...
                                  .done(
                                    e.proxy(function (e, n, o) {
                                      ...
                                      if (e)
                                        for (c in e)
                                          e.hasOwnProperty(c) &&
                                            (this._data.massload[c] = e[c]);
                                      for (c = 0, l = t.length; c < l; c++)
                                        (d = this.get_node(t[c], !0)) &&
                                          d.length &&
                                          d
                                            .removeClass("jstree-loading")
                                            .attr("aria-busy", !1);
                        ...
                        return r._load_nodes.call(this, t, i, s, a);
                      }),
                  ...
                  (e.jstree.plugins.search = function (r, i) {
                    (this.bind = function () {
                      i.bind.call(this),
                        ...
                        this.element
                          .on(
                            "search.jstree",
                            e.proxy(function (t, r) {
                              if (this._data.search.som && r.res.length) {
                                var i,
                                  s,
                                  a,
                                  n,
                                  o = this._model.data,
                                  d = [];
                                for (i = 0, s = r.res.length; i < s; i++)
                                  if (
                                    o[r.res[i]] &&
                                    !o[r.res[i]].state.hidden &&
                                    (d.push(r.res[i]),
                                    (d = d.concat(o[r.res[i]].parents)),
                                    this._data.search.smc)
                                  )
                                    for (
                                      a = 0, n = o[r.res[i]].children_d.length;
                                      a < n;
                                      a++
                                    )
                                      o[o[r.res[i]].children_d[a]] &&
                                        !o[o[r.res[i]].children_d[a]].state
                                          .hidden &&
                                        d.push(o[r.res[i]].children_d[a]);
                      ...
                      (this.search = function (r, i, s, a, n, o) {
                            ...
                            ? h.call(
                                ...
                                e.proxy(function (t) {
                                  t && t.d && (t = t.d),
                                    this._load_nodes(
                                      e.isArray(t)
                                        ? e.vakata.array_unique(t)
                                        : [],
                                      function () {
                                        this.search(r, !0, s, a, n, o);
                                      }
                                    );
                                }, this),
                                a
                              ...
                              i.text &&
                                ...
                                (!l.search_leaves_only ||
                                  (i.state.loaded &&
                                    0 === i.children.length)) &&
                                ((l.search_callback &&
                                  l.search_callback.call(this, r, i)) ||
                                  (!l.search_callback &&
                                    u.search(i.text).isMatch)) &&
                                (g.push(t), (f = f.concat(i.parents)));
                            }
                          ),
                          g.length)
                        ) {
                          for (
                            d = 0, c = (f = e.vakata.array_unique(f)).length;
                            d < c;
                            d++
                          )
                            f[d] !== e.jstree.root &&
                          ...
                          n
                            ? ((this._data.search.dom =
                              ...
                              (this._data.search.res = e.vakata.array_unique(
                                this._data.search.res.concat(g)
                              )))
                            : ((this._data.search.dom = e(
                                this.element[0].querySelectorAll(
                                  "#" +
                      ...
                      (this.redraw_node = function (t, r, s, a) {
                        if (
                          (t = i.redraw_node.apply(this, arguments)) &&
                  ...
                  (function (e) {
                    (e.vakata.search = function (t, r, i) {
                      (i = i || {}),
                        !1 !==
                          (i = e.extend({}, e.vakata.search.defaults, i))
                            .fuzzy && (i.fuzzy = !0),
                      ...
                      return (
                        ...
                        i.fuzzy &&
                          ...
                          (a = (function () {
                            var e = {},
                              r = 0;
                            for (r = 0; r < h; r++) e[t.charAt(r)] = 0;
                            for (r = 0; r < h; r++)
                              e[t.charAt(r)] |= 1 << (h - r - 1);
                            return e;
                          })()),
                          (n = function (e, t) {
                            var r = e / h,
                              i = Math.abs(d - t);
                            return c ? r + i / c : i ? 1 : r;
                          })),
                        (o = function (e) {
                          if (
                          ...
                          for (
                            ...
                            for (c = 0, _ = k; c < _; )
                              n(r, d + _) <= j ? (c = _) : (k = _),
                                (_ = Math.floor((k - c) / 2 + c));
                            for (
                              k = _,
                                g = Math.max(1, d - _ + 1),
                                f = Math.min(d + _, v) + h,
                                (p = new Array(f + 2))[f + 1] = (1 << r) - 1,
                                o = f;
                              o >= g;
                              o--
                            )
                    ...
                    (this.bind = function () {
                      ...
                      (this.sort = function (t, r) {
                        ...
                        if (
                          ...
                          t.children &&
                          t.children.length &&
                          (t.children.sort(e.proxy(this.settings.sort, this)),
                          r)
                        )
                          for (i = 0, s = t.children_d.length; i < s; i++)
                            this.sort(t.children_d[i], !1);
                      });
                  });
                var g = !1;
                (e.jstree.defaults.state = {
                    ...
                    (this.bind = function () {
                      ...
                      (this.restore_state = function () {
                        ...
                        return (
                          ...
                          (t && t.state && (t = t.state),
                          t &&
                            e.isFunction(this.settings.state.filter) &&
                  ...
                  (e.jstree.plugins.types = function (r, i) {
                    (this.init = function (r, s) {
                      ...
                      (this.get_json = function (t, r, s) {
                        var a,
                          n,
                          o = this._model.data,
                          d = r ? e.extend(!0, {}, r, { no_id: !1 }) : {},
                          c = i.get_json.call(this, t, d, s);
                        if (!1 === c) return !1;
                        if (e.isArray(c))
                          ...
                          (c.type =
                            c.id && o[c.id] && o[c.id].type
                              ? o[c.id].type
                              : "default"),
                            r && r.no_id && (c = this._delete_ids(c));
                        return c;
                      }),
                      (this._delete_ids = function (t) {
                        if (e.isArray(t)) {
                          for (var r = 0, i = t.length; r < i; r++)
                            t[r] = this._delete_ids(t[r]);
                          return t;
                        }
                        return (
                          delete t.id,
                          ...
                          t.children &&
                            e.isArray(t.children) &&
                            (t.children = this._delete_ids(t.children)),
                          t
                        );
                      }),
                      (this.check = function (r, s, a, n, o) {
                        if (!1 === i.check.call(this, r, s, a, n, o)) return !1;
                        ...
                        switch (
                          ...
                          case "copy_node":
                            if (
                              ...
                              if (
                                (d = this.get_rules(a)).max_children !== t &&
                                -1 !== d.max_children &&
                                ...
                                return (
                                  (this._data.core.last_error = {
                                    ...
                                    id: "types_01",
                                    reason:
                                      "max_children prevents function: " + r,
                                    data: JSON.stringify({
                                      chk: r,
                                      pos: n,
                                      obj: !(!s || !s.id) && s.id,
                              ...
                              if (
                                ...
                                return (
                                  (this._data.core.last_error = {
                                    ...
                                    id: "types_02",
                                    reason:
                                      "valid_children prevents function: " + r,
                                    data: JSON.stringify({
                                      chk: r,
                                      pos: n,
                                      obj: !(!s || !s.id) && s.id,
                              ...
                              if (_ && s.children_d && s.parents) {
                                for (
                                  c = 0, l = 0, h = s.children_d.length;
                                  l < h;
                                  l++
                                )
                                  c = Math.max(
                                    c,
                                    _[s.children_d[l]].parents.length
                                  );
                      ...
                      (this.get_rules = function (e) {
                        ...
                        return (
                          r.max_depth === t && (r.max_depth = -1),
                          r.max_children === t && (r.max_children = -1),
                          r.valid_children === t && (r.valid_children = -1),
                          r
                        );
                      }),
                      ...
                      (this.set_type = function (r, i) {
                        ...
                        if (
                          ...
                          (!0 === d ||
                            ...
                            this.set_icon(r, s[i].icon === t || s[i].icon),
                          s[o] &&
                            s[o].li_attr !== t &&
                          ...
                          for (c in s[o].li_attr)
                            if (s[o].li_attr.hasOwnProperty(c)) {
                              if ("id" === c) continue;
                              "class" === c
                                ? ((_[r.id].li_attr.class = (
                                    _[r.id].li_attr.class || ""
                                  ).replace(s[o].li_attr[c], "")),
                                  l && l.removeClass(s[o].li_attr[c]))
                                : _[r.id].li_attr[c] === s[o].li_attr[c] &&
                                  ((_[r.id].li_attr[c] = null),
                                  l && l.removeAttr(c));
                            }
                        if (
                          s[o] &&
                          ...
                          for (c in s[o].a_attr)
                            if (s[o].a_attr.hasOwnProperty(c)) {
                              ...
                              "class" === c
                                ...
                                : _[r.id].a_attr[c] === s[o].a_attr[c] &&
                                  ("href" === c
                                    ? ((_[r.id].a_attr[c] = "#"),
                                      h && h.attr("href", "#"))
                                    : (delete _[r.id].a_attr[c],
                                      h && h.removeAttr(c)));
                            }
                        if (
                          s[i].li_attr !== t &&
                          "object" == typeof s[i].li_attr
                        )
                          for (c in s[i].li_attr)
                            if (s[i].li_attr.hasOwnProperty(c)) {
                              if ("id" === c) continue;
                              _[r.id].li_attr[c] === t
                                ? ((_[r.id].li_attr[c] = s[i].li_attr[c]),
                                  l &&
                                    ("class" === c
                                      ? l.addClass(s[i].li_attr[c])
                                      : l.attr(c, s[i].li_attr[c])))
                                : "class" === c &&
                                  ((_[r.id].li_attr.class =
                                    s[i].li_attr[c] +
                                    " " +
                                    _[r.id].li_attr.class),
                                  l && l.addClass(s[i].li_attr[c]));
                            }
                        if (s[i].a_attr !== t && "object" == typeof s[i].a_attr)
                          for (c in s[i].a_attr)
                            if (s[i].a_attr.hasOwnProperty(c)) {
                              if ("id" === c) continue;
                              _[r.id].a_attr[c] === t
                                ? ((_[r.id].a_attr[c] = s[i].a_attr[c]),
                                  h &&
                                    ("class" === c
                                      ? h.addClass(s[i].a_attr[c])
                                      : h.attr(c, s[i].a_attr[c])))
                                : "href" === c && "#" === _[r.id].a_attr[c]
                                ? ((_[r.id].a_attr.href = s[i].a_attr.href),
                                  h && h.attr("href", s[i].a_attr.href))
                                : "class" === c &&
                                  ((_[r.id].a_attr.class =
                                    s[i].a_attr.class +
                                    " " +
                                    _[r.id].a_attr.class),
                                  h && h.addClass(s[i].a_attr[c]));
                            }
                        return !0;
                      });
                  }),
                  ...
                  (e.jstree.plugins.unique = function (r, i) {
                    (this.check = function (t, r, s, a, n) {
                      if (!1 === i.check.call(this, t, r, s, a, n)) return !1;
                      if (
                        ((r = r && r.id ? r : this.get_node(r)),
                      ...
                      (this.create_node = function (r, s, a, n, o) {
                        if (!s || s.text === t) {
                          if (
                            ...
                            return i.create_node.call(this, r, s, a, n, o);
                          if (
                            !(a = a === t ? "last" : a)
                              .toString()
                              .match(/^(before|after)$/) &&
                ...
                if (
                  ...
                  (f.innerHTML = "&#160;"),
                  (e.jstree.plugins.wholerow = function (t, r) {
                    (this.bind = function () {
                      r.bind.call(this),
                        this.element
                          .on(
                          ...
                          .on(
                            ...
                            e.proxy(function (e, t) {
                              ...
                              var r,
                                i,
                                s = !1;
                              for (r = 0, i = t.selected.length; r < i; r++)
                                (s = this.get_node(t.selected[r], !0)) &&
                                  s.length &&
                                  s
