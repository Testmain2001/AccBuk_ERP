(function (global, factory) {
  ...
  function t$i(t) {
    ...
    var r = 0;
    while (e--) {
      r += l[n][parseFloat(t.charAt(e), 10)];
      n = 1 - n;
    }
    return r % 10 === 0 && r > 0;
  }
  function t$h(t) {
    ...
    var n = 5;
    for (var r = 0; r < e; r++) {
      n = ((((n || 10) * 2) % 11) + parseFloat(t.charAt(r), 10)) % 10;
    }
    return n === 1;
  }
  function t$g(t) {
    ...
    return {
      validate: function validate(a) {
        ...
        return n.inclusive
          ? {
              message: r$2(
                a.l10n ? n.message || a.l10n.between["default"] : n.message,
                ["".concat(l), "".concat(o)]
              ),
          ...
          : {
              message: r$2(
                a.l10n ? n.message || a.l10n.between.notInclusive : n.message,
                ["".concat(l), "".concat(o)]
              ),
              valid: parseFloat(t) > l && parseFloat(t) < o,
            };
    ...
    return {
      validate: function validate(t) {
        ...
        var a = t.l10n
          ...
          : t.options.message;
        var l = !((s && o < parseFloat(s, 10)) || (n && o > parseFloat(n, 10)));
        switch (true) {
          case !!s && !!n:
  ...
  function l$2() {
    return {
      validate: function validate(l) {
        ...
        for (
          var _i = 0, _Object$keys = Object.keys(t$a);
          ...
          for (var n in t$a[_e].prefix) {
            if (
              l.value.substr(0, t$a[_e].prefix[n].length) ===
                t$a[_e].prefix[n] &&
              t$a[_e].length.indexOf(r.length) !== -1
            ) {
  ...
  function t$9(t, e, n, r) {
    ...
    if (r === true) {
      ...
      var u = _r.getDate();
      return (
        t < _s || (t === _s && e - 1 < a) || (t === _s && e - 1 === a && n < u)
      );
    }
    return true;
  }
  function n() {
    var n = function n(t, e, _n) {
      ...
      if (o.length > 1) {
        var _t = o[1].split(":");
        c.setHours(_t.length > 0 ? parseFloat(_t[0], 10) : 0);
        c.setMinutes(_t.length > 1 ? parseFloat(_t[1], 10) : 0);
        c.setSeconds(_t.length > 2 ? parseFloat(_t[2], 10) : 0);
      }
      return c;
    };
    ...
    return {
      validate: function validate(e) {
        ...
        if (n) {
          ...
          if (
            e.options.maxFiles &&
            o > parseFloat("".concat(e.options.maxFiles), 10)
          ) {
            return { meta: { error: "INVALID_MAX_FILES" }, valid: false };
          }
          if (
            e.options.minFiles &&
            o < parseFloat("".concat(e.options.minFiles), 10)
          ) {
          ...
          for (var l = 0; l < o; l++) {
            ...
            if (
              e.options.minSize &&
              _n[l].size < parseFloat("".concat(e.options.minSize), 10)
            ) {
              return {
                meta: Object.assign({}, { error: "INVALID_MIN_SIZE" }, r),
                valid: false,
              };
            }
            if (
              e.options.maxSize &&
              _n[l].size > parseFloat("".concat(e.options.maxSize), 10)
            ) {
              return {
                meta: Object.assign({}, { error: "INVALID_MAX_SIZE" }, r),
                valid: false,
              };
            }
            if (i && i.indexOf(t.toLowerCase()) === -1) {
              return {
                meta: Object.assign({}, { error: "INVALID_EXTENSION" }, r),
                valid: false,
              };
            }
            if (_n[l].type && s && s.indexOf(_n[l].type.toLowerCase()) === -1) {
              return {
                meta: Object.assign({}, { error: "INVALID_TYPE" }, r),
                valid: false,
              };
            }
          }
          if (
            ...
            a > parseFloat("".concat(e.options.maxTotalSize), 10)
          ) {
            return {
              meta: Object.assign(
                {},
                { error: "INVALID_MAX_TOTAL_SIZE", totalSize: a },
                r
              ),
              valid: false,
            };
          ...
          if (
            ...
            a < parseFloat("".concat(e.options.minTotalSize), 10)
          ) {
            return {
              meta: Object.assign(
                {},
                { error: "INVALID_MIN_TOTAL_SIZE", totalSize: a },
                r
              ),
              valid: false,
            };
    ...
    return {
      validate: function validate(a) {
        ...
        return s.inclusive
          ? {
              message: r$2(
                a.l10n ? s.message || a.l10n.greaterThan["default"] : s.message,
                "".concat(t)
              ),
    ...
    return {
      validate: function validate(s) {
        ...
        return a.inclusive
          ? {
              message: r$2(
                s.l10n ? a.message || s.l10n.lessThan["default"] : a.message,
                "".concat(l)
              ),
          ...
          : {
              message: r$2(
                s.l10n ? a.message || s.l10n.lessThan.notInclusive : a.message,
                "".concat(l)
              ),
              valid: parseFloat(s.value) < l,
            };
  ...
  function a$2() {
    return {
      validate: function validate(a) {
        ...
        var i = new RegExp(
          "^-?[0-9]{1,3}(".concat(s, "[0-9]{3})*(").concat(r, "[0-9]+)?$")
        );
      ...
      var a = Object.keys(d.params)
        .map(function (e) {
          return ""
            ...
            .concat(encodeURIComponent(d.params[e]));
        })
        .join("&");
      var r = e.indexOf("?");
      var c =
    ...
    return {
      validate: function validate(s) {
        ...
        var m = s.l10n
          ...
          : n.message;
        if ((r && i < parseFloat(r, 10)) || (l && i > parseFloat(l, 10))) {
          g = false;
        }
        switch (true) {
          case !!r && !!l:
            m = r$2(
              s.l10n ? n.message || s.l10n.stringLength.between : n.message,
              [r, l]
            );
            break;
          case !!r:
            m = r$2(
              s.l10n ? n.message || s.l10n.stringLength.more : n.message,
              "".concat(parseFloat(r, 10))
            );
            break;
          case !!l:
            m = r$2(
              s.l10n ? n.message || s.l10n.stringLength.less : n.message,
              "".concat(parseFloat(l, 10))
            );
            break;
        }
  ...
  function r(e, t) {
    var i = Object.assign(
      {},
      { fields: {}, locale: "en_US", plugins: {}, init: function init(e) {} },
      t
    );
  ...
  var t$3 = (function (_e) {
    ...
    function t(e) {
      ...
      _this.opts = Object.assign(
        {},
        { html5Input: false, pluginPrefix: "data-fvp-", prefix: "data-fv-" },
        e
      );
        ...
        value: function parseOptions() {
          ...
          i.forEach(function (s) {
            ...
            if (!_this4.isEmptyOption(a)) {
              var _i =
                s.getAttribute("name") || s.getAttribute("".concat(e, "field"));
          ...
          for (var i = 0; i < s; i++) {
            ...
            if (r && r.length === 4) {
              ...
              a[_e3] = Object.assign(
                {},
                r[3]
                  ? _defineProperty({}, this.toCamelCase(r[3]), n)
                  : { enabled: "" === n || "true" === n },
                a[_e3]
              );
            }
              ...
              switch (true) {
                case "minlength" === _s3:
                  a["stringLength"] = Object.assign(
                    {},
                    { enabled: true, min: parseFloat(r, 10) },
                    a["stringLength"]
                  );
                  break;
                case "maxlength" === _s3:
                  a["stringLength"] = Object.assign(
                    {},
                    { enabled: true, max: parseFloat(r, 10) },
                    a["stringLength"]
                  );
                  break;
                case "pattern" === _s3:
      ...
      [
        ...
        },
        {
          ...
          value: function onFieldRemoved(e) {
            ...
            var _s2 =
              "radio" === t || "checkbox" === t ? [e.elements[0]] : e.elements;
        ...
        },
        {
          ...
          value: function onValidatorValidated(e) {
            ...
            var a =
              ("radio" === i || "checkbox" === i) && _s6.length > 0
                ? _s6[0]
                : e.element;
        ...
        },
        {
          ...
          value: function onElementIgnored(e) {
            ...
            if (this.messages.has(i)) {
              ...
              var _s15 = [].slice.call(
                _t4.querySelectorAll('[data-field="'.concat(e.field, '"]'))
              );
        ...
        value: function removeClasses(e, s) {
          ...
          s.forEach(function (e) {
            ...
            c(
              e,
              ((_t7 = {}),
              _defineProperty(_t7, _this6.opts.eleValidClass, false),
              _defineProperty(_t7, _this6.opts.eleInvalidClass, false),
              _t7)
            );
          });
        ...
        value: function onElementValidated(e) {
          ...
          s.forEach(function (s) {
            ...
            c(
              s,
              ((_t9 = {}),
              _defineProperty(_t9, _this7.opts.eleValidClass, e.valid),
              _defineProperty(_t9, _this7.opts.eleInvalidClass, !e.valid),
              _t9)
            );
          });
    ...
    _createClass(i, [
      ...
      },
      {
        ...
        value: function shouldValidate(e, _i, t, l) {
          var d =
            (this.opts.enabled === true || this.opts.enabled[e] === true) &&
          ...
          _t2.forEach(function (_t3) {
            ...
            if (!!_this2.opts.event && _this2.opts.event[e] === false) {
              ...
              var n =
                ...
                "select" === s
                  ? "change"
                  : _this2.ieVersion >= 10 && _t3.getAttribute("placeholder")
                  ? "keyup"
                  : _this2.defaultEvent;
              i = [n];
            }
      ...
      },
      {
        ...
        value: function onFieldRemoved(e) {
          this.handlers
            .filter(function (_t6) {
              return (
                _t6.field === e.field && e.elements.indexOf(_t6.element) >= 0
              );
            })
            .forEach(function (e) {
              return e.element.removeEventListener(e.event, e.handler);
