          ...
          void 0 ===
            (r = function (t) {
              return (function (t, e, n, a) {
                        ...
                        var r = this.api(!0),
                          o =
                            ...
                            (Array.isArray(e[0]) || t.isPlainObject(e[0]))
                              ...
                              : r.row.add(e);
                        return (
                          (n === a || n) && r.draw(), o.flatten().toArray()
                        );
                      }),
                      ...
                      this.each(function () {
                        ...
                        if ("table" == this.nodeName.toLowerCase()) {
                          P(d),
                            R(d.column),
                            I(d, d, !0),
                            I(d.column, d.column, !0),
                            I(d, t.extend(o, h.data()), !0);
                          var p = s.settings;
                          for (u = 0, r = p.length; u < r; u++) {
                            ...
                            if (
                              ...
                              var b =
                                  o.bRetrieve !== a ? o.bRetrieve : d.bRetrieve,
                          ...
                          (m.nTable = this),
                            ...
                            o.aLengthMenu &&
                              !o.iDisplayLength &&
                              (o.iDisplayLength = Array.isArray(
                                o.aLengthMenu[0]
                              )
                                ? o.aLengthMenu[0][0]
                                : o.aLengthMenu[0]),
                            ...
                            ue(m.oLanguage, o, "fnInfoCallback"),
                            de(m, "aoDrawCallback", o.fnDrawCallback, "user"),
                            de(m, "aoServerParams", o.fnServerParams, "user"),
                            de(
                              m,
                              "aoStateSaveParams",
                              o.fnStateSaveParams,
                            ...
                            de(m, "aoStateLoaded", o.fnStateLoaded, "user"),
                            de(m, "aoRowCallback", o.fnRowCallback, "user"),
                            de(
                              m,
                            ...
                            de(m, "aoInitComplete", o.fnInitComplete, "user"),
                            de(
                              m,
                              "aoPreDrawCallback",
                              o.fnPreDrawCallback,
                          ...
                          var S = m.oClasses;
                          if (
                            (t.extend(S, s.ext.classes, o.oClasses),
                            h.addClass(S.sTable),
                            m.iInitDisplayStart === a &&
                              ((m.iInitDisplayStart = o.iDisplayStart),
                              (m._iDisplayStart = o.iDisplayStart)),
                          ...
                          var _ = m.asStripeClasses,
                            T = h.children("tbody").find("tr").eq(0);
                          -1 !==
                            t.inArray(
                              !0,
                          ...
                          if (
                            (0 !== x.length &&
                              (dt(m.aoHeader, x[0]), (C = ht(m))),
                            null === o.aoColumns)
                          )
                            for (w = [], u = 0, r = C.length; u < r; u++)
                              w.push(null);
                          else w = o.aoColumns;
                          for (u = 0, r = w.length; u < r; u++)
                            H(m, C ? C[u] : null);
                          if (
                            (V(m, o.aoColumnDefs, w, function (t, e) {
                              O(m, t, e);
                            }),
                            T.length)
                          ) {
                            ...
                            N = function () {
                              ...
                              if (
                                (0 === s.length &&
                                  ...
                                  ("" !== m.oScroll.sX ||
                                    "" !== m.oScroll.sY) &&
                                  (s = t("<tfoot/>").appendTo(h)),
                                0 === s.length || 0 === s.children().length
                                ...
                                for (u = 0; u < o.aaData.length; u++)
                                  X(m, o.aaData[u]);
                              else
                                (m.bDeferLoading || "dom" == be(m)) &&
                                  J(m, t(m.nTBody).children("tr"));
                          ...
                          o.bStateSave
                            ? ((L.bStateSave = !0),
                              de(m, "aoDrawCallback", oe, "state_save"),
                              ie(m, o, N))
                            : N();
                ...
                function P(t) {
                  L(t, "ordering", "bSort"),
                    L(t, "orderMulti", "bSortMulti"),
                    L(t, "orderClasses", "bSortClasses"),
                    L(t, "orderCellsTop", "bSortCellsTop"),
                    L(t, "order", "aaSorting"),
                    L(t, "orderFixed", "aaSortingFixed"),
                    L(t, "paging", "bPaginate"),
                    L(t, "pagingType", "sPaginationType"),
                    L(t, "pageLength", "iDisplayLength"),
                    L(t, "searching", "bFilter"),
                ...
                function R(t) {
                  L(t, "orderable", "bSortable"),
                    L(t, "orderData", "aDataSort"),
                    L(t, "orderSequence", "asSorting"),
                    L(t, "orderDataType", "sortDataType");
                  var e = t.aDataSort;
                  "number" != typeof e ||
                    Array.isArray(e) ||
                    (t.aDataSort = [e]);
                    ...
                    if (((f = []), !(u = d[e]).sType && u._sManualType))
                      ...
                      for (r = 0, o = p.length; r < o; r++) {
                        for (
                          i = 0, l = h.length;
                          i < l &&
                          (f[i] === a && (f[i] = G(t, i, e, "type")),
                          (c = p[r](f[i], t)) || r === p.length - 1) &&
                          ("html" !== c || g(f[i]));
                          i++
                        );
                        if (c) {
                ...
                function X(e, n, r, o) {
                  ...
                  return (
                    d !== a && (e.aIds[d] = l),
                    (!r && e.oFeatures.bDeferRender) || ot(e, i, r, o),
                    i
                  );
                }
                function J(e, n) {
                ...
                function rt(t, e, n, r) {
                  ...
                  if (u)
                    ...
                    for (var g = 0, b = (s = e.anCells).length; g < b; g++)
                      p(s[g]);
                    ...
                    for (
                      ...
                      (s = e.aoColumns[u]),
                        ((l = (f = !r)
                          ...
                          : o[u])._DT_CellIndex = { row: a, column: u }),
                        p.push(l),
                        (!f &&
                          ((!s.mRender && s.mData === u) ||
                ...
                function lt(e) {
                  var n,
                    ...
                    f = e.aoColumns;
                  for (
                    u && (o = t("<tr/>").appendTo(l)), n = 0, a = f.length;
                    n < a;
                    n++
                  )
                    (i = f[n]),
                ...
                function st(e, n, r) {
                  ...
                  if (n) {
                    for (r === a && (r = !1), o = 0, i = n.length; o < i; o++) {
                      for (
                        p[o] = n[o].slice(), p[o].nTr = n[o].nTr, l = b - 1;
                        l >= 0;
                        l--
                      )
                ...
                function ut(e, n) {
                  ...
                  if (-1 === t.inArray(!1, r)) {
                    ...
                    if (0 !== d.length)
                      for (
                        var g = f ? 0 : h, b = f ? e.aoData.length : p, v = g;
                        v < b;
                        v++
                      ) {
                        var m = d[v],
                        ...
                        if (0 !== s) {
                          var D = l[i % s];
                          S._sRowStripe != D &&
                            (t(y).removeClass(S._sRowStripe).addClass(D),
                            (S._sRowStripe = D));
                        }
                        he(e, "aoRowCallback", null, [y, S._aData, i, v, m]),
                          o.push(y),
                          i++;
                      }
                    else {
                    ...
                    if (((l = null), "<" == (u = p[g]))) {
                      if (
                        ...
                        if (
                          ...
                          var b = d.split(".");
                          (c.id = b[0].substr(1, b[0].length - 1)),
                            (c.className = b[1]);
                        } else
                          "#" == d.charAt(0)
                      ...
                      for (
                        var v = s.ext.feature, m = 0, S = v.length;
                        m < S;
                        m++
                      )
                        if (u == v[m].cFeature) {
                ...
                function pt(e, n, a) {
                  if (
                    (he(e, "aoServerParams", "serverParams", [n]),
                    n && Array.isArray(n))
                  ) {
                    var r = {},
                      o = /(.*?)\[\]$/;
                  ...
                  var f = {
                    ...
                    error: function (n, a, r) {
                      var o = he(e, null, "xhr", [e, null, e.jqXHR]);
                      -1 === t.inArray(!0, o) &&
                        ("parsererror" == a
                ...
                function bt(e) {
                  ...
                  for (n = 0; n < l; n++)
                    (r = i[n]),
                      ...
                      b("mDataProp_" + n, a),
                      u.bFilter &&
                        (b("sSearch_" + n, o.sSearch),
                        b("bRegex_" + n, o.bRegex),
                ...
                function vt(t, e) {
                  ...
                  et(t),
                    (t._iRecordsTotal = parseFloat(i, 10)),
                    (t._iRecordsDisplay = parseFloat(l, 10));
                ...
                function yt(t, e, n) {
                  ...
                  if ((U(t), "ssp" != be(t))) {
                    Tt(t, e.sSearch, n, l(e), e.bSmart, e.bCaseInsensitive),
                      i(e);
                ...
                function Dt(e) {
                  for (
                    ...
                    for (var u = [], c = 0, f = o.length; c < f; c++)
                      (a = o[c]),
                        (n = e.aoData[a]),
                        r[i](e, n._aFilterData, a, n._aData, c) && u.push(a);
                ...
                function _t(t, e, n, a, r, o) {
                  if ("" !== e) {
                    for (
                      var i, l = [], s = t.aiDisplay, u = wt(e, a, r, o), c = 0;
                      c < s.length;
                      c++
                    )
                      ...
                      for (i = [], a = 0, o = c.length; a < o; a++)
                        (e = c[a]).bSearchable
                          ...
                          l.indexOf &&
                            -1 !== l.indexOf("&") &&
                            ((xt.innerHTML = l),
                            (l = At ? xt.textContent : xt.innerText)),
                ...
                function Pt(e) {
                  ...
                  return (
                    a ||
                      (e.aoDrawCallback.push({ fn: Rt, sName: "information" }),
                ...
                function Rt(e) {
                  ...
                  if (0 !== n.length) {
                    ...
                    l !== i && (s += " " + a.sInfoFiltered),
                      (s = jt(e, (s += a.sInfoPostFix)));
                    var u = a.fnInfoCallback;
                    null !== u && (s = u.call(e.oInstance, e, r, o, i, l, s)),
                      t(n).html(s);
                  }
                }
                function jt(t, e) {
                        ...
                        fn: function (t) {
                          if (r) {
                            ...
                            for (e = 0, n = l.p.length; e < n; e++)
                              ge(t, "pageButton")(t, l.p[e], e, h, f, d);
                          } else a.fnUpdate(t, o);
                        },
                        sName: "pagination",
                      })),
                ...
                function Vt(e) {
                  ...
                  if (e.scrollBarVis !== V && e.scrollBarVis !== a)
                    return (e.scrollBarVis = V), void M(e);
                  (e.scrollBarVis = V),
                    F.children("thead, tfoot").remove(),
                    R &&
                      ((s = R.clone().prependTo(F)),
                      (r = R.find("tr")),
                      (i = s.find("tr"))),
                    (l = I.clone().prependTo(F)),
                    (n = I.find("tr")),
                    (o = l.find("tr")),
                    l.find("th, td").removeAttr("tabindex"),
                    h || ((C.width = "100%"), (v[0].style.width = "100%")),
                    t.each(ht(e, l), function (t, n) {
                    ...
                    "" === h
                      ? ((P.width = "100%"),
                        N &&
                          (F.find("tbody").height() > T.offsetHeight ||
                            "scroll" == w.css("overflow-y")) &&
                          (P.width = Zt(F.outerWidth() - b)),
                        (f = F.outerWidth()))
                      : "" !== p && ((P.width = Zt(p)), (f = F.outerWidth())),
                    Xt(U, o),
                    Xt(function (e) {
                    ...
                    F.outerWidth() < f
                      ? ((c =
                        ...
                        N &&
                          ...
                          (P.width = Zt(c - b)),
                        ("" !== h && "" === p) ||
                          se(e, 1, "Possible column misalignment", 6))
                      : (c = "100%"),
                    (C.width = Zt(c)),
                    (m.width = Zt(c)),
                    R && (e.nScrollFoot.style.width = Zt(c)),
                  ...
                  (D[q] = J ? b + "px" : "0px"),
                    R &&
                      ...
                      (x[0].style.width = Zt(X)),
                      (x[0].style[q] = J ? b + "px" : "0px")),
                ...
                function Xt(t, e, n) {
                  for (var a, r, o = 0, i = 0, l = e.length; i < l; ) {
                    for (
                      a = e[i].firstChild, r = n ? n[i].firstChild : null;
                      a;
                ...
                function qt(n) {
                  var a,
                    ...
                    y = i.style.width;
                  for (
                    y && -1 !== y.indexOf("%") && (g = y), a = 0;
                    a < h.length;
                    a++
                  )
                    null !== (r = l[h[a]]).sWidth &&
                      ((r.sWidth = $t(r.sWidthOrig, b)), (v = !0));
                  if (S || (!v && !c && !u && d == E(n) && d == p.length))
                    ...
                    for (a = 0; a < h.length; a++) {
                      var x = t(p[a]),
                        ...
                        I = m.bBounding
                          ? Math.ceil(p[a].getBoundingClientRect().width)
                          : x.outerWidth();
                ...
                function zt(e, n) {
                  ...
                  return r.nTr
                    ? r.anCells[n]
                    : t("<td/>").html(G(e, a, n, "display"))[0];
                }
                function Yt(t, e) {
                  for (
                    var n, a = -1, r = -1, o = 0, i = t.aoData.length;
                    o < i;
                    o++
                  )
                ...
                function Kt(e) {
                  ...
                  for (
                    ...
                    for (
                      r = 0, o = (i = d[(c = g[n][0])].aDataSort).length;
                      r < o;
                      r++
                    )
                      (u = d[(l = i[r])].sType || "string"),
                        g[n]._idx === a &&
                ...
                function Qt(t) {
                  var e,
                    ...
                    c = (t.aoColumns, 0),
                    f = t.aiDisplayMaster;
                  for (U(t), e = 0, n = (o = Kt(t)).length; e < n; e++)
                    (r = o[e]).formatter && c++, re(t, r.col);
                ...
                function ae(e) {
                  ...
                  if (s.bSort && s.bSortClasses) {
                    for (n = 0, a = o.length; n < a; n++)
                      (r = o[n].src),
                        t(y(e.aoData, "anCells", r)).removeClass(
                          i + (n < 2 ? n + 1 : 3)
                        );
                    for (n = 0, a = l.length; n < a; n++)
                      (r = l[n].src),
                        t(y(e.aoData, "anCells", r)).addClass(
                          i + (n < 2 ? n + 1 : 3)
                        );
                  }
                  e.aLastSort = l;
                ...
                function re(t, e) {
                  ...
                  for (
                    ...
                    (a = t.aoData[u])._aSortData || (a._aSortData = []),
                      (a._aSortData[e] && !i) ||
                ...
                function oe(e) {
                  if (e.oFeatures.bStateSave && !e.bDestroying) {
                    ...
                    he(e, "aoStateSaveParams", "stateSaveParams", [e, n]),
                      (e.oSavedState = n),
                ...
                function ie(e, n, r) {
                  var o,
                    ...
                    s = function (n) {
                      if (n && n.time) {
                        var s = he(e, "aoStateLoadParams", "stateLoadParams", [
                          e,
                          n,
                        ]);
                        if (-1 === t.inArray(!1, s)) {
                          ...
                          if (u > 0 && n.time < +new Date() - 1e3 * u) r();
                            ...
                            if (
                              ...
                              n.search !== a &&
                                t.extend(e.oPreviousSearch, Lt(n.search)),
                              n.columns)
                            )
                              for (o = 0, i = n.columns.length; o < i; o++) {
                                var c = n.columns[o];
                                c.visible !== a && (l[o].bVisible = c.visible),
                                  c.search !== a &&
                                    t.extend(
                                      e.aoPreSearchCols[o],
                                      Lt(c.search)
                ...
                function se(t, n, a, r) {
                  if (
                    ...
                    if ((t && he(t, null, "error", [t, r, a]), "alert" == i))
                      alert(a);
                    else {
                  ...
                  t.extend(o.prototype, {
                    ...
                    iterator: function (t, e, n, r) {
                      ...
                      for (
                        ...
                        var v = new o(g[l]);
                        if ("table" === e)
                          (i = n.call(v, g[l], l)) !== a && p.push(i);
                        else if ("columns" === e || "rows" === e)
                          (i = n.call(v, g[l], this[l], l)) !== a && p.push(i);
                        else if (
                          "column" === e ||
                          "column-rows" === e ||
                          "row" === e ||
                          ...
                          for (
                            ...
                            (h = d[u]),
                              (i =
                                "cell" === e
                                  ? n.call(v, g[l], h.row, h.column, l, u)
                                  : n.call(v, g[l], h, l, u, f)) !== a &&
                                p.push(i);
                      }
                      if (p.length || r) {
                ...
                var ye = function (t, e, n) {
                  ...
                  if ("ssp" == be(t)) ct(t, e);
                    ...
                    r && 4 !== r.readyState && r.abort(),
                      pt(t, [], function (n) {
                        et(t);
                        for (var a = mt(t, n), r = 0, o = a.length; r < o; r++)
                          X(t, a[r]);
                        ct(t, e), Bt(t, !1);
                      });
                  }
                ...
                var Ce = function (t, e) {
                  ...
                  xe = function (t, e) {
                    ...
                    if (n.length && t.length) {
                      ...
                      a._details &&
                        ((a._detailsShow = e),
                        e ? a._details.insertAfter(a.nTr) : a._details.detach(),
                        Ae(n[0]));
                    }
                  },
                  Ae = function (t) {
                            ...
                            var o = [],
                              i = function (n, a) {
                                if (Array.isArray(n) || n instanceof t)
                                  ...
                                  (t("td", s).addClass(a).html(n)[0].colSpan =
                                    E(e)),
                                    o.push(s[0]);
                                }
                              };
                ...
                i("cells()", function (e, n, r) {
                  ...
                  var o,
                    ...
                    s,
                    u = r
                      ? { page: r.page, order: r.order, search: r.search }
                      : {},
                    c = this.columns(n, u),
                    f = this.rows(e, u),
                    d = this.iterator(
                  ...
                  i("cell().data()", function (t) {
                    ...
                    return t === a
                      ...
                      : ($(e[0], n[0].row, n[0].column, t),
                        at(e[0], n[0].row, "data", n[0].column),
                        this);
                  }),
                  ...
                  (s.versionCheck = s.fnVersionCheck =
                    function (t) {
                      for (
                        ...
                        if (
                          (e = parseFloat(a[o], 10) || 0) !==
                          (n = parseFloat(r[o], 10) || 0)
                        )
                          return e > n;
                      return !0;
                    }),
                  ...
                  i("$()", function (e, n) {
                    var a = this.rows(n).nodes(),
                      r = t(a);
                    return t(
                      [].concat(r.filter(e).toArray(), r.find(e).toArray())
                    );
                  }),
                  ...
                  i("destroy()", function (n) {
                    return (
                      ...
                      this.iterator("table", function (a) {
                        ...
                        (a.bDestroying = !0),
                          he(a, "aoDestroyCallback", "destroy", [a]),
                          n || new o(a).columns().visible(!0),
                          g.off(".DT").find(":not(tbody *)").off(".DT"),
                          t(e).off(".DT-" + a.sInstance),
                          u != f.parentNode &&
                            (h.children("thead").detach(), h.append(f)),
                          d &&
                            u != d.parentNode &&
                            (h.children("tfoot").detach(), h.append(d)),
                          (a.aaSorting = []),
                          (a.aaSortingFixed = []),
                          ae(a),
                          t(b).removeClass(a.asStripeClasses.join(" ")),
                          t("th, td", f).removeClass(
                            l.sSortable +
                              " " +
                              l.sSortableAsc +
                              " " +
                ...
                function Pe(t, e) {
                  ...
                  return (
                    e <= a
                      ...
                      : t >= e - 1 - r
                      ? ((n = _(e - (a - 2), e)).splice(0, 0, "ellipsis"),
                        n.splice(0, 0, 0))
                  ...
                  t.each(
                    ...
                    function (t, n) {
                      (r.type.order[t + e + "-pre"] = n),
                        t.match(/^html\-/) &&
                          (r.type.search[t + e] = r.type.search.html);
                    }
                  );
                }
                ...
                function He(t) {
                  return function () {
                    var e = [le(this[s.ext.iApiIndex])].concat(
