!(function (t, e) {
  ...
  (function (t) {
      ...
      t.exports = (function () {
        ...
        function m(t, e, r, i, n) {
          ...
          !(function (t, e, r, i, n) {
            ...
            var u = t.element;
            (t.reach[a] = null),
              u[s] < 1 && (t.reach[a] = "start"),
              u[s] > t[l] - t[o] - 1 && (t.reach[a] = "end"),
              e &&
        ...
        (g.prototype.eventElement = function (t) {
          ...
          (g.prototype.bind = function (t, e, r) {
            this.eventElement(t).bind(e, r);
          }),
          (g.prototype.unbind = function (t, e, r) {
          ...
          (g.prototype.once = function (t, e, r) {
            var i = this.eventElement(t),
              n = function (t) {
                i.unbind(e, n), r(t);
              };
        ...
        function X(t) {
          ...
          (t.containerWidth = Math.ceil(n.width)),
            ...
            r.contains(t.scrollbarXRail) ||
              (o(r, c.rail("x")).forEach(function (t) {
                return l(t);
              }),
              r.appendChild(t.scrollbarXRail)),
            r.contains(t.scrollbarYRail) ||
              (o(r, c.rail("y")).forEach(function (t) {
                return l(t);
              }),
            ...
            (function (t, r) {
              ...
              r.isRtl
                ...
                r.isScrollbarXUsingBottom
                  ? (i.bottom = r.scrollbarXBottom - n)
                  : (i.top = r.scrollbarXTop + n),
              ...
              r.isScrollbarYUsingRight
                ? r.isRtl
                  ? (l.right =
                      r.contentWidth -
                      (r.negativeScrollAdjustment + t.scrollLeft) -
                      r.scrollbarYRight -
            ...
            t.scrollbarXActive
              ? r.classList.add(h.active("x"))
              : (r.classList.remove(h.active("x")),
                (t.scrollbarXWidth = 0),
                (t.scrollbarXLeft = 0),
                (r.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
            t.scrollbarYActive
              ? r.classList.add(h.active("y"))
              : (r.classList.remove(h.active("y")),
        ...
        var L = {
              ...
              t.event.bind(t.ownerDocument, "keydown", function (r) {
                if (
                  ...
                  if (l) {
                    ...
                    if (
                      n((i = l), "input,[contenteditable]") ||
                      n(i, "select,[contenteditable]") ||
                      n(i, "textarea,[contenteditable]") ||
                      n(i, "button,[contenteditable]")
                    )
                      return;
                  }
                  var o = 0,
                  ...
                  (t.settings.suppressScrollX && 0 !== o) ||
                    ...
                    (function (r, i) {
                      ...
                      if (0 === i) {
                        ...
                        if (
                          (0 === l && r < 0) ||
                          (l >= t.contentWidth - t.containerWidth && r > 0)
                        )
                          return !t.settings.wheelPropagation;
                      }
                      return !0;
            ...
            wheel: function (e) {
              ...
              function i(i) {
                ...
                if (
                  !(function (e, i, n) {
                    if (!w.isWebKit && r.querySelector("select:focus"))
                      return !0;
                  ...
                  e.settings.useBothWheelAxes
                    ? e.scrollbarYActive && !e.scrollbarXActive
                      ? (o
                          ? (r.scrollTop -= o * e.settings.wheelSpeed)
                          : (r.scrollTop += l * e.settings.wheelSpeed),
                        (s = !0))
                      : e.scrollbarXActive &&
                        !e.scrollbarYActive &&
                        (l
                          ? (r.scrollLeft += l * e.settings.wheelSpeed)
                          : (r.scrollLeft -= o * e.settings.wheelSpeed),
                        (s = !0))
                    : ((r.scrollTop -= o * e.settings.wheelSpeed),
                      (r.scrollLeft += l * e.settings.wheelSpeed)),
                    X(e),
                  ...
                  : w.supportsIePointer &&
                    (window.PointerEvent
                      ...
                      : window.MSPointerEvent &&
                        (e.event.bind(r, "MSPointerDown", u),
                        e.event.bind(r, "MSPointerMove", d),
                        e.event.bind(r, "MSPointerUp", f)));
              }
              function s(t, i) {
                (r.scrollTop -= i), (r.scrollLeft -= t), X(e);
              }
              function a(t) {
                  ...
                  g > 0 && ((l.x = f / g), (l.y = p / g), (n = b)),
                    (function (t, i) {
                      ...
                      if (s > o) {
                        if (
                          (i < 0 &&
                            n === e.contentHeight - e.containerHeight) ||
                          (i > 0 && 0 === n)
                        )
                          return 0 === window.scrollY && i > 0 && w.isChrome;
                      } else if (
                        o > s &&
                  ...
                  (o = setInterval(function () {
                    e.isInitialized
                      ...
                      ? Math.abs(l.x) < 0.01 && Math.abs(l.y) < 0.01
                        ? clearInterval(o)
                        : (s(30 * l.x, 30 * l.y), (l.x *= 0.8), (l.y *= 0.8))
                      : clearInterval(o);
                  }, 10)));
              }
            },
          ...
          R = function (i, n) {
            ...
            var u,
              d,
              f = function () {
                return i.classList.add(h.focus);
              },
              p = function () {
                return i.classList.remove(h.focus);
              };
            (this.isRtl = "rtl" === t(i).direction),
              !0 === this.isRtl && i.classList.add(a),
            ...
            (this.scrollbarXBottom = parseFloat(b.bottom, 10)),
              isNaN(this.scrollbarXBottom)
                ? ((this.isScrollbarXUsingBottom = !1),
                  (this.scrollbarXTop = Y(b.top)))
                : (this.isScrollbarXUsingBottom = !0),
              (this.railBorderXWidth =
                Y(b.borderLeftWidth) + Y(b.borderRightWidth)),
              e(this.scrollbarXRail, { display: "block" }),
              (this.railXMarginWidth = Y(b.marginLeft) + Y(b.marginRight)),
            ...
            (this.scrollbarYRight = parseFloat(v.right, 10)),
              isNaN(this.scrollbarYRight)
                ? ((this.isScrollbarYUsingRight = !1),
                  (this.scrollbarYLeft = Y(v.left)))
              ...
              (this.scrollbarYOuterWidth = this.isRtl
                ? (function (e) {
                    ...
                    return (
                      ...
                      Y(r.paddingRight) +
                      Y(r.borderLeftWidth) +
                      Y(r.borderRightWidth)
                    );
                  })(this.scrollbarY)
                : null),
              (this.railBorderYWidth =
                Y(v.borderTopWidth) + Y(v.borderBottomWidth)),
              e(this.scrollbarYRail, { display: "block" }),
              (this.railYMarginHeight = Y(v.marginTop) + Y(v.marginBottom)),
          ...
          (R.prototype.update = function () {
            this.isAlive &&
              ...
              (this.railXMarginWidth =
                Y(t(this.scrollbarXRail).marginLeft) +
                Y(t(this.scrollbarXRail).marginRight)),
              (this.railYMarginHeight =
                Y(t(this.scrollbarYRail).marginTop) +
                Y(t(this.scrollbarYRail).marginBottom)),
    ...
    471: function (t, e, r) {
      ...
      var i = r(177),
        n = r.n(i);
      r.d(e, "PerfectScrollbar", function () {
        return n.a;
      });
    },
  })
