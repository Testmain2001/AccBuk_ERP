      ...
      !(function (e) {
        ...
        function a(e, t, i) {
          ...
          for (var s = Object.keys(t), n = 0, o = e.length; n < o; n++)
            for (
              var r = e[n].querySelectorAll("*"), a = 0, c = r.length;
              a < c;
              a++
            ) {
              var d = r[a],
          ...
          (function (t) {
            if ("Element" in t) {
              ...
              if (s.defineProperty) {
                ...
                s.prototype.__defineGetter__ &&
                  i.__defineGetter__("classList", n);
            }
          })(window);
        var d,
          h,
            ...
            if (i.is("select")) {
              ...
              if ((l.title && (l.placeholder = l.title), r)) {
                ...
                (p.template = e.extend(
                  ...
                  i.data("selectpicker", (r = new te(this, p)));
              }
              "string" == typeof o &&
                (s =
                  r[o] instanceof Function ? r[o].apply(r, n) : r.options[o]);
            }
          });
          return void 0 !== s ? s : a;
        }
          ...
          (te.prototype = {
            ...
            init: function () {
              ...
              _++,
                ...
                this.checkDisabled(),
                this.clickListener(),
                V.major > 4 && (this.dropdown = new U(this.$button[0])),
                ...
                if (s) l = this.$menuInner[0].scrollTop;
                  ...
                  if ("number" == typeof h && !1 !== r.options.size) {
                    ...
                    u &&
                      (l =
                        u -
                        (r.sizeInfo.menuInnerHeight + r.sizeInfo.liHeight) / 2);
                  }
                }
              function f(e, i) {
                var s,
                  ...
                  g,
                  b,
                  w = r.selectpicker.current.data.length,
                  I = [],
                  x = !0,
                  k = r.isVirtual();
                (r.selectpicker.view.scrollTop = e),
                  (s = r.options.chunkSize),
                  (l = Math.ceil(w / s) || 1);
                for (var y = 0; y < l; y++) {
                  var $ = (y + 1) * s;
                  if (
                  ...
                  void 0 === p &&
                    e - 1 <=
                      r.selectpicker.current.data[$ - 1].position -
                ...
                if (
                  ...
                  (m =
                    u[0] !== r.selectpicker.view.position0 ||
                    u[1] !== r.selectpicker.view.position1),
                  void 0 !== r.activeIndex &&
                    ((o = (r.selectpicker.main.data[r.prevActiveIndex] || {})
                      .element),
                    (c = (r.selectpicker.main.data[r.activeIndex] || {})
                      .element),
                    (n = (r.selectpicker.main.data[r.selectedIndex] || {})
                      .element),
                    i &&
                      (r.activeIndex !== r.selectedIndex && r.defocusItem(c),
                  ...
                  if (
                    ((v = r.selectpicker.view.visibleElements
                    ...
                    (t || (!1 === k && i)) &&
                      ((g = v),
                      (b = r.selectpicker.view.visibleElements),
                      (x = !(
                        g.length === b.length &&
                      ...
                      r.options.sanitize &&
                        ...
                        (N =
                          r.selectpicker.current.data[
                            y + r.selectpicker.view.position0
                          ]) &&
                        N.content &&
                        !N.sanitized &&
                    ...
                    if (
                      (r.options.sanitize &&
                        z.length &&
                        a(z, r.options.whiteList, r.options.sanitizeFn),
                      !0 === k
                        ? ((S =
                          ...
                          (E =
                            r.selectpicker.view.position1 > w - 1
                              ? 0
                      ...
                      !0 === k && r.sizeInfo.hasScrollBar)
                    ) {
                      var P = C.firstChild.offsetWidth;
                      if (
                        i &&
                        P < r.sizeInfo.menuInnerInnerWidth &&
                        r.sizeInfo.totalMenuWidth > r.sizeInfo.selectWidth
                      )
                        C.firstChild.style.minWidth =
                          r.sizeInfo.menuInnerInnerWidth + "px";
                      else if (P > r.sizeInfo.menuInnerInnerWidth) {
                        r.$menu[0].style.minWidth = 0;
                        var W = C.firstChild.offsetWidth;
                        W > r.sizeInfo.menuInnerInnerWidth &&
                          ((r.sizeInfo.menuInnerInnerWidth = W),
                          (C.firstChild.style.minWidth =
                            r.sizeInfo.menuInnerInnerWidth + "px")),
                  ...
                  ((!t && r.options.source.load) ||
                    (t && r.options.source.search)) &&
                    p === l - 1 &&
                    r.fetchData(
                      function () {
                        r.render(),
                      ...
                      t ? "search" : "load",
                      p + 1,
                      t ? r.selectpicker.search.previousValue : void 0
                    );
                }
                if (
                  ((r.prevActiveIndex = r.activeIndex), r.options.liveSearch)
                ) {
                  if (t && i) {
                    var B,
                      M = 0;
                    r.selectpicker.view.canHighlight[M] ||
                      (M =
                        1 +
                        r.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                      (B = r.selectpicker.view.visibleElements[M]),
                      r.defocusItem(r.selectpicker.view.currentActive),
                      (r.activeIndex = (
                        r.selectpicker.current.data[M] || {}
                      ).index),
                      r.focusItem(B);
                  }
              ...
              f(l, !0),
                ...
                e(window)
                  ...
                  .on(
                    ...
                    function () {
                      r.$newElement.hasClass(G.SHOW) &&
                        f(r.$menuInner[0].scrollTop);
                    }
                  );
            },
            ...
            buildData: function (e, t) {
              ...
              function d(e, t) {
                if (
                  (((t = t || {}).divider = i(e, "divider")), !0 === t.divider)
                )
                  c({ optID: t.optID });
                else {
                  var s = n.length + o,
              ...
              function h(t, o) {
                ...
                if (u.length) {
                  ...
                  r++, h && c({ optID: r }), (g.optID = r), n.push(g);
            ...
            render: function (e) {
              ...
              if (
                ...
                ((t =
                  ...
                  l > 1) &&
                  (t =
                    ((i = this.options.selectedTextFormat.split(">")).length >
                      1 &&
                      l > i[1]) ||
                    (1 === i.length && l >= 2)),
                !1 === t)
                ...
                var x = this.$element[0].querySelectorAll(
                  ...
                  k =
                    "function" == typeof this.options.countSelectedText
                      ? this.options.countSelectedText(l, x)
            ...
            liHeight: function (t) {
              if (
                ...
                if (
                  ...
                  (i = K.li.cloneNode(!1)), c.appendChild(d), i.appendChild(c);
                if (
            ...
            getSelectPosition: function () {
              ...
              this.options.container && n.length && !n.is("body")
                ? (((t = n.offset()).top += parseFloat(
                    n.css("borderTopWidth")
                  )),
                  (t.left += parseFloat(n.css("borderLeftWidth"))))
                : (t = { top: 0, left: 0 });
            ...
            setMenuSize: function (e) {
              ...
              if (
                (this.options.dropupAuto &&
                  ((l = d * this.selectpicker.current.data.length + v.vert),
                  (a =
                    this.sizeInfo.selectOffsetTop -
                      this.sizeInfo.selectOffsetBot >
              ...
              var t,
                ...
                r = function (r) {
                  ...
                  n.$bsContainer
                    ...
                    .toggleClass(G.DROPUP, r.hasClass(G.DROPUP)),
                    (t = r.offset()),
                    o.is("body")
                      ? (i = { top: 0, left: 0 })
                      : (((i = o.offset()).top +=
                          parseFloat(o.css("borderTopWidth")) - o.scrollTop()),
                        (i.left +=
                          parseFloat(o.css("borderLeftWidth")) -
                          o.scrollLeft())),
                    (s = r.hasClass(G.DROPUP) ? 0 : r[0].offsetHeight),
                    (V.major < 4 || "static" === a) &&
                      ((l.top = t.top - i.top + s), (l.left = t.left - i.left)),
            ...
            keydown: function (t) {
              var i,
                ...
                c = (a ? l.closest(".dropdown") : l.closest(q.MENU)).data(
                  "this"
                ),
                d = c.findLis(),
                h = !1,
              ...
              if (!(t.which >= 112 && t.which <= 123))
                if (
                  ...
                  if (
                    ...
                    (!l.is("input") && !Y.test(t.which)) ||
                    (t.which === W && c.selectpicker.keydown.keyHistory)
                  ) {
                    var g,
                      b,
                      w = [];
                    ...
                    for (
                      var I = 0;
                      I < c.selectpicker.current.data.length;
                      I++
                    ) {
                    ...
                    if (w.length) {
                      ...
                      d.removeClass("active").find("a").removeClass("active"),
                        ...
                        f - (o = c.selectpicker.main.data[g]).position > 0
                          ? ((r = o.position - o.height), (h = !0))
                          : ((r = o.position - c.sizeInfo.menuInnerHeight),
                  ...
                  s &&
                    ...
                    (t.which !== W && t.preventDefault(),
                    (c.options.liveSearch && t.which === W) ||
