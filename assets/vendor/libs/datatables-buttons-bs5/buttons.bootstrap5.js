        ...
        void 0 ===
          (i = function (t) {
            return (function (t, n, e, o) {
              ...
              return (
                t.extend(!0, i.Buttons.defaults, {
                  dom: {
                    container: { className: "dt-buttons btn-group flex-wrap" },
                    // button: { className: "btn btn-secondary" },
                    button: { className: "btndt btn-light" },
                    collection: {
                      tag: "div",
                  ...
                  buttonCreated: function (n, e) {
                    return n.buttons
                      ? t('<div class="btn-group"/>').append(e)
                      : e;
                  },
                }),
                (i.ext.buttons.collection.className += " dropdown-toggle"),
                (i.ext.buttons.collection.rightAlignClassName =
                  "dropdown-menu-right"),
                i.Buttons
              );
            })(t, window, document);
          ...
          (i = function (t) {
            return (function (t, n, e, o) {
              ...
              return (
                ...
                (i.ext.renderer.pageButton.bootstrap = function (
                  n,
                  s,
                  r,
                  a,
                  ...
                  var c,
                    ...
                    p = new i.Api(n),
                    b = n.oClasses,
                    h = n.oLanguage.oPaginate,
                    g = n.oLanguage.oAria.paginate || {},
                    m = 0,
                    v = function (e, o) {
                      var i,
                        s,
                        ...
                        y = function (n) {
                          n.preventDefault(),
                            t(n.currentTarget).hasClass("disabled") ||
                              p.page() == n.data.action ||
                              p.page(n.data.action).draw("page");
                        };
                      for (i = 0, s = o.length; i < s; i++)
                        if (((f = o[i]), Array.isArray(f))) v(e, f);
                        else {
                          switch (((c = ""), (d = ""), f)) {
                            case "ellipsis":
                              (c = "&#x2026;"), (d = "disabled");
                          ...
                          c &&
                            ((a = t("<li>", {
                              ...
                              .appendTo(e)),
                            n.oApi._fnBindAction(a, { action: f }, y),
                            m++);
                        }
                    };
                  try {
                    f = t(s).find(e.activeElement).data("dt-idx");
                  } catch (t) {}
                  v(
                    t(s)
                      .empty()
          ...
          (i = function (t) {
            return (function (t, n, e, o) {
              ...
              function u(n, e, o) {
                t.fn.animate
                  ? n.stop().fadeIn(e, o)
                  : (n.css("display", "block"), o && o.call(n));
              }
              function l(n, e, o) {
                t.fn.animate
                  ? n.stop().fadeOut(e, o)
                  : (n.css("display", "none"), o && o.call(n));
              }
              var c,
                d = function (n, e) {
              ...
              t.extend(d.prototype, {
                action: function (t, n) {
                  ...
                  return n === o ? e.conf.action : ((e.conf.action = n), this);
                },
                active: function (n, e) {
                ...
                add: function (t, n) {
                  ...
                  if ("string" == typeof n) {
                    for (
                      ...
                      s = s.buttons[1 * i[r]];
                    (e = s.buttons), (n = 1 * i[i.length - 1]);
                  }
                  return (
                    this._expandButton(e, t, s !== o, n), this._draw(), this
                  );
                },
                container: function () {
                ...
                destroy: function () {
                  ...
                  for (n = 0, e = o.length; n < e; n++) this.remove(o[n].node);
                ...
                processing: function (n, e) {
                  ...
                  return e === o
                    ? t(s.node).hasClass("processing")
                    : (t(s.node).toggleClass("processing", e),
                      t(i.table().node()).triggerHandler(
                        "buttons-processing.dt",
                        [e, i.button(n), i, t(n), s.conf]
                      ),
                      this);
                },
                remove: function (n) {
                  ...
                  e.conf.destroy &&
                    e.conf.destroy.call(i.button(n), i, t(n), e.conf),
                ...
                text: function (n, e) {
                  var i = this._nodeToButton(n),
                    ...
                    r =
                      i.inCollection && s && s.tag
                        ? s.tag
                        : this.c.dom.buttonLiner.tag,
                    a = this.s.dt,
                    u = t(i.node),
                    l = function (t) {
                      return "function" == typeof t ? t(a, u, i.conf) : t;
                    };
                  return e === o
                    ? l(i.conf.text)
                    : ((i.conf.text = e),
                      r ? u.children(r).html(l(e)) : u.html(l(e)),
                      this);
                },
                _constructor: function () {
                  ...
                  i._buttons || (i._buttons = []),
                    i._buttons.push({ inst: this, name: this.c.name });
                  for (var r = 0, a = s.length; r < a; r++) this.add(s[r]);
                  o.on("destroy", function (t, e) {
                    ...
                    t("body").on("keyup." + this.s.namespace, function (t) {
                      if (!e.activeElement || e.activeElement === e.body) {
                        ...
                        -1 !== n.s.listenKeys.toLowerCase().indexOf(o) &&
                          n._keypress(o, t);
                      }
                    });
                },
                _addKey: function (n) {
                  n.key &&
                    (this.s.listenKeys += t.isPlainObject(n.key)
                      ? n.key.key
                      : n.key);
                },
                _draw: function (t, n) {
                ...
                _expandButton: function (n, e, i, s) {
                  for (
                    var r = this.s.dt,
                    ...
                    if (c)
                      if (Array.isArray(c)) this._expandButton(n, c, i, s);
                      else {
                        ...
                        d &&
                          ...
                          c.init &&
                            c.init.call(r.button(d.node), r, t(d.node), c));
                      }
                  }
                },
                _buildButton: function (n, e) {
                  var i = this.c.dom.button,
                    s = this.c.dom.buttonLiner,
                    a = this.c.dom.collection,
                    u = this.s.dt,
                    l = function (t) {
                      return "function" == typeof t ? t(u, p, n) : t;
                    };
                  if (
                    (e && a.button && (i = a.button),
                    e && a.buttonLiner && (s = a.buttonLiner),
                  ...
                  var c = function (n, e, o, i) {
                    ...
                    p = t("<" + d + "/>")
                      ...
                      .on("click.dtb", function (t) {
                        t.preventDefault(),
                          !p.hasClass(i.disabled) && n.action && c(t, u, p, n),
                          f && p.trigger("blur");
                      })
                      .on("keyup.dtb", function (t) {
                        13 === t.keyCode &&
                          !p.hasClass(i.disabled) &&
                          n.action &&
                          c(t, u, p, n);
                      });
                  if (
                    ("a" === d.toLowerCase() && p.attr("href", "#"),
                    "button" === d.toLowerCase() && p.attr("type", "button"),
                    s.tag)
                  ) {
                    var b = t("<" + s.tag + "/>")
                      .html(l(n.text))
                      .addClass(s.className);
                    "a" === s.tag.toLowerCase() && b.attr("href", "#"),
                      p.append(b);
                  } else p.html(l(n.text));
                  !1 === n.enabled && p.addClass(i.disabled),
                    n.className && p.addClass(n.className),
                    n.titleAttr && p.attr("title", l(n.titleAttr)),
                    n.attr && p.attr(n.attr),
                  ...
                  return (
                    (h =
                      g && g.tag
                        ...
                        : p),
                    this._addKey(n),
                    this.c.buttonCreated && (h = this.c.buttonCreated(n, h)),
                    {
                      conf: n,
                      node: p.get(0),
                      inserter: h,
                ...
                _keypress: function (n, e) {
                  if (!e._buttonsHandled) {
                    var o = function (o, i) {
                        if (o.key)
                          if (o.key === n)
                            (e._buttonsHandled = !0), t(i).click();
                          else if (t.isPlainObject(o.key)) {
                            if (o.key.key !== n) return;
                            if (o.key.shiftKey && !e.shiftKey) return;
                            if (o.key.altKey && !e.altKey) return;
                            if (o.key.ctrlKey && !e.ctrlKey) return;
                            if (o.key.metaKey && !e.metaKey) return;
                            (e._buttonsHandled = !0), t(i).click();
                          }
                      },
                      i = function (t) {
                ...
                _removeKey: function (n) {
                  if (n.key) {
                    var e = t.isPlainObject(n.key) ? n.key.key : n.key,
                      ...
                      i = t.inArray(e, o);
                    o.splice(i, 1), (this.s.listenKeys = o.join(""));
                  }
                },
                _resolveExtends: function (n) {
                  var e,
                    ...
                    r = function (e) {
                      for (
                        var i = 0;
                        !t.isPlainObject(e) && !Array.isArray(e);
                        ...
                        if ("function" == typeof e) {
                          ...
                          if (!a[e]) throw "Unknown button type: " + e;
                          e = a[e];
                        }
                        if (++i > 30) throw "Buttons: Too many iterations";
                      }
                  ...
                  for (n = r(n); n && n.extend; ) {
                    ...
                    if (c) {
                      for (
                        n.buttons || (n.buttons = []), e = 0, i = c.length;
                        e < i;
                        e++
                      )
                        n.buttons.push(c[e]);
                    ...
                    if (d) {
                      for (
                        n.buttons || (n.buttons = []), e = 0, i = d.length;
                        e < i;
                        e++
                      )
                ...
                _popover: function (o, i, s) {
                  var r = i,
                    ...
                    f = i.node(),
                    p = function () {
                      l(t(".dt-button-collection"), c.fade, function () {
                        t(this).detach();
                      }),
                        t(
                          r
                  ...
                  (o = t(o)
                    ...
                    f.parents("body")[0] !== e.body && (f = e.body.lastChild),
                    c.collectionTitle &&
                      h.prepend(
                    ...
                    u(h.insertAfter(f), c.fade);
                  var g = t(i.table().container()),
                    m = h.css("position");
                  if (
                    ("dt-container" === c.align &&
                      ((f = f.parent()), h.css("width", g.width())),
                    "absolute" === m)
                  ) {
                    var v = f.position(),
                      y = t(i.node()).position();
                    h.css({ top: y.top + f.outerHeight(), left: v.left });
                    var x = h.outerHeight(),
                    ...
                    var N = g.offset().left,
                      ...
                      S = P + f.outerWidth();
                    if (
                      h.hasClass(c.rightAlignClassName) ||
                      h.hasClass(c.leftAlignClassName) ||
                      "dt-container" === c.align
                    ) {
                      var O,
                        K,
                      ...
                      h.hasClass(c.rightAlignClassName)
                        ? N > H + (j = S - L) &&
                          (j += (O = N - (H + j)) > (K = B - (L + j)) ? K : O)
                        : B < L + (j = N - H) &&
                          (j += (O = N - (H + j)) > (K = B - (L + j)) ? K : O),
                        h.css("left", h.position().left + j);
                    } else {
                      var D = f.offset().top;
                      (j = 0),
                        (j = "button-right" === c.align ? S - L : P - H),
                        h.css("left", h.position().left + j);
                    }
                  } else
                    (D = h.height() / 2) > t(n).height() / 2 &&
                      (D = t(n).height() / 2),
                      h.css("marginTop", -1 * D);
                  c.background &&
                    d.background(!0, c.backgroundClassName, c.fade, f),
                    ...
                    t("body")
                      .on("click.dtb-collection", function (n) {
                        ...
                        ((!t(n.target).parents()[e]().filter(o).length &&
                          !t(i).hasClass("dt-buttons")) ||
                    ...
                    t(h).trigger("buttons-popover.dt");
                },
              }),
                ...
                (d.instanceSelector = function (n, e) {
                  ...
                  var i = [],
                    ...
                    r = function (n) {
                      if (Array.isArray(n))
                        for (var o = 0, a = n.length; o < a; o++) r(n[o]);
                      else if ("string" == typeof n)
                        if (-1 !== n.indexOf(",")) r(n.split(","));
                        else {
                          var u = t.inArray(n.trim(), s);
                          -1 !== u && i.push(e[u].inst);
                        }
                      else "number" == typeof n && i.push(e[n].inst);
                    };
                  return r(n), i;
                }),
                (d.buttonSelector = function (n, e) {
                  for (
                    var i = [],
                      s = function (t, n, e) {
                        for (var i, r, a = 0, u = n.length; a < u; a++)
                          (i = n[a]) &&
                            ((r = e !== o ? e + a : a + ""),
                            t.push({ node: i.node, name: i.conf.name, idx: r }),
                      ...
                      r = function (n, e) {
                        ...
                        if (Array.isArray(n) || n instanceof t)
                          for (a = 0, u = n.length; a < u; a++) r(n[a], e);
                        else if (null === n || n === o || "*" === n)
                          for (a = 0, u = l.length; a < u; a++)
                            i.push({ inst: e, node: l[a].node });
                        else if ("number" == typeof n)
                          i.push({ inst: e, node: e.s.buttons[n].node });
                        else if ("string" == typeof n)
                          if (-1 !== n.indexOf(",")) {
                            var d = n.split(",");
                            ...
                            var f = t.map(l, function (t) {
                              return t.idx;
                            });
                            i.push({ inst: e, node: l[t.inArray(n, f)].node });
                            ...
                            t(c)
                              .filter(n)
                              .each(function () {
                                i.push({ inst: e, node: this });
                              });
                        else if ("object" == typeof n && n.nodeName) {
                          var b = t.inArray(n, c);
                          -1 !== b && i.push({ inst: e, node: c[b] });
                        }
                      },
                      a = 0,
                      u = n.length;
                ...
                t.extend(a, {
                  ...
                  pageLength: function (n) {
                    var e = n.settings()[0].aLengthMenu,
                      o = [],
                      i = [];
                    if (Array.isArray(e[0])) (o = e[0]), (i = e[1]);
                    else
                      for (var s = 0; s < e.length; s++) {
                        var r = e[s];
                        t.isPlainObject(r)
                          ? (o.push(r.value), i.push(r.label))
                          : (o.push(r), i.push(r));
                      }
                    return {
                      extend: "collection",
                      ...
                      buttons: t.map(o, function (t, n) {
                        return {
                          ...
                          init: function (n, e, o) {
                            ...
                            n.on("length.dt" + o.namespace, s), s();
                          },
                    ...
                    function (e) {
                      if (e._buttons)
                        return d.buttonSelector(
                          d.instanceSelector(t, e._buttons),
                          n
                        );
                    },
                    !0
                ...
                i.Api.register("button()", function (t, n) {
                  ...
                  return e.length > 1 && e.splice(1, e.length), e;
                }),
                ...
                i.Api.register("buttons().containers()", function () {
                  ...
                  return (
                    this.iterator(!0, "table", function (t) {
                      if (t._buttons)
                        for (
                          var o = d.instanceSelector(e, t._buttons),
                            i = 0,
                            s = o.length;
                          i < s;
                          i++
                ...
                i.Api.register("buttons.info()", function (n, e, i) {
                  ...
                  return !1 === n
                    ? (this.off("destroy.btn-info"),
                      l(t("#datatables_buttons_info"), 400, function () {
                        t(this).remove();
                      }),
                      clearTimeout(c),
                      (c = null),
              ...
              var f = function (n) {
                  var e =
                    ...
                    "" !== n.title
                      ...
                      : n.filename;
                  if (
                    ("function" == typeof e && (e = e()), e === o || null === e)
                  )
                    return null;
                  -1 !== e.indexOf("*") &&
                ...
                b = function (n) {
                  ...
                  return null === e
                    ...
                    ? e.replace(
                        "*",
                        t("head > title").text() || "Exported data"
                      )
                    : e;
                },
                h = function (n, e, o) {
                ...
                m = function (n, e) {
                  ...
                  n.select &&
                    ...
                    a.selected === o &&
                    n.rows(i.rows, t.extend({ selected: !0 }, a)).any() &&
                    t.extend(a, { selected: !0 });
                  for (
                    var u = n.rows(i.rows, a).indexes().toArray(),
                      l = n.cells(u, i.columns),
                      c = l.render(i.orthogonal).toArray(),
                      f = l.nodes().toArray(),
                      p = s.length,
                      b = [],
                      h = 0,
                    ...
                    for (var v = [p], y = 0; y < p; y++)
                      (v[y] = i.format.body(c[h], g, y, f[h])), h++;
                    b[g] = v;
                  }
                  var x = { header: s, footer: r, body: b };
                  return i.customizeData && i.customizeData(x), x;
                };
              function v(t, n) {
                var e = new i.Api(t),
              ...
              return (
                ...
                i.ext.feature.push({ fnInit: v, cFeature: "B" }),
