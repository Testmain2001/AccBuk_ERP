    ...
    var e = {
        luhn: function (e) {
          for (
            ...
            (r += n[i][parseFloat(e.charAt(t), 10)]), (i = 1 - i);
          return r % 10 == 0 && r > 0;
        },
        mod11And10: function (e) {
          for (var t = e.length, n = 5, i = 0; i < t; i++)
            n = (((2 * (n || 10)) % 11) + parseFloat(e.charAt(i), 10)) % 10;
          return 1 === n;
        },
  ...
  Ie.exports = (function () {
    ...
    var e = o,
      ...
      r = function (e, t, n) {
        ...
        if (a.length > 1) {
          var c = a[1].split(":"),
            u = c.length > 0 ? parseFloat(c[0], 10) : 0;
          l.setHours(d && "PM" === d.toUpperCase() && u < 12 ? u + 12 : u),
            l.setMinutes(c.length > 1 ? parseFloat(c[1], 10) : 0),
            l.setSeconds(c.length > 2 ? parseFloat(c[2], 10) : 0);
        }
        return l;
      },
      a = function (e, t) {
        ...
        return {
          validate: function (t) {
            ...
            if (window.File && window.FileList && window.FileReader) {
              ...
              if (
                t.options.maxFiles &&
                s > parseFloat("".concat(t.options.maxFiles), 10)
              )
                return { meta: { error: "INVALID_MAX_FILES" }, valid: !1 };
              if (
                t.options.minFiles &&
                s < parseFloat("".concat(t.options.minFiles), 10)
              )
              ...
              for (var d = {}, c = 0; c < s; c++) {
                if (
                  ...
                  t.options.minSize &&
                    a[c].size < parseFloat("".concat(t.options.minSize), 10))
                )
                  return {
                ...
                if (
                  t.options.maxSize &&
                  a[c].size > parseFloat("".concat(t.options.maxSize), 10)
                )
                  return {
              ...
              if (
                ...
                l > parseFloat("".concat(t.options.maxTotalSize), 10)
              )
                return {
                  meta: Object.assign(
                    {},
              ...
              if (
                ...
                l < parseFloat("".concat(t.options.minTotalSize), 10)
              )
                return {
                  meta: Object.assign(
                    {},
      ...
      (Dt.stringLength = function () {
        return {
          validate: function (e) {
            ...
            switch (
              (((o && s < parseFloat(o, 10)) || (a && s > parseFloat(a, 10))) &&
                (l = !1),
              !0)
            ) {
              case !!o && !!a:
