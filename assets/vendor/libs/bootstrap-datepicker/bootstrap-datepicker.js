            ...
            typeof (a = function (t, e) {
              ...
              var o,
                r =
                  ((o = {
                    ...
                    contains: function (t) {
                      for (
                        var e = t && t.valueOf(), i = 0, a = this.length;
                        i < a;
                        i++
                      )
                        if (
                          0 <= this[i].valueOf() - e &&
                          this[i].valueOf() - e < 864e5
                        )
                          return i;
                      return -1;
                    },
              ...
              h.prototype = {
                ...
                _resolveViewName: function (e) {
                  return (
                    t.each(m.viewModes, function (i, a) {
                      if (e === i || -1 !== t.inArray(e, a.names))
                        return (e = i), !1;
                    }),
                    e
                  );
                ...
                _resolveDaysOfWeek: function (e) {
                  return (
                    t.isArray(e) || (e = e.split(/[,\s]*/)), t.map(e, Number)
                  );
                },
                ...
                _process_options: function (e) {
                  ...
                  var s = (this.o = t.extend({}, this._o)),
                    n = s.language;
                  D[n] || ((n = n.split("-")[0]), D[n] || (n = f.language)),
                    (s.language = n),
                    ...
                    s.endDate !== 1 / 0 &&
                      (s.endDate
                        ? s.endDate instanceof Date
                          ? (s.endDate = this._local_to_utc(
                              this._zero_time(s.endDate)
                            ))
                          : (s.endDate = m.parseDate(
                              s.endDate,
                              o,
                              s.language,
                              s.assumeNearbyYear
                ...
                _local_to_utc: function (t) {
                  return (
                    t && new Date(t.getTime() - 6e4 * t.getTimezoneOffset())
                  );
                },
                ...
                _zero_utc_time: function (t) {
                  return (
                    t && i(t.getUTCFullYear(), t.getUTCMonth(), t.getUTCDate())
                  );
                },
                getDates: function () {
                ...
                place: function () {
                  ...
                  if (
                    ...
                    "top" === f
                      ? (p -= i + parseFloat(this.picker.css("padding-top")))
                      : (p += d),
                    this.o.rtl)
                  ) {
                    var g = s - (u + c);
                    this.picker.css({ top: p, right: g, zIndex: h });
                  } else this.picker.css({ top: p, left: u, zIndex: h });
                  return this;
                },
                _allow_update: !0,
                update: function () {
                    ...
                    for (
                      ...
                      (i += '<th class="dow'),
                        -1 !== t.inArray(e, this.o.daysOfWeekDisabled) &&
                          (i += " disabled"),
                        (i +=
                          '">' + D[this.o.language].daysMin[e++ % 7] + "</th>");
                    (i += "</tr>"),
                ...
                fillMonths: function () {
                  for (
                    ...
                    e +=
                      ...
                      '">' +
                      D[this.o.language].monthsShort[i] +
                      "</span>";
                ...
                _fill_yearsView: function (i, a, s, n, o, r, h) {
                  for (
                    ...
                    (l = [a]),
                      ...
                      (v < o || v > r) && l.push("disabled"),
                      v === m && l.push("focused"),
                      h !== t.noop &&
                        ((c = h(new Date(v, 0, 1))) === e
                          ? (c = {})
                          : "boolean" == typeof c
                          ? (c = { enabled: c })
                          : "string" == typeof c && (c = { classes: c }),
                        !1 === c.enabled && l.push("disabled"),
                      ...
                      (u +=
                        ...
                        v +
                        "</span>");
                  f.find(".datepicker-switch").text(g + "-" + D),
                    f.find("td").html(u);
                },
                fill: function () {
                  var s,
                    ...
                    u =
                      this.o.endDate !== 1 / 0
                        ...
                        : 1 / 0,
                    p = D[this.o.language].today || D.en.today || "",
                    f = D[this.o.language].clear || D.en.clear || "",
                    g = D[this.o.language].titleFormat || D.en.titleFormat,
                    y = a(),
                    v =
                      (!0 === this.o.todayBtn ||
                  ...
                  if (!isNaN(r) && !isNaN(h)) {
                    this.picker
                      ...
                      .text(m.formatDate(o, g, this.o.language)),
                      this.picker
                        .find("tfoot .today")
                        .text(p)
                        .css("display", v ? "table-cell" : "none"),
                      this.picker
                        .find("tfoot .clear")
                        .text(f)
                        .css(
                    ...
                    var w = i(r, h, 0),
                      k = w.getUTCDate();
                    w.setUTCDate(
                      k - ((w.getUTCDay() - this.o.weekStart + 7) % 7)
                    );
                    var b = new Date(w);
                    w.getUTCFullYear() < 100 &&
                      b.setUTCFullYear(w.getUTCFullYear()),
                      b.setUTCDate(b.getUTCDate() + 42),
                      (b = b.valueOf());
                    for (var _, C, T = []; w.valueOf() < b; ) {
                      if (
                        (_ = w.getUTCDay()) === this.o.weekStart &&
                        (T.push("<tr>"), this.o.calendarWeeks)
                      ) {
                        var M = new Date(
                            +w + ((this.o.weekStart - _ - 7) % 7) * 864e5
                          ),
                          U = new Date(
                            Number(M) + ((11 - M.getUTCDay()) % 7) * 864e5
                          ),
                          x = new Date(
                            Number((x = i(U.getUTCFullYear(), 0, 1))) +
                      ...
                      this.o.beforeShowDay !== t.noop &&
                        ((n = this.o.beforeShowDay(this._utc_to_local(w))) === e
                          ? (n = {})
                          : "boolean" == typeof n
                          ? (n = { enabled: n })
                          : "string" == typeof n && (n = { classes: n }),
                        !1 === n.enabled && C.push("disabled"),
                        n.classes && (C = C.concat(n.classes.split(/\s+/))),
                        n.tooltip && (s = n.tooltip),
                        n.content && (V = n.content)),
                        (C = t.isFunction(t.uniqueSort)
                          ? t.uniqueSort(C)
                          : t.unique(C)),
                        T.push(
                          '<td class="' +
                    ...
                    if (
                      (t.each(this.dates, function (t, e) {
                        e.getUTCFullYear() === r &&
                          O.eq(e.getUTCMonth()).addClass("active");
                      }),
                      (r < l || r > c) && O.addClass("disabled"),
                      r === l && O.slice(0, d).addClass("disabled"),
                      r === c && O.slice(u + 1).addClass("disabled"),
                      this.o.beforeShowMonth !== t.noop)
                    ) {
                      var A = this;
                      t.each(O, function (i, a) {
                        var s = new Date(r, i, 1),
                          n = A.o.beforeShowMonth(s);
                        n === e
                          ? (n = {})
                          : "boolean" == typeof n
                          ? (n = { enabled: n })
                ...
                navArrowsClick: function (e) {
                  ...
                  0 !== this.viewMode &&
                    (i *= 12 * m.viewModes[this.viewMode].navStep),
                ...
                moveAvailableDate: function (t, e, i) {
                  do {
                    if (((t = this[i](t, e)), !this.dateWithinRange(t)))
                      return !1;
                    i = "moveDay";
                ...
                setViewMode: function (t) {
                  (this.viewMode = t),
                    this.picker
                      ...
                      .hide()
                      .filter(
                        ".datepicker-" + m.viewModes[this.viewMode].clsName
                      )
                      .show(),
                    this.updateNavArrows(),
                    ...
                    if (a !== e) {
                      ...
                      if (-1 !== o) {
                        if (
                          ...
                          for (; h < l && s > this.dates[h]; )
                            this.pickers[h++].setUTCDate(s);
              ...
              var u = t.fn.datepicker,
                p = function (i) {
                  ...
                  if (
                    ...
                    a === e || a instanceof h || a instanceof l)
                  )
                    return this;
                  if (this.length > 1)
                    throw new Error(
                ...
                m = {
                  ...
                  parseDate: function (i, s, n, o) {
                    ...
                    var r,
                      ...
                      f = { yesterday: "-1d", today: "+0d", tomorrow: "+1d" };
                    if (
                      (i in f && (i = f[i]),
                    ...
                    if (
                      ...
                      for (c = 0, C = b.length; c < C; c++) {
                        if (((g = parseFloat(r[c], 10)), (l = b[c]), isNaN(g)))
                          switch (l) {
                            case "MM":
                              (y = t(D[n].months).filter(_)),
                                (g = t.inArray(y[0], D[n].months) + 1);
                              break;
                            case "M":
                              (y = t(D[n].monthsShort).filter(_)),
                                (g = t.inArray(y[0], D[n].monthsShort) + 1);
                          }
                        v[l] = g;
                      }
                  ...
                  formatDate: function (e, i, a) {
                    ...
                    for (
                      ...
                      n.length && e.push(n.shift()), e.push(s[i.parts[o]]);
                    return e.join("");
                  },
                  headTemplate:
              ...
              (m.template =
                ...
                t(document).on(
                  ...
                  function (e) {
                    var i = t(this);
                    i.data("datepicker") ||
                      (e.preventDefault(), p.call(i, "show"));
                  }
                ),
                t(function () {
