            ...
            return (function (t, n, e, o) {
              ...
              t.extend(d.prototype, {
                ...
                active: function (n, e) {
                  ...
                  return e === o
                    ? s.hasClass(r)
                    : (s.toggleClass(r, e === o || e), this);
                },
                add: function (t, n) {
                  var e = this.s.buttons;
                  if ("string" == typeof n) {
                    for (
                      var i = n.split("-"), r = this.s, s = 0, a = i.length - 1;
                      s < a;
                      s++
                    )
                      r = r.buttons[1 * i[s]];
                    (e = r.buttons), (n = 1 * i[i.length - 1]);
                  }
                  return (
                    this._expandButton(e, t, r !== o, n), this._draw(), this
                  );
                },
                container: function () {
                ...
                processing: function (n, e) {
                  ...
                  return e === o
                    ...
                    : (t(r.node).toggleClass("processing", e),
                ...
                remove: function (n) {
                  var e = this._nodeToButton(n),
                    ...
                    i = this.s.dt;
                  if (e.buttons.length)
                    for (var r = e.buttons.length - 1; r >= 0; r--)
                ...
                text: function (n, e) {
                  ...
                  return e === o
                    ? l(i.conf.text)
                    : ((i.conf.text = e),
                      s ? u.children(s).html(l(e)) : u.html(l(e)),
                      this);
                },
                _constructor: function () {
                  ...
                  for (var s = 0, a = r.length; s < a; s++) this.add(r[s]);
                ...
                _expandButton: function (n, e, i, r) {
                  for (
                    ...
                    if (c)
                      if (Array.isArray(c)) this._expandButton(n, c, i, r);
                      else {
                        ...
                        d &&
                          ...
                          c.init &&
                            c.init.call(s.button(d.node), s, t(d.node), c));
                      }
                  }
                },
                _buildButton: function (n, e) {
                  var i = this.c.dom.button,
                    ...
                    u = this.s.dt,
                    l = function (t) {
                      return "function" == typeof t ? t(u, h, n) : t;
                    };
                  if (
                    (e && a.button && (i = a.button),
                    e && a.buttonLiner && (r = a.buttonLiner),
                  ...
                  var c = function (n, e, o, i) {
                    ...
                    h = t("<" + d + "/>")
                      ...
                      .on("click.dtb", function (t) {
                        t.preventDefault(),
                          !h.hasClass(i.disabled) && n.action && c(t, u, h, n),
                          f && h.trigger("blur");
                      })
                  ...
                  return (
                    (b =
                      g && g.tag
                        ...
                        : h),
                    this._addKey(n),
                    this.c.buttonCreated && (b = this.c.buttonCreated(n, b)),
                    {
                      conf: n,
                      node: h.get(0),
                      inserter: b,
                ...
                _popover: function (o, i, r) {
                  var s = i,
                    ...
                    h = function () {
                      l(t(".dt-button-collection"), c.fade, function () {
                        ...
                        s.off("buttons-action.b-internal");
                    };
                  !1 === o && h();
                  var p = t(
                    s
                  ...
                  if (
                    ("dt-container" === c.align &&
                      ((f = f.parent()), b.css("width", g.width())),
                    "absolute" === m)
                  ) {
                    var v = f.position(),
                      y = t(i.node()).position();
                    b.css({ top: y.top + f.outerHeight(), left: v.left });
                    var x = b.outerHeight(),
                    ...
                    if (
                      ...
                      b.hasClass(c.rightAlignClassName)
                        ? B > H + (j = S - L) &&
                          (j += (P = B - (H + j)) > (K = N - (L + j)) ? K : P)
                        : N < L + (j = B - H) &&
                          (j += (P = B - (H + j)) > (K = N - (L + j)) ? K : P),
                        b.css("left", b.position().left + j);
                    } else {
                      var D = f.offset().top;
                      (j = 0),
                        (j = "button-right" === c.align ? S - L : O - H),
                        b.css("left", b.position().left + j);
                    }
                  } else
                    (D = b.height() / 2) > t(n).height() / 2 &&
                      (D = t(n).height() / 2),
                      b.css("marginTop", -1 * D);
                  c.background &&
                ...
                (d.instanceSelector = function (n, e) {
                  ...
                  var i = [],
                    ...
                    s = function (n) {
                      if (Array.isArray(n))
                        for (var o = 0, a = n.length; o < a; o++) s(n[o]);
                      else if ("string" == typeof n)
                        if (-1 !== n.indexOf(",")) s(n.split(","));
                        else {
                          var u = t.inArray(n.trim(), r);
                          -1 !== u && i.push(e[u].inst);
                        }
                ...
                (d.buttonSelector = function (n, e) {
                  for (
                    var i = [],
                      r = function (t, n, e) {
                        for (var i, s, a = 0, u = n.length; a < u; a++)
                          (i = n[a]) &&
                            ((s = e !== o ? e + a : a + ""),
                            t.push({ node: i.node, name: i.conf.name, idx: s }),
                            i.buttons && r(t, i.buttons, s + "-"));
                      },
                      s = function (n, e) {
                        var a,
                          u,
                        ...
                        if (Array.isArray(n) || n instanceof t)
                          for (a = 0, u = n.length; a < u; a++) s(n[a], e);
                      ...
                      buttons: t.map(o, function (t, n) {
                        return {
                          ...
                          init: function (n, e, o) {
                            ...
                            n.on("length.dt" + o.namespace, r), r();
                          },
                ...
                m = function (n, e) {
                  ...
                  for (
                    ...
                    for (var v = [h], y = 0; y < h; y++)
                      (v[y] = i.format.body(c[b], g, y, f[b])), b++;
                    p[g] = v;
                  }
