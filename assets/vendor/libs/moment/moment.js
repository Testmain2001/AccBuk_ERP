  ...
  (function (e) {
      ...
      (function (e) {
        e.exports = (function () {
          ...
          function M(e, a) {
            ...
            return (
              d(a, "toString") && (e.toString = a.toString),
          ...
          function z(e, a) {
            ...
            for (O.lastIndex = 0; t >= 0 && O.test(e); )
              (e = e.replace(O, s)), (O.lastIndex = 0), (t -= 1);
            return e;
          }
          var N = {};
          function J(e, a) {
          ...
          function K(e, a) {
            return function (t) {
              return null != t
                ? (Z(this, e, t), n.updateOffset(this, a), this)
                : q(this, e);
            };
          }
          function q(e, a) {
          ...
          function ze(e, a, t) {
            ...
            return (
              i < 1
                ? (s = i + Ne((n = e.year() - 1), a, t))
                : i > Ne(e.year(), a, t)
                ? ((s = i - Ne(e.year(), a, t)), (n = e.year() + 1))
                : ((n = e.year()), (s = i)),
              { week: s, year: n }
            );
          }
          ...
          function da(e, a) {
            if (null !== a) {
              ...
              if (((a.abbr = e), null != aa[e]))
                ...
                if (null != aa[a.parentLocale]) s = aa[a.parentLocale]._config;
                else {
          ...
          function ya(e) {
            var a,
              ...
              i,
              d = e._i,
              _ = ua.exec(d) || ma.exec(d);
            if (_) {
              for (c(e).iso = !0, a = 0, t = Ma.length; a < t; a++)
                if (Ma[a][1].exec(_[1])) {
                  (n = Ma[a][0]), (s = !1 !== Ma[a][2]);
                  break;
                }
          ...
          function pa(e) {
            ...
            if (o) {
              if (
                ...
                d && _.push(parseFloat(d, 10)),
                (a = _),
                !(function (e, a, t) {
                  return (
                    !e ||
                    Ce.indexOf(e) === new Date(a[0], a[1], a[2]).getDay() ||
            ...
            if (e._f !== n.ISO_8601)
              if (e._f !== n.RFC_2822) {
                ...
                var a,
                  ...
                  u = 0;
                for (
                  s = z(e._f, e._locale).match(P) || [], a = 0;
                  a < s.length;
                  a++
                )
                  (r = s[a]),
                    (t = (_.match(ce(r, e)) || [])[0]) &&
                      ((i = _.substr(0, _.indexOf(t))).length > 0 &&
                        c(e).unusedInput.push(i),
          ...
          function xa(e) {
            ...
            (this._isValid = (function (e) {
              ...
              for (a in e)
                if (
                  d(e, a) &&
                  (-1 === Ye.call(ja, a) || (null != e[a] && isNaN(e[a])))
                )
                  return !1;
          ...
          function Fa(e, a) {
            ...
            return a._isUTC
              ? ((t = a.clone()),
                (s =
                  (D(e) || m(e) ? e.valueOf() : va(e).valueOf()) - t.valueOf()),
                  ...
                  (n =
                    r.isValid() && i.isValid()
                      ? ((i = Fa(i, r)),
                        r.isBefore(i)
                          ? (_ = Ua(r, i))
                          : (((_ = Ua(i, r)).milliseconds = -_.milliseconds),
                            (_.months = -_.months)),
                        _)
          ...
          function Xa(e) {
            ...
            return void 0 === e
              ? this._locale._abbr
              : (null != (a = _a(e)) && (this._locale = a), this);
          }
          ...
          E("N", 0, 0, "eraAbbr"),
            ...
            he("GGGGG", _e, te),
            he("ggggg", _e, te),
            pe(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, a, t, s) {
              a[s.substr(0, 2)] = B(e);
            }),
          ...
          (Lt.add = Ba),
            (Lt.calendar = function (e, a) {
              1 === arguments.length &&
                (arguments[0]
                  ? Za(arguments[0])
                    ...
                    : $a(arguments[0]) && ((a = arguments[0]), (e = void 0))
                  : ((e = void 0), (a = void 0)));
              var t = e || va(),
              ...
              return this.format(
                i || this.localeData().calendar(r, this, va(t))
              );
            }),
            (Lt.clone = function () {
              return new k(this);
            ...
            (Lt.diff = function (e, a, t) {
              ...
              switch (
                ((n = 6e4 * (s.utcOffset() - this.utcOffset())), (a = R(a)))
              ) {
                case "year":
                  r = Qa(this, s) / 12;
                  break;
            ...
            "undefined" != typeof Symbol &&
              null != Symbol.for &&
              (Lt[Symbol.for("nodejs.util.inspect.custom")] = function () {
            ...
            (Lt.hour = Lt.hours = Xe),
            (Lt.minute = Lt.minutes = mt),
            (Lt.second = Lt.seconds = ht),
            ...
            (Lt.utcOffset = function (e, a, t) {
              ...
              if (null != e) {
                ...
                return (
                  !this._isUTC && a && (s = za(this)),
                  (this._offset = e),
                  (this._isUTC = !0),
                  null != s && this.add(s, "m"),
                  r !== e &&
                    (!a || this._changeInProgress
                      ? Va(this, Ca(e - r, "m"), 1, !1)
          ...
          function pt(e, a, t) {
            if ((u(e) && ((a = e), (e = void 0)), (e = e || ""), null != a))
              return ft(e, a, t, "month");
            var s,
              n = [];
          ...
          (yt.calendar = function (e, a, t) {
            ...
            (yt.preparse = Yt),
            (yt.postformat = Yt),
            (yt.relativeTime = function (e, a, t, s) {
            ...
            (yt.erasAbbrRegex = function (e) {
              return (
                d(this, "_erasAbbrRegex") || it.call(this),
                e ? this._erasAbbrRegex : this._erasRegex
              );
            }),
            (yt.erasNameRegex = function (e) {
              return (
                d(this, "_erasNameRegex") || it.call(this),
                e ? this._erasNameRegex : this._erasRegex
              );
            }),
            (yt.erasNarrowRegex = function (e) {
              return (
                d(this, "_erasNarrowRegex") || it.call(this),
            ...
            (yt.months = function (e, a) {
              return e
                ? r(this._months)
                  ...
                  : this._months[
                      (this._months.isFormat || we).test(a)
                        ? "format"
                        : "standalone"
                    ][e.month()]
                : r(this._months)
            ...
            (yt.monthsShort = function (e, a) {
              return e
                ? r(this._monthsShort)
                  ...
                  : this._monthsShort[we.test(a) ? "format" : "standalone"][
                      e.month()
                    ]
                : r(this._monthsShort)
                ? this._monthsShort
            ...
            (yt.weekdaysRegex = function (e) {
              return this._weekdaysParseExact
                ? (d(this, "_weekdaysRegex") || Ke.call(this),
          ...
          function Zt() {
            ...
            return m
              ? ((e = V(_ / 60)),
                ...
                (n = m < 0 ? "-" : ""),
                (r = qt(this._months) !== qt(m) ? "-" : ""),
                (i = qt(this._days) !== qt(m) ? "-" : ""),
                (d = qt(this._milliseconds) !== qt(m) ? "-" : ""),
                n +
                  "P" +
                  (t ? r + t + "Y" : "") +
                  (u ? r + u + "M" : "") +
          ...
          return (
            ...
            ($t.abs = function () {
              var e = this._data;
              return (
                (this._milliseconds = Dt(this._milliseconds)),
            ...
            ($t.as = function (e) {
              ...
              if ("month" === (e = R(e)) || "quarter" === e || "year" === e)
                switch (
                  ((a = this._days + s / 864e5), (t = this._months + wt(a)), e)
                ) {
                  case "month":
                    return t;
                  case "quarter":
                ...
                switch (((a = this._days + Math.round(vt(this._months))), e)) {
                  case "week":
                    return a / 7 + s / 6048e5;
                  case "day":
                    return a + s / 864e5;
            ...
            (n.updateLocale = function (e, a) {
              if (null != a) {
                var t,
                  s,
                  n = ea;
                null != aa[e] && null != aa[e].parentLocale
                  ? aa[e].set(H(aa[e]._config, a))
                ...
                null != aa[e] &&
                  (null != aa[e].parentLocale
                    ? ((aa[e] = aa[e].parentLocale), e === ia() && ia(e))
      ...
      !(function (e) {
        ...
        function t(e, t, s, n) {
          ...
          switch (s) {
            ...
            case "ss":
              return a(e)
                ? r + (t || n ? "sekúndur" : "sekúndum")
                : r + "sekúnda";
            case "m":
              return t ? "mínúta" : "mínútu";
            case "mm":
              return a(e)
                ? r + (t || n ? "mínútur" : "mínútum")
                : t
                ? r + "mínúta"
                : r + "mínútu";
            case "hh":
              return a(e)
                ? r + (t || n ? "klukkustundir" : "klukkustundum")
                : r + "klukkustund";
            case "d":
      ...
      !(function (e) {
        ...
        e.defineLocale("ja", {
          ...
          eraYearOrdinalParse: function (e, a) {
            return "元" === a[1] ? 1 : parseFloat(a[1] || e, 10);
          },
    ...
    function (e, a, t) {
      !(function (e) {
        ...
        function t(e) {
          if (((e = parseFloat(e, 10)), isNaN(e))) return !1;
          if (e < 0) return !0;
          ...
          ordinal: function (e, t) {
            switch (t) {
              ...
              default:
                ...
                var s = e % 10;
                return (
                  e + (a[s] || a[(e % 100) - s] || a[e >= 100 ? 100 : null])
                );
            }
          },
          week: { dow: 1, doy: 7 },
