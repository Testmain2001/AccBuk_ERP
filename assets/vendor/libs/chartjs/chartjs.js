  ...
  (function (t) {
    ...
    32: function (t, e, i) {
      ...
      t.exports = (function () {
        ...
        function Oe(t, e, i, n) {
          const o = [];
          return Gt(e, t.chartArea, t._minPadding)
            ? (De(
                t,
                i,
                e,
        ...
        function Ce(t, e, i, n, o) {
          ...
          return Gt(e, t.chartArea, t._minPadding)
            ? (De(t, i, e, function (i, l, c) {
                ...
                if (
                  !Gt(h, t.chartArea, t._minPadding) &&
                  !i.inRange(e.x, e.y, o)
                )
                  return;
                const d = s(e, h);
                d < a
                  ...
                  : d === a &&
                    r.push({ element: i, datasetIndex: l, index: c });
              }),
              r)
            : r;
        }
        ...
        var Ae = {
          modes: {
            index(t, e, i, n) {
              const o = Se(e, t),
                s = i.axis || "x",
                a = i.intersect ? Oe(t, o, s, n) : Ce(t, o, s, !1, n),
                r = [];
              return a.length
            ...
            dataset(t, e, i, n) {
              const o = Se(e, t),
                s = i.axis || "xy";
              let a = i.intersect ? Oe(t, o, s, n) : Ce(t, o, s, !1, n);
              if (a.length > 0) {
            ...
            point: (t, e, i, n) => Oe(t, Se(e, t), i.axis || "xy", n),
            nearest: (t, e, i, n) =>
              Ce(t, Se(e, t), i.axis || "xy", i.intersect, n),
        ...
        const an = {
          ...
          color(t, e, i) {
            const n = W(t || "transparent"),
              o = n.valid && W(e || "transparent");
        ...
        class rn {
          constructor(t, e, i, n) {
            ...
            (this._active = !0),
              (this._fn = t.fn || an[t.type || typeof s]),
        ...
        const ln = Object.keys(xt.animation);
        ...
        function mn(t, e) {
          ...
          for (let t = 0; t < d; ++t) {
            const i = e[t],
              { [l]: n, [c]: s } = i;
            (u = (i._stacks || (i._stacks = {}))[c] = gn(o, h, n)),
              (u[r] = s),
              (u._top = pn(u, a, !0)),
              (u._bottom = pn(u, a, !1));
          }
        ...
        class vn {
          ...
          initialize() {
            ...
            this.configure(),
              this.linkScales(),
              (t._stacked = fn(t.vScale, t)),
              this.addElements();
          }
          updateIndex(t) {
            this.index !== t && bn(this._cachedMeta), (this.index = t);
          }
          linkScales() {
            const t = this,
              e = t.chart,
              ...
              s = (i.xAxisID = K(n.xAxisID, xn(e, "x"))),
              a = (i.yAxisID = K(n.yAxisID, xn(e, "y"))),
              r = (i.rAxisID = K(n.rAxisID, xn(e, "r"))),
              l = i.indexAxis,
          ...
          _destroy() {
            const t = this._cachedMeta;
            this._data && he(this._data, this), t._stacked && bn(t);
          }
          _dataCheck() {
            const t = this,
              e = t.getDataset(),
          ...
          buildOrUpdateElements(t) {
            ...
            e._dataCheck();
            const s = i._stacked;
            (i._stacked = fn(i.vScale, i)),
              i.stack !== n.stack && ((o = !0), bn(i), (i.stack = n.stack)),
              e._resyncElements(t),
              (o || s !== i._stacked) && mn(e, i._parsed);
          }
          configure() {
            const t = this,
              e = t.chart.config,
          ...
          applyStack(t, e, i) {
            const n = this.chart,
              ...
              s = e[t.axis];
            return un(
              { keys: dn(n, !0), values: e._stacks[t.axis] },
              s,
              o.index,
              { mode: i }
            );
          ...
          updateRangeFromParsed(t, e, i, n) {
            ...
            n &&
              ...
              (s = un(n, o, this._cachedMeta.index, { all: !0 }))),
              (t.min = Math.min(t.min, s)),
              (t.max = Math.max(t.max, s));
          }
          getMinMax(t, e) {
            const i = this,
              ...
              l = e && n._stacked && { keys: dn(i.chart, !0), values: null },
              c = {
          ...
          _resolveElementOptions(t, e = "default", i) {
            ...
            return (
              g.$shared && ((g.$shared = l), (s[a] = Object.freeze(yn(g, l)))),
              g
            );
          }
          _resolveAnimations(t, e, i) {
            ...
            const c = new cn(o, l && l.animations);
          ...
          includeOptions(t, e) {
            return !e || _n(t) || this.chart._animationsDisabled;
          }
          ...
          updateSharedOptions(t, e, i) {
            t && !_n(e) && this._resolveAnimations(void 0, e).update(t, i);
          }
          _setStyle(t, e, i, n) {
            t.active = n;
        ...
        const Mn = {
          ...
          logarithmic(t, e, i) {
            ...
            return 1 === n || 2 === n || 5 === n
              ? Mn.numeric.call(this, t, e, i)
              : "";
          },
        };
        var kn = { formatters: Mn };
        function Sn(t, e) {
          ...
          if (s > 0) {
            ...
            for (Pn(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++)
              Pn(e, l, c, o[t], o[t + 1]);
            return Pn(e, l, c, r, $(n) ? e.length : r + n), l;
          }
          return Pn(e, l, c), l;
        }
        ...
        class Rn extends wn {
          ...
          update(t, e, i) {
            ...
            n._convertTicksToLabels(a ? On(n.ticks, s) : n.ticks),
              ...
              o.display &&
                ...
                ((n.ticks = Sn(n, n.ticks)), (n._labelSizes = null)),
          ...
          calculateLabelRotation() {
            ...
            const h = t._getLabelSizes(),
              d = h.widest.width,
              u = h.highest.height,
              f = jt(t.chart.width - d, 0, t.maxWidth);
            (a = e.offset ? t.maxWidth / n : f / (n - 1)),
              d + 6 > a &&
                ...
                (r =
                  ...
                  Tn(e.grid) -
                  i.padding -
                  An(e.title, t.chart.options.font)),
                (l = Math.sqrt(d * d + u * u)),
                (c = It(
                  Math.min(
                    Math.asin(jt((h.highest.height + 6) / a, -1, 1)),
                    Math.asin(jt(r / l, -1, 1)) - Math.asin(jt(u / l, -1, 1))
                  )
                )),
          ...
          fit() {
            const t = this,
              ...
              r = t.isHorizontal();
            if (a) {
              const a = An(o, i.options.font);
              if (
                (r
                  ? ((e.width = t.maxWidth), (e.height = Tn(s) + a))
                  : ((e.height = t.maxHeight), (e.width = Tn(s) + a)),
          ...
          getPixelForDecimal(t) {
            ...
            return Ht(e._alignToPixels ? Xt(e.chart, i, 0) : i);
          }
          ...
          _computeGridLineItems(t) {
            ...
            const O = K(o.ticks.maxTicksLimit, c),
              C = Math.max(1, Math.ceil(c / O));
            for (x = 0; x < c; x += C) {
          ...
          getLineWidthForValue(t) {
            ...
            return n >= 0 ? i.setContext(e.getContext(n)).lineWidth : 0;
          }
          drawGrid(t) {
            const e = this,
              i = e.options.grid,
          ...
          _layers() {
            ...
            return t._isVisible() && t.draw === Rn.prototype.draw
              ? [
                  {
                    z: n,
                    draw(e) {
        ...
        class En {
          ...
          unregister(t) {
            ...
            i in e && delete e[i],
              n &&
                i in xt[n] &&
                (delete xt[n][i], this.override && delete ft[i]);
          }
        }
        var In = new (class {
          constructor() {
            (this.controllers = new En(vn, "datasets", !0)),
              (this.elements = new En(wn, "elements")),
              (this.plugins = new En(Object, "plugins")),
              (this.scales = new En(Rn, "scales")),
        ...
        class zn {
          ...
          _createDescriptors(t, e) {
            const i = t && t.config,
              ...
              o = (function (t) {
                const e = [],
                  i = Object.keys(In.plugins.items);
                for (let t = 0; t < i.length; t++) e.push(In.getPlugin(i[t]));
                const n = t.plugins || [];
              ...
              ? (function (t, e, i, n) {
                  ...
                  for (let a = 0; a < e.length; a++) {
                    const r = e[a],
                      ...
                      c = Fn(i[l], n);
                    null !== c &&
                      o.push({ plugin: r, options: Bn(t.config, r, c, s) });
                  }
                  return o;
                })(t, o, n, e)
              : [];
        ...
        class Xn {
          constructor(t) {
            (this._config = (function (t) {
              return ((t = t || {}).data = jn(t.data)), Nn(t), t;
            })(t)),
          ...
          datasetScopeKeys(t) {
            return Yn(t, () => [["datasets." + t, ""]]);
          }
          datasetAnimationScopeKeys(t, e) {
            return Yn(`${t}.transition.${e}`, () => [
          ...
          getOptionScopes(t, e, i) {
            ...
            e.forEach((e) => {
              t && (r.add(t), e.forEach((e) => Un(r, t, e))),
                e.forEach((t) => Un(r, n, t)),
                e.forEach((t) => Un(r, ft[o] || {}, t)),
                e.forEach((t) => Un(r, xt, t)),
                e.forEach((t) => Un(r, gt, t));
            });
        ...
        const Kn = ["top", "bottom", "left", "right", "chartArea"];
        function Gn(t, e) {
          return (
            "top" === t || "bottom" === t || (-1 === Kn.indexOf(t) && "x" === e)
          );
        }
        function Zn(t, e) {
          return function (i, n) {
        ...
        class no {
          ...
          _initialize() {
            ...
            return (
              ...
              t.options.responsive
                ? t.resize()
                : we(t, t.options.devicePixelRatio),
              t.bindEvents(),
            ...
            i &&
              ...
              J(s, (i) => {
                const s = i.options,
                  ...
                  l = K(s.type, i.dtype);
                (void 0 !== s.position &&
                  Gn(s.position, r) === Gn(i.dposition)) ||
          ...
          _updateMetasets() {
            ...
            t._sortedMetasets = e.slice(0).sort(Zn("order", "index"));
          }
          ...
          buildOrUpdateControllers() {
            ...
            for (
              ...
              if (
                ...
                (s.type = a),
                (s.indexAxis = o.indexAxis || Vn(a, t.options)),
                (s.order = o.order || 0),
                (s.index = n),
                (s.label = "" + o.label),
                ...
                const i = In.getController(a),
                  { datasetElementType: o, dataElementType: r } =
                    xt.datasets[a];
                Object.assign(i.prototype, {
                  dataElementType: In.getElement(r),
                  datasetElementType: o && In.getElement(o),
                }),
        ...
        const oo = () => J(no.instances, (t) => t._plugins.invalidate());
        function so() {
          throw new Error(
        ...
        Object.defineProperties(no, {
          defaults: { enumerable: !0, value: xt },
          instances: { enumerable: !0, value: eo },
          overrides: { enumerable: !0, value: ft },
          registry: { enumerable: !0, value: In },
          version: { enumerable: !0, value: "3.5.1" },
          getChart: { enumerable: !0, value: io },
          register: {
            enumerable: !0,
            value: (...t) => {
              In.add(...t), oo();
            ...
            for (let d = e; d < e + i; d++) {
              const e = o.getParsed(d),
                ...
                m = {
                  ...
                  base: i.base,
                  enableBorderRadius:
                    !p || uo(e._custom) || a === p._top || a === p._bottom,
                  x: c ? i.head : g.center,
                  y: c ? g.center : i.head,
              ...
              f &&
                (m.options =
                  u ||
                  o.resolveDataElementOptions(d, t[d].active ? "active" : n)),
                fo(m, m.options || t[d].options, p, a),
          ...
          _calculateBarValuePixels(t) {
            ...
            if (
              ...
              Math.abs(h) < o &&
                ...
                d === s && (p -= h / 2),
                (c = p + h)),
              p === e.getPixelForValue(s))
            ) {
              const t = (Dt(h) * e.getLineWidthForValue(s)) / 2;
              (p += t), (h -= t);
            }
        ...
        class bo extends vn {
          ...
          _circumference(t, e) {
            ...
            return (e && i.animation.animateRotate) ||
              ...
              n.data[t].hidden
              ? 0
              : this.calculateCircumference((n._parsed[t] * o) / _t);
          }
          updateElements(t, e, i, n) {
            const o = this,
              s = "reset" === n,
          ...
          getLabelAndValue(t) {
            const e = this._cachedMeta,
              i = this.chart,
              n = i.data.labels || [],
              o = Ci(e._parsed[t], i.options.locale);
            ...
            for (let c = e; c < e + i; ++c) {
              ...
              (g.skip = isNaN(_) || isNaN(y) || b),
                ...
                d &&
                  (g.options =
                    h ||
                    o.resolveDataElementOptions(c, e.active ? "active" : n)),
        ...
        class yo extends vn {
          ...
          getLabelAndValue(t) {
            const e = this._cachedMeta,
              i = this.chart,
              n = i.data.labels || [],
              o = Ci(e._parsed[t].r, i.options.locale);
            return { label: n[t] || "", value: o };
          }
          update(t) {
            const e = this._cachedMeta.data;
          ...
          updateElements(t, e, i, n) {
            ...
            for (f = e; f < e + i; f++) {
              ...
              (g = m),
                s &&
                  (l.animateScale && (x = 0), l.animateRotate && (i = m = u));
              const b = {
                x: h,
                y: d,
                innerRadius: 0,
                ...
                startAngle: i,
                endAngle: m,
                options: o.resolveDataElementOptions(
                  f,
                  e.active ? "active" : n
                ),
              };
        ...
        var ko = Object.freeze({
          ...
          BarController: mo,
          BubbleController: xo,
          DoughnutController: bo,
          LineController: _o,
          PolarAreaController: yo,
          PieController: vo,
          RadarController: wo,
          ScatterController: Mo,
        });
        function So(t, e, i) {
          const {
            startAngle: n,
        ...
        function Po(t, e, i, n) {
          const o = Ie(t.options.borderRadius, [
            ...
            r = (t) => {
              ...
              return jt(t, 0, Math.min(s, e));
            };
          return {
            outerStart: r(o.outerStart),
            outerEnd: r(o.outerEnd),
            innerStart: jt(o.innerStart, 0, a),
            innerEnd: jt(o.innerEnd, 0, a),
          };
        }
        function Do(t, e, i, n) {
        ...
        function Oo(t, e, i, n, o) {
          ...
          if ((t.lineTo(C.x, C.y), y > 0)) {
            const e = Do(P, O, s, a);
            t.arc(e.x, e.y, y, m + Mt, O + Math.PI);
          }
        ...
        class To extends wn {
          ...
          draw(t) {
            ...
            const r = (function (t, e, i, n) {
              ...
              return Oo(t, e, i, n, r), t.fill(), r;
            })(t, e, a, s);
            Co(t, e, a, s, r), t.restore();
          }
        }
        function Ao(t, e, i = e) {
        ...
        function Eo(t, e, i, n) {
          const { points: o, options: s } = e,
            { count: a, start: r, loop: l, ilen: c } = Ro(o, i, n),
            h = (function (t) {
              return t.stepped
                ? Jt
        ...
        function Io(t, e, i, n) {
          const o = e.points,
            { count: s, start: a, ilen: r } = Ro(o, i, n),
        ...
        (To.id = "arc"),
          ...
          (To.defaultRoutes = { backgroundColor: "backgroundColor" });
        const Fo = "function" == typeof Path2D;
        function Bo(t, e, i, n) {
          Fo && 1 === e.segments.length
            ? (function (t, e, i, n) {
                let o = e._path;
                o ||
        ...
        class Vo extends wn {
          ...
          get segments() {
            return (
              this._segments ||
              (this._segments = Fi(this, this.options.segment))
            );
          }
          first() {
          ...
          interpolate(t, e) {
            const i = this.options,
              n = t[e],
              o = this.points,
              s = zi(this, { property: e, start: n, end: n });
            if (!s.length) return;
            const a = [],
              r = (function (t) {
                return t.stepped
        ...
        class qo extends wn {
          ...
          inXRange(t, e) {
            return Yo(this, t, null, e);
          }
          inYRange(t, e) {
            return Yo(this, null, t, e);
          }
          getCenterPoint(t) {
            const {
              x: e,
            ...
            t.data.datasets.forEach((e, o) => {
              ...
              let h,
                { start: d, count: u } = (function (t, e) {
                  ...
                  return (
                    l && (o = jt(se(e, s.axis, a).lo, 0, i - 1)),
                    (n = c ? jt(se(e, s.axis, r).hi + 1, o, i) - o : i - o),
                    { start: o, count: n }
                  );
                })(r, l);
              if (u <= (i.threshold || 4 * n)) Go(e);
              else {
                switch (
                  ($(s) &&
                    ((e._data = l),
          ...
          const { chart: e, scale: i, index: n, line: o } = t,
            ...
            l = (function (t, e) {
              ...
              for (let t = 0; t < n.length; t++) {
                const o = n[t];
                if (o.index === e) break;
                os(o) && i.unshift(o.dataset);
              }
              return i;
            })(e, n);
          l.push(rs({ x: null, y: i.bottom }, o));
          for (let t = 0; t < a.length; t++) {
            const e = a[t];
            for (let t = e.start; t <= e.end; t++) ss(s, r[t], l);
          }
          return new Vo({ points: s, options: {} });
        }
        const os = (t) => "line" === t.type && !t.hidden;
        function ss(t, e, i) {
          const n = [];
          for (let o = 0; o < i.length; o++) {
            const s = i[o],
              { first: a, last: r, point: l } = as(s, e, "x");
            if (!(!l || (a && r)))
              if (a) n.unshift(l);
          ...
          const { line: i, target: n, property: o, color: s, scale: a } = e,
            r = (function (t, e, i) {
              ...
              for (const t of n) {
                ...
                const c = zi(e, l);
                for (const e of c) {
                  const n = hs(i, s[e.start], s[e.end], e.loop),
                    r = Ii(t, o, n);
                  for (const t of r)
                    a.push({
                      source: t,
                      target: e,
                      start: { [i]: ds(l, n, "start", Math.max) },
                      end: { [i]: ds(l, n, "end", Math.min) },
                    });
                }
              }
              return a;
        ...
        function ps(t, e, i) {
          const n = (function (t) {
              ...
              if ("stack" === i) return ns(t);
              if ("shape" === i) return !0;
              const o = es(t);
              return o instanceof ts ? o : rs(o, n);
            })(e),
            ...
            (function (t, e) {
              ...
              t.save(),
                "x" === l &&
                  ...
                  t.save(),
                  cs(t, n, a.bottom)),
                gs(t, { line: i, target: n, color: s, scale: r, property: l }),
                t.restore();
            })(t, {
              line: o,
              target: n,
        ...
        var ms = {
          ...
          afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
              (l = o[a]),
                l && !1 !== l.fill && (l.fill = ls(o, a, i.propagate));
          },
          beforeDraw(t, e, i) {
            ...
            for (let e = o.length - 1; e >= 0; --e) {
              const i = o[e].$filler;
              i &&
                (i.line.updateControlPoints(s, i.axis), n && ps(t.ctx, i, s));
            }
          },
        ...
        class bs extends wn {
          ...
          fit() {
            ...
            const n = e.labels,
              ...
              { boxWidth: r, itemHeight: l } = xs(n, s);
            let c, h;
            (i.font = o.string),
              t.isHorizontal()
          ...
          _fitRows(t, e, i, n) {
            ...
            return (
              this.legendItems.forEach((t, f) => {
                ...
                (0 === f || l[l.length - 1] + g + 2 * a > s) &&
                  ((h += c),
                  (l[l.length - (f > 0 ? 0 : 1)] = 0),
                  (u += c),
                  d++),
                  (r[f] = { left: 0, top: u, row: d, width: g, height: n }),
                  (l[l.length - 1] += g + a);
              }),
              h
            );
            ...
            return (
              this.legendItems.forEach((t, s) => {
                ...
                s > 0 &&
                  ...
                  g++,
                  (d = u = 0)),
                  (r[s] = { left: f, top: u, col: g, width: p, height: n }),
                  (d = Math.max(d, p)),
                  (u += n + a);
              }),
              (h += d),
          ...
          _draw() {
            ...
            t.drawTitle(),
              ...
              (a.lineWidth = 0.5),
              (a.font = d.string);
            const { boxWidth: x, boxHeight: b, itemHeight: _ } = xs(l, g),
              y = t.isHorizontal(),
              ...
              h.setWidth(t.width),
                y
                  ? k > 0 &&
                    ...
                    ((C = m.y += w),
                    m.line++,
                    (O = m.x = o(r, t.left + f, t.right - n[m.line])))
                  : k > 0 &&
                    C + w > t.bottom &&
                    ((O = m.x = O + i[m.line].width + f),
                    m.line++,
                    (C = m.y =
                      o(r, t.top + v + f, t.bottom - i[m.line].height))),
                (function (t, e, i) {
                ...
                (O = s(P, O + x + p, y ? O + D : t.right, e.rtl)),
                (function (t, e, i) {
        ...
        var _s = {
          ...
          _element: bs,
          start(t, e, i) {
            const n = (t.legend = new bs({ ctx: t.ctx, options: i, chart: t }));
        ...
        var vs = {
          ...
          start(t, e, i) {
            !(function (t, e) {
              const i = new ys({ ctx: t.ctx, options: e, chart: t });
        ...
        var Ms = {
          id: "subtitle",
          start(t, e, i) {
            const n = new ys({ ctx: t.ctx, options: i, chart: t });
            ti.configure(t, n, i), ti.addBox(t, n), ws.set(t, n);
          },
          stop(t) {
            ti.removeBox(t, ws.get(t)), ws.delete(t);
          },
          beforeUpdate(t, e, i) {
            const n = ws.get(t);
            ti.configure(t, n, i), (n.options = i);
        ...
        function As(t, e, i, n) {
          ...
          const u = (function (t, e, i) {
            let { y: n, height: o } = t;
            return (
              "top" === e ? (n += i) : (n -= "bottom" === e ? o + i : o / 2), n
            );
          })(e, l, c);
          return (
            "center" === l
              ...
              ? (d -= h)
              : "right" === r && (d += h),
            { x: jt(d, 0, n.width - e.width), y: jt(u, 0, n.height - e.height) }
          );
        }
        function Ls(t, e, i) {
        ...
        class Is extends wn {
          ...
          getTitle(t, e) {
            ...
            let a = [];
            return (
              (a = Ss(a, Ps(n))), (a = Ss(a, Ps(o))), (a = Ss(a, Ps(s))), a
            );
          }
          getBeforeBody(t, e) {
            return Rs(e.callbacks.beforeBody.apply(this, [t]));
          }
          getBody(t, e) {
            const i = this,
              { callbacks: n } = e,
            ...
            return (
              J(t, (t) => {
                const e = { before: [], lines: [], after: [] },
                  s = Es(n, t);
                Ss(e.before, Ps(s.beforeLabel.call(i, t))),
                  Ss(e.lines, s.label.call(i, t)),
                  Ss(e.after, Ps(s.afterLabel.call(i, t))),
                  o.push(e);
              }),
              o
            );
          ...
          getAfterBody(t, e) {
            return Rs(e.callbacks.afterBody.apply(this, [t]));
          }
          getFooter(t, e) {
            const { callbacks: i } = e,
          ...
          update(t, e) {
            ...
            let s,
              a = [];
            if (o.length) {
              const t = ks[n.position].call(i, o, i._eventPosition);
              (a = i._createItems(n)),
          ...
          _drawColorBox(t, e, i, n, o) {
            ...
            if (o.usePointStyle) {
              ...
              Object.values(a).some((t) => 0 !== t)
                ? (t.beginPath(),
                  (t.fillStyle = o.multiKeyBackground),
                  ne(t, { x: e, y: f, w: l, h: r, radius: a }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = s.backgroundColor),
                  t.beginPath(),
                  ne(t, { x: i, y: f + 1, w: l - 2, h: r - 2, radius: a }),
                  t.fill())
                : ((t.fillStyle = o.multiKeyBackground),
                  t.fillRect(e, f, l, r),
          ...
          drawBody(t, e, i) {
            ...
            for (
              e.textAlign = a,
                ...
                J(n.beforeBody, g),
                u =
                  r && "right" !== p ? ("center" === a ? c / 2 + 1 : c + 2) : 0,
                _ = 0,
                v = o.length;
              _ < v;
              ++_
          ...
          _updateAnimationTarget(t) {
            const e = this,
              ...
              s = n && n.y;
            if (o || s) {
              const n = ks[t.position].call(e, e._active, e._eventPosition);
              if (!n) return;
              const a = (e._size = Os(e, t)),
        ...
        var zs = {
            ...
            positioners: ks,
            afterInit(t, e, i) {
              i && (t.tooltip = new Is({ _chart: t, options: i }));
            },
            beforeUpdate(t, e, i) {
        ...
        function Ws(t, e, { horizontal: i, minRotation: n }) {
          const o = Et(n),
        ...
        (Vs.id = "category"),
          (Vs.defaults = {
            ticks: { callback: Vs.prototype.getLabelForValue },
          });
        class Ns extends Rn {
          constructor(t) {
            super(t),
            ...
            const o = (function (t, e) {
              ...
              for (
                ...
                (d && v !== s
                  ? (i.push({ value: s }),
                    v < s && P++,
                    At(Math.round((v + P * k) * y) / y, s, Ws(s, _, t)) && P++)
                  : v < s && P++);
                P < M;
                ++P
              )
              ...
              return (
                x && d && w !== a
                  ? At(i[i.length - 1].value, a, Ws(a, _, t))
          ...
          getLabelForValue(t) {
            return Ci(t, this.chart.options.locale);
          }
        }
        class js extends Ns {
          determineDataLimits() {
        ...
        (js.id = "linear"),
          (js.defaults = { ticks: { callback: kn.formatters.numeric } });
        class $s extends Rn {
          constructor(t) {
            super(t),
              (this.start = void 0),
          ...
          parse(t, e) {
            const i = Ns.prototype.parse.apply(this, [t, e]);
          ...
          buildTicks() {
            const t = this,
              ...
              i = (function (t, e) {
                ...
                do {
                  o.push({ value: s, major: Hs(s) }),
                    ++r,
                    10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
                    (s = Math.round(r * Math.pow(10, a) * l) / l);
                } while (a < i || (a === i && r < n));
                const c = q(t.max, s);
                return o.push({ value: c, major: Hs(s) }), o;
          ...
          getLabelForValue(t) {
            return void 0 === t ? "0" : Ci(t, this.chart.options.locale);
          }
          configure() {
            const t = this.min;
            super.configure(),
        ...
        function Xs(t) {
          ...
          for (let c = 0; c < s; c++) {
            const s = t.options.pointLabels.setContext(
              t.getPointLabelContext(c)
            );
            o[c] = s.padding;
            ...
            (t._pointLabelItems = (function (t, e, i) {
              const n = [],
                ...
                r = t.getDistanceFromCenterForValue(
                  s.ticks.reverse ? t.min : t.max
                );
              for (let s = 0; s < o; s++) {
                const o = 0 === s ? a / 2 : 0,
                  d = t.getPointPosition(s, r + o + i[s]),
                  u = It(t.getIndexAngle(s)),
                  f = e[s],
                  g = Ks(d.y, f.h, u),
                  p = qs(u),
                  m =
        ...
        ($s.id = "logarithmic"),
          ($s.defaults = {
            ticks: {
              callback: kn.formatters.logarithmic,
              major: { enabled: !0 },
            },
          });
        class Qs extends Ns {
          ...
          generateTickLabels(t) {
            const e = this;
            Ns.prototype.generateTickLabels.call(e, t),
        ...
        (Qs.id = "radialLinear"),
          (Qs.defaults = {
            ...
            grid: { circular: !1 },
            startAngle: 0,
            ticks: { showLabelBackdrop: !0, callback: kn.formatters.numeric },
            pointLabels: {
          ...
          (Qs.descriptors = { angleLines: { _fallback: "grid" } });
        const Js = {
        ...
        function na(t, e, i, n) {
          const o = ta.length;
          for (let s = ta.indexOf(t); s < o - 1; ++s) {
            const t = Js[ta[s]],
        ...
        class aa extends Rn {
          ...
          buildTicks() {
            const t = this,
              ...
              n = e.ticks,
              o =
                "labels" === n.source ? t.getLabelTimestamps() : t._generate();
            "ticks" === e.bounds &&
              o.length &&
            ...
            return (
              (t._unit =
                i.unit ||
                (n.autoSkip
                  ? na(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
                  : (function (t, e, i, n, o) {
                      for (let s = ta.length - 1; s >= ta.indexOf(i); s--) {
                        const i = ta[s];
                        if (Js[i].common && t._adapter.diff(o, n, i) >= e - 1)
                          return i;
                      }
          ...
          initOffsets(t) {
            ...
            e.options.offset &&
              ...
              (o =
                1 === t.length ? 1 - i : (e.getDecimalForValue(t[1]) - i) / 2),
          ...
          _generate() {
            const t = this,
              ...
              o = t.options,
              s = o.time,
              a = s.unit || na(s.minUnit, i, n, t._getLabelCapacity(i)),
              r = K(s.stepSize, 1),
            ...
            for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) oa(h, d, g);
            return (
              (d !== n && "ticks" !== o.bounds && 1 !== u) || oa(h, d, g),
              Object.keys(h)
                .sort((t, e) => t - e)
                .map((t) => +t)
            );
          ...
          _getLabelCapacity(t) {
            const e = this,
              ...
              s = e._tickFormatFunction(t, 0, sa(e, [t], e._majorUnit), o),
              a = e._getLabelSize(s),
              r =
                Math.floor(e.isHorizontal() ? e.width / a.w : e.height / a.h) -
                1;
            return r > 0 ? r : 1;
          }
          getDataTimestamps() {
          ...
          getLabelTimestamps() {
            ...
            const o = t.getLabels();
            for (i = 0, n = o.length; i < n; ++i) e.push(ia(t, o[i]));
        ...
        class la extends aa {
          ...
          initOffsets() {
            ...
            (t._minPos = ra(i, t.min)),
              (t._tableRange = ra(i, t.max) - t._minPos),
              super.initOffsets(e);
          }
          buildLookupTable(t) {
          ...
          getValueForPixel(t) {
            const e = this,
              i = e._offsets,
              n = e.getDecimalForPixel(t) / i.factor - i.end;
            return ra(e._table, n * e._tableRange + e._minPos, !0);
          }
        }
        ...
        return (
          no.register(ko, ca, Ko, Fs),
          (no.helpers = { ...Ni }),
          (no._adapters = ro),
          (no.Animation = rn),
          (no.Animations = cn),
          (no.animator = a),
          (no.controllers = In.controllers.items),
          (no.DatasetController = vn),
          (no.Element = wn),
          (no.elements = Ko),
          (no.Interaction = Ae),
          (no.layouts = ti),
          ...
          (no.Scale = Rn),
          (no.Ticks = kn),
          Object.assign(no, ko, ca, Ko, Fs, sn),
          (no.Chart = no),
          "undefined" != typeof window && (window.Chart = no),
          no
        );
      })();
    },
