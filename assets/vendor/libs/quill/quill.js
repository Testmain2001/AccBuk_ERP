            ...
            return (function (t) {
              ...
              function (t, e, n) {
                ...
                function O(t, e) {
                  if (
                    ...
                    if (
                      ((e.theme = _.import("themes/" + e.theme)),
                      null == e.theme)
                    )
                      throw new Error(
                      ...
                      (function l(u, y) {
                        ...
                        if (Object.getOwnPropertySymbols) {
                          ...
                          for (m = 0; m < O.length; m++) {
                            var w = O[m];
                            (!(x = Object.getOwnPropertyDescriptor(u, w)) ||
                              x.enumerable ||
                              f) &&
                              ((v[w] = l(u[w], y - 1)),
                              x.enumerable ||
                        ...
                        if (f) {
                          ...
                          for (m = 0; m < E.length; m++) {
                            var x,
                              k = E[m];
                            ((x = Object.getOwnPropertyDescriptor(u, k)) &&
                              x.enumerable) ||
                              ((v[k] = l(u[k], y - 1)),
                  ...
                  m = (function (t) {
                    function e(t, n) {
                      ...
                      return (
                        ...
                        r.addBinding({ key: e.keys.ENTER, shiftKey: null }, x),
                        r.addBinding(
                          {
                            key: e.keys.ENTER,
                            metaKey: null,
                          ...
                          value: function (t, e) {
                            ...
                            (this.pickers = t.map(function (t) {
                              if (t.classList.contains("ql-align"))
                                return (
                                  null == t.querySelector("option") && x(t, b),
                          ...
                          case 0:
                            l + a > 1
                              ? (0 !== l &&
                                  0 !== a &&
                                  (0 !== (n = o(u, s)) &&
                                    (r - l - a > 0 && 0 == e[r - l - a - 1][0]
                                      ? (e[r - l - a - 1][1] += u.substring(
                                          0,
                                          n
                                        ))
                                ...
                                0 === l
                                  ? e.splice(r - a, l + a, [1, u])
                                  : 0 === a
                                  ? e.splice(r - l, l + a, [-1, s])
                                  : e.splice(r - l - a, l + a, [-1, s], [1, u]),
                                (r = r - l - a + (l ? 1 : 0) + (a ? 1 : 0) + 1))
                              : 0 !== r && 0 == e[r - 1][0]
              ...
              function (t, e, n) {
                ...
                var O = (0, c.default)("quill:clipboard"),
                  ...
                  x = [h.AlignAttribute, v.DirectionAttribute].reduce(function (
                    t,
                    e
                  ) {
                ...
                function M(t, e) {
                  ...
                  if (!j(t.parentNode).whiteSpace.startsWith("pre")) {
                    ...
                    (n = (n = n
                      ...
                      ((null == t.previousSibling && P(t.parentNode)) ||
                        (null != t.previousSibling && P(t.previousSibling))) &&
                        (n = n.replace(/^\s+/, r.bind(r, !1))),
                      ((null == t.nextSibling && P(t.parentNode)) ||
                        (null != t.nextSibling && P(t.nextSibling))) &&
                        (n = n.replace(/\s+$/, r.bind(r, !1)));
                  }
                  return e.insert(n);
                }
    ...
    19: function (t, e, n) {
      ...
      (function (t) {
        ...
        function m(t, e, n, r) {
          ...
          r > i / 2 && (r = i / 2);
          for (var l = 0; l < r; ++l) {
            var a = parseFloat(e.substr(2 * l, 2), 16);
            if (isNaN(a)) return l;
            t[n + l] = a;
          }
          return l;
        ...
        (s.prototype.slice = function (t, e) {
          ...
          (s.prototype.writeUIntLE = function (t, e, n, r) {
            ((t = +t), (e |= 0), (n |= 0), r) ||
              q(this, t, e, n, Math.pow(2, 8 * n) - 1, 0);
            var o = 1,
              i = 0;
    ...
    20: function (t, e, n) {
      ...
      (e.byteLength = function (t) {
        ...
        (e.fromByteArray = function (t) {
          for (
            var e, n = t.length, o = n % 3, i = [], l = 0, a = n - o;
            l < a;
            l += 16383
          )
            ...
            e = Math.abs(e),
              isNaN(e) || e === 1 / 0
                ...
                : ((l = Math.floor(Math.log(e) / Math.LN2)),
                  ...
                  (e += l + f >= 1 ? h / s : h * Math.pow(2, 1 - f)) * s >= 2 &&
                    (l++, (s /= 2)),
                  l + f >= c
                    ? ((a = 0), (l = c))
                    : l + f >= 1
