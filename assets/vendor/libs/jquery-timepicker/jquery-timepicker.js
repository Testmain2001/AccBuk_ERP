      ...
      (function (e) {
         ...
         */ !(function () {
          ...
          var h = function (e, t) {
            ...
            return (
              (n -=
                (null !== (i = t.minTime()) && void 0 !== i ? i : 0) %
                (60 * t.step)) >=
              30 * t.step
                ? (e += 60 * t.step - n)
                : (e -= n),
              (function (e, t) {
                if (86400 == e && t.show2400) return e;
                return e % 86400;
              })(e, t)
            );
          };
          var d,
            ...
            y = { bubbles: !0, cancelable: !1, detail: null },
            b = (function () {
              function e(t) {
                var i =
                ...
                o(this, e),
                  ...
                  (this.targetEl = t);
                var n = e.extractAttrOptions(t, Object.keys(g));
                this.settings = this.parseSettings(p(p(p({}, g), i), n));
              }
              var t, i, n;
              return (
                (t = e),
                (n = [
                  {
                    ...
                    value: function (e, t) {
                      ...
                      try {
                        for (s.s(); !(i = s.n()).done; ) {
                          var r = i.value;
                          r in e.dataset && (n[r] = e.dataset[r]);
                        }
                      } catch (e) {
                        s.e(e);
                      } finally {
                ...
                (i = [
                    ...
                    value: function () {
                      if (this.settings.useSelect) this.targetEl.blur();
                        ...
                        this.settings.selectOnBlur && this._selectValue(),
                          this.list.hide();
                        var t = new CustomEvent("hideTimepicker", y);
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      var t = !1;
                      return (
                        (e = this.settings.roundingFunction(e, this.settings)),
                        !!this.list &&
                          (this.list.find("li").each(function (i, n) {
                            var s = parseFloat(n.dataset.time);
                            if (!isNaN(s))
                              return s == e ? ((t = n), !1) : void 0;
                          }),
                          t)
                      );
                    },
                    ...
                    value: function (e, t) {
                      if ("INPUT" === this.targetEl.nodeName) {
                        ...
                        i.settings.useSelect &&
                          "select" != t &&
                          i.list &&
                          i.list.val(i._roundAndFormatTime(i.anytime2int(e)));
                      }
                      var n = new CustomEvent("selectTime", y);
                      if (this.selectedValue != e) {
                        this.selectedValue = e;
                        var s = new CustomEvent("changeTime", y),
                          r = new CustomEvent(
                            "change",
                            Object.assign(y, { detail: "timepicker" })
                          );
                        return (
                          "select" == t
                  ...
                  },
                  {
                    ...
                    value: function () {
                      this.settings;
                      var e = this.list.find(".ui-timepicker-selected");
                      if (e.hasClass("ui-timepicker-disabled")) return !1;
                      if (!e.length) return !0;
                      var t = e.get(0).dataset.time;
                      if (t) {
                        var i = parseFloat(t);
                        isNaN(i) || (t = i);
                      }
                      return (
                        null !== t &&
                          ("string" != typeof t && (t = this._int2time(t)),
                          this._setTimeValue(t, "select")),
                        !0
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      var i = e.match(t);
                      if (!i) return null;
                      var n = parseFloat(1 * i[3], 10),
                        s = i[2] || i[9],
                        r = n,
                        a = 1 * i[5] || 0,
                        o = 1 * i[7] || 0;
                      if (
                        (s || 2 != i[3].length || "0" != i[3][0] || (s = "am"),
                        n <= 12 && s)
                      ) {
                        var l =
                          (s = s.trim()) == this.settings.lang.pm ||
                          s == this.settings.lang.PM;
                        r = 12 == n ? (l ? 12 : 0) : n + (l ? 12 : 0);
                      } else if (
                        3600 * n + 60 * a + o >=
                        86400 + (this.settings.show2400 ? 1 : 0)
                      ) {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        ...
                        (e.minTime = this.intStringDateOrFunc2func(e.minTime)),
                        (e.maxTime = this.intStringDateOrFunc2func(e.maxTime)),
                        (e.durationTime = this.intStringDateOrFunc2func(
                          e.durationTime
                        )),
                        e.scrollDefault
                          ? (e.scrollDefault = this.intStringDateOrFunc2func(
                              e.scrollDefault
                            ))
                        ...
                        e.disableTimeRanges || (e.disableTimeRanges = []),
                        e.disableTimeRanges.length > 0)
                      ) {
                        for (var t in e.disableTimeRanges)
                          e.disableTimeRanges[t] = [
                            this.anytime2int(e.disableTimeRanges[t][0]),
                            this.anytime2int(e.disableTimeRanges[t][1]),
                          ];
                        for (
                          e.disableTimeRanges = e.disableTimeRanges.sort(
                            ...
                            t = e.disableTimeRanges.length - 1;
                          t > 0;
                          t--
                        )
                          e.disableTimeRanges[t][0] <=
                            e.disableTimeRanges[t - 1][1] &&
                            ((e.disableTimeRanges[t - 1] = [
                              Math.min(
                                e.disableTimeRanges[t][0],
                                e.disableTimeRanges[t - 1][0]
                              ),
                              Math.max(
                                e.disableTimeRanges[t][1],
                                e.disableTimeRanges[t - 1][1]
                            ...
                            e.disableTimeRanges.splice(t, 1));
                      }
                      return e;
                    },
                  },
                      ...
                      return (
                        s < 60
                          ...
                          : ((i = Math.floor(s / 60)),
                            ...
                            30 != t &&
                              n &&
                              (r.push(n), r.push(this.settings.lang.mins))),
                        r.join(" ")
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      var t = parseFloat(e % 60),
                        i = parseFloat((e / 60) % 60),
                        n = parseFloat((e / 3600) % 24),
                        s = new Date(1970, 0, 2, n, i, t, 0);
                      if (isNaN(s.getTime())) return null;
                      if ("function" == typeof this.settings.timeFormat)
                        return this.settings.timeFormat(s);
                      for (
                        var r, a, o = "", l = 0;
                        ...
                        switch ((a = this.settings.timeFormat.charAt(l))) {
                          ...
                          case "A":
                            ...
                            break;
                          case "g":
                            o += 0 == (r = s.getHours() % 12) ? "12" : r;
                            break;
                          case "G":
                            (r = s.getHours()),
                              86400 === e &&
                                (r = this.settings.show2400 ? 24 : 0),
                              (o += r);
                            break;
                          case "h":
                            0 != (r = s.getHours() % 12) &&
                          ...
                          case "H":
                            ...
                            break;
                          case "i":
                            o += (i = s.getMinutes()) > 9 ? i : "0" + i;
                            break;
                          case "s":
                            o += (t = s.getSeconds()) > 9 ? t : "0" + t;
                            break;
                          case "\\":
                      ...
                      if (null !== t) {
                        ...
                        if (i) {
                          var n = i.getBoundingClientRect(),
                            ...
                            r = n.top - s.top;
                          if (r + n.height > s.height || r < 0) {
                            var a = e.scrollTop() + (n.top - s.top) - n.height;
                            e.scrollTop(a);
                          }
                          var o = parseFloat(i.dataset.time);
                        ...
                        if (
                          ...
                          if (null !== n) {
                            ...
                            if (s) {
                              ...
                              var c = new CustomEvent("timeRangeError", y);
                              this.targetEl.dispatchEvent(c);
                            } else this._setTimeValue(u, t);
                          } else {
                            var p = new CustomEvent("timeFormatError", y);
                            this.targetEl.dispatchEvent(p);
                          }
                        }
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      return (
                        "object" == a(e)
                          ? ((i = e.label), (n = e.className), (s = e.value))
                          : "string" == typeof e
                          ? ((i = e), (s = ""))
                          : $.error("Invalid noneOption value"),
                        t
                          ? ((r = document.createElement("option")).value = s)
                          : ((r = document.createElement("li")).dataset.time =
                              String(s)),
                        (r.innerText = i),
                        r.classList.add(n),
                        r
            ...
            (d = function (e) {
              var t = {
                init: function (n) {
                  return this.each(function () {
                    ...
                    if (
                      ...
                      if ((r.prop("autocomplete", "off"), o.showOn))
                        for (var l in o.showOn)
                          r.on(o.showOn[l] + ".timepicker", t.show);
                      r.on("change.timepicker", a._handleFormatValue),
                        r.on("keydown.timepicker", s),
                        r.on("keyup.timepicker", a._handleKeyUp),
                        o.disableTextInput &&
                          r.on(
                            "keydown.timepicker",
                            a._disableTextInputHandler
                          ),
                        r.on("cut.timepicker", a._handleKeyUp),
                        r.on("paste.timepicker", a._handleKeyUp),
                ...
                show: function (t) {
                  ...
                  if ((t && t.preventDefault(), a.useSelect))
                    r.list.trigger("focus");
                  else {
                    r._hideKeyboard() && s.trigger("blur");
                    var o = r.list;
                    if (
                      !s.prop("readonly") &&
                      (i(s), (o = r.list), !b.isVisible(o))
                    ) {
                      s.is("input") && (r.selectedValue = s.val()),
                        r._setSelected(),
                        b.hideAll(),
                        "number" == typeof a.listWidth &&
                          o.width(s.outerWidth() * a.listWidth),
                        o.show();
                      var l = {};
                      ...
                      if (!u.length) {
                        var c = r.anytime2int(r._getTimeValue());
                        null !== c
                          ? (u = e(r._findRow(c)))
                          : a.scrollDefault() &&
                            (u = e(r._findRow(a.scrollDefault())));
                      }
                      if (
                        ((u.length && !u.hasClass("ui-timepicker-disabled")) ||
                          (u = o.find("li:not(.ui-timepicker-disabled):first")),
                        u && u.length)
                      ) {
                        var p =
                          o.scrollTop() + u.position().top - u.outerHeight();
                        o.scrollTop(p);
                      } else o.scrollTop(0);
                      return (
                  ...
                  return "string" == typeof t && void 0 === n
                    ...
                    : this.each(function () {
                        ...
                        "object" == a(t)
                          ...
                          (o = r.parseSettings(o)),
                          (r.settings = o),
                          r._formatValue({ type: "change" }, "initial"),
                          l && (l.remove(), (r.list = null)),
                          o.useSelect && i(s);
                      });
                },
                ...
                remove: function () {
                  if (this.hasClass("ui-timepicker-input")) {
                    ...
                    return (
                      ...
                      this.removeData("timepicker-obj"),
                      this.off(".timepicker"),
                      e.list && e.list.remove(),
              ...
              function i(i) {
                var n,
                  ...
                  l = a.settings;
                if (
                  (o && o.length && (o.remove(), (a.list = null)), l.useSelect)
                ) {
                  (o = e("<select></select>", {
                    class: "ui-timepicker-select",
                  })),
                    i.attr("name") &&
                      o.attr("name", "ui-timepicker-" + i.attr("name"));
                  var u = o;
                } else
                  (o = e("<ul></ul>", { class: "ui-timepicker-list" })),
                    (u = e("<div></div>", {
                ...
                if (l.noneOption)
                  if (
                    (!0 === l.noneOption &&
                      (l.noneOption = l.useSelect ? "Time..." : "None"),
                    e.isArray(l.noneOption))
                  ) {
                    for (var c in l.noneOption)
                      if (parseFloat(c, 10) == c) {
                        var p = a._generateNoneElement(
                          l.noneOption[c],
                          l.useSelect
                        );
                        o.append(p);
                    ...
                    (p = a._generateNoneElement(l.noneOption, l.useSelect)),
                      o.append(p);
                l.className && u.addClass(l.className),
                  (null === l.minTime && null === l.durationTime) ||
                    !l.showDuration ||
                    ("function" == typeof l.step || l.step,
                    u.addClass("ui-timepicker-with-duration"),
                    u.addClass("ui-timepicker-step-" + l.step));
                var f =
                    null !== (n = l.durationTime()) && void 0 !== n
                      ? n
                      : l.minTime(),
                  m = null !== (s = l.minTime()) && void 0 !== s ? s : 0,
                  d =
                    null !== (r = l.maxTime()) && void 0 !== r
                      ? r
                      : m + 86400 - 1;
                d < m && (d += 86400),
                  86399 === d &&
                    "string" === e.type(l.timeFormat) &&
                    l.show2400 &&
                    (d = 86400);
                var g = l.disableTimeRanges,
                  v = 0,
                  y = g.length,
                  b = l.step;
                "function" != typeof b &&
                  ...
                  (c = m);
                for (var k = 0; c <= d; c += 60 * b(++k)) {
                  var T,
                    w = c,
                    O = a._int2time(w);
                  if (
                    (l.useSelect
                      ? (T = e("<option></option>", { value: O })).text(O)
                      : ((T = e("<li></li>")).addClass(
                          w % 86400 < 43200
                            ? "ui-timepicker-am"
                            : "ui-timepicker-pm"
                        ),
                        T.attr("data-time", h(w, l)),
                        T.text(O)),
                    (null !== l.minTime() || null !== l.durationTime()) &&
                      l.showDuration)
                  ) {
                    var _ = a._int2duration(c - f, l.step);
                    if (l.useSelect) T.text(T.text() + " (" + _ + ")");
                    else {
                      var S = e("<span></span>", {
                  ...
                  v < y &&
                    ...
                    g[v] &&
                      ...
                      (l.useSelect
                        ? T.prop("disabled", !0)
                        : T.addClass("ui-timepicker-disabled"))),
                    o.append(T);
                }
                if ((u.data("timepicker-input", i), (a.list = u), l.useSelect))
                  i.val() &&
                    o.val(a._roundAndFormatTime(a.anytime2int(i.val()))),
                    o.on("focus", function () {
                      e(this)
                    ...
                    o.on("change", function () {
                      a._setTimeValue(e(this).val(), "select");
                    }),
                    a._setTimeValue(o.val(), "initial"),
                    i.hide().after(o);
                else {
                  var E = l.appendTo;
                  "string" == typeof E
              ...
              function s(i) {
                ...
                if (!r || !b.isVisible(r)) {
                  ...
                  t.show.call(n.get(0)),
                    (r = s.list),
                    s._hideKeyboard() || n.trigger("focus");
                }
                switch (i.keyCode) {
                  case 13:
                    return (
                      s._selectValue() &&
                        (s._formatValue({ type: "change" }), s.hideMe()),
                      i.preventDefault(),
                      !1
                    );
                  case 38:
                    var a = r.find(".ui-timepicker-selected");
                    return (
                      a.length
                        ? a.is(":first-child") ||
                          ...
                          a.prev().position().top < a.outerHeight() &&
                            r.scrollTop(r.scrollTop() - a.outerHeight()))
                        : (r.find("li").each(function (t, i) {
                  ...
                  case 40:
                    return (
                      0 === (a = r.find(".ui-timepicker-selected")).length
                        ? (r.find("li").each(function (t, i) {
                            if (e(i).position().top > 0) return (a = e(i)), !1;
                          }),
                          a.addClass("ui-timepicker-selected"))
              ...
              (e.fn.timepicker = function (i) {
                return this.length
                  ? t[i]
                    ...
                    : "object" !== a(i) && i
                    ? void e.error(
                        "Method " + i + " does not exist on jQuery.timepicker"
                      )
                    : t.init.apply(this, arguments)
                  : this;
              }),
                (e.fn.timepicker.defaults = g);
            }),
            "object" === a(t) && t && "object" === a(e) && e && e.exports === t
              ? d(i(1))
              : ((s = [i(1)]),
                void 0 ===
                  (r = "function" == typeof (n = d) ? n.apply(t, s) : n) ||
                  (e.exports = r));
        })();
      }).call(this, i(18)(e));
    },
