                    ...
                    this.jKanban = function () {
                      ...
                      function s(t) {
                        ...
                        if (e.options.itemHandleOptions.enabled)
                          if (
                            void 0 ===
                            (e.options.itemHandleOptions.customHandler ||
                              void 0)
                          ) {
                            var o =
                                e.options.itemHandleOptions.customCssHandler,
                              i =
                                e.options.itemHandleOptions
                      ...
                      arguments[0] &&
                                ...
                                .on("dragend", function (t) {
                                  !(function () {
                                    for (
                                      ...
                                      e.container.childNodes[n].dataset.order =
                                        t++;
                                  })(),
                              ...
                              (e.drake = e
                                ...
                                .on("drop", function (t, n, o, i) {
                                  ...
                                  void 0 !== r.dragTo &&
                                    -1 ===
                                      r.dragTo.indexOf(
                                        n.parentNode.dataset.id
                                      ) &&
                                    n.parentNode.dataset.id !==
                                      o.parentNode.dataset.id &&
                                    e.drake.cancel(!0),
                                    null !== t &&
                            ...
                            n || e.options.boards.push(p),
                              e.options.responsivePercentage ||
                                ("" === e.container.style.width
                                  ? (e.container.style.width =
                                      parseFloat(o) +
                                      2 * parseFloat(e.options.gutter) +
                                      "px")
                                  : (e.container.style.width =
                                      parseFloat(e.container.style.width) +
                                      parseFloat(o) +
                                      2 * parseFloat(e.options.gutter) +
                                      "px"));
                        ...
                        (this.getParentBoardID = function (t) {
                          return (
                            ...
                            null === t
                              ? null
                              : t.parentNode.parentNode.dataset.id
                          );
                        }),
                  ...
                  (function (n) {
                    (function () {
                      ...
                      function w(e, t) {
                        ...
                        return (
                          e in o && !(e in n) && o[e] in n && (e = o[e]), n[e]
                        );
                      }
                      t.exports = function (e, t) {
                        ...
                        function P(e) {
                          return (
                            -1 !== A.containers.indexOf(e) || I.isContainer(e)
                          );
                        }
                        function H(e) {
                          var t = e ? "remove" : "add";
                        ...
                        function Y(e) {
                          if (!((A.dragging && n) || P(e))) {
                            ...
                            var o = h(e);
                            if (o && !I.invalid(e, t) && I.moves(e, o, t, b(e)))
                        ...
                        function V() {
                          ...
                          U(),
                            n &&
                              (r.rm(I.mirrorContainer, "gu-unselectable"),
                        ...
                        function ee(e, t, n, o) {
                          var i,
                            r = "horizontal" === I.direction;
                          return t !== e
                            ? ((i = t.getBoundingClientRect()),
                              a(
                                r ? n > i.left + v(i) / 2 : o > i.top + m(i) / 2
                              ))
                            : (function () {
                                var t,
                                  i,
                                ...
                                for (t = 0; t < c; t++) {
                                  if (
                                    ((a = (i =
                                      e.children[t]).getBoundingClientRect()),
