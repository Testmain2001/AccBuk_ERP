  ...
  (function (t) {
    ...
    11: function (t, e) {
      ...
      function f() {
        l &&
          a &&
          ((l = !1), a.length ? (c = a.concat(c)) : (h = -1), c.length && d());
      }
      function d() {
        if (!l) {
          var t = u(f);
                  ...
                  return (
                    n.mixin(i.prototype, {
                      ...
                      set: function (t, e, i) {
                        return (
                          n.isNumber(i)
                            ? this._safeSet(this._ttlKey(t), s(r() + i))
              ...
              return (
                  ...
                  return {
                    ...
                    trigger: function (n) {
                      ...
                      for (
                        ...
                        (i = n.shift()) && (s = this._callbacks[i]);

                      )
                        (u = r(s.sync, this, [i].concat(o))),
                          (a = r(s.async, this, [i].concat(o))),
                          u() && e(a);
                      return this;
                    },
                  };
                    ...
                    n.mixin(i.prototype, o, {
                      ...
                      _setQuery: function (t, e) {
                        ...
                        (s = t),
                          ...
                          (r =
                            !!(n =
                              i.normalizeQuery(s) === i.normalizeQuery(o)) &&
                  ...
                  return (
                    ...
                    n.mixin(r.prototype, o, {
                      ...
                      _renderPending: function (t) {
                        ...
                        this._resetLastSuggestion(),
                          e &&
                            this.$el.html(e({ query: t, dataset: this.name }));
                      },
                          ...
                          n.each(r, function (n) {
                            ...
                            (u = o._injectQuery(i, n)),
                              (r = e(o.templates.suggestion(u))
                                ...
                                .addClass(
                                  o.classes.suggestion +
                                    " " +
                                    o.classes.selectable
                                )),
                              s.appendChild(r[0]);
                          }),
                          this.highlight &&
                    ...
                    n.mixin(t.prototype, o, {
                      ...
                      _ensureVisible: function (t) {
                        ...
                        (n = (e = t.position().top) + t.outerHeight(!0)),
                          ...
                          (r =
                            this.$node.height() +
                            parseFloat(this.$node.css("paddingTop"), 10) +
                            parseFloat(this.$node.css("paddingBottom"), 10)),
                          e < 0
                      ...
                      _updateHint: function () {
                        ...
                        (t = this.menu.getTopSelectable()),
                          ...
                          !e || n.isBlankString(i) || this.input.hasOverflow()
                            ...
                            : ((r = a.normalizeQuery(i)),
                              (s = n.escapeRegExChars(r)),
                              (o = new RegExp("^(?:" + s + ")(.+$)", "i").exec(
                                e.val
                              )) && this.input.setHint(i + o[1]));
                      },
                      isEnabled: function () {
                        return this.enabled;
                      },
                ...
                void (function () {
                  ...
                  function p(t) {
                    var i;
                    return (i =
                      n.isJQuery(t) || n.isElement(t) ? e(t).first() : [])
                      .length
                      ? i
                      : null;
                  }
                  (t = e.fn.typeahead),
                    ...
                    (o = {
                      initialize: function (t, o) {
                        var u;
                        return (
                          (o = n.isArray(o) ? o : [].slice.call(arguments, 1)),
                          (u = r((t = t || {}).classNames)),
                          this.each(g)
                        );
                        function g() {
