...
!(function (a) {
  ...
  var u = function (a, b, c, d, e) {
    ...
    x = (function () {
      ...
      function P(a) {
        var b = parseFloat(a.elements.modal.style.marginTop, 10),
          c = parseFloat(a.elements.modal.style.marginLeft, 10);
        if (
          ...
          "" !== a.elements.dialog.style.top &&
            (d = parseFloat(a.elements.dialog.style.top, 10)),
            (a.elements.dialog.style.top = d + (b - e()) + "px"),
            "" !== a.elements.dialog.style.left &&
              (g = parseFloat(a.elements.dialog.style.left, 10)),
      ...
      function fa(a, c) {
        if (null === Xa && !c.isMaximized() && c.get("movable")) {
          ...
          if (
            ...
            if (
              (b(g, Ia.capture),
              g.style.left && (e = parseFloat(g.style.left, 10)),
              g.style.top && (f = parseFloat(g.style.top, 10)),
              (Qa = d[Sa] - e),
              (Ra = d[Ta] - f),
              c.isModal()
        ...
        moveTo: function (a, b) {
          if (!isNaN(a) && !isNaN(b)) {
            ...
            var c = this.elements.dialog,
              ...
              f = 0,
              g = 0;
            c.style.left && (f -= parseFloat(c.style.left, 10)),
              c.style.top && (g -= parseFloat(c.style.top, 10));
            do {
              (f += e.offsetLeft), (g += e.offsetTop);
            } while ((e = e.offsetParent));
            var h = a - f,
