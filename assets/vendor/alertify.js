...
(function (window) {
  ...
  var dialog = (function () {
    ...
    function removeAbsPositionFix(instance) {
      var marginTop = parseFloat(instance.elements.modal.style.marginTop, 10);
      var marginLeft = parseFloat(instance.elements.modal.style.marginLeft, 10);
      ...
      if (instance.isOpen()) {
        ...
        if (instance.elements.dialog.style.top !== "") {
          top = parseFloat(instance.elements.dialog.style.top, 10);
        }
        instance.elements.dialog.style.top =
          top + (marginTop - getScrollTop()) + "px";

        if (instance.elements.dialog.style.left !== "") {
          left = parseFloat(instance.elements.dialog.style.left, 10);
        }
    ...
    function beginResize(event, instance) {
      if (!instance.isMaximized()) {
        ...
        if (eventSrc) {
          ...
          var element = instance.elements.dialog;
          addClass(element, classes.capture);
          startingLeft = parseFloat(element.style.left, 10);
    ...
    return {
      ...
      moveTo: function (x, y) {
        if (!isNaN(x) && !isNaN(y)) {
          ...
          if (element.style.left) {
            offsetLeft -= parseFloat(element.style.left, 10);
          }
          if (element.style.top) {
            offsetTop -= parseFloat(element.style.top, 10);
          }
          //calc offset
          do {
            offsetLeft += current.offsetLeft;
