...
<div class="row">     
	<div class="col-md-4">       
	<h4 class="fw-bold mb-4" style="padding-top:2px;">Pending Purchase Order Registor </h4>
	</div>
  ...
  <div class="card-datatable table-responsive pt-0">
	...
	<table class="datatables-basic table border-top" id="datatable-buttons" role="grid">
      <thead>
        <tr>
			<th width='3%'>Sr.No.</th>
			<th width='10%'>Date</th>
			<th width='10%'>Purchase Order No</th>
	...
	<tbody>
	   <?php
			...
			$data=$utilObj->getMultipleRow("purchase_order"," $cnd ");
...
function Search(){
	...
	window.location="pending_purchase_order_registor_list.php?FromDate="+fromdate+"&ToDate="+todate+"&supplier="+supplier+"&Task=filter";
}
